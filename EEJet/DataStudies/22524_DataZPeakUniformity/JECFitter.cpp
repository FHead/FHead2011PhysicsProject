...
int main(int argc, char *argv[])
{
   ...
   H0.SetStats(0);
   Events.FunctionType = AllEvent::Const;
   H0.SetBinContent(1, Events.GetJEC(45, 0.25 * M_PI, Parameter0));
   H0.SetBinContent(2, Events.GetJEC(45, 0.35 * M_PI, Parameter0));
   H0.SetBinContent(3, Events.GetJEC(45, 0.45 * M_PI, Parameter0));
   H0.SetBinContent(4, Events.GetJEC(45, 0.55 * M_PI, Parameter0));
   H0.SetBinContent(5, Events.GetJEC(45, 0.65 * M_PI, Parameter0));
   H0.SetBinContent(6, Events.GetJEC(45, 0.75 * M_PI, Parameter0));
   Events.FunctionType = AllEvent::Linear;
   H11.SetBinContent(1, Events.GetJEC(5, 0.25 * M_PI, Parameter1));
   H11.SetBinContent(2, Events.GetJEC(5, 0.35 * M_PI, Parameter1));
   H11.SetBinContent(3, Events.GetJEC(5, 0.45 * M_PI, Parameter1));
   H11.SetBinContent(4, Events.GetJEC(5, 0.55 * M_PI, Parameter1));
   H11.SetBinContent(5, Events.GetJEC(5, 0.65 * M_PI, Parameter1));
   H11.SetBinContent(6, Events.GetJEC(5, 0.75 * M_PI, Parameter1));
   H12.SetBinContent(1, Events.GetJEC(50, 0.25 * M_PI, Parameter1));
   H12.SetBinContent(2, Events.GetJEC(50, 0.35 * M_PI, Parameter1));
   H12.SetBinContent(3, Events.GetJEC(50, 0.45 * M_PI, Parameter1));
   H12.SetBinContent(4, Events.GetJEC(50, 0.55 * M_PI, Parameter1));
   H12.SetBinContent(5, Events.GetJEC(50, 0.65 * M_PI, Parameter1));
   H12.SetBinContent(6, Events.GetJEC(50, 0.75 * M_PI, Parameter1));
