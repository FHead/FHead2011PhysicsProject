...
public:
   ...
   double GetJEC(double P, const double *Parameters) const;
...
vector<double> AllEvent::GetMass(const vector<Event> &E, bool ApplyJEC, const double *Parameters) const
{
   ...
   for(int i = 0; i < (int)E.size(); i++)
   {
      ...
      for(int j = 0; j < E[i].N; j++)
      {
         ...
         double JEC = (ApplyJEC ? GetJEC(P, Parameters) : 1);
...
double AllEvent::GetJEC(double P, const double *Parameters) const
{
   ...
   if(FunctionType == Linear)
      return Parameters[0] + Parameters[1] * P;
   if(FunctionType == Quadratic)
      return Parameters[0] + Parameters[1] * P + Parameters[2] * P * P;
   if(FunctionType == Cubic)
      return Parameters[0] + Parameters[1] * P + Parameters[2] * P * P + Parameters[3] * P * P * P;
   if(FunctionType == Quartic)
      return Parameters[0] + Parameters[1] * P + Parameters[2] * P * P + Parameters[3] * P * P * P + Parameters[4] * P * P * P * P;
   if(FunctionType == Cintic)
      return Parameters[0] + Parameters[1] * P + Parameters[2] * P * P + Parameters[3] * P * P * P + Parameters[4] * P * P * P * P + Parameters[5] * P * P * P * P * P;
