...
int main(int argc, char *argv[])
{
   ...
   double E3Cut       = CL.GetDouble("E3Cut", 5);
   ...
   int N;
   float JetE[MAX], JetPT[MAX], JetEta[MAX], JetTheta[MAX], JetPhi[MAX], JetM[MAX];
   ...
   for(int iE = 0; iE < EntryCount; iE++)
   {
      ...
      if(J3E > E3Cut)   // remove events with significant third jet
         continue;
   ...
   for(int iB = 0; iB < NBins; iB++)
   {
      ...
      TH1D HP("HP", ";Jet E;", 100, 0, 100);
      TH1D HM("HM", ";Jet E;", 100, 0, 100);
      ...
      TLegend Legend(0.55, 0.8, 0.85, 0.55);
      Legend.SetTextFont(42);
      Legend.SetTextSize(0.05);
      Legend.SetFillStyle(0);
      Legend.SetBorderSize(0);
      Legend.AddEntry("", Form("%.2f-%.2f#pi", Bin[iB], Bin[iB+1]), "");
      Legend.AddEntry(&HP, "Plus side", "l");
      Legend.AddEntry(&HM, "Minus side", "l");
      Legend.Draw();
   ...
   HPMRatio.SetMarkerSize(2);
   HPMRatio.SetLineWidth(2);
