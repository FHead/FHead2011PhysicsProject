...
public:
   AllEvent();
   AllEvent(string FileNameMC, string FileNameData, double MinimumE = 5, int MaximumN = 3, double Percentage = 1);
   void Initialize(string FileNameMC, string FileNameData, double MinimumE = 5, int MaximumN = 3, double Percentage = 1);
...
AllEvent::AllEvent(string FileNameMC, string FileNameData, double MinimumE, int MaximumN, double Percentage)
{
   Initialize(FileNameMC, FileNameData, MinimumE, MaximumN);
}

void AllEvent::Initialize(string FileNameMC, string FileNameData, double MinimumE, int MaximumN, double Percentage)
{
   ECut = MinimumE;
   NJet = MaximumN;
...
vector<pair<double, double>> AllEvent::DoFit()
{
   ...
   Minimizer->SetLimitedVariable(0, "JECT0", 1.008, 0.003, 0.5, 1.5);
   Minimizer->SetLimitedVariable(1, "JECT1", 1.018, 0.003, 0.5, 1.5);
   Minimizer->SetLimitedVariable(2, "JECT2", 1.010, 0.003, 0.5, 1.5);
   Minimizer->SetLimitedVariable(3, "JECT3", 1.008, 0.003, 0.5, 1.5);
   Minimizer->SetLimitedVariable(4, "JECT4", 1.008, 0.003, 0.5, 1.5);
   Minimizer->SetLimitedVariable(5, "JECT5", 1.005, 0.003, 0.5, 1.5);
...
int main(int argc, char *argv[])
{
   ...
   AllEvent Events(FileNameMC, FileNameData, ECut, NJet, Percentage);
