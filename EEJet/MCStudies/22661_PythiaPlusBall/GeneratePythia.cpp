...
void GenerateEvents(string OutputFileName, int NEvent, double EPythia, double EBall, double Mean);
...
int main(int argc, char *argv[])
{
   ...
   double EPythia        = CL.GetDouble("EPythia", 90);
   ...
   GenerateEvents(OutputFileName, N, EPythia, EBall, Mean);
