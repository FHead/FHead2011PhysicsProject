...
int main(int argc, char *argv[])
{
   ...
   TH1D HJetXi("HJetXi", ";#xi;#frac{1}{N_{jet}}#frac{dN}{d#xi}", 40, 0, 5.5);
   TH1D HJetXi_20_25("HJetXi_20_25", "JetP = 20-25;#xi;#frac{1}{N_{jet}}#frac{dN}{d#xi}", 40, 0, 5.5);
   TH1D HJetXi_25_30("HJetXi_25_30", "JetP = 25-30;#xi;#frac{1}{N_{jet}}#frac{dN}{d#xi}", 40, 0, 5.5);
   TH1D HJetXi_30_35("HJetXi_30_35", "JetP = 30-35;#xi;#frac{1}{N_{jet}}#frac{dN}{d#xi}", 40, 0, 5.5);
   TH1D HJetXi_35_40("HJetXi_35_40", "JetP = 35-40;#xi;#frac{1}{N_{jet}}#frac{dN}{d#xi}", 40, 0, 5.5);
   TH1D HJetXi_35_37("HJetXi_35_37", "JetP = 35-37;#xi;#frac{1}{N_{jet}}#frac{dN}{d#xi}", 40, 0, 5.5);
   TH1D HJetXi_37_40("HJetXi_37_40", "JetP = 37-40;#xi;#frac{1}{N_{jet}}#frac{dN}{d#xi}", 40, 0, 5.5);
   TH1D HJetSD0ZG_35_40("HJetSD0ZG_35_40", "Jet P = 35-40, SD (0.1, 0.0);ZG;", 40, 0, 0.5);
   TH1D HJetSD0RG_35_40("HJetSD0RG_35_40", "Jet P = 35-40, SD (0.1, 0.0);RG;", 40, 0, 0.4);
   TH1D HJetSD0PF_35_40("HJetSD0PF_35_40", "Jet P = 35-40, SD (0.1, 0.0);Guu P / P;", 40, 0, 1.0);
   TH1D HJetSD1ZG_35_40("HJetSD1ZG_35_40", "Jet P = 35-40, SD (0.5, 1.5);ZG;", 40, 0, 0.5);
   TH1D HJetSD1RG_35_40("HJetSD1RG_35_40", "Jet P = 35-40, SD (0.5, 1.5);RG;", 40, 0, 0.4);
   TH1D HJetSD1PF_35_40("HJetSD1PF_35_40", "Jet P = 35-40, SD (0.5, 1.5);Guu P / P;", 40, 0, 1.0);
   ...
   double JetSDZG[MAX][SDMAX];
   double JetSDRG[MAX][SDMAX];
   double JetSDP[MAX][SDMAX];
   int JetSDDepth[MAX][SDMAX];
