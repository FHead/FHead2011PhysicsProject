# hltGetConfiguration /users/chenyi/PbPb2018/SiPixelClusterDebug/V3 --globaltag 100X_dataRun2_v1 --input file:/eos/cms/store/group/phys_heavyions/chenyi/Samples/XeXeDataMB8/RAW/TestDataFile.root --customise HLTrigger/Configuration/customizeHLTforCMSSW.customiseFor2017DtUnpacking --setup /dev/CMSSW_10_1_0/GRun --customise=L1Trigger/Configuration/customiseReEmul.L1TReEmulFromRAW --customise=L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleEMU --customise=L1Trigger/Configuration/customiseUtils.L1TTurnOffUnpackStage2GtGmtAndCalo --customise=FWCore/ParameterSet/MassReplace.massReplaceInputTag --process MyWonderfulHLT --full --offline --data --unprescale --max-events 20 --l1-emulator Full

# /users/chenyi/PbPb2018/SiPixelClusterDebug/V3 (CMSSW_10_1_2_patch2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/chenyi/PbPb2018/SiPixelClusterDebug/V3')
)
...
process.hltPreHIUPCNotMBORBptxANDPixelSingleTrack = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.HLT_HIUPCNotMBOR_BptxANDPixel_SingleTrack_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sNotZdcORBptxAND + process.hltPreHIUPCNotMBORBptxANDPixelSingleTrack + process.HLTDoHILocalPixelSequence + process.HLTRecopixelvertexingSequenceForUPC + process.hltPixelCandsForUPC + process.hltSinglePixelTrackForUPC + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_ZeroBias_v6, process.HLT_HIUPCNotMBOR_BptxANDPixel_SingleTrack_v1, process.HLTriggerFinalPath, process.HLTAnalyzerEndpath ))
