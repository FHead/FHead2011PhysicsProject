# hltGetConfiguration /users/chenyi/PbPb2018/HighPTJetsPbPb2018/V8 --globaltag 100X_dataRun2_v1 --input file:/eos/cms/store/group/phys_heavyions/chenyi/Samples/XeXeDataMB8/RAW/TestDataFile.root --setup /dev/CMSSW_10_1_0/GRun --customise HLTrigger/Configuration/customizeHLTforCMSSW.customiseFor2017DtUnpacking,L1Trigger/Configuration/customiseReEmul.L1TReEmulFromRAW,L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleEMU,L1Trigger/Configuration/customiseUtils.L1TTurnOffUnpackStage2GtGmtAndCalo,FWCore/ParameterSet/MassReplace.massReplaceInputTag --process MyWonderfulHLT --full --offline --data --unprescale --max-events 10 --l1-emulator Full
