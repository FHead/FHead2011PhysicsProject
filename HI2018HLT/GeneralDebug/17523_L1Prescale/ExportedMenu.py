# hltGetConfiguration /users/chenyi/PbPb2018/DefaultMenu/V4 --globaltag 100X_dataRun2_v1 --input file:/eos/cms/store/group/phys_heavyions/chenyi/Samples/XeXeDataMB8/RAW/TestDataFile.root --customise HLTrigger/Configuration/customizeHLTforCMSSW.customiseFor2017DtUnpacking,FWCore/ParameterSet/MassReplace.massReplaceInputTag --setup /dev/CMSSW_10_1_0/GRun --process MyWonderfulHLT --full --offline --data --unprescale --max-events -1

# /users/chenyi/PbPb2018/DefaultMenu/V4 (CMSSW_10_1_2_patch2)
