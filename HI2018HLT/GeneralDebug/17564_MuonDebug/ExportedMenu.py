# hltGetConfiguration /users/jaebeom/PbPb2018_HLT_min/V10 --globaltag auto:run2_mc_GRun --input __FILE__ --customise HLTrigger/Configuration/customizeHLTforCMSSW.customiseFor2017DtUnpacking --setup /dev/CMSSW_10_1_0/GRun --process MyWonderfulHLT --full --offline --mc --unprescale --max-events -1 --l1-emulator FullMC --l1Xml L1Menu_CollisionsHeavyIons2018_v1.xml
...
process = L1XML(process,"L1Menu_CollisionsHeavyIons2018_v1.xml")
...
_customInfo['inputFile' ]=  ['file:Samples/F4DA098E-76AB-E811-93EE-68CC6EA5BE82.root']
