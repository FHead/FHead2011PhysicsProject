# hltGetConfiguration /users/jaebeom/PbPb2018_HLT_min/V10 --globaltag auto:run2_mc_GRun --input _FILE_ --customise HLTrigger/Configuration/customizeHLTforCMSSW.customiseFor2017DtUnpacking --setup /dev/CMSSW_10_1_0/GRun --process MyWonderfulHLT --full --offline --mc --unprescale --max-events -1 --l1-emulator FullMC

# /users/jaebeom/PbPb2018_HLT_min/V10 (CMSSW_10_1_7)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/jaebeom/PbPb2018_HLT_min/V10')
)
...
process.hltPreHIL1DoubleMuOpenBptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreHIL1DoubleMuOpenOSBptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreHIL1DoubleMuOpenSSBptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1sDoubleMuOpenCent10100BptxAND = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_DoubleMuOpen_Centrality_50_100_MinimumBiasHF1_AND_BptxAND" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreHIL1DoubleMuOpenCent10100BptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1fL1sDoubleMuOpenCent10100BptxANDL1Filtered0 = cms.EDFilter( "HLTMuonL1TFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL1sDoubleMuOpenCent10100BptxAND" ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 2.5 ),
    CentralBxOnly = cms.bool( True ),
...
process.hltL1sDoubleMuOpenCent50100BptxAND = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_DoubleMuOpen_Centrality_50_100_MinimumBiasHF1_AND_BptxAND" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
...
process.hltPreHIL1DoubleMuOpenCent50100BptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1fL1sDoubleMuOpenCent50100BptxANDL1Filtered0 = cms.EDFilter( "HLTMuonL1TFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL1sDoubleMuOpenCent50100BptxAND" ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 2.5 ),
    CentralBxOnly = cms.bool( True ),
...
process.hltPreHIL1DoubleMu0BptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1sDoubleMu0Cent10100BptxAND = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_DoubleMu0_Centrality_10_100_MinimumBiasHF1_AND_BptxAND" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreHIL1DoubleMu0Cent10100BptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1fL1sDoubleMu0Cent10100BptxANDL1Filtered0 = cms.EDFilter( "HLTMuonL1TFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL1sDoubleMu0Cent10100BptxAND" ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 2.5 ),
    CentralBxOnly = cms.bool( True ),
...
process.hltL1sDoubleMu0Cent30100BptxAND = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_DoubleMu0_Centrality_30_100_MinimumBiasHF1_AND_BptxAND" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreHIL1DoubleMu0Cent30100BptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1fL1sDoubleMu0Cent30100BptxANDL1Filtered0 = cms.EDFilter( "HLTMuonL1TFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL1sDoubleMu0Cent30100BptxAND" ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 2.5 ),
    CentralBxOnly = cms.bool( True ),
...
process.hltL1sDoubleMu0Cent50100BptxAND = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_DoubleMu0_Centrality_50_100_MinimumBiasHF1_AND_BptxAND" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreHIL1DoubleMu0Cent50100BptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1fL1sDoubleMu0Cent50100BptxANDL1Filtered0 = cms.EDFilter( "HLTMuonL1TFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL1sDoubleMu0Cent50100BptxAND" ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 2.5 ),
    CentralBxOnly = cms.bool( True ),
...
process.hltSiPixelClusters = cms.EDProducer( "SiPixelClusterProducer",
    ...
    maxNumberOfClusters = cms.int32( 100000 ),
...
process.HLT_HIL1DoubleMuOpen_BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleMuOpenBptxAND + process.hltPreHIL1DoubleMuOpenBptxAND + process.hltL1fL1sDoubleMuOpenBptxANDL1Filtered0 + process.HLTEndSequence )
process.HLT_HIL1DoubleMuOpen_OS_BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleMuOpenOSBptxAND + process.hltPreHIL1DoubleMuOpenOSBptxAND + process.hltL1fL1sDoubleMuOpenOSBptxANDL1Filtered0 + process.HLTEndSequence )
process.HLT_HIL1DoubleMuOpen_SS_BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleMuOpenSSBptxAND + process.hltPreHIL1DoubleMuOpenSSBptxAND + process.hltL1fL1sDoubleMuOpenSSBptxANDL1Filtered0 + process.HLTEndSequence )
process.HLT_HIL1DoubleMuOpen_Cent10100_BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleMuOpenCent10100BptxAND + process.hltPreHIL1DoubleMuOpenCent10100BptxAND + process.hltL1fL1sDoubleMuOpenCent10100BptxANDL1Filtered0 + process.HLTEndSequence )
process.HLT_HIL1DoubleMuOpen_Cent50100_BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleMuOpenCent50100BptxAND + process.hltPreHIL1DoubleMuOpenCent50100BptxAND + process.hltL1fL1sDoubleMuOpenCent50100BptxANDL1Filtered0 + process.HLTEndSequence )
...
process.HLT_HIL1DoubleMu0_BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleMu0BptxAND + process.hltPreHIL1DoubleMu0BptxAND + process.hltL1fL1sDoubleMu0BptxANDL1Filtered0 + process.HLTEndSequence )
process.HLT_HIL1DoubleMu0_Cent10100_BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleMu0Cent10100BptxAND + process.hltPreHIL1DoubleMu0Cent10100BptxAND + process.hltL1fL1sDoubleMu0Cent10100BptxANDL1Filtered0 + process.HLTEndSequence )
process.HLT_HIL1DoubleMu0_Cent30100_BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleMu0Cent30100BptxAND + process.hltPreHIL1DoubleMu0Cent30100BptxAND + process.hltL1fL1sDoubleMu0Cent30100BptxANDL1Filtered0 + process.HLTEndSequence )
process.HLT_HIL1DoubleMu0_Cent50100_BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleMu0Cent50100BptxAND + process.hltPreHIL1DoubleMu0Cent50100BptxAND + process.hltL1fL1sDoubleMu0Cent50100BptxANDL1Filtered0 + process.HLTEndSequence )
...
process.HLT_HIL3DoubleMu0_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleMu0 + process.hltPreHIL3DoubleMu0 + process.hltL1fL1sDoubleMu0L1Filtered0 + process.HLTL2muonrecoSequence + cms.ignore(process.hltL2fL1sDoubleMu0L1f0L2Filtered0) + process.HLTL3muonrecoSequence + cms.ignore(process.hltL1fForIterL3L1fL1sDoubleMu0L1Filtered0) + process.hltL3fL1sDoubleMu0L1f0L2f0L3Filtered0 + process.HLTEndSequence )
...
process.HLT_L1SingleMuOpen_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMuOpen + process.hltPreL1SingleMuOpen + process.hltL1MuOpenL1Filtered0 + process.HLTEndSequence )
...
process.HLT_HIL3Mu7_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu3OR5 + process.hltPreHIL3Mu7 + process.hltL1fL1sSingleMu3OR5L1Filtered0 + process.HLTL2muonrecoSequence + cms.ignore(process.hltL2fL1sSingleMu3OR5L1f0L2Filtered0) + process.HLTL3muonrecoSequence + cms.ignore(process.hltL1fForIterL3L1fL1sSingleMu3OR5L1Filtered0) + process.hltL3fL1sSingleMu3OR5L1f0L2f0L3Filtered7 + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_HIL1DoubleMuOpen_v1, process.HLT_HIL1DoubleMuOpen_OS_v1, process.HLT_HIL1DoubleMuOpen_SS_v1, process.HLT_HIL1DoubleMuOpen_BptxAND_v1, process.HLT_HIL1DoubleMuOpen_OS_BptxAND_v1, process.HLT_HIL1DoubleMuOpen_SS_BptxAND_v1, process.HLT_HIL1DoubleMuOpen_Cent10100_BptxAND_v1, process.HLT_HIL1DoubleMuOpen_Cent50100_BptxAND_v1, process.HLT_HIL1DoubleMu0_v1, process.HLT_HIL1DoubleMu0_BptxAND_v1, process.HLT_HIL1DoubleMu0_Cent10100_BptxAND_v1, process.HLT_HIL1DoubleMu0_Cent30100_BptxAND_v1, process.HLT_HIL1DoubleMu0_Cent50100_BptxAND_v1, process.HLT_HIL2DoubleMu0_v1, process.HLT_HIL3DoubleMu0_v2, process.HLT_L1DoubleMu0_v1, process.HLT_L1SingleMuOpen_v1, process.HLT_L1SingleMu3_v1, process.HLT_L1SingleMu5_v1, process.HLT_L1SingleMu7_v1, process.HLT_HIL2Mu7_v1, process.HLT_HIL3Mu3_v1, process.HLT_HIL3Mu5_v1, process.HLT_HIL3Mu7_v2, process.HLT_HIL3Mu12_v1, process.HLT_HIL3Mu15_v1, process.HLT_HIL3Mu20_v1, process.HLTriggerFinalPath, process.HLTAnalyzerEndpath ))
...
_customInfo['inputFile' ]=  ['/store/himc/HINPbPbSpring18DR/Hydjet_Quenched_Drum5Ev8_PbPbMinBias_5020GeV_2018/GEN-SIM-RAW/NoPU_100X_upgrade2018_realistic_v10_ext1-v1/00001/F4DA098E-76AB-E811-93EE-68CC6EA5BE82.root']
