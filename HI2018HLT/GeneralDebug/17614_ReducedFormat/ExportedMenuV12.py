# hltGetConfiguration /users/chenyi/PbPb2018/ReducedFormat/V12 --globaltag auto:run2_data_HIon --input file:step2_RAW2DIGI_REPACK.root --customise HLTrigger/Configuration/customizeHLTforCMSSW.customiseFor2017DtUnpacking --setup /dev/CMSSW_10_1_0/GRun --process MyWonderfulHLT --full --offline --data --unprescale --max-events -1

# /users/chenyi/PbPb2018/ReducedFormat/V12 (CMSSW_10_3_0_pre4)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/chenyi/PbPb2018/ReducedFormat/V12')
)
