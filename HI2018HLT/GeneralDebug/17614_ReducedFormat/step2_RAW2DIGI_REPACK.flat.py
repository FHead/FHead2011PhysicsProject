...
process = cms.Process("EMULATEHYBRID")
...
process.DefaultAlgorithms = cms.PSet(
    APVInspectMode = cms.string('HybridEmulation'),
    ...
    MeanCM = cms.int32(512),
    PedestalSubtractionFedMode = cms.bool(False),
    SiStripFedZeroSuppressionMode = cms.uint32(4),
    TruncateInSuppressor = cms.bool(True),
    Use10bitsTruncation = cms.bool(True),
...
process.rawDataCollector = cms.EDProducer("RawDataCollectorByLabel",
    RawCollectionList = cms.VInputTag(cms.InputTag("SiStripDigiToZSRaw"), cms.InputTag("rawDataCollector"), cms.InputTag("l1tDigiToRaw")),
...
process.siStripZeroSuppression = cms.EDProducer("SiStripZeroSuppression",
    ...
    produceHybridFormat = cms.bool(True),
...
process.DigiToHybridRawRepack = cms.Sequence(process.siStripZeroSuppression+process.SiStripDigiToHybridRaw+process.hybridRawDataRepacker)
...
process.DigiToRawRepack = cms.Sequence(process.SiStripDigiToZSRaw+process.rawDataRepacker)
...
process.DigiToVirginRawRepack = cms.Sequence(process.SiStripRawDigiToVirginRaw+process.virginRawDataRepacker)


process.DigiToSplitRawRepack = cms.Sequence(process.DigiToRawRepack+process.DigiToVirginRawRepack)
...
process.schedule = cms.Schedule(*[ process.raw2digi_step, process.digi2repack_step, process.endjob_step, process.RAWoutput_step ], tasks=[process.patAlgosToolsTask])
