# hltGetConfiguration /users/chenyi/PbPb2018/ReducedFormat/V13 --globaltag auto:run2_data_HIon --input file:step2_RAW2DIGI_REPACK.root --customise HLTrigger/Configuration/customizeHLTforCMSSW.customiseFor2017DtUnpacking --setup /dev/CMSSW_10_1_0/GRun --process MyMarvelousHLT --full --offline --data --unprescale --max-events -1
