# hltGetConfiguration /users/chenyi/PbPb2018/ReducedFormat/V14 --globaltag auto:run2_data_HIon --input file:/eos/cms/store/group/phys_heavyions/chenyi/Samples/store/user/caber/Data_DeltaCMThreshold10_newHybridFormat_v2/HITrackerVirginRaw/crab_data_DeltaCMThreshold10_newHybridFormat_v2/180911_231252/0001/step2_RAW2DIGI_DIGI2RAW_Hybrid_1850.root --customise HLTrigger/Configuration/customizeHLTforCMSSW.customiseFor2017DtUnpacking --setup /dev/CMSSW_10_1_0/GRun --process MyMarvelousHLT --full --offline --data --unprescale --max-events 10

# /users/chenyi/PbPb2018/ReducedFormat/V14 (CMSSW_10_2_5)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "MyMarvelousHLT" )
process.load("setup_dev_CMSSW_10_1_0_GRun_cff")

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/chenyi/PbPb2018/ReducedFormat/V14')
)
...
process.hltOutputStreamMuonFullRAW = cms.OutputModule( "PoolOutputModule",
    fileName = cms.untracked.string( "outputStreamMuonFullRAW.root" ),
...
process.hltOutputStreamMuonRFRAW = cms.OutputModule( "PoolOutputModule",
    fileName = cms.untracked.string( "outputStreamMuonRFRAW.root" ),
    fastCloning = cms.untracked.bool( False ),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string( "" ),
        dataTier = cms.untracked.string( "RAW" )
...
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/eos/cms/store/group/phys_heavyions/chenyi/Samples/store/user/caber/Data_DeltaCMThreshold10_newHybridFormat_v2/HITrackerVirginRaw/crab_data_DeltaCMThreshold10_newHybridFormat_v2/180911_231252/0001/step2_RAW2DIGI_DIGI2RAW_Hybrid_1850.root',
    ),
...
_customInfo['inputFile' ]=  ['/store/user/caber/Data_DeltaCMThreshold20_newHybridFormat_v2/HITrackerVirginRaw/crab_data_DeltaCMThreshold20_newHybridFormat_v2/180805_025943/0000/file_RECO_734.root']
