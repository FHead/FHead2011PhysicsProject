# hltGetConfiguration /users/chenyi/PbPb2018/ReducedFormatFullMenu/V8 --globaltag auto:run2_data_HIon --input file:/eos/cms/store/group/phys_heavyions/chenyi/Samples/store/user/caber/Data_DeltaCMThreshold20_newHybridFormat_v2/HITrackerVirginRaw/crab_data_DeltaCMThreshold20_newHybridFormat_v2/180805_025943/0000/file_RECO_734.root --process MyWonderfulHLT --full --offline --data --unprescale --max-events 10

# /users/chenyi/PbPb2018/ReducedFormatFullMenu/V8 (CMSSW_10_2_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/chenyi/PbPb2018/ReducedFormatFullMenu/V8')
)
