# hltGetConfiguration /users/chenyi/PbPb2018/ReducedFormatFullMenu/V9 --globaltag auto:run2_data_HIon --input file:/eos/cms/store/group/phys_heavyions/chenyi/Samples/store/user/caber/Data_DeltaCMThreshold20_newHybridFormat_v2/HITrackerVirginRaw/crab_data_DeltaCMThreshold20_newHybridFormat_v2/180805_025943/0000/file_RECO_734.root --process MyWonderfulHLT --full --offline --data --unprescale --max-events 10

# /users/chenyi/PbPb2018/ReducedFormatFullMenu/V9 (CMSSW_10_2_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/chenyi/PbPb2018/ReducedFormatFullMenu/V9')
)
...
process.datasets = cms.PSet(
  ...
  ExpressAlignment = cms.vstring( 'HLT_L1SingleMuOpen_v2' ),
  ExpressPhysics = cms.vstring( 'HLT_L1SingleMuOpen_v2',
    'HLT_Physics_v7',
    'HLT_Random_v3' ),
...
process.HLT_L1SingleMuOpen_ForVR_v2 = cms.Path( process.HLTBeginSequence + cms.ignore(process.hltL1sSingleMuOpen) + process.hltPreL1SingleMuOpenForVR + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
...
process.HITestReducedOutput = cms.EndPath( process.hltGtStage2Digis + process.hltPreHITestVROutput + process.hltOutputHITestFull )
...
_customInfo['maxEvents' ]=  15
_customInfo['globalTag' ]= "auto:run2_data_HIon"
_customInfo['inputFile' ]=  ['file:/eos/cms/store/group/phys_heavyions/chenyi/Samples/store/user/caber/Data_DeltaCMThreshold20_newHybridFormat_v2/HITrackerVirginRaw/crab_data_DeltaCMThreshold20_newHybridFormat_v2/180805_025943/0000/file_RECO_734.root']
...
process = massReplaceInputTag(process, "rawDataCollector", "myRawDataCollector", False, True)
process = massReplaceInputTag(process, "TriggerResults::HLT", "TriggerResults::@currentProcess", False, True)
process = massReplaceInputTag(process, "hltTriggerSummaryAOD::HLT", "hltTriggerSummaryAOD::@currentProcess", False, True)
