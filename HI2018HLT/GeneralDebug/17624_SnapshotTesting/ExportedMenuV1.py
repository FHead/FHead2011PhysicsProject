# hltGetConfiguration /users/chenyi/PbPb2018/SnapshotMenu/V1 --globaltag auto:run2_mc_GRun --input file:SamplesDiJet100/step1_DIGI_L1_DIGI2RAW_HLT_PU_34.root --customise HLTrigger/Configuration/customizeHLTforCMSSW.customiseFor2017DtUnpacking --process MyWonderfulHLT --full --offline --mc --unprescale --max-events -1 --l1-emulator FullMC

# /users/chenyi/PbPb2018/SnapshotMenu/V1 (CMSSW_10_2_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/chenyi/PbPb2018/SnapshotMenu/V1')
)
...
process.RatesMonitoring = cms.EndPath( )
process.DQMHistograms = cms.EndPath( )
