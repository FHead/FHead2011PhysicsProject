OutputBase = '/store/group/phys_heavyions/chenyi/PbPb2022/HLTJEC/'
...
DatasetName = 'KayaJECDigiTrees'
Tag = '20220930_HLTJECTrees'
...
config.JobType.psetName = 'ExportedMenu.py'
