# hltGetConfiguration /users/chenyi/PbPb2022/RawPrime/HLT/V9 --globaltag auto:phase1_2022_realistic_hi --l1Xml L1Menu_CollisionsHeavyIons2022_v0_0_0.xml --l1-emulator FullMC --era Run3 --input root://cmsxrootd.fnal.gov//store/himc/Run3Winter22PbPbNoMixDIGI/MinBias_Hydjet_Drum5F_5p02TeV/GEN-SIM-DIGI-RAW-HLTDEBUG/122X_mcRun3_2021_realistic_HI_v10-v3/2430000/0084147f-227f-4698-be9f-fa9d58036906.root --process MyHLT --full --mc --unprescale --no-output --max-events -1

# /users/chenyi/PbPb2022/RawPrime/HLT/V9 (CMSSW_12_4_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/chenyi/PbPb2022/RawPrime/HLT/V9')
)
...
process.hltL1sSingleEG3Centrality30100BptxAND = cms.EDFilter( "HLTL1TSeed",
...
process.HLT_HICentralityVeto_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG3Centrality30100BptxAND + process.hltPreHICentralityVeto + process.HLTDoHIStripZeroSuppressionAndRawPrime + process.HLTEndSequence )
...
process.schedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_HICentralityVeto_v2, process.HLT_HIZeroBias_v2, process.HLT_HIZeroBias_FirstCollisionAfterAbortGap_v2, process.HLT_HIMinimumBias_v1, process.HLT_HIRandom_v1, process.HLT_HIPhysics_v2, process.HLT_HIHcalNZS_v2, process.HLT_HIL1NotBptxOR_v2, process.HLT_HIL1UnpairedBunchBptxMinus_v2, process.HLT_HIL1UnpairedBunchBptxPlus_v2, process.HLTriggerFinalPath, ))


# source module (EDM inputs)
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'root://cmsxrootd.fnal.gov//store/himc/Run3Winter22PbPbNoMixDIGI/MinBias_Hydjet_Drum5F_5p02TeV/GEN-SIM-DIGI-RAW-HLTDEBUG/122X_mcRun3_2021_realistic_HI_v10-v3/2430000/0084147f-227f-4698-be9f-fa9d58036906.root',
    ),
...
# _customInfo['inputFile' ]=  ['root://cmsxrootd.fnal.gov//store/himc/Run3Winter22PbPbNoMixDIGI/MinBias_Hydjet_Drum5F_5p02TeV/GEN-SIM-DIGI-RAW-HLTDEBUG/122X_mcRun3_2021_realistic_HI_v10-v3/2430000/0084147f-227f-4698-be9f-fa9d58036906.root']
...
process.output = cms.OutputModule("PoolOutputModule",
    outputCommands = cms.untracked.vstring("drop *", "keep *_TriggerResults_*_*", "keep *_hltTriggerSummaryAOD_*_*", "keep *_hltGtStage2Digis_*_*", "keep *_hltGtStage2ObjectMap_*_*", "keep *_rawDataRepacker_*_*", "keep *_rawPrimeDataRepacker_*_*", "keep *_SiStripClusters2ApproxClustersHLT_*_*", "keep *_hltSiStripClusterizerForRawPrime_*_*"),
