...
process.rawDataRepacker = cms.EDProducer( "EvFFEDSelector",
...
process.HLTDoHIStripZeroSuppressionAndRawPrime = cms.Sequence( process.hltSiStripRawToDigi + process.hltSiStripZeroSuppression + process.hltSiStripDigiToZSRaw + process.hltSiStripClusterizerForRawPrime + process.SiStripClusters2ApproxClustersHLT + process.rawDataRepackerFull + process.rawDataRepacker )
...
process.output = cms.OutputModule("PoolOutputModule",
    outputCommands = cms.untracked.vstring("drop *", "keep *_TriggerResults_*_*", "keep *_hltTriggerSummaryAOD_*_*", "keep *_hltGtStage2Digis_*_*", "keep *_hltGtStage2ObjectMap_*_*", "keep *_rawDataRepacker_*_*", "keep *_SiStripClusters2ApproxClustersHLT_*_*"),
