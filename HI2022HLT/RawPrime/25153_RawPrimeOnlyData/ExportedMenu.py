# hltGetConfiguration /users/chenyi/PbPb2022/RawPrime/RawPrimeAsNominal/V1 --globaltag auto:phase1_2022_realistic_hi --l1Xml L1Menu_CollisionsHeavyIons2022_v0_0_0.xml --l1-emulator uGT --era Run3 --input file:///eos/cms/store/data/Run2022F/EphemeralHLTPhysics0/RAW/v1/000/360/761/00000/f9db72a8-c646-48c1-9d64-edf91c7de7cf.root --process MyHLT --full --data

# /users/chenyi/PbPb2022/RawPrime/RawPrimeAsNominal/V1 (CMSSW_12_4_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/chenyi/PbPb2022/RawPrime/RawPrimeAsNominal/V1')
)
...
process.rawDataRepackerFull = cms.EDProducer( "RawDataCollectorByLabel",
...
process.rawPrimeDataRepacker = cms.EDProducer( "EvFFEDSelector",
    inputTag = cms.InputTag( "rawDataRepackerFull" ),
...
process.HLTDoHIStripZeroSuppressionAndRawPrime = cms.Sequence( process.hltSiStripRawToDigi + process.hltSiStripZeroSuppression + process.hltSiStripDigiToZSRaw + process.hltSiStripClusterizerForRawPrime + process.SiStripClusters2ApproxClustersHLT + process.rawDataRepackerFull + process.rawPrimeDataRepacker )
...
process.schedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_HIZeroBias_v2, process.HLTriggerFinalPath, ))
...
process.output = cms.OutputModule("PoolOutputModule",
    outputCommands = cms.untracked.vstring("drop *", "keep *_TriggerResults_*_*", "keep *_hltTriggerSummaryAOD_*_*", "keep *_hltGtStage2Digis_*_*", "keep *_hltGtStage2ObjectMap_*_*", "keep *_rawPrimeDataRepacker_*_*", "keep *_SiStripClusters2ApproxClustersHLT_*_*"),
