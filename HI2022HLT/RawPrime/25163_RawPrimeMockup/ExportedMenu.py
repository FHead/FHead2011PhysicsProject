# hltGetConfiguration /users/chenyi/PbPb2022/RawPrime/RawPrimeCleanUp/V5 --globaltag auto:phase1_2022_realistic_hi --l1Xml L1Menu_CollisionsHeavyIons2022_v0_0_0.xml --l1-emulator uGT --era Run3 --input file:///eos/cms/store/data/Run2022F/EphemeralHLTPhysics0/RAW/v1/000/360/761/00000/f9db72a8-c646-48c1-9d64-edf91c7de7cf.root --process MyHLT --full --data --unprescale --no-output --max-events 2000

# /users/chenyi/PbPb2022/RawPrime/RawPrimeCleanUp/V5 (CMSSW_12_4_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/chenyi/PbPb2022/RawPrime/RawPrimeCleanUp/V5')
)
...
process.schedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_HIMinimumBias_v1, process.HLTriggerFinalPath, ))
