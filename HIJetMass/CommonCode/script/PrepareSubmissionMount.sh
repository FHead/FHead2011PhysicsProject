...
do
   ...
   do
      ...
      echo "      | sed \"s#__INPUT__#$EOSBase/$Location/$i#g\" \\"
...
cp $WorkspaceBase/CommonCode/script/BatchHeaderMount.txt BatchTemplate.submit
echo "__EXECUTABLE__ __INPUT__ Output.root __TAG__ $@" >> BatchTemplate.submit
