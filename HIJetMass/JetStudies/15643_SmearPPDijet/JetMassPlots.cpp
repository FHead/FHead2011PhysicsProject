...
int main(int argc, char *argv[])
{
   ...
   double TreeNewJetPT, TreeNewJetEta, TreeNewJetPhi, TreeNewJetSDMass, TreeNewJetDR, TreeNewJetZG, TreeNewJetMass;
   double TreeBestJetPT, TreeBestJetEta, TreeBestJetPhi, TreeBestJetSDMass, TreeBestJetDR, TreeBestJetZG, TreeBestJetMass;
   double TreeNewJetSDMass2, TreeNewJetDR2, TreeNewJetZG2;
   double TreeBestJetSDMass2, TreeBestJetDR2, TreeBestJetZG2;
   double TreeNewJetSDMass3, TreeNewJetDR3, TreeNewJetZG3;
   double TreeBestJetSDMass3, TreeBestJetDR3, TreeBestJetZG3;
   ...
   int EntryCount = MHiEvent.Tree->GetEntries() * 0.25;
