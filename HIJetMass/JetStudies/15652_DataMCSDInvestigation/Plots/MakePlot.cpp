...
int main()
{
   ...
   for(int i = 0; i < 10; i++)
   {
      ...
      Canvas.SaveAs(Form("SDParameterScan_SDMass_%d.png", i));
      Canvas.SaveAs(Form("SDParameterScan_SDMass_%d.C", i));
      Canvas.SaveAs(Form("SDParameterScan_SDMass_%d.eps", i));
      Canvas.SaveAs(Form("SDParameterScan_SDMass_%d.pdf", i));
      ...
      Canvas.SaveAs(Form("SDParameterScan_ZG_%d.png", i));
      Canvas.SaveAs(Form("SDParameterScan_ZG_%d.C", i));
      Canvas.SaveAs(Form("SDParameterScan_ZG_%d.eps", i));
      Canvas.SaveAs(Form("SDParameterScan_ZG_%d.pdf", i));
