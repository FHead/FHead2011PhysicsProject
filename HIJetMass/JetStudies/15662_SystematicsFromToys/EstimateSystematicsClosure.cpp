...
int main(int argc, char *argv[])
{
   ...
   T1->SetAlias("Fudge", "((MCWeight < 500) * (1 + 148.508 * exp(-0.5 * ((JetPT-21.6726) / 51.3483)**2)))");
   T1->SetAlias("JetPTWeight", "(0.530445 + exp(6.17999 - 0.0488322 * NewJetPT))");
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P0", "MCWeight * JetPTWeight * (JetShift < 0.2 && JetPT > 120 && JetPT < 140 && NewJetDR2 > 0.1)");
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P1", "MCWeight * JetPTWeight * (JetShift < 0.2 && JetPT > 140 && JetPT < 160 && NewJetDR2 > 0.1)");
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P2", "MCWeight * JetPTWeight * (JetShift < 0.2 && JetPT > 160 && JetPT < 180 && NewJetDR2 > 0.1)");
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P3", "MCWeight * JetPTWeight * (JetShift < 0.2 && JetPT > 180 && JetPT < 200 && NewJetDR2 > 0.1)");
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P4", "MCWeight * JetPTWeight * (JetShift < 0.2 && JetPT > 200 && JetPT < 300 && NewJetDR2 > 0.1)");
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P5", "MCWeight * JetPTWeight * (JetShift < 0.2 && JetPT > 300 && JetPT < 500 && NewJetDR2 > 0.1)");

   T2->SetAlias("Fudge", "((MCWeight < 1000) * (1 + 1997.74 * exp(-(JetPT+14.1508)**2 / (2*54.9762**2))))");
   T2->Draw("SDMass[7]/NewJetPT>>HModified_P0", "MCWeight * (SDRecoDR[7] > 0.1 && JetPT > 120 && JetPT < 140 && Centrality < 0.10 && abs(JetEta) < 1.3) * Fudge");
   T2->Draw("SDMass[7]/NewJetPT>>HModified_P1", "MCWeight * (SDRecoDR[7] > 0.1 && JetPT > 140 && JetPT < 160 && Centrality < 0.10 && abs(JetEta) < 1.3) * Fudge");
   T2->Draw("SDMass[7]/NewJetPT>>HModified_P2", "MCWeight * (SDRecoDR[7] > 0.1 && JetPT > 160 && JetPT < 180 && Centrality < 0.10 && abs(JetEta) < 1.3) * Fudge");
   T2->Draw("SDMass[7]/NewJetPT>>HModified_P3", "MCWeight * (SDRecoDR[7] > 0.1 && JetPT > 180 && JetPT < 200 && Centrality < 0.10 && abs(JetEta) < 1.3) * Fudge");
   T2->Draw("SDMass[7]/NewJetPT>>HModified_P4", "MCWeight * (SDRecoDR[7] > 0.1 && JetPT > 200 && JetPT < 300 && Centrality < 0.10 && abs(JetEta) < 1.3) * Fudge");
   T2->Draw("SDMass[7]/NewJetPT>>HModified_P5", "MCWeight * (SDRecoDR[7] > 0.1 && JetPT > 300 && JetPT < 500 && Centrality < 0.10 && abs(JetEta) < 1.3) * Fudge");
