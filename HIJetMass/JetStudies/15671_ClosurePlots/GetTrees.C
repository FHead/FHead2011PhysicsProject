{
   ...
   if(T8)  T8->SetAlias("AdjustedExcessPT", "(ExcessPT*(ExcessPT>0)+ExcessPT*16*(ExcessPT<0))");
   ...
   if(T8)  T8->SetAlias("SmearWeightAdjusted", "(((AdjustedExcessPT>0)+16*(AdjustedExcessPT<0)*(exp(-AdjustedExcessPT*AdjustedExcessPT/2/(27.35*27.35))/exp(-AdjustedExcessPT*AdjustedExcessPT/2/(27.35*27.35*16*16))))*(exp(-AdjustedExcessPT*AdjustedExcessPT/(2*17.2*17.2))/exp(-AdjustedExcessPT*AdjustedExcessPT/(2*27.35*27.35))))");
   if(T8)  T8->SetAlias("JetPTWeight", "(1 / (0.526940+0.475752*erf(0.0379893*(JetPT-95.6267))))");
   if(T8)  T8->SetAlias("SmearWeightAdjusted2", "(((AdjustedExcessPT>0)+16*(AdjustedExcessPT<0)*(exp(-AdjustedExcessPT*AdjustedExcessPT/2/(27.35*27.35))/exp(-AdjustedExcessPT*AdjustedExcessPT/2/(27.35*27.35*16*16))))*(exp(-AdjustedExcessPT*AdjustedExcessPT/(2*12.8*12.8))/exp(-AdjustedExcessPT*AdjustedExcessPT/(2*27.35*27.35))))");
