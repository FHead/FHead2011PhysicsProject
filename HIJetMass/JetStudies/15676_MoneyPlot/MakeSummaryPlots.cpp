...
int main()
{
   // string FileName = "GraphsMCAdjusted.root";
   // string OutputBase = "MCClosure";
   string FileName = "GraphsDataAdjusted.root";
   string OutputBase = "DataClosure";
   ...
   for(int i = 1; i < 6; i++)
   {
      ...
      DoGraph(Gs, OutputBase + Form("_PrettyPlotPTBin%d", i));
   }
