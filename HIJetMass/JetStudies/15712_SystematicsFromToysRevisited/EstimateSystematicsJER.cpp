...
int main(int argc, char *argv[])
{
   if(argc < 6)
   {
      cerr << "Usage: " << argv[0] << " BaseFile ModifiedFile Tag Left Right" << endl;
      return -1;
   }
   ...
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P0", "MCWeight * (JetShift < 0.2 && JetPT > 120 && JetPT < 140 && NewJetDR2 > 0.1)");
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P1", "MCWeight * (JetShift < 0.2 && JetPT > 140 && JetPT < 160 && NewJetDR2 > 0.1)");
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P2", "MCWeight * (JetShift < 0.2 && JetPT > 160 && JetPT < 180 && NewJetDR2 > 0.1)");
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P3", "MCWeight * (JetShift < 0.2 && JetPT > 180 && JetPT < 200 && NewJetDR2 > 0.1)");
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P4", "MCWeight * (JetShift < 0.2 && JetPT > 200 && JetPT < 300 && NewJetDR2 > 0.1)");
   T1->Draw("NewJetSDMass2/NewJetPT>>HNominal_P5", "MCWeight * (JetShift < 0.2 && JetPT > 300 && JetPT < 500 && NewJetDR2 > 0.1)");
   
   T2->SetAlias("Fudge", "((MCWeight < 500) * (1 + 122.874 * exp(-0.5 * ((JetPT-45.0945) / 43.8684)**2)))");
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P0", "MCWeight * (JetShift < 0.2 && JetPT*Smear > 120 && JetPT*Smear < 140 && NewJetDR2 > 0.1)");
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P1", "MCWeight * (JetShift < 0.2 && JetPT*Smear > 140 && JetPT*Smear < 160 && NewJetDR2 > 0.1)");
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P2", "MCWeight * (JetShift < 0.2 && JetPT*Smear > 160 && JetPT*Smear < 180 && NewJetDR2 > 0.1)");
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P3", "MCWeight * (JetShift < 0.2 && JetPT*Smear > 180 && JetPT*Smear < 200 && NewJetDR2 > 0.1)");
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P4", "MCWeight * (JetShift < 0.2 && JetPT*Smear > 200 && JetPT*Smear < 300 && NewJetDR2 > 0.1)");
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P5", "MCWeight * (JetShift < 0.2 && JetPT*Smear > 300 && JetPT*Smear < 500 && NewJetDR2 > 0.1)");
