...
int main(int argc, char *argv[])
{
   ...
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P0", "MCWeight * (JetShift < 0.2 && JetPT*1.1 > 120 && JetPT*1.1 < 140 && NewJetDR2 > 0.1)");
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P1", "MCWeight * (JetShift < 0.2 && JetPT*1.1 > 140 && JetPT*1.1 < 160 && NewJetDR2 > 0.1)");
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P2", "MCWeight * (JetShift < 0.2 && JetPT*1.1 > 160 && JetPT*1.1 < 180 && NewJetDR2 > 0.1)");
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P3", "MCWeight * (JetShift < 0.2 && JetPT*1.1 > 180 && JetPT*1.1 < 200 && NewJetDR2 > 0.1)");
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P4", "MCWeight * (JetShift < 0.2 && JetPT*1.1 > 200 && JetPT*1.1 < 300 && NewJetDR2 > 0.1)");
   T2->Draw("NewJetSDMass2/NewJetPT>>HModified_P5", "MCWeight * (JetShift < 0.2 && JetPT*1.1 > 300 && JetPT*1.1 < 500 && NewJetDR2 > 0.1)");
