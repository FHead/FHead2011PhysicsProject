...
int main(int argc, char *argv[])
{
   ...
   for(int iE = 0; iE < SmearEntryCount; iE = iE + SmearJump)
   {
      ...
      if(RatioBin < 0)   continue;
      if(RatioBin >= 50) RatioBin = 49;
      SmearGroomed[iC][iPT][RatioBin] = SmearGroomed[iC][iPT][RatioBin] + SmearMCWeight * SmearWeight;
   }
   ...
   for(int iE = 0; iE < SmearEntryCount; iE = iE + SmearJump)
   {
      ...
      SmearPT[iC][iPT][JetBin] = SmearPT[iC][iPT][JetBin] + SmearMCWeight * SmearWeight * GroomedWeight;
   }
   ...
   for(int iE = 0; iE < SmearEntryCount; iE = iE + SmearJump)
   {
      ...
      SmearCentralityBins[iPT][SmearCentrality] = SmearCentralityBins[iPT][SmearCentrality] + SmearMCWeight * SmearWeight * GroomedWeight * JetWeight;
   }   
   ...
   for(int iE = 0; iE < SmearEntryCount * 0.2; iE = iE + SmearJump)
   {
      ...
      double TotalWeight = SmearMCWeight * SmearWeight * GroomedWeight * JetWeight;
