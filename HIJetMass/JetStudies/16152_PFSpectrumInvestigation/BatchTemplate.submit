...
cp /afs/cern.ch/user/c/chenyi/work/PhysicsWorkspace/HIJetMass/JetStudies/16152_PFSpectrumInvestigation/*dh .
...
OutputBase=/store/cmst3/user/chenyi/BatchOutput/HIJetMass/JetStudies/16152_PFSpectrumInvestigation/Result
...
for PTType in `seq 0 0`
do
   time __EXECUTABLE__ Input.root Output13.root __TAG__ __PTHATMIN__ __PTHATMAX__ 1.00 0.07 0.20 1.00 1.2 $PTType __EXTRA1__ __EXTRA2__ __EXTRA3__
   cmsStage -f Output13.root ${OutputBase}13/PTType${PTType}_$Mod$OutputName
done
