...
int main(int argc, char *argv[])
{
   if(argc != 5)
   {
      cerr << "Usage: " << argv[0] << " SDChoice IsMC=Y PTHatChoice Tag" << endl;
      cerr << "Usage: " << argv[0] << " SDChoice IsMC=N IsPrescale Tag" << endl;
   }
   ...
   string FileNameData = "AAData16214/AADataMeow.root";
   ...
   if(IsMC == false && argv[3][0] == 'Y')
      FileNameData = "AADataPrescale16214/AADataPrescale.root";
