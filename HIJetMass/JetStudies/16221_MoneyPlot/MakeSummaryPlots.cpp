...
int main()
{
   ...
   for(int iSD = 0; iSD < 2; iSD++)
   {
      ...
      for(int iMC = 0; iMC < 2; iMC++)
      {
         if(iMC == 0)
         {
            FileName1 = "Graphs_SD" + SD + "_DataPicked.root";
            FileName2 = "Graphs_SD" + SD + "_DataPicked.root";
         ...
         for(int i = 1; i < 5; i++)
         {
            TFile *F1 = ((i <= 1) ? &FGraphs1 : &FGraphs2);
            TFile *F2 = &FGraphs2;
            
            vector<TGraphAsymmErrors *> Gs(16);
            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("MassData_0_%d"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("MassDataSys_0_%d" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("MassSmear_0_%d"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("MassSmearSys_0_%d", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("MassData_1_%d"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys_1_%d" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("MassSmear_1_%d"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys_1_%d", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("MassData_2_%d"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys_2_%d" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("MassSmear_2_%d"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys_2_%d", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("MassData_3_%d"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys_3_%d" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("MassSmear_3_%d"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys_3_%d", i));

            DoGraph(Gs, OutputBase + Form("_PrettyPlotPTBin%d", i), PTBinEdge[i], PTBinEdge[i+1], IsMC, true, TYPE_MASS, SD);

            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("ZGData_0_%d"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("ZGDataSys_0_%d" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("ZGSmear_0_%d"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("ZGSmearSys_0_%d", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("ZGData_1_%d"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys_1_%d" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear_1_%d"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys_1_%d", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("ZGData_2_%d"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys_2_%d" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear_2_%d"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys_2_%d", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("ZGData_3_%d"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys_3_%d" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear_3_%d"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys_3_%d", i));

            DoGraph(Gs, OutputBase + Form("_ZGPrettyPlotPTBin%d", i), PTBinEdge[i], PTBinEdge[i+1], IsMC, true, TYPE_ZG, SD);

            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("DRData_0_%d"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("DRDataSys_0_%d" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("DRSmear_0_%d"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("DRSmearSys_0_%d", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("DRData_1_%d"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys_1_%d" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("DRSmear_1_%d"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys_1_%d", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("DRData_2_%d"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys_2_%d" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("DRSmear_2_%d"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys_2_%d", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("DRData_3_%d"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys_3_%d" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("DRSmear_3_%d"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys_3_%d", i));

            DoGraph(Gs, OutputBase + Form("_DRPrettyPlotPTBin%d", i), PTBinEdge[i], PTBinEdge[i+1], IsMC, true, TYPE_DR, SD);

            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("MassData0_0_%d"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("MassDataSys0_0_%d" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("MassSmear0_0_%d"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("MassSmearSys0_0_%d", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("MassData0_1_%d"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys0_1_%d" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("MassSmear0_1_%d"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys0_1_%d", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("MassData0_2_%d"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys0_2_%d" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("MassSmear0_2_%d"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys0_2_%d", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("MassData0_3_%d"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys0_3_%d" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("MassSmear0_3_%d"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys0_3_%d", i));

            DoGraph(Gs, OutputBase + Form("_0PrettyPlotPTBin%d", i), PTBinEdge[i], PTBinEdge[i+1], IsMC, true, TYPE_MASS, SD);

            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("ZGData0_0_%d"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("ZGDataSys0_0_%d" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("ZGSmear0_0_%d"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("ZGSmearSys0_0_%d", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("ZGData0_1_%d"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys0_1_%d" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear0_1_%d"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys0_1_%d", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("ZGData0_2_%d"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys0_2_%d" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear0_2_%d"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys0_2_%d", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("ZGData0_3_%d"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys0_3_%d" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear0_3_%d"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys0_3_%d", i));

            DoGraph(Gs, OutputBase + Form("_ZG0PrettyPlotPTBin%d", i), PTBinEdge[i], PTBinEdge[i+1], IsMC, true, TYPE_ZG, SD);

            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("DRData0_0_%d"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("DRDataSys0_0_%d" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("DRSmear0_0_%d"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("DRSmearSys0_0_%d", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("DRData0_1_%d"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys0_1_%d" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("DRSmear0_1_%d"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys0_1_%d", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("DRData0_2_%d"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys0_2_%d" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("DRSmear0_2_%d"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys0_2_%d", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("DRData0_3_%d"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys0_3_%d" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("DRSmear0_3_%d"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys0_3_%d", i));
         ...
         for(int i = 0; i < 4; i++)
         {
            TFile *F1 = ((i == 0) ? &FGraphs1 : &FGraphs2);
            TFile *F2 = &FGraphs2;

            vector<TGraphAsymmErrors *> Gs(16);
            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("MassData_%d_1"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("MassDataSys_%d_1" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("MassSmear_%d_1"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("MassSmearSys_%d_1", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("MassData_%d_2"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys_%d_2" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("MassSmear_%d_2"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys_%d_2", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("MassData_%d_3"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys_%d_3" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("MassSmear_%d_3"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys_%d_3", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("MassData_%d_4"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys_%d_4" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("MassSmear_%d_4"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys_%d_4", i));

            DoGraph(Gs, OutputBase + Form("_PrettyPlotCentralityBin%d", i), CBinEdge[i], CBinEdge[i+1], IsMC, false, TYPE_MASS, SD);

            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("ZGData_%d_1"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("ZGDataSys_%d_1" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("ZGSmear_%d_1"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("ZGSmearSys_%d_1", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("ZGData_%d_2"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys_%d_2" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear_%d_2"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys_%d_2", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("ZGData_%d_3"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys_%d_3" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear_%d_3"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys_%d_3", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("ZGData_%d_4"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys_%d_4" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear_%d_4"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys_%d_4", i));

            DoGraph(Gs, OutputBase + Form("_ZGPrettyPlotCentralityBin%d", i), CBinEdge[i], CBinEdge[i+1], IsMC, false, TYPE_ZG, SD);

            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("DRData_%d_1"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("DRDataSys_%d_1" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("DRSmear_%d_1"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("DRSmearSys_%d_1", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("DRData_%d_2"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys_%d_2" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("DRSmear_%d_2"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys_%d_2", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("DRData_%d_3"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys_%d_3" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("DRSmear_%d_3"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys_%d_3", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("DRData_%d_4"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys_%d_4" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("DRSmear_%d_4"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys_%d_4", i));

            DoGraph(Gs, OutputBase + Form("_DRPrettyPlotCentralityBin%d", i), CBinEdge[i], CBinEdge[i+1], IsMC, false, TYPE_DR, SD);
            
            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("MassData0_%d_1"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("MassDataSys0_%d_1" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("MassSmear0_%d_1"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("MassSmearSys0_%d_1", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("MassData0_%d_2"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys0_%d_2" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("MassSmear0_%d_2"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys0_%d_2", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("MassData0_%d_3"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys0_%d_3" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("MassSmear0_%d_3"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys0_%d_3", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("MassData0_%d_4"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("MassDataSys0_%d_4" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("MassSmear0_%d_4"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("MassSmearSys0_%d_4", i));

            DoGraph(Gs, OutputBase + Form("_0PrettyPlotCentralityBin%d", i), CBinEdge[i], CBinEdge[i+1], IsMC, false, TYPE_MASS, SD);

            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("ZGData0_%d_1"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("ZGDataSys0_%d_1" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("ZGSmear0_%d_1"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("ZGSmearSys0_%d_1", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("ZGData0_%d_2"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys0_%d_2" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear0_%d_2"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys0_%d_2", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("ZGData0_%d_3"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys0_%d_3" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear0_%d_3"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys0_%d_3", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("ZGData0_%d_4"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("ZGDataSys0_%d_4" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmear0_%d_4"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("ZGSmearSys0_%d_4", i));

            DoGraph(Gs, OutputBase + Form("_ZG0PrettyPlotCentralityBin%d", i), CBinEdge[i], CBinEdge[i+1], IsMC, false, TYPE_ZG, SD);

            Gs[0]  = (TGraphAsymmErrors *)F1->Get(Form("DRData0_%d_1"    , i));
            Gs[1]  = (TGraphAsymmErrors *)F1->Get(Form("DRDataSys0_%d_1" , i));
            Gs[2]  = (TGraphAsymmErrors *)F1->Get(Form("DRSmear0_%d_1"   , i));
            Gs[3]  = (TGraphAsymmErrors *)F1->Get(Form("DRSmearSys0_%d_1", i));
            Gs[4]  = (TGraphAsymmErrors *)F2->Get(Form("DRData0_%d_2"    , i));
            Gs[5]  = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys0_%d_2" , i));
            Gs[6]  = (TGraphAsymmErrors *)F2->Get(Form("DRSmear0_%d_2"   , i));
            Gs[7]  = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys0_%d_2", i));
            Gs[8]  = (TGraphAsymmErrors *)F2->Get(Form("DRData0_%d_3"    , i));
            Gs[9]  = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys0_%d_3" , i));
            Gs[10] = (TGraphAsymmErrors *)F2->Get(Form("DRSmear0_%d_3"   , i));
            Gs[11] = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys0_%d_3", i));
            Gs[12] = (TGraphAsymmErrors *)F2->Get(Form("DRData0_%d_4"    , i));
            Gs[13] = (TGraphAsymmErrors *)F2->Get(Form("DRDataSys0_%d_4" , i));
            Gs[14] = (TGraphAsymmErrors *)F2->Get(Form("DRSmear0_%d_4"   , i));
            Gs[15] = (TGraphAsymmErrors *)F2->Get(Form("DRSmearSys0_%d_4", i));
