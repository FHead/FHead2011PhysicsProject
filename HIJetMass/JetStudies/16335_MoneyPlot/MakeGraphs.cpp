...
int main(int argc, char *argv[])
{
   ...
   string FileNameData = "AAData16325RhoM.root";
   string FileNameSmear = "ModAll_PPDataHighPTJet.root";
   // FileNameSmear = "Mod0_PPDataHighPTJet.root";
   ...
   if(IsMC == true)
   {
      ...
      if(PTHatMin <= 0)
      {
         ...
         // FileNameSmear = "AA6DijetCymbal16335Passthrough.root";
   ...
   if(IsMC == false && TriggerSelection != TRIGGER_NONE)
      FileNameData = "AADataPrescale.root";
