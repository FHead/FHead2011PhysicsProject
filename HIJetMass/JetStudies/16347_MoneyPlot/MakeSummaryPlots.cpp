   ...
   for(int iSD = 0; iSD < 2; iSD++)
   {
      ...
      for(int iMC = 0; iMC < 2; iMC++)
      {
         ...
         for(int i = 1; i < 5; i++)
         {
            ...
            // DoGraph(Gs, OutputBase + Form("_PTPT0PrettyPlotPTBin%d", i), PTBinEdge[i], PTBinEdge[i+1], IsMC, true, TYPE_PTPT0, SD);
         }
         ...
         for(int i = 0; i < 5; i++)
         {
            ...
            // DoGraph(Gs, OutputBase + Form("_0_PTPTPrettyPlotCentralityBin%d", i), CBinEdge[i], CBinEdge[i+1], IsMC, false, TYPE_PTPT0, SD);
         }
