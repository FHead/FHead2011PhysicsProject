...
int main(int argc, char *argv[])
{
   ...
   if(IsMC == true)
   {
      ...
      if(PTHatMin <= 0)
      {
         ...
         FileNameSmear = "SampleBase/MBSmearTree/16354NoRhoM/PP6Dijet.root";
         PTHatMin = 100;
         PTHatMax = 10000000;
      }
   }
   ...
   for(int iE = 0; iE < DataEntryCount; iE++)
   {
      ...
      if(MData.SDRecoDR > 0.1 && MData.SDRecoDR < 0.40)
      {
   ...
   for(int iE = 0; iE < SmearEntryCount; iE++)
   {
      ...
      double AngleWeight = DataAngle[CBin][PTBin][AngleBin] / SmearAngle[CBin][PTBin][AngleBin];

      double TotalWeight = MSmear.MCWeight * JetWeight * CentralityWeight * AngleWeight;
      // double TotalWeight = MSmear.MCWeight * JetWeight;
      ...
      if(MSmear.SDRecoDR > 0.1 && MSmear.SDRecoDR < 0.40)
      {
