...
int main(int argc, char *argv[])
{
   ...
   if(IsMC == true)
   {
      ...
      if(PTHatMin <= 0)
      {
         FileNameData = "SampleBase/PlainTree/16354EventInfo/AA6DijetCymbal.root";
   ...
   for(int iE = 0; iE < SmearEntryCount; iE++)
   {
      ...
      int iMassB0 = GetBin(MSmear.SDMassRatio, Mass0BinEdge, MASSBINCOUNT);
      ...
      if(MSmear.SDRecoDR > 0.1 && MSmear.SDRecoDR < 0.35)
      {
