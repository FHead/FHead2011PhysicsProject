...
int main(int argc, char *argv[])
{
   ...
   PdfFileHelper PdfFile("SkewnessMassSanityCheck_" + SD + "_" + Data + ".pdf");
   PdfFile.AddTextPage("Sanity checks for mass skewness plots");
   ...
   double Min = ((SD == "0") ? -1.00 : 0.00);
   double Max = ((SD == "0") ? 2.00 : 3.00);
   ...
   TH2D HWorld1("HWorld1", ";p_{T,jet} (GeV);skewness (M_{g}/p_{T})", 16, 0, 16, 100, Min, Max);
   HWorld1.SetStats(0);
   ...
   C.SaveAs(("Plots/SkewnessMassPlot_" + SD + "_" + Data + ".png").c_str());
   C.SaveAs(("Plots/SkewnessMassPlot_" + SD + "_" + Data + ".C").c_str());
   C.SaveAs(("Plots/SkewnessMassPlot_" + SD + "_" + Data + ".eps").c_str());
   C.SaveAs(("PDFPlots/SkewnessMassPlot_" + SD + "_" + Data + ".pdf").c_str());
