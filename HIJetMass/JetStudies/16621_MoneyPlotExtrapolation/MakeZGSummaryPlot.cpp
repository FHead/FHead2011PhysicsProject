...
int main()
{
   ...
   TLegend Legend((BorderWidth + PanelWidth * 0.40) / TotalWidth, (BorderHeight + PanelHeight * 0.80) / TotalHeight, (BorderWidth + PanelWidth * 0.85) / TotalWidth, (BorderHeight + 0.60 * PanelHeight) / TotalHeight);
