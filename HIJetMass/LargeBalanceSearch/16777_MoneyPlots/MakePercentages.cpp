...
int main(int argc, char *argv[])
{
   ...
   bool IsShiftedMC = ((argv[1][0] == 'S') ? true : false);
   ...
   cout << "Running with Shifted MC = " << IsShiftedMC << endl;
   ...
   {
      FileNameData = "StraightResult/AA6DijetCymbalV2.root";
      FileNameSmear = "ShiftedResult/PP6Dijet.root";
      PTHatMin = 100;
      PTHatMax = 10000000;
   }
   ...
   for(int iE = 0; iE < DataEntryCount; iE++)
   {
      ...
      FillVector(DataCount[CBin][PTBin][0], MData.SDWTADR, TotalWeight);
      FillVector(DataCount[CBin][PTBin][1], MData.SDWTADRs[0], TotalWeight);
      FillVector(DataCount[CBin][PTBin][2], MData.SDWTADRs[1], TotalWeight);
      FillVector(DataCount[CBin][PTBin][3], MData.SDWTADRs[2], TotalWeight);
      FillVector(DataCount[CBin][PTBin][4], MData.SDWTADRs[3], TotalWeight);
      FillVector(DataCount[CBin][PTBin][5], MData.SDWTADRs[4], TotalWeight);
      FillVector(DataCount[CBin][PTBin][6], MData.SDWTADRs[5], TotalWeight);

      FillVector(DataCount2[CBin][PTBin][0], MData.SDWTADR, TotalWeight * TotalWeight);
      FillVector(DataCount2[CBin][PTBin][1], MData.SDWTADRs[0], TotalWeight * TotalWeight);
      FillVector(DataCount2[CBin][PTBin][2], MData.SDWTADRs[1], TotalWeight * TotalWeight);
      FillVector(DataCount2[CBin][PTBin][3], MData.SDWTADRs[2], TotalWeight * TotalWeight);
      FillVector(DataCount2[CBin][PTBin][4], MData.SDWTADRs[3], TotalWeight * TotalWeight);
      FillVector(DataCount2[CBin][PTBin][5], MData.SDWTADRs[4], TotalWeight * TotalWeight);
      FillVector(DataCount2[CBin][PTBin][6], MData.SDWTADRs[5], TotalWeight * TotalWeight);
   }
   BarData.Update(DataEntryCount);
   BarData.Print();
   BarData.PrintLine();
   ...
   for(int iE = 0; iE < SmearEntryCount; iE++)
   {
      ...
      FillVector(SmearCount[CBin][PTBin][0], MSmear.SDWTADR, TotalWeight);
      FillVector(SmearCount[CBin][PTBin][1], MSmear.SDWTADRs[0], TotalWeight);
      FillVector(SmearCount[CBin][PTBin][2], MSmear.SDWTADRs[1], TotalWeight);
      FillVector(SmearCount[CBin][PTBin][3], MSmear.SDWTADRs[2], TotalWeight);
      FillVector(SmearCount[CBin][PTBin][4], MSmear.SDWTADRs[3], TotalWeight);
      FillVector(SmearCount[CBin][PTBin][5], MSmear.SDWTADRs[4], TotalWeight);
      FillVector(SmearCount[CBin][PTBin][6], MSmear.SDWTADRs[5], TotalWeight);

      FillVector(SmearCount2[CBin][PTBin][0], MSmear.SDWTADR, TotalWeight * TotalWeight);
      FillVector(SmearCount2[CBin][PTBin][1], MSmear.SDWTADRs[0], TotalWeight * TotalWeight);
      FillVector(SmearCount2[CBin][PTBin][2], MSmear.SDWTADRs[1], TotalWeight * TotalWeight);
      FillVector(SmearCount2[CBin][PTBin][3], MSmear.SDWTADRs[2], TotalWeight * TotalWeight);
      FillVector(SmearCount2[CBin][PTBin][4], MSmear.SDWTADRs[3], TotalWeight * TotalWeight);
      FillVector(SmearCount2[CBin][PTBin][5], MSmear.SDWTADRs[4], TotalWeight * TotalWeight);
      FillVector(SmearCount2[CBin][PTBin][6], MSmear.SDWTADRs[5], TotalWeight * TotalWeight);
   }
   BarSmear.Update(SmearEntryCount);
   BarSmear.Print();
   BarSmear.PrintLine();
