...
{
   return GetBin(AdjustedCentrality, CBinEdge, BinCount);
}
...
{
   return (int)(AdjustedCentrality * 100);
}

void SmearTreeMessenger::AdjustCentrality(double Shift)
{
...
double SmearTreeMessenger::CentralityToHF(double C)
{
