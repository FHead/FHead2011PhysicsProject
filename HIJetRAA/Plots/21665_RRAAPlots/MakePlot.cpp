...
int main(int argc, char *argv[])
{
   ...
   string File = "RRAA_Smooth_NotRedStat.root";
   ...
   Legend.AddEntry(&HP0C0RRAASys, "0-10%", "plf");
   Legend.AddEntry(&HP0C1RRAASys, "10-30%", "plf");
   Legend.AddEntry(&HP0C2RRAASys, "30-50%", "plf");
   Legend.AddEntry(&HP0C3RRAASys, "50-90%", "plf");
   ...
   GLine.Draw("l");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.9, "200 < p_{T} < 250");
   P2.cd();
   HWorld.Draw("axis");
   HP1C0RRAASys.Draw("2");
   HP1C1RRAASys.Draw("2");
   ...
   GLine.Draw("l");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.9, "250 < p_{T} < 300");
   P3.cd();
   HWorld.Draw("axis");
   HP2C0RRAASys.Draw("2");
   HP2C1RRAASys.Draw("2");
   ...
   GLine.Draw("l");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.9, "300 < p_{T} < 400");
   P4.cd();
   HWorld.Draw("axis");
   HP3C0RRAASys.Draw("2");
   HP3C1RRAASys.Draw("2");
   ...
   GLine.Draw("l");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.9, "400 < p_{T} < 500");
   P5.cd();
   HWorld.Draw("axis");
   HP4C0RRAASys.Draw("2");
   HP4C1RRAASys.Draw("2");
   ...
   GLine.Draw("l");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.9, "500 < p_{T} < 1000");
   P6.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(11);
   ...
   Canvas.SaveAs("PlotRRAA.pdf");
   Canvas.SaveAs("PlotRRAA.png");
