...
int main(int argc, char *argv[])
{
   ...
   HWorld.Draw("axis");
   Latex.SetTextAlign(31);
   Latex.DrawLatex(0.92, 0.88, "R = 0.2, pp");
   DrawAll(HPPR02);
   P2.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(31);
   Latex.DrawLatex(0.92, 0.88, "R = 0.2, PbPb 50-90%");
   DrawAll(HC3R02);
   P3.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(31);
   Latex.DrawLatex(0.92, 0.88, "R = 0.2, PbPb 30-50%");
   DrawAll(HC2R02);
   P4.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(31);
   Latex.DrawLatex(0.92, 0.88, "R = 0.2, PbPb 10-30%");
   DrawAll(HC1R02);
   P5.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(31);
   Latex.DrawLatex(0.92, 0.88, "R = 0.2, PbPb 0-10%");
   DrawAll(HC0R02);
   P6.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(31);
   Latex.DrawLatex(0.92, 0.88, "R = 1.0, pp");
   DrawAll(HPPR10);
   P7.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(31);
   Latex.DrawLatex(0.92, 0.88, "R = 1.0, PbPb 50-90%");
   DrawAll(HC3R10);
   P8.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(31);
   Latex.DrawLatex(0.92, 0.88, "R = 1.0, PbPb 30-50%");
   DrawAll(HC2R10);
   P9.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(31);
   Latex.DrawLatex(0.92, 0.88, "R = 1.0, PbPb 10-30%");
   DrawAll(HC1R10);
   P10.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(31);
   Latex.DrawLatex(0.92, 0.88, "R = 1.0, PbPb 0-10%");
   Legend.Draw();
   DrawAll(HC0R10);
