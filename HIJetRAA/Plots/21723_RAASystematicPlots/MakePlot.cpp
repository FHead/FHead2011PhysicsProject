...
int main(int argc, char *argv[])
{
   ...
   int CanvasWidth = PanelSize * 4 + PaddingWidth * 2;
   ...
   string FileName = "SysRAA_Smooth.root";
   ...
   Latex.SetTextAngle(0);
   Latex.DrawLatex(PadX0 + PadDX * 4, PadY0 + PadDY * 2 + PadY0 * 0.15, "#sqrt{s_{NN}} = 5.02 TeV, PbPb 404 #mub^{-1}, pp 27.4 pb^{-1}");

   Latex.SetTextFont(42);
   Latex.SetTextSize(0.040);
   Latex.SetTextAlign(22);
   Latex.SetTextAngle(270);
   Latex.DrawLatex(PadX0 + PadDX * 4 + PadX0 * 0.5, PadY0 + PadDY * 1.5, "R = 0.2");
   Latex.DrawLatex(PadX0 + PadDX * 4 + PadX0 * 0.5, PadY0 + PadDY * 0.5, "R = 1.0");
   ...
   for(int i = 0; i < (int)HC0R02.size(); i++)
      Legend.AddEntry(HC0R02[i], Sys[i].c_str(), "l");
   ...
   HWorld.Draw("axis");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.88, "50-90%");
   DrawAll(HC3R02);
   P2.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.88, "30-50%");
   DrawAll(HC2R02);
   P3.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.88, "10-30%");
   DrawAll(HC1R02);
   P4.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.88, "0-10%");
   DrawAll(HC0R02);
   P5.cd();
   HWorld.Draw("axis");
   DrawAll(HC3R10);
   ...
   Canvas.SaveAs("PlotSystematicsRAA.pdf");
   Canvas.SaveAs("PlotSystematicsRAA.png");
