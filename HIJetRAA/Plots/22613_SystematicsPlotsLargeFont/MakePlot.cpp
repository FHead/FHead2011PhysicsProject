...
int main(int argc, char *argv[])
{
   ...
   if(Grouping == 1)
      Sys = {"JES", "Unfold", "Lumi/T_{AA}", "Misrec."};
   if(Grouping == 2)
      Sys = {"JES", "JER", "Unfold", "Lumi/T_{AA}", "Misrec."};
   ...
   Latex.SetTextAngle(0);
   Latex.DrawLatex(PadX0, PadY0 + PadDY * 2 + PadY0 * 0.15, "CMS #scale[0.8]{#font[52]{}}");
   ...
   TLegend Legend(0.08, 0.08, 0.48, 0.83);
   ...
   HWorld.Draw("axis");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.85, "pp");
   DrawAll(HPPR02);
   P2.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.85, "PbPb 50-90%");
   DrawAll(HC3R02);
   P3.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.85, "PbPb 30-50%");
   DrawAll(HC2R02);
   P4.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.85, "PbPb 10-30%");
   DrawAll(HC1R02);
   P5.cd();
   HWorld.Draw("axis");
   Latex.SetTextAlign(11);
   Latex.DrawLatex(0.08, 0.85, "PbPb 0-10%");
   DrawAll(HC0R02);
   P6.cd();
   HWorld.Draw("axis");
   DrawAll(HPPR10);
...
vector<TH1D *> DoGrouping(vector<TH1D *> &H, int Grouping)
{
   ...
   if(Grouping == 1)
   {
      ...
      QuadratureAdd(Result[1], H[6]);
      QuadratureAdd(Result[1], H[7]);
      QuadratureAdd(Result[1], H[8]);
      QuadratureAdd(Result[1], H[9]);
      QuadratureAdd(Result[2], H[10]);
      QuadratureAdd(Result[2], H[11]);
      QuadratureAdd(Result[3], H[5]);
   }
   if(Grouping == 2)
   {
      int N = 5;
