...
int main(int argc, char *argv[])
{
   ...
   Latex.SetTextAlign(22);
   Latex.SetTextAngle(90);
   Latex.DrawLatex(PadX0 * 0.30, PadY0 + PadDY1 * 0.5, "#frac{Pythia}{Data}  R = 0.2, 0.4");

   Latex.SetTextFont(62);
   Latex.SetTextSize(0.050);
   Latex.SetTextAlign(11);
   Latex.SetTextAngle(0);
   Latex.DrawLatex(PadX0, PadY0 + PadDY1 + PadDY2 + PadY0 * 0.15, "CMS #scale[0.8]{#font[52]{}}");
   ...
   Legend.AddEntry(PPR2Sys, "R = 0.2", "f");
   Legend.AddEntry(PPR3Sys, "R = 0.3", "f");
   Legend.AddEntry(PPR4Sys, "R = 0.4", "f");
   Legend.AddEntry(PPR6Sys, "R = 0.6", "f");
   Legend.AddEntry(PPR8Sys, "R = 0.8", "f");
   ...
   SetTheoryHistogram(&HP6, kBlack, false);
   SetTheoryHistogram(&HP8, kBlack, true);
