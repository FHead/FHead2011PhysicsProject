...
OutputBase=/eos/user/c/chenyi/Share/21267_FakeJetThirdLook/

rm Submit.condor
touch Submit.condor

echo 'Universe   = vanilla' >> Submit.condor
echo 'Executable = /afs/cern.ch/user/c/chenyi/work/PhysicsWorkspace/HIJetReco2018/DataStudies/21267_FakeJetThirdLook/RunJob.sh' >> Submit.condor
