...
int main(int argc, char *argv[])
{
   ...
   vector<double> MVACut = {0.85, 0.90, 0.91, 0.92, 0.93, 0.94, 0.95, 0.96, 0.97, 0.98, 0.99, 1.00};
   vector<string> MVALabel = {"MVA085", "MVA090", "MVA091", "MVA092", "MVA093", "MVA094", "MVA095", "MVA096", "MVA097", "MVA098", "MVA099", "MVA100"};
         ...
         for(int iM = 0; iM < (int)MVACut.size(); iM++)
         {
            ...
            for(int iT = 0; iT < MTrack.TrackCount; iT++)
            {
               ...
               if(MTrack.TrackAlgo[iT] == 6 && MTrack.TrackMVA[iT] < 0.98)
                  continue;
               if(MTrack.TrackAlgo[iT] == 7 && MTrack.TrackMVA[iT] < MVACut[iM])
                  continue;
