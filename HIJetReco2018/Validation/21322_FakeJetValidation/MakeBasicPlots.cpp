...
int main(int argc, char *argv[])
{
   ...
   string TriggerName            = CL.Get("Trigger", "NONE");
   ...
   H1["LeadingJetPT"] = new TH1D("HLeadingJetPT", ";Jet p_{T};", 100, 0, 200);
   H1["LeadingJetPTPassL156"] = new TH1D("HLeadingJetPTPassL156", ";Jet p_{T};", 100, 0, 200);
   H1["LeadingJetPTEtaN25P25"] = new TH1D("HLeadingJetPTEtaN25P25", ";Jet p_{T};", 100, 0, 200);
   H1["LeadingJetPTEtaN25P25PassL156"] = new TH1D("HLeadingJetPTEtaN25P25PassL156", ";Jet p_{T};", 100, 0, 200);
   H1["LeadingJetPTEtaN25N15"] = new TH1D("HLeadingJetPTEtaN25N15", ";Jet p_{T};", 100, 0, 200);
   H1["LeadingJetPTEtaN25N15PassL156"] = new TH1D("HLeadingJetPTEtaN25N15PassL156", ";Jet p_{T};", 100, 0, 200);
   H1["LeadingJetPTEtaN15N00"] = new TH1D("HLeadingJetPTEtaN15N00", ";Jet p_{T};", 100, 0, 200);
   H1["LeadingJetPTEtaN15N00PassL156"] = new TH1D("HLeadingJetPTEtaN15N00PassL156", ";Jet p_{T};", 100, 0, 200);
   H1["LeadingJetPTEtaP00P15"] = new TH1D("HLeadingJetPTEtaP00P15", ";Jet p_{T};", 100, 0, 200);
   H1["LeadingJetPTEtaP00P15PassL156"] = new TH1D("HLeadingJetPTEtaP00P15PassL156", ";Jet p_{T};", 100, 0, 200);
   H1["LeadingJetPTEtaP15P25"] = new TH1D("HLeadingJetPTEtaP15P25", ";Jet p_{T};", 100, 0, 200);
   H1["LeadingJetPTEtaP15P25PassL156"] = new TH1D("HLeadingJetPTEtaP15P25PassL156", ";Jet p_{T};", 100, 0, 200);
   ...
   for(string FileName : InputFileName)
   {
      ...
      for(int iE = 0; iE < EntryCount; iE++)
      {
         ...
         // cout << "TRIGGER " << MHLT.CheckTrigger(TriggerName) << endl;

         // HLT trigger requirement
         if(TriggerName != "NONE")
            if(MHLT.CheckTrigger(TriggerName) <= 0)
               continue;
         ...
         for(int iJ = 0; iJ < MJet.JetCount; iJ++)
         {
            if(LeadingJet[0] < 0 || MJet.JetPT[iJ] > LeadingJet.GetPT())
               if(MJet.JetPFCHF[iJ] > 0.01 && MJet.JetPFCHF[iJ] < 0.99 && MJet.JetPFMUF[iJ] > 0.01 && MJet.JetPFNHF[iJ] > 0.01)
         ...
         for(int iJ = 0; iJ < MJet.JetCount; iJ++)
         {
            ...
            H1["LeadingJetPT"]->Fill(LeadingJet.GetPT());
            if(PassL156 == true)
               H1["LeadingJetPTPassL156"]->Fill(LeadingJet.GetPT());

            if(LeadingJet.GetAbsEta() < 2.5)
               H1["LeadingJetPTEtaN25P25"]->Fill(LeadingJet.GetPT());
            if(PassL156 == true && LeadingJet.GetAbsEta() < 2.5)
               H1["LeadingJetPTEtaN25P25PassL156"]->Fill(LeadingJet.GetPT());

            if(LeadingJet.GetEta() > -2.5 && LeadingJet.GetEta() < -1.5)
               H1["LeadingJetPTEtaN25N15"]->Fill(LeadingJet.GetPT());
            if(LeadingJet.GetEta() > -2.5 && LeadingJet.GetEta() < -1.5 && PassL156 == true)
               H1["LeadingJetPTEtaN25N15PassL156"]->Fill(LeadingJet.GetPT());
            if(LeadingJet.GetEta() > -1.5 && LeadingJet.GetEta() < 0.0)
               H1["LeadingJetPTEtaN15N00"]->Fill(LeadingJet.GetPT());
            if(LeadingJet.GetEta() > -1.5 && LeadingJet.GetEta() < 0.0 && PassL156 == true)
               H1["LeadingJetPTEtaN15N00PassL156"]->Fill(LeadingJet.GetPT());
            if(LeadingJet.GetEta() > 0.0 && LeadingJet.GetEta() < 1.5)
               H1["LeadingJetPTEtaP00P15"]->Fill(LeadingJet.GetPT());
            if(LeadingJet.GetEta() > 0.0 && LeadingJet.GetEta() < 1.5 && PassL156 == true)
               H1["LeadingJetPTEtaP00P15PassL156"]->Fill(LeadingJet.GetPT());
            if(LeadingJet.GetEta() > 1.5 && LeadingJet.GetEta() < 2.5)
               H1["LeadingJetPTEtaP15P25"]->Fill(LeadingJet.GetPT());
            if(LeadingJet.GetEta() > 1.5 && LeadingJet.GetEta() < 2.5 && PassL156 == true)
               H1["LeadingJetPTEtaP15P25PassL156"]->Fill(LeadingJet.GetPT());
