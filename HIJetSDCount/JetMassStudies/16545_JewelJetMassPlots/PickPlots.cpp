...
int main()
{
   ...
   PickFile(File0, "Plots_QPythia_S_N.root", "QPythiaMedS", true);
   PickFile(File0, "Plots_QPythia_SB_N.root", "QPythiaMedSB", true);
   PickFile(File0, "Plots_QPythia_P_N.root", "QPythiaVacS", true);
   PickFile(File0, "Plots_QPythia_PB_N.root", "QPythiaVacSB", true);
   File0.Close();
   ...
   PickFile(File7, "Plots_QPythia_S_N.root", "QPythiaMedS", false);
   PickFile(File7, "Plots_QPythia_SB_N.root", "QPythiaMedSB", false);
   PickFile(File7, "Plots_QPythia_P_N.root", "QPythiaVacS", false);
   PickFile(File7, "Plots_QPythia_PB_N.root", "QPythiaVacSB", false);
   File7.Close();
