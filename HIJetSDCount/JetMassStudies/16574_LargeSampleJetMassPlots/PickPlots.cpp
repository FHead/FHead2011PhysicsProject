...
int main()
{
   ...
   PickFile(File0, "Plots_QPythia_Q1_N.root", "QPythiaMedS", true);
   PickFile(File0, "Plots_QPythia_QB1_N.root", "QPythiaMedSB", true);
   PickFile(File0, "Plots_QPythia_Vac_N.root", "QPythiaVacS", true);
   PickFile(File0, "Plots_QPythia_VacB_N.root", "QPythiaVacSB", true);
   File0.Close();
   ...
   PickFile(File7, "Plots_QPythia_Q1_N.root", "QPythiaMedS", false);
   PickFile(File7, "Plots_QPythia_QB1_N.root", "QPythiaMedSB", false);
   PickFile(File7, "Plots_QPythia_Vac_N.root", "QPythiaVacS", false);
   PickFile(File7, "Plots_QPythia_VacB_N.root", "QPythiaVacSB", false);
   File7.Close();
