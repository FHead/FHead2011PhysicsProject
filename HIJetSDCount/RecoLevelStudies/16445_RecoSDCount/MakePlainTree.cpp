...
int main(int argc, char *argv[])
{
   ...
   int GenSD0Depth, GenSD7Depth;
   double GenSD0DR, GenSD7DR;
   double GenSD0Mass, GenSD7Mass;
   double GenSD0SubJet1E, GenSD0SubJet1PT, GenSD0SubJet1Eta, GenSD0SubJet1Phi;
   double GenSD0SubJet2E, GenSD0SubJet2PT, GenSD0SubJet2Eta, GenSD0SubJet2Phi;
   double GenSD7SubJet1E, GenSD7SubJet1PT, GenSD7SubJet1Eta, GenSD7SubJet1Phi;
   double GenSD7SubJet2E, GenSD7SubJet2PT, GenSD7SubJet2Eta, GenSD7SubJet2Phi;
   OutputTree.Branch("GenSD0Depth", &GenSD0Depth, "GenSD0Depth/I");
   OutputTree.Branch("GenSD7Depth", &GenSD7Depth, "GenSD7Depth/I");
   OutputTree.Branch("GenSD0DR", &GenSD0DR, "GenSD0DR/D");
   OutputTree.Branch("GenSD7DR", &GenSD7DR, "GenSD7DR/D");
   OutputTree.Branch("GenSD0Mass", &GenSD0Mass, "GenSD0Mass/D");
   OutputTree.Branch("GenSD7Mass", &GenSD7Mass, "GenSD7Mass/D");
   OutputTree.Branch("GenSD0SubJet1E", &GenSD0SubJet1E, "GenSD0SubJet1E/D");
   OutputTree.Branch("GenSD0SubJet1PT", &GenSD0SubJet1PT, "GenSD0SubJet1PT/D");
   OutputTree.Branch("GenSD0SubJet1Eta", &GenSD0SubJet1Eta, "GenSD0SubJet1Eta/D");
   OutputTree.Branch("GenSD0SubJet1Phi", &GenSD0SubJet1Phi, "GenSD0SubJet1Phi/D");
   OutputTree.Branch("GenSD0SubJet2E", &GenSD0SubJet2E, "GenSD0SubJet2E/D");
   OutputTree.Branch("GenSD0SubJet2PT", &GenSD0SubJet2PT, "GenSD0SubJet2PT/D");
   OutputTree.Branch("GenSD0SubJet2Eta", &GenSD0SubJet2Eta, "GenSD0SubJet2Eta/D");
   OutputTree.Branch("GenSD0SubJet2Phi", &GenSD0SubJet2Phi, "GenSD0SubJet2Phi/D");
   OutputTree.Branch("GenSD7SubJet1E", &GenSD7SubJet1E, "GenSD7SubJet1E/D");
   OutputTree.Branch("GenSD7SubJet1PT", &GenSD7SubJet1PT, "GenSD7SubJet1PT/D");
   OutputTree.Branch("GenSD7SubJet1Eta", &GenSD7SubJet1Eta, "GenSD7SubJet1Eta/D");
   OutputTree.Branch("GenSD7SubJet1Phi", &GenSD7SubJet1Phi, "GenSD7SubJet1Phi/D");
   OutputTree.Branch("GenSD7SubJet2E", &GenSD7SubJet2E, "GenSD7SubJet2E/D");
   OutputTree.Branch("GenSD7SubJet2PT", &GenSD7SubJet2PT, "GenSD7SubJet2PT/D");
   OutputTree.Branch("GenSD7SubJet2Eta", &GenSD7SubJet2Eta, "GenSD7SubJet2Eta/D");
   OutputTree.Branch("GenSD7SubJet2Phi", &GenSD7SubJet2Phi, "GenSD7SubJet2Phi/D");

   double GenSD0C0_0, GenSD0C0_1, GenSD0C0_2;
   double GenSD0C1_0, GenSD0C1_1, GenSD0C1_2;
   double GenSD7C0_0, GenSD7C0_1, GenSD7C0_2;
   double GenSD7C1_0, GenSD7C1_1, GenSD7C1_2;
   OutputTree.Branch("GenSD0C0_0", &GenSD0C0_0, "GenSD0C0_0/D");
   OutputTree.Branch("GenSD0C0_1", &GenSD0C0_1, "GenSD0C0_1/D");
   OutputTree.Branch("GenSD0C0_2", &GenSD0C0_2, "GenSD0C0_2/D");
   OutputTree.Branch("GenSD0C1_0", &GenSD0C1_0, "GenSD0C1_0/D");
   OutputTree.Branch("GenSD0C1_1", &GenSD0C1_1, "GenSD0C1_1/D");
   OutputTree.Branch("GenSD0C1_2", &GenSD0C1_2, "GenSD0C1_2/D");
   OutputTree.Branch("GenSD7C0_0", &GenSD7C0_0, "GenSD7C0_0/D");
   OutputTree.Branch("GenSD7C0_1", &GenSD7C0_1, "GenSD7C0_1/D");
   OutputTree.Branch("GenSD7C0_2", &GenSD7C0_2, "GenSD7C0_2/D");
   OutputTree.Branch("GenSD7C1_0", &GenSD7C1_0, "GenSD7C1_0/D");
   OutputTree.Branch("GenSD7C1_1", &GenSD7C1_1, "GenSD7C1_1/D");
   OutputTree.Branch("GenSD7C1_2", &GenSD7C1_2, "GenSD7C1_2/D");
   ...
   double SD0C0_0, SD0C0_1, SD0C0_2;
   double SD0C1_0, SD0C1_1, SD0C1_2;
   double SD7C0_0, SD7C0_1, SD7C0_2;
   double SD7C1_0, SD7C1_1, SD7C1_2;
   OutputTree.Branch("SD0C0_0", &SD0C0_0, "SD0C0_0/D");
   OutputTree.Branch("SD0C0_1", &SD0C0_1, "SD0C0_1/D");
   OutputTree.Branch("SD0C0_2", &SD0C0_2, "SD0C0_2/D");
   OutputTree.Branch("SD0C1_0", &SD0C1_0, "SD0C1_0/D");
   OutputTree.Branch("SD0C1_1", &SD0C1_1, "SD0C1_1/D");
   OutputTree.Branch("SD0C1_2", &SD0C1_2, "SD0C1_2/D");
   OutputTree.Branch("SD7C0_0", &SD7C0_0, "SD7C0_0/D");
   OutputTree.Branch("SD7C0_1", &SD7C0_1, "SD7C0_1/D");
   OutputTree.Branch("SD7C0_2", &SD7C0_2, "SD7C0_2/D");
   OutputTree.Branch("SD7C1_0", &SD7C1_0, "SD7C1_0/D");
   OutputTree.Branch("SD7C1_1", &SD7C1_1, "SD7C1_1/D");
   OutputTree.Branch("SD7C1_2", &SD7C1_2, "SD7C1_2/D");
   ...
   int Mod = (EntryCount > 200) ? EntryCount / 200 : 1;
   ...
   for(int iE = 0; iE < EntryCount; iE++)
   {
      ...
      {
         if(GenJets[iG].perp() < 20)   // mini jets!
            continue;
         if(fabs(GenJets[iG].eta()) > 3.0)   // forward jets!
            continue;
         ...
         vector<PseudoJet> GenConstituents = GenJets[iG].constituents();
         ...
         Node *GenGroomed0 = FindSDNode(GenNodes[0], 0.1, 0.0, 0.4);
         Node *GenGroomed7 = FindSDNode(GenNodes[0], 0.5, 1.5, 0.4);

         vector<pair<double, double>> GenSD0C0 = CountSD(GenNodes[0], 0.1 ,0.0, 0.4, 0.0);
         vector<pair<double, double>> GenSD0C1 = CountSD(GenNodes[0], 0.1 ,0.0, 0.4, 0.1);
         vector<pair<double, double>> GenSD7C0 = CountSD(GenNodes[0], 0.5 ,1.5, 0.4, 0.0);
         vector<pair<double, double>> GenSD7C1 = CountSD(GenNodes[0], 0.5 ,1.5, 0.4, 0.1);

         GenSD0C0_0 = SDCSum(GenSD0C0, 0.0);
         GenSD0C0_1 = SDCSum(GenSD0C0, 1.0);
         GenSD0C0_2 = SDCSum(GenSD0C0, 2.0);
         GenSD0C1_0 = SDCSum(GenSD0C1, 0.0);
         GenSD0C1_1 = SDCSum(GenSD0C1, 1.0);
         GenSD0C1_2 = SDCSum(GenSD0C1, 2.0);
         GenSD7C0_0 = SDCSum(GenSD7C0, 0.0);
         GenSD7C0_1 = SDCSum(GenSD7C0, 1.0);
         GenSD7C0_2 = SDCSum(GenSD7C0, 2.0);
         GenSD7C1_0 = SDCSum(GenSD7C1, 0.0);
         GenSD7C1_1 = SDCSum(GenSD7C1, 1.0);
         GenSD7C1_2 = SDCSum(GenSD7C1, 2.0);

         SD0Depth = NodeDistance(GenGroomed0, GenNodes[0]);
         SD7Depth = NodeDistance(GenGroomed7, GenNodes[0]);

         if(GenGroomed0->N > 1)
         {
            GenSD0DR         = GetDR(GenGroomed0->Child1->P, GenGroomed0->Child2->P);
            GenSD0Mass       = GenGroomed0->P.GetMass();

            GenSD0SubJet1E   = GenGroomed0->Child1->P[0];
            GenSD0SubJet1PT  = GenGroomed0->Child1->P.GetPT();
            GenSD0SubJet1Eta = GenGroomed0->Child1->P.GetEta();
            GenSD0SubJet1Phi = GenGroomed0->Child1->P.GetPhi();
            GenSD0SubJet2E   = GenGroomed0->Child2->P[0];
            GenSD0SubJet2PT  = GenGroomed0->Child2->P.GetPT();
            GenSD0SubJet2Eta = GenGroomed0->Child2->P.GetEta();
            GenSD0SubJet2Phi = GenGroomed0->Child2->P.GetPhi();
         }
         else
            GenSD0DR = -1;
         ...
         if(GenGroomed7->N > 1)
         {
            GenSD7DR         = GetDR(GenGroomed7->Child1->P, GenGroomed7->Child2->P);
            GenSD7Mass       = GenGroomed7->P.GetMass();

            GenSD7SubJet1E   = GenGroomed7->Child1->P[0];
            GenSD7SubJet1PT  = GenGroomed7->Child1->P.GetPT();
            GenSD7SubJet1Eta = GenGroomed7->Child1->P.GetEta();
            GenSD7SubJet1Phi = GenGroomed7->Child1->P.GetPhi();
            GenSD7SubJet2E   = GenGroomed7->Child1->P[0];
            GenSD7SubJet2PT  = GenGroomed7->Child2->P.GetPT();
            GenSD7SubJet2Eta = GenGroomed7->Child2->P.GetEta();
            GenSD7SubJet2Phi = GenGroomed7->Child2->P.GetPhi();
         }
         else
            GenSD7DR = -1;
         ...
         vector<pair<double, double>> SD0C0 = CountSD(Nodes[0], 0.1 ,0.0, 0.4, 0.0);
         vector<pair<double, double>> SD0C1 = CountSD(Nodes[0], 0.1 ,0.0, 0.4, 0.1);
         vector<pair<double, double>> SD7C0 = CountSD(Nodes[0], 0.5 ,1.5, 0.4, 0.0);
         vector<pair<double, double>> SD7C1 = CountSD(Nodes[0], 0.5 ,1.5, 0.4, 0.1);

         SD0C0_0 = SDCSum(SD0C0, 0.0);
         SD0C0_1 = SDCSum(SD0C0, 1.0);
         SD0C0_2 = SDCSum(SD0C0, 2.0);
         SD0C1_0 = SDCSum(SD0C1, 0.0);
         SD0C1_1 = SDCSum(SD0C1, 1.0);
         SD0C1_2 = SDCSum(SD0C1, 2.0);
         SD7C0_0 = SDCSum(SD7C0, 0.0);
         SD7C0_1 = SDCSum(SD7C0, 1.0);
         SD7C0_2 = SDCSum(SD7C0, 2.0);
         SD7C1_0 = SDCSum(SD7C1, 0.0);
         SD7C1_1 = SDCSum(SD7C1, 1.0);
         SD7C1_2 = SDCSum(SD7C1, 2.0);
