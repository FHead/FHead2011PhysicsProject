...
//---------------------------------------------------------------------------
double GetPTYDensity_MZ_CTEQ6l1_13432(int PID1, int PID2, double pt, double y, double s = 125 * 125);
double GetPTYDensityUUbar_MZ_CTEQ6l1_13432(double pt, double y, double s = 125 * 125);
double GetPTYDensityDDbar_MZ_CTEQ6l1_13432(double pt, double y, double s = 125 * 125);
double GetPTYDensityGG_MZ_CTEQ6l1_13432(double pt, double y, double s = 125 * 125);
double GetPTYDensity_2_CTEQ6l1_13432(int PID1, int PID2, double pt, double y, double s = 125 * 125);
double GetPTYDensityUUbar_2_CTEQ6l1_13432(double pt, double y, double s = 125 * 125);
double GetPTYDensityDDbar_2_CTEQ6l1_13432(double pt, double y, double s = 125 * 125);
double GetPTYDensityGG_2_CTEQ6l1_13432(double pt, double y, double s = 125 * 125);
//---------------------------------------------------------------------------
// Tofu
