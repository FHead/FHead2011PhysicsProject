...
int main(int argc, char *argv[])
{
   ...
   CalculatorBEMuubar.SetMECalculator(CalculateUUbarBackground2e2muDirectional);
   CalculatorBEEuubar.SetMECalculator(CalculateUUbarBackground4eDirectional);
   CalculatorBEMddbar.SetMECalculator(CalculateDDbarBackground2e2muDirectional);
   CalculatorBEEddbar.SetMECalculator(CalculateDDbarBackground4eDirectional);
