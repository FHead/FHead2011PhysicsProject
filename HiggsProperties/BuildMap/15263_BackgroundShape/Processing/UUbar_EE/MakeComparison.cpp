...
int main()
{
   ...
   TH1D HM2Toy("HM2Toy", "M2 Toy;M2;", 100, 30, 120);                                  HM2Toy.Sumw2();
   TH1D HM2MG("HM2MG", "M2 MG;M2;", 100, 30, 120);                                     HM2MG.Sumw2();
   ...
   double Weight;
   TreeToy->SetBranchAddress("EEUU", &Weight);
   double PassA;
   TreeToy->SetBranchAddress("EEA", &PassA);

   int EntryToy = TreeToy->GetEntries();
   ProgressBar BarToy(cout, EntryToy);
   for(int iE = 0; iE < EntryToy / 20; iE++)
   {
      ...
      LeptonToy = LeptonToy.ReorderLeptons4e();
   ...
   for(int iE = 0; iE < EntryMG; iE++)
   {
      ...
      LeptonMG = LeptonMG.ReorderLeptons4e();
