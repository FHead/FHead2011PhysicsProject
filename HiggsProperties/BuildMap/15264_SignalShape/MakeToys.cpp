...
int main(int argc, char *argv[])
{
   ...
   for(int iEvent = 0; iEvent < EventCount; iEvent++)
   {
      ...
      cout << "EVENT ";
      cout << " " << IntegralSEM[0] * Weight
         << " " << IntegralSEE[0] * Weight;
      cout << " " << LeptonsEM.Lepton11[1];
      cout << " " << LeptonsEM.Lepton11[2];
      cout << " " << LeptonsEM.Lepton11[3];
      cout << " " << LeptonsEM.Lepton12[1];
      cout << " " << LeptonsEM.Lepton12[2];
      cout << " " << LeptonsEM.Lepton12[3];
      cout << " " << LeptonsEM.Lepton21[1];
      cout << " " << LeptonsEM.Lepton21[2];
      cout << " " << LeptonsEM.Lepton21[3];
      cout << " " << LeptonsEM.Lepton22[1];
      cout << " " << LeptonsEM.Lepton22[2];
      cout << " " << LeptonsEM.Lepton22[3];
      for(int i = 0; i < 13; i++)
         cout << " " << PassEM[i];
      for(int i = 0; i < 13; i++)
         cout << " " << PassEE[i];
