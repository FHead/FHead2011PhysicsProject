...
int main()
{
   ...
   double ME;
   TreeToy.SetBranchAddress("B2_UUbar", &ME);
   ...
   for(int iE = 0; iE < EntryToy; iE++)
   {
      ...
      HMHToy.Fill(Event.HMass, Weight * ME * PassCuts[0]);
      HM1Toy.Fill(Event.ZMass, Weight * ME * PassCuts[0]);
      HM2Toy.Fill(Event.Z2Mass, Weight * ME * PassCuts[0]);
      HCosTheta0Toy.Fill(cos(Event.Theta0), Weight * ME * PassCuts[0]);
      HPhi0Toy.Fill(Event.Phi0, Weight * ME * PassCuts[0]);
      HCosTheta1Toy.Fill(cos(Event.Theta1), Weight * ME * PassCuts[0]);
      HCosTheta2Toy.Fill(cos(Event.Theta2), Weight * ME * PassCuts[0]);
      HPhiToy.Fill(Event.Phi, Weight * ME * PassCuts[0]);
      HYHToy.Fill(Event.YH, Weight * ME * PassCuts[0]);

      PM1MHToy.Fill(Event.HMass, Event.ZMass, Weight * ME * PassCuts[0]);
   }
   ...
   for(int iE = 0; iE < EntryMG; iE++)
   {
      ...
      if(iE % 2 == 1)
      {
         LeptonMG.Lepton11[3] = -LeptonMG.Lepton11[3];
         LeptonMG.Lepton12[3] = -LeptonMG.Lepton12[3];
         LeptonMG.Lepton21[3] = -LeptonMG.Lepton21[3];
         LeptonMG.Lepton22[3] = -LeptonMG.Lepton22[3];
      }
      ...
      PM1MHMG.Fill(Event.HMass, Event.ZMass, Weight * PassCuts[0]);
   }
