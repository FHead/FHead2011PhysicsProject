...
inline unsigned int FindLeptonBinBinary(double value, double bins[], unsigned int nbins);
inline unsigned int FindLeptonBin(double value, double bins[], unsigned int nbins);
