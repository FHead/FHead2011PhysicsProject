      ...
      if(iEvent % 8 == 0)
      {
         ...
         do
         {
            ...
            if(DrawRandom(0, 1) < 0.5)
               swap(Angles.ZMass, Angles.Z2Mass);
...
double GiveMeZ2Mass()
{
   ...
   double Type = DrawRandom(0, 1);
   if(Type < 0.1)
      Value = DrawExponential(1.806, 0.1, 10);
   else
      Value = DrawExponential(0.8643, 0.1, 10);
...
{
   return exp(-7.161 + 1.806 * Z2Mass) + exp(2.508 + 0.8643 * Z2Mass);
}
