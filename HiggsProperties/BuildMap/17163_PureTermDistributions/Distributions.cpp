...
class Histograms;
int main();
void OverlayPlots(PdfFileHelper &PdfFile, TH1D *H1, TH1D *H2, TH1D *H3, TH1D *H4, TH1D *H5, TH1D *H6, TH1D *H7, TH1D *H8, double Max);
...
public:
      ...
      : HM1(NULL), HM2(NULL), HCosTheta0(NULL), HPhi0(NULL), HCosTheta1(NULL), HCosTheta2(NULL), HPhi(NULL)
   {
      ...
      HCosTheta0 = new TH1D(Form("HCosTheta0%s", Tag.c_str()), ";cos#Theta;", 50, -1, 1);
...
int main()
{
   ...
   Histograms A3UA2e2mu("A3UA2e2mu");
   Histograms A3UZ2e2mu("A3UZ2e2mu");
   ...
   Histograms A3UA4e("A3UA4e");
   Histograms A3UZ4e("A3UZ4e");
   
   TFile FA1UU2e2mu("Trees/Phto2e2mu_A1UU_18p4GeV_NoPDF_ForEff.root");
   TFile FA1UZ2e2mu("Trees/Phto2e2mu_A1UZ_18p4GeV_NoPDF_ForEff.root");
   TFile FA2UA2e2mu("Trees/Phto2e2mu_A2UA_18p4GeV_NoPDF_ForEff.root");
   TFile FA2UU2e2mu("Trees/Phto2e2mu_A2UU_18p4GeV_NoPDF_ForEff.root");
   TFile FA2UZ2e2mu("Trees/Phto2e2mu_A2UZ_18p4GeV_NoPDF_ForEff.root");
   TFile FA3UU2e2mu("Trees/Phto2e2mu_A3UU_18p4GeV_NoPDF_ForEff.root");
   TFile FA3UA2e2mu("Trees/Phto2e2mu_A3UA_18p4GeV_NoPDF_ForEff.root");
   TFile FA3UZ2e2mu("Trees/Phto2e2mu_A3UZ_18p4GeV_NoPDF_ForEff.root");
   TFile FA1UU4e("Trees/Phto4e_A1UU_18p4GeV_NoPDF_ForEff.root");
   TFile FA1UZ4e("Trees/Phto4e_A1UZ_18p4GeV_NoPDF_ForEff.root");
   TFile FA2UA4e("Trees/Phto4e_A2UA_18p4GeV_NoPDF_ForEff.root");
   TFile FA2UU4e("Trees/Phto4e_A2UU_18p4GeV_NoPDF_ForEff.root");
   TFile FA2UZ4e("Trees/Phto4e_A2UZ_18p4GeV_NoPDF_ForEff.root");
   TFile FA3UU4e("Trees/Phto4e_A3UU_18p4GeV_NoPDF_ForEff.root");
   TFile FA3UA4e("Trees/Phto4e_A3UA_18p4GeV_NoPDF_ForEff.root");
   TFile FA3UZ4e("Trees/Phto4e_A3UZ_18p4GeV_NoPDF_ForEff.root");
   ...
   A3UA2e2mu.FillLepton((TTree *)FA3UA2e2mu.Get("Tree"));
   A3UZ2e2mu.FillLepton((TTree *)FA3UZ2e2mu.Get("Tree"));
   ...
   A3UA4e.FillLepton((TTree *)FA3UA4e.Get("Tree"));
   A3UZ4e.FillLepton((TTree *)FA3UZ4e.Get("Tree"));

   PdfFileHelper PdfFile("BasicDistributions.pdf");
   PdfFile.AddTextPage("Distributions from MG");

   PdfFile.AddTextPage("2e2#mu plots");
   OverlayPlots(PdfFile, A1UU2e2mu.HM1, A1UZ2e2mu.HM1, A2UA2e2mu.HM1, A2UU2e2mu.HM1, A2UZ2e2mu.HM1, A3UU2e2mu.HM1, A3UA2e2mu.HM1, A3UZ2e2mu.HM1, -1);
   OverlayPlots(PdfFile, A1UU2e2mu.HM2, A1UZ2e2mu.HM2, A2UA2e2mu.HM2, A2UU2e2mu.HM2, A2UZ2e2mu.HM2, A3UU2e2mu.HM2, A3UA2e2mu.HM2, A3UZ2e2mu.HM2, 1);
   OverlayPlots(PdfFile, A1UU2e2mu.HCosTheta0, A1UZ2e2mu.HCosTheta0, A2UA2e2mu.HCosTheta0, A2UU2e2mu.HCosTheta0, A2UZ2e2mu.HCosTheta0, A3UU2e2mu.HCosTheta0, A3UA2e2mu.HCosTheta0, A3UZ2e2mu.HCosTheta0, 1.35 / 2);
   OverlayPlots(PdfFile, A1UU2e2mu.HPhi0, A1UZ2e2mu.HPhi0, A2UA2e2mu.HPhi0, A2UU2e2mu.HPhi0, A2UZ2e2mu.HPhi0, A3UU2e2mu.HPhi0, A3UA2e2mu.HPhi0, A3UZ2e2mu.HPhi0, 0.22);
   OverlayPlots(PdfFile, A1UU2e2mu.HCosTheta1, A1UZ2e2mu.HCosTheta1, A2UA2e2mu.HCosTheta1, A2UU2e2mu.HCosTheta1, A2UZ2e2mu.HCosTheta1, A3UU2e2mu.HCosTheta1, A3UA2e2mu.HCosTheta1, A3UZ2e2mu.HCosTheta1, 1.7 / 2);
   OverlayPlots(PdfFile, A1UU2e2mu.HCosTheta2, A1UZ2e2mu.HCosTheta2, A2UA2e2mu.HCosTheta2, A2UU2e2mu.HCosTheta2, A2UZ2e2mu.HCosTheta2, A3UU2e2mu.HCosTheta2, A3UA2e2mu.HCosTheta2, A3UZ2e2mu.HCosTheta2, 1.7 / 2);
   OverlayPlots(PdfFile, A1UU2e2mu.HPhi, A1UZ2e2mu.HPhi, A2UA2e2mu.HPhi, A2UU2e2mu.HPhi, A2UZ2e2mu.HPhi, A3UU2e2mu.HPhi, A3UA2e2mu.HPhi, A3UZ2e2mu.HPhi, 0.27);
   
   PdfFile.AddTextPage("4e/4#mu plots");
   OverlayPlots(PdfFile, A1UU4e.HM1, A1UZ4e.HM1, A2UA4e.HM1, A2UU4e.HM1, A2UZ4e.HM1, A3UU4e.HM1, A3UA4e.HM1, A3UZ4e.HM1, -1);
   OverlayPlots(PdfFile, A1UU4e.HM2, A1UZ4e.HM2, A2UA4e.HM2, A2UU4e.HM2, A2UZ4e.HM2, A3UU4e.HM2, A3UA4e.HM2, A3UZ4e.HM2, 0.85);
   OverlayPlots(PdfFile, A1UU4e.HCosTheta0, A1UZ4e.HCosTheta0, A2UA4e.HCosTheta0, A2UU4e.HCosTheta0, A2UZ4e.HCosTheta0, A3UU4e.HCosTheta0, A3UA4e.HCosTheta0, A3UZ4e.HCosTheta0, 1.35 / 2);
   OverlayPlots(PdfFile, A1UU4e.HPhi0, A1UZ4e.HPhi0, A2UA4e.HPhi0, A2UU4e.HPhi0, A2UZ4e.HPhi0, A3UU4e.HPhi0, A3UA4e.HPhi0, A3UZ4e.HPhi0, 0.22);
   OverlayPlots(PdfFile, A1UU4e.HCosTheta1, A1UZ4e.HCosTheta1, A2UA4e.HCosTheta1, A2UU4e.HCosTheta1, A2UZ4e.HCosTheta1, A3UU4e.HCosTheta1, A3UA4e.HCosTheta1, A3UZ4e.HCosTheta1, 2.2 / 2);
   OverlayPlots(PdfFile, A1UU4e.HCosTheta2, A1UZ4e.HCosTheta2, A2UA4e.HCosTheta2, A2UU4e.HCosTheta2, A2UZ4e.HCosTheta2, A3UU4e.HCosTheta2, A3UA4e.HCosTheta2, A3UZ4e.HCosTheta2, 2.1 / 2);
   OverlayPlots(PdfFile, A1UU4e.HPhi, A1UZ4e.HPhi, A2UA4e.HPhi, A2UU4e.HPhi, A2UZ4e.HPhi, A3UU4e.HPhi, A3UA4e.HPhi, A3UZ4e.HPhi, 0.7);
...
void OverlayPlots(PdfFileHelper &PdfFile, TH1D *H1, TH1D *H2, TH1D *H3, TH1D *H4, TH1D *H5, TH1D *H6, TH1D *H7, TH1D *H8, double Max)
{
   ...
   TH1D *HT7 = (TH1D *)H7->Clone("TempH7");
   TH1D *HT8 = (TH1D *)H8->Clone("TempH8");
   ...
   NormalizeHistogram(HT7);
   NormalizeHistogram(HT8);

   int Color[] = {kGreen - 3, kRed, kYellow + 3, kBlack, kCyan - 3, kBlue, kMagenta, kGreen + 3};
   
   HT1->SetLineColor(Color[0]);
   HT2->SetLineColor(Color[1]);
   HT3->SetLineColor(Color[2]);
   HT4->SetLineColor(Color[3]);
   HT5->SetLineColor(Color[4]);
   HT6->SetLineColor(Color[5]);
   HT7->SetLineColor(Color[6]);
   HT8->SetLineColor(Color[7]);

   HT1->SetMarkerColor(Color[0]);
   HT2->SetMarkerColor(Color[1]);
   HT3->SetMarkerColor(Color[2]);
   HT4->SetMarkerColor(Color[3]);
   HT5->SetMarkerColor(Color[4]);
   HT6->SetMarkerColor(Color[5]);
   HT7->SetMarkerColor(Color[6]);
   HT8->SetMarkerColor(Color[7]);
   ...
   HWorldLog.GetXaxis()->CenterTitle(true);
   HWorldLog.GetYaxis()->CenterTitle(true);

   TLegend Legend1(0.20, 0.75, 0.35, 0.85);
   Legend1.SetTextFont(42);
   Legend1.SetTextSize(0.035);
   Legend1.SetFillStyle(0);
   TLegend Legend2(0.35, 0.75, 0.50, 0.85);
   Legend2.SetTextFont(42);
   Legend2.SetTextSize(0.035);
   Legend2.SetFillStyle(0);
   TLegend Legend3(0.50, 0.75, 0.65, 0.85);
   Legend3.SetTextFont(42);
   Legend3.SetTextSize(0.035);
   Legend3.SetFillStyle(0);
   TLegend Legend4(0.65, 0.75, 0.80, 0.85);
   ...
   Legend4.AddEntry(HT7, "|A_{3}^{#Upsilon#gamma}|^{2}", "l");
   Legend4.AddEntry(HT8, "|A_{3}^{#UpsilonZ}|^{2}", "l");
   ...
   TH1D *HT7C = (TH1D *)HT7->Clone();
   TH1D *HT8C = (TH1D *)HT8->Clone();
