...
void BranchAddresses(TTree *T, Likelihoods &M)
{
   ...
   T->SetBranchStatus("LikelihoodLarge_ExtSig1", true);
   T->SetBranchStatus("LikelihoodLarge_ExtSig3", true);
   T->SetBranchStatus("LikelihoodLarge_ExtSig13", true);
   T->SetBranchStatus("LikelihoodLarge_EffMEE", true);
   T->SetBranchStatus("LikelihoodLarge_ExtSig1_Integral", true);
   T->SetBranchStatus("LikelihoodLarge_ExtSig3_Integral", true);
   T->SetBranchStatus("LikelihoodLarge_ExtSig13_Integral", true);
   T->SetBranchStatus("mass", true);

   T->SetBranchAddress("LikelihoodLarge_ExtSig1", &M.L1);
   T->SetBranchAddress("LikelihoodLarge_ExtSig3", &M.L3);
   T->SetBranchAddress("LikelihoodLarge_ExtSig13", &M.L13);
   T->SetBranchAddress("LikelihoodLarge_EffMEE", &M.LB);
   T->SetBranchAddress("LikelihoodLarge_ExtSig1_Integral", &M.I1);
   T->SetBranchAddress("LikelihoodLarge_ExtSig3_Integral", &M.I3);
   T->SetBranchAddress("LikelihoodLarge_ExtSig13_Integral", &M.I13);
