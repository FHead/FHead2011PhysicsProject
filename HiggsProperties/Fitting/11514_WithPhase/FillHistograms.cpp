...
int main(int argc, char *argv[])
{
   ...
   string Tag = Form("%d_%d", SignalDatasetSize, BackgroundDatasetSize);
   TFile OutputFile(Form("%s_%s.root", OutputFileName.c_str(), Tag.c_str()), "RECREATE");

   TNtuple OutputTree("OutputTree", "THIS IS TITLE!",
      "SignalSize:BackgroundSize:MedianFraction:PlusFraction:MinusFraction");
   
   TNtuple OutputTreeComplex("OutputTreeComplex", "THIS IS TITLE!",
      "SignalSize:BackgroundSize:ATanA3A1:A3Phase:F:N:Likelihood");
   ...
   {
      ///////////////////////////////////////////////////////////////
      // Collect dataset with correct signal and background counts //
      ///////////////////////////////////////////////////////////////
      ...
      OutputTreeComplex.Fill(SignalDatasetSize, BackgroundDatasetSize, BestATanA3A1, BestA3Phase,
