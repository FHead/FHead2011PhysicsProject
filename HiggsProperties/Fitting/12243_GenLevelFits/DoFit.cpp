...
FitResultSummary FitClass::DoFit()
{
   ...
   Worker->SetLimitedVariable(0, "A3A1", 0, 0.4, -1000, 1000);
   Worker->SetLimitedVariable(1, "A3Phase", PI / 3, 0.4, -PI * 10, PI * 10);
   Worker->SetLimitedVariable(2, "A2A1", 0, 0.3, -1000, 1000);
   Worker->SetLimitedVariable(3, "A2Phase", PI / 6, 0.3, -PI * 10, PI * 10);
   Worker->SetLimitedVariable(4, "Fem", 0, 0.2, 0, 1);
   Worker->SetLimitedVariable(5, "Fme", 0, 0, 0, 1);
   Worker->SetLimitedVariable(6, "Fee", 0, 0, 0, 1);
   Worker->SetLimitedVariable(7, "Fmm", 0, 0, 0, 1);
