   ...
   for(int iE = 0; iE < EntryCount; iE++)
   {
      ...
      else
      {
         for(int j = 0; j < 5; j++)
         {
            ...
            Integral[12][j] = Integral[13][j];   // quick fix
         }
      }
      ...
      // for(int i = 0; i < 92; i++)
      //    for(int j = 0; j < 5; j++)
      //       Value[i][j] = Value[i][j] / Event.ZMass / Event.Z2Mass / Event.HMass;

      // cout << Value[1][0] << " " << Value[2][0] << " " << Value[3][0] << " " << Value[14][0] << " " << Value[15][0] << " " << Value[26][0] << endl;
      // cout << Integral[1][0] << " " << Integral[2][0] << " " << Integral[3][0] << " " << Integral[14][0] << " " << Integral[15][0] << " " << Integral[26][0] << endl;
      // cout << "!" << endl;
