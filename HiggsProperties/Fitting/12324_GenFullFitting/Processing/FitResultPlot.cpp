...
int main(int argc, char *argv[])
{
   double R2ZZReal = 0, R3ZZReal = 5.1;
   double R2ZAReal = 0.05, R3ZAReal = -0.1;
   double R2AAReal = 0.07, R3AAReal = -0.08;
   double FemReal = 0;

   string InputFileName = "OutputFile_8_1000.root";

   TH1D HR2ZZ("HR2ZZ", "R_{2}^{ZZ};R_{2}^{ZZ}", 100, -5, 5);
   TH1D HR3ZZ("HR3ZZ", "R_{3}^{ZZ};R_{3}^{ZZ}", 100, 0, 10);
   TH1D HR2ZA("HR2ZA", "R_{2}^{ZA};R_{2}^{ZA}", 100, -0.2, 0.2);
   TH1D HR3ZA("HR3ZA", "R_{3}^{ZA};R_{3}^{ZA}", 100, -0.4, 0.4);
   ...
   TH2D HR2ZZR3ZZ("HR2ZZR3ZZ", "R^{ZZ};R_{2}^{ZZ};R_{3}^{ZZ}", 100, -5, 5, 100, 0, 10);
   TH2D HR2ZAR3ZA("HR2ZAR3ZA", "R^{ZA};R_{2}^{ZA};R_{3}^{ZA}", 100, 0, 0.2, 100, -0.4, 0);
   TH2D HR2AAR3AA("HR2AAR3AA", "R^{AA};R_{2}^{AA};R_{3}^{AA}", 100, 0, 0.2, 100, -0.2, 0);
   TH2D HR2ZZR2ZA("HR2ZZR2ZA", "R_{2}^{ZZ} vs. R_{2}^{ZA};R_{2}^{ZZ};R_{2}^{ZA}", 100, -5, 5, 100, 0, 0.2);
   TH2D HR2ZZR2AA("HR2ZZR2AA", "R_{2}^{ZZ} vs. R_{2}^{AA};R_{2}^{ZZ};R_{2}^{AA}", 100, -5, 5, 100, 0, 0.2);
   TH2D HR2ZAR2AA("HR2ZAR2AA", "R_{2}^{ZA} vs. R_{2}^{AA};R_{2}^{ZA};R_{2}^{AA}", 100, 0, 0.2, 100, 0, 0.2);
   TH2D HR3ZZR3ZA("HR3ZZR3ZA", "R_{3}^{ZZ} vs. R_{3}^{ZA};R_{3}^{ZZ};R_{3}^{ZA}", 100, 0, 10, 100, -0.4, 0);
   TH2D HR3ZZR3AA("HR3ZZR3AA", "R_{3}^{ZZ} vs. R_{3}^{AA};R_{3}^{ZZ};R_{3}^{AA}", 100, 0, 10, 100, -0.2, 0);
   TH2D HR3ZAR3AA("HR3ZAR3AA", "R_{3}^{ZA} vs. R_{3}^{AA};R_{3}^{ZA};R_{3}^{AA}", 100, -0.4, 0, 100, -0.2, 0);
