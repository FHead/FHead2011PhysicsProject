...
{
public:
   double ThetaZX, ThetaZXError;
   double PhiZX, PhiZXError;
   double ThetaZZ, ThetaZZError;
   double PhiZZ, PhiZZError;
   double ThetaZA, ThetaZAError;
   double ThetaAA, ThetaAAError;
