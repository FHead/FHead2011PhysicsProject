...
int main()
{
   ...
   string TNames[] = {"A1ZZ", "A2ZZ", "A3ZZ", "A2ZA", "A3ZA", "A2AA", "A3AA"};
      ...
      for(int iN = 0; iN < 4; iN++)
      {
         ...
         for(int iS = 0; iS < 7; iS++)
         {
            ...
            for(int iT = 0; iT < 7; iT++)
            {
               ...
               if(iT != 0)
               {
                  TH1D *H = new TH1D(HistogramName.c_str(), HistogramName.c_str(), 50, -1, 1);
                  H1D.insert(pair<string, TH1D *>(HistogramName, H));
               }
               else
               {
                  TH1D *H = new TH1D(HistogramName.c_str(), HistogramName.c_str(), 50, 0, 1);
                  H1D.insert(pair<string, TH1D *>(HistogramName, H));
               }
            }
         }
   ...
   for(int iE = 0; iE < EntryCount; iE++)
   {
      ...
      double Centers[7] = {0};
      Centers[0] = 1;
      Centers[1] = M.A2ZZA1ZZ;
      Centers[2] = M.A3ZZA1ZZ;
      Centers[3] = M.A2ZAA1ZZ;
      Centers[4] = M.A3ZAA1ZZ;
      Centers[5] = M.A2AAA1ZZ;
      Centers[6] = M.A3AAA1ZZ;

      double Length = 0;
      for(int iT = 0; iT < 7; iT++)
         Length = Length + Centers[iT] * Centers[iT];
      Length = sqrt(Length);
      
      for(int iT = 0; iT < 7; iT++)
         Centers[iT] = Centers[iT] / Length;
