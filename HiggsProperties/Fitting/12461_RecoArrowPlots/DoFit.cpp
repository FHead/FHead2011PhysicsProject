...
int main(int argc, char *argv[])
{
   ...
   for(int i = 1; i <= 1000; i++)
   {
      ...
      vector<double> AValues = ListToVector(6, DrawRandom(-3, 3), DrawRandom(-5, 5),
         DrawRandom(-0.1, 0.1), DrawRandom(-0.1, 0.1), DrawRandom(-0.1, 0.1), DrawRandom(-0.1, 0.1));
   ...
   BranchList = BranchList + ":InitialA2ZZ:InitialA3ZZ";
   BranchList = BranchList + ":InitialA2ZA:InitialA3ZA";
   BranchList = BranchList + ":InitialA2AA:InitialA3AA";
   ...
   for(int i = 0; i < (int)Results.size(); i++)
   {
      ...
      Array[48] = Results[i].InitialA2ZZ;
      Array[49] = Results[i].InitialA3ZZ;
      Array[50] = Results[i].InitialA2ZA;
      Array[51] = Results[i].InitialA3ZA;
      Array[52] = Results[i].InitialA2AA;
      Array[53] = Results[i].InitialA3AA;
