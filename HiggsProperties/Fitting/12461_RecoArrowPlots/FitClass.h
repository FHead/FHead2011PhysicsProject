...
public:
   ...
   double Smm, Bmm;
   int FitStatus;
   double InitialA2ZZ, InitialA2ZZPhase;
   double InitialA3ZZ, InitialA3ZZPhase;
   double InitialA2ZA, InitialA2ZAPhase;
   double InitialA3ZA, InitialA3ZAPhase;
   double InitialA2AA, InitialA2AAPhase;
   double InitialA3AA, InitialA3AAPhase;
};
