...
int main()
{
   ...
   string TNames[] = {"A2ZZ", "A3ZZ", "A2ZA", "A3ZA", "A2AA", "A3AA", "Fraction"};
   double Boundary[] = {5, 8, 0.1, 0.1, 0.1, 0.1, 0.3};
   // double Center[] = {0, 0, 0, 0, 0, 0, 0.375};
   double Center[] = {3, 5, 0, 0, 0, 0, 0.375};
