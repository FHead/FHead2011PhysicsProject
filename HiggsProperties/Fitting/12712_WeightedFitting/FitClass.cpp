...
double FitClass::CalculateLogLikelihoodAll(const double *Parameters) const
{
   ...
   for(int iS = 0; iS < SampleSize; iS++)
   {
      ...
      double BackgroundZJLikelihood = LZJa;
...
FitResultSummary FitClass::DoFit(FitConfiguration configuration)
{
   ...
   Worker->SetLimitedVariable(26, "N3",        configuration.N1InitialValue, StepSize[26], -5, 5);
   Worker->SetLimitedVariable(27, "N4",        configuration.N2InitialValue, StepSize[27], -5, 5);
   Worker->SetLimitedVariable(28, "N5",        configuration.N2InitialValue, StepSize[28], -5, 5);
   Worker->SetLimitedVariable(29, "N6",        configuration.N2InitialValue, StepSize[29], -5, 5);
   Worker->SetLimitedVariable(30, "N7",        configuration.N2InitialValue, StepSize[30], -5, 5);
