...
FitResultSummary FitClass::DoFit(FitConfiguration configuration)
{
   ...
   StepSize[20] = (configuration.FloatFZJ[0] == true) ? 0.1 : 0;
   StepSize[21] = (configuration.FloatFZJ[1] == true) ? 0.1 : 0;
   StepSize[22] = (configuration.FloatFZJ[2] == true) ? 0.1 : 0;
   StepSize[23] = (configuration.FloatFZJ[3] == true) ? 0.1 : 0;
   ...
   StepSize[28] = (configuration.FloatN[0] == true) ? 0.1 : 0;
   StepSize[29] = (configuration.FloatN[1] == true) ? 0.1 : 0;
   StepSize[30] = (configuration.FloatN[2] == true) ? 0.1 : 0;
   StepSize[31] = (configuration.FloatN[3] == true) ? 0.1 : 0;
   StepSize[32] = (configuration.FloatN[4] == true) ? 0.1 : 0;
   StepSize[33] = (configuration.FloatN[5] == true) ? 0.1 : 0;
