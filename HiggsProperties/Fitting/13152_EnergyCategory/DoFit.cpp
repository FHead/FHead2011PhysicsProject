...
void ReadEvents(vector<SingleEvent> &EventsEM, vector<SingleEvent> &EventsME,
   ...
   string FileName, bool Capital, double MaxWeight = 1, bool Is7TeV = false, bool AlternativeWeight = false);
...
int main(int argc, char *argv[])
{
   ...
   // ReadEvents(SignalEM[1],     SignalME[1],     SignalEE[1],     SignalMM[1],     SignalFileName[1],     true,  1,    true,  false);
   // ReadEvents(BackgroundEM[1], BackgroundME[1], BackgroundEE[1], BackgroundMM[1], BackgroundFileName[1], true,  1,    true,  false);
   // ReadEvents(ZJEM[1],         ZJME[1],         ZJEE[1],         ZJMM[1],         ZJFileName[1],         false, 6e-6, true,  false);
   // ReadEvents(ggZZEM[1],       ggZZME[1],       ggZZEE[1],       ggZZMM[1],       ggZZFileName[1],       false, 1e-4, true,  false);
   ReadEvents(SignalEM[0],     SignalME[0],     SignalEE[0],     SignalMM[0],     SignalFileName[0],     true,  1,    false, false);
   ReadEvents(BackgroundEM[0], BackgroundME[0], BackgroundEE[0], BackgroundMM[0], BackgroundFileName[0], true,  1,    false, false);
   ReadEvents(ZJEM[0],         ZJME[0],         ZJEE[0],         ZJMM[0],         ZJFileName[0],         false, 6e-6, false, false);
   ReadEvents(ggZZEM[0],       ggZZME[0],       ggZZEE[0],       ggZZMM[0],       ggZZFileName[0],       false, 1e-4, false, false);
   ...
   for(int i = 1; i <= 63; i++)
   {
      ...
      Configurations.push_back(FitConfiguration(As, Phases, Counts, Counts,
            Fs, Fs, "NNNNNYN",                                                       /* What to float */
         ListToVector(6, A2ZZ, A3ZZ, A2ZA, A3ZA, A2AA, A3AA),                        /* Ratios */
         ListToVector(6, 0, 0, 0, 0, 0, 0),                                          /* Phases */
         ListToVector(4, NS7[0] + NB7[0] + NZJ7[0] + NggZZ7[0], NS7[1] + NB7[1] + NZJ7[1] + NggZZ7[1],
            NS7[2] + NB7[2] + NZJ7[2] + NggZZ7[2], NS7[3] + NB7[3] + NZJ7[3] + NggZZ7[3]),   /* Event Counts */
         ListToVector(4, NS8[0] + NB8[0] + NZJ8[0] + NggZZ8[0], NS8[1] + NB8[1] + NZJ8[1] + NggZZ8[1],
            NS8[2] + NB8[2] + NZJ8[2] + NggZZ8[2], NS8[3] + NB8[3] + NZJ8[3] + NggZZ8[3]),   /* Event Counts */
         ...
         NS7, NS8, NSSigma7, NSSigma8,
         NB7, NB8, NBSigma7, NBSigma8,
         NZJ7, NZJ8, NZJSigma7, NZJSigma8,
         NggZZ7, NggZZ8, NggZZSigma7, NggZZSigma8));                                 /* Constraints */
   }
   ...
   while(Good == true)
   {
      ...
      // Before the 7 TeV toys are ready, take events from 8 TeV sample TODO
      Fits.SignalStateCount[1][0]     = PullEvents(Events, SignalEM[0],     NS7[0],    NSSigma7[0],    false);
      Fits.SignalStateCount[1][1]     = PullEvents(Events, SignalME[0],     NS7[1],    NSSigma7[1],    false);
      Fits.SignalStateCount[1][2]     = PullEvents(Events, SignalEE[0],     NS7[2],    NSSigma7[2],    false);
      Fits.SignalStateCount[1][3]     = PullEvents(Events, SignalMM[0],     NS7[3],    NSSigma7[3],    false);
      ...
      Fits.BackgroundStateCount[1][0] = PullEvents(Events, BackgroundEM[0], NB7[0],    NBSigma7[0],    false);
      Fits.BackgroundStateCount[1][1] = PullEvents(Events, BackgroundME[0], NB7[1],    NBSigma7[1],    false);
      Fits.BackgroundStateCount[1][2] = PullEvents(Events, BackgroundEE[0], NB7[2],    NBSigma7[2],    false);
      Fits.BackgroundStateCount[1][3] = PullEvents(Events, BackgroundMM[0], NB7[3],    NBSigma7[3],    false);
      ...
      Fits.ZJStateCount[1][0]         = PullEvents(Events, ZJEM[0],         NZJ7[0],   NZJSigma7[0],   true);
      Fits.ZJStateCount[1][1]         = PullEvents(Events, ZJME[0],         NZJ7[1],   NZJSigma7[1],   true);
      Fits.ZJStateCount[1][2]         = PullEvents(Events, ZJEE[0],         NZJ7[2],   NZJSigma7[2],   true);
      Fits.ZJStateCount[1][3]         = PullEvents(Events, ZJMM[0],         NZJ7[3],   NZJSigma7[3],   true);
      ...
      Fits.ggZZStateCount[1][0]       = PullEvents(Events, ggZZEM[0],       NggZZ7[0], NggZZSigma7[0], true);
      Fits.ggZZStateCount[1][1]       = PullEvents(Events, ggZZME[0],       NggZZ7[1], NggZZSigma7[1], true);
      Fits.ggZZStateCount[1][2]       = PullEvents(Events, ggZZEE[0],       NggZZ7[2], NggZZSigma7[2], true);
      Fits.ggZZStateCount[1][3]       = PullEvents(Events, ggZZMM[0],       NggZZ7[3], NggZZSigma7[3], true);
...
void ReadEvents(vector<SingleEvent> &EventsEM, vector<SingleEvent> &EventsME,
   vector<SingleEvent> &EventsEE, vector<SingleEvent> &EventsMM,
   string FileName, bool Capital, double MaxWeight, bool Is7TeV, bool AlternativeWeight)
{
   ...
   for(int i = 0; i < 91; i++)   // TODO CHANGE TO 153
   ...
   for(int iE = 0; iE < EntryCount; iE++)
   {
      ...
      else
      {
         for(int j = 0; j < 13; j++)
         {
            ...
            for(int i = 1; i < 92; i++)   // TODO CHANGE TO 154
            {
