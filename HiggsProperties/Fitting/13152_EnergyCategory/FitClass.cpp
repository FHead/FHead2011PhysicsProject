...
FitConfiguration::FitConfiguration(string FloatAs, string FloatPhases,
   ...
   string FloatFractions7TeV, string FloatFractions8TeV, string FloatNs)
{
   SetFloatAs(FloatAs);
...
double FitClass::CalculateLogLikelihoodAll(const double *Parameters) const
{
   ...
   for(int i = 0; i < 4; i++)
   {
      for(int j = 0; j < 2; j++)
      {
         ...
         if(EventCount[j][i] > 0)
            LogTotal = LogTotal + EventCount[j][i] * log(Counts[j][i]) - Counts[j][i];
      }
   }
...
FitResultSummary FitClass::DoFit(FitConfiguration configuration)
{
   ...
   ROOT::Math::Functor Function(this, &FitClass::CalculateLogLikelihoodAll, 51);
   ...
   Result.Count[1][0] = Parameters[12];   Result.CountError[1][0] = Errors[12];
   Result.Count[1][1] = Parameters[13];   Result.CountError[1][1] = Errors[13];
   Result.Count[1][2] = Parameters[14];   Result.CountError[1][2] = Errors[14];
   Result.Count[1][3] = Parameters[15];   Result.CountError[1][3] = Errors[15];
   Result.F[0][0] = Parameters[16];       Result.FError[0][0] = Errors[16];
   Result.F[0][1] = Parameters[17];       Result.FError[0][1] = Errors[17];
   Result.F[0][2] = Parameters[18];       Result.FError[0][2] = Errors[18];
   Result.F[0][3] = Parameters[19];       Result.FError[0][3] = Errors[19];
   Result.F[1][0] = Parameters[16];       Result.FError[1][0] = Errors[16];
   Result.F[1][1] = Parameters[17];       Result.FError[1][1] = Errors[17];
   Result.F[1][2] = Parameters[18];       Result.FError[1][2] = Errors[18];
   Result.F[1][3] = Parameters[19];       Result.FError[1][3] = Errors[19];
   Result.FZJ[0][0] = Parameters[20];     Result.FZJError[0][0] = Errors[20];
   Result.FZJ[0][1] = Parameters[21];     Result.FZJError[0][1] = Errors[21];
   Result.FZJ[0][2] = Parameters[22];     Result.FZJError[0][2] = Errors[22];
   Result.FZJ[0][3] = Parameters[23];     Result.FZJError[0][3] = Errors[23];
   Result.FZJ[1][0] = Parameters[20];     Result.FZJError[1][0] = Errors[20];
   Result.FZJ[1][1] = Parameters[21];     Result.FZJError[1][1] = Errors[21];
   Result.FZJ[1][2] = Parameters[22];     Result.FZJError[1][2] = Errors[22];
   Result.FZJ[1][3] = Parameters[23];     Result.FZJError[1][3] = Errors[23];
   Result.FggZZ[0][0] = Parameters[24];   Result.FggZZError[0][0] = Errors[24];
   Result.FggZZ[0][1] = Parameters[25];   Result.FggZZError[0][1] = Errors[25];
   Result.FggZZ[0][2] = Parameters[26];   Result.FggZZError[0][2] = Errors[26];
   Result.FggZZ[0][3] = Parameters[27];   Result.FggZZError[0][3] = Errors[27];
   Result.FggZZ[1][0] = Parameters[24];   Result.FggZZError[1][0] = Errors[24];
   Result.FggZZ[1][1] = Parameters[25];   Result.FggZZError[1][1] = Errors[25];
   Result.FggZZ[1][2] = Parameters[26];   Result.FggZZError[1][2] = Errors[26];
   Result.FggZZ[1][3] = Parameters[27];   Result.FggZZError[1][3] = Errors[27];
