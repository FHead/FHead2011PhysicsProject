   ...
   for(int i = 0; i < 4; i++)
   {
      ...
      for(int j = 0; j < 2; j++)
      {
         ...
         if(EventCount[j][i] > 0)
         {
            ...
            // cout << i << " " << j << " " << SigmaMu << " " << R << " " << Counts[j][i] << " " << PoissonMean << endl;
         }
      }
   }
...
FitResultSummary FitClass::DoFit(FitConfiguration configuration)
{
   ...
   StepSize[24] = (configuration.FloatF[0][0] == true) ? 0.1 : 0;
   StepSize[25] = (configuration.FloatF[0][1] == true) ? 0.1 : 0;
   StepSize[26] = (configuration.FloatF[0][2] == true) ? 0.1 : 0;
   StepSize[27] = (configuration.FloatF[0][3] == true) ? 0.1 : 0;
   StepSize[28] = (configuration.FloatF[1][0] == true) ? 0.1 : 0;
   StepSize[29] = (configuration.FloatF[1][1] == true) ? 0.1 : 0;
   StepSize[30] = (configuration.FloatF[1][2] == true) ? 0.1 : 0;
   StepSize[31] = (configuration.FloatF[1][3] == true) ? 0.1 : 0;
   ...
   StepSize[40] = (configuration.FloatFggZZ[0][0] == true) ? 0.1 : 0;
   StepSize[41] = (configuration.FloatFggZZ[0][1] == true) ? 0.1 : 0;
   StepSize[42] = (configuration.FloatFggZZ[0][2] == true) ? 0.1 : 0;
   StepSize[43] = (configuration.FloatFggZZ[0][3] == true) ? 0.1 : 0;
   StepSize[44] = (configuration.FloatFggZZ[1][0] == true) ? 0.1 : 0;
   StepSize[45] = (configuration.FloatFggZZ[1][1] == true) ? 0.1 : 0;
   StepSize[46] = (configuration.FloatFggZZ[1][2] == true) ? 0.1 : 0;
   StepSize[47] = (configuration.FloatFggZZ[1][3] == true) ? 0.1 : 0;
   StepSize[48] = (configuration.FloatN[0] == true) ? 0.1 : 0;   // up-down
   StepSize[49] = (configuration.FloatN[1] == true) ? 0.1 : 0;   // wide-narrow
   StepSize[50] = (configuration.FloatN[2] == true) ? 0.1 : 0;   // spectrum
   StepSize[51] = (configuration.FloatN[3] == true) ? 0.1 : 0;   // spectrum
   StepSize[52] = (configuration.FloatN[4] == true) ? 0.1 : 0;   // mass
   StepSize[53] = (configuration.FloatN[5] == true) ? 0.1 : 0;   // ZX
   StepSize[54] = (configuration.FloatN[6] == true) ? 0.1 : 0;
   StepSize[55] = (configuration.FloatMu == true) ? 0.1 : 0;   // Sigma / Sigma_SM
