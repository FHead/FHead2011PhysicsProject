...
g++ FitClass.cpp -o FitClass.o -c -I ../../CommonCode/include `root-config --cflags` -I$Home/RootMacros -g
echo Compiling M4lSpectrum.o
g++ M4lSpectrum.cpp -o M4lSpectrum.o -c -I ../../CommonCode/include `root-config --cflags` -I$Home/RootMacros -g
...
g++ Likelihood.cpp `root-config --glibs` `root-config --cflags` -o RunLikelihood2 \
   -I../../CommonCode/include/ ../../CommonCode/library/AngleConversion.o \
   -I$Home/RootMacros $Home/RootMacros/Code/library/* FitClass.o ../../CommonCode/library/Lists.o \
   M4lSpectrum.o -g
