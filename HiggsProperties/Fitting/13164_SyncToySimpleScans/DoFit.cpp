...
int main(int argc, char *argv[])
{
   ...
   // vector<double> NS8 = ListToVector(4, 500, 0, 500, 500);
   ...
   // vector<double> NB8 = ListToVector(4, 400, 0, 400, 400);
   ...
   // vector<double> NZJ8 = ListToVector(4, 100, 0, 100, 100);
   ...
   // vector<double> NS7 = ListToVector(4, 500, 0, 500, 550);
   ...
   // vector<double> NB7 = ListToVector(4, 400, 0, 400, 400);
   ...
   // vector<double> NZJ7 = ListToVector(4, 100, 0, 100, 50);
   ...
   for(int i = 0; i <= 127; i++)
   {
      ...
      string Fs7 = "YNYYYNYYYNYY";   // FB(EM, ME, EE, MM), FZJ(EM, ME, EE, MM), FggZZ(EM, ME, EE, MM)
      string Fs8 = "YNYYYNYYYNYY";   // FB(EM, ME, EE, MM), FZJ(EM, ME, EE, MM), FggZZ(EM, ME, EE, MM)

      Configurations.push_back(FitConfiguration(As, Phases, Counts, Counts,
            Fs7, Fs8, "NNNNNNN", "N",                                                  /* What to float */
         ...
         ListToVector(12, ((Fs7[0] == 'Y') ? 0.5 : 0), ((Fs7[1] == 'Y') ? 0.5 : 0),
            ((Fs7[2] == 'Y') ? 0.5 : 0), ((Fs7[3] == 'Y') ? 0.5 : 0),
            ((Fs7[4] == 'Y') ? 0.15 : 0), ((Fs7[5] == 'Y') ? 0.25 : 0),
            ((Fs7[6] == 'Y') ? 0.25 : 0), ((Fs7[7] == 'Y') ? 0.15 : 0),
            ((Fs7[8] == 'Y') ? 0.12 : 0), ((Fs7[9] == 'Y') ? 0.12 : 0),
            ((Fs7[10] == 'Y') ? 0.12 : 0), ((Fs7[11] == 'Y') ? 0.12 : 0)),             /* Background fraction */
         ListToVector(12, ((Fs8[0] == 'Y') ? 0.5 : 0), ((Fs8[1] == 'Y') ? 0.5 : 0),
            ((Fs8[2] == 'Y') ? 0.5 : 0), ((Fs8[3] == 'Y') ? 0.5 : 0),
            ((Fs8[4] == 'Y') ? 0.15 : 0), ((Fs8[5] == 'Y') ? 0.25 : 0),
            ((Fs8[6] == 'Y') ? 0.25 : 0), ((Fs8[7] == 'Y') ? 0.15 : 0),
            ((Fs8[8] == 'Y') ? 0.12 : 0), ((Fs8[9] == 'Y') ? 0.12 : 0),
            ((Fs8[10] == 'Y') ? 0.12 : 0), ((Fs8[11] == 'Y') ? 0.12 : 0)),             /* Background fraction */
   ...
   double MaxWeight, bool Is7TeV, bool AlternativeWeight, int TargetToyNumber)
{
   ...
   for(int iE = 0; iE < EntryCount; iE++)
   {
      ...
      if(Is7TeV == false && State == "em")   ggZZ_S_Offset = log(GetggZZ8TeV2e2muSpectrum(S)) - 6.25;
      if(Is7TeV == false && State == "me")   ggZZ_S_Offset = log(GetggZZ8TeV2mu2eSpectrum(S)) - 6.60;
      if(Is7TeV == false && State == "ee")   ggZZ_S_Offset = log(GetggZZ8TeV4eSpectrum(S))    - 5.40;
      if(Is7TeV == false && State == "mm")   ggZZ_S_Offset = log(GetggZZ8TeV4muSpectrum(S))   - 6.25;
      if(Is7TeV == true  && State == "em")   ggZZ_S_Offset = log(GetggZZ8TeV2e2muSpectrum(S)) - 6.25;
      ...
      if(Is7TeV == true  && State == "mm")   ggZZ_S_Offset = log(GetggZZ8TeV4muSpectrum(S))   - 6.25;
