...
// #define PI 3.141515465358979323846264338327950288479716939937510
...
double FitClass::CalculateLogLikelihoodAll(const double *Parameters) const
{
   ...
   for(int iS = 0; iS < SampleSize; iS++)
   {
      ...
      for(int i = 0; i < 13; i++)
      {
         Value[i] = A1ZZR * A1ZZR * V[1][i][iS]
            ...
            + A1L1ZZR * A1L1ZZR * V[92][i][iS]
            + A1L1ZZI * A1L1ZZI * V[93][i][iS]
            + A1LQZZR * A1LQZZR * V[94][i][iS]
            + A1LQZZI * A1LQZZI * V[95][i][iS]
            + A1ZZR * A1L1ZZR * V[96][i][iS]
            + A2ZZR * A1L1ZZR * V[97][i][iS]
            + A2ZZI * A1L1ZZR * V[98][i][iS]
            + A3ZZR * A1L1ZZR * V[99][i][iS]
            + A3ZZI * A1L1ZZR * V[100][i][iS]
            + A2ZZR * A1L1ZZR * V[101][i][iS]
            + A2ZZI * A1L1ZZR * V[102][i][iS]
            + A3ZZR * A1L1ZZR * V[103][i][iS]
            + A3ZZI * A1L1ZZR * V[104][i][iS]
            + A2ZZR * A1L1ZZR * V[105][i][iS]
            + A2ZZI * A1L1ZZR * V[106][i][iS]
            + A3ZZR * A1L1ZZR * V[107][i][iS]
            + A3ZZI * A1L1ZZR * V[108][i][iS]
            + A1ZZR * A1L1ZZI * V[109][i][iS]
            + A2ZZR * A1L1ZZI * V[110][i][iS]
            + A2ZZI * A1L1ZZI * V[111][i][iS]
            + A3ZZR * A1L1ZZI * V[112][i][iS]
            + A3ZZI * A1L1ZZI * V[113][i][iS]
            + A2ZZR * A1L1ZZI * V[114][i][iS]
            + A2ZZI * A1L1ZZI * V[115][i][iS]
            + A3ZZR * A1L1ZZI * V[116][i][iS]
            + A3ZZI * A1L1ZZI * V[117][i][iS]
            + A2ZZR * A1L1ZZI * V[118][i][iS]
            + A2ZZI * A1L1ZZI * V[119][i][iS]
            + A3ZZR * A1L1ZZI * V[120][i][iS]
            + A3ZZI * A1L1ZZI * V[121][i][iS]
            + A1L1ZZR * A1L1ZZI * V[122][i][iS]
            + A1ZZR * A1LQZZR * V[123][i][iS]
            + A2ZZR * A1LQZZR * V[124][i][iS]
            + A2ZZI * A1LQZZR * V[125][i][iS]
            + A3ZZR * A1LQZZR * V[126][i][iS]
            + A3ZZI * A1LQZZR * V[127][i][iS]
            + A2ZZR * A1LQZZR * V[128][i][iS]
            + A2ZZI * A1LQZZR * V[129][i][iS]
            + A3ZZR * A1LQZZR * V[130][i][iS]
            + A3ZZI * A1LQZZR * V[131][i][iS]
            + A2ZZR * A1LQZZR * V[132][i][iS]
            + A2ZZI * A1LQZZR * V[133][i][iS]
            + A3ZZR * A1LQZZR * V[134][i][iS]
            + A3ZZI * A1LQZZR * V[135][i][iS]
            + A1L1ZZR * A1LQZZR * V[136][i][iS]
            + A1L1ZZI * A1LQZZR * V[137][i][iS]
            + A1ZZR * A1LQZZI * V[138][i][iS]
            + A2ZZR * A1LQZZI * V[139][i][iS]
            + A2ZZI * A1LQZZI * V[140][i][iS]
            + A3ZZR * A1LQZZI * V[141][i][iS]
            + A3ZZI * A1LQZZI * V[142][i][iS]
            + A2ZZR * A1LQZZI * V[143][i][iS]
            + A2ZZI * A1LQZZI * V[144][i][iS]
            + A3ZZR * A1LQZZI * V[145][i][iS]
            + A3ZZI * A1LQZZI * V[146][i][iS]
            + A2ZZR * A1LQZZI * V[147][i][iS]
            + A2ZZI * A1LQZZI * V[148][i][iS]
            + A3ZZR * A1LQZZI * V[149][i][iS]
            + A3ZZI * A1LQZZI * V[150][i][iS]
            + A1L1ZZR * A1LQZZI * V[151][i][iS]
            + A1L1ZZI * A1LQZZI * V[152][i][iS]
            + A1LQZZR * A1LQZZI * V[153][i][iS];
         Integral[i] = A1ZZR * A1ZZR * I[1][i][iS]
            ...
            + A1L1ZZR * A1L1ZZR * I[92][i][iS]
            + A1L1ZZI * A1L1ZZI * I[93][i][iS]
            + A1LQZZR * A1LQZZR * I[94][i][iS]
            + A1LQZZI * A1LQZZI * I[95][i][iS]
            + A1ZZR * A1L1ZZR * I[96][i][iS]
            + A2ZZR * A1L1ZZR * I[97][i][iS]
            + A2ZZI * A1L1ZZR * I[98][i][iS]
            + A3ZZR * A1L1ZZR * I[99][i][iS]
            + A3ZZI * A1L1ZZR * I[100][i][iS]
            + A2ZZR * A1L1ZZR * I[101][i][iS]
            + A2ZZI * A1L1ZZR * I[102][i][iS]
            + A3ZZR * A1L1ZZR * I[103][i][iS]
            + A3ZZI * A1L1ZZR * I[104][i][iS]
            + A2ZZR * A1L1ZZR * I[105][i][iS]
            + A2ZZI * A1L1ZZR * I[106][i][iS]
            + A3ZZR * A1L1ZZR * I[107][i][iS]
            + A3ZZI * A1L1ZZR * I[108][i][iS]
            + A1ZZR * A1L1ZZI * I[109][i][iS]
            + A2ZZR * A1L1ZZI * I[110][i][iS]
            + A2ZZI * A1L1ZZI * I[111][i][iS]
            + A3ZZR * A1L1ZZI * I[112][i][iS]
            + A3ZZI * A1L1ZZI * I[113][i][iS]
            + A2ZZR * A1L1ZZI * I[114][i][iS]
            + A2ZZI * A1L1ZZI * I[115][i][iS]
            + A3ZZR * A1L1ZZI * I[116][i][iS]
            + A3ZZI * A1L1ZZI * I[117][i][iS]
            + A2ZZR * A1L1ZZI * I[118][i][iS]
            + A2ZZI * A1L1ZZI * I[119][i][iS]
            + A3ZZR * A1L1ZZI * I[120][i][iS]
            + A3ZZI * A1L1ZZI * I[121][i][iS]
            + A1L1ZZR * A1L1ZZI * I[122][i][iS]
            + A1ZZR * A1LQZZR * I[123][i][iS]
            + A2ZZR * A1LQZZR * I[124][i][iS]
            + A2ZZI * A1LQZZR * I[125][i][iS]
            + A3ZZR * A1LQZZR * I[126][i][iS]
            + A3ZZI * A1LQZZR * I[127][i][iS]
            + A2ZZR * A1LQZZR * I[128][i][iS]
            + A2ZZI * A1LQZZR * I[129][i][iS]
            + A3ZZR * A1LQZZR * I[130][i][iS]
            + A3ZZI * A1LQZZR * I[131][i][iS]
            + A2ZZR * A1LQZZR * I[132][i][iS]
            + A2ZZI * A1LQZZR * I[133][i][iS]
            + A3ZZR * A1LQZZR * I[134][i][iS]
            + A3ZZI * A1LQZZR * I[135][i][iS]
            + A1L1ZZR * A1LQZZR * I[136][i][iS]
            + A1L1ZZI * A1LQZZR * I[137][i][iS]
            + A1ZZR * A1LQZZI * I[138][i][iS]
            + A2ZZR * A1LQZZI * I[139][i][iS]
            + A2ZZI * A1LQZZI * I[140][i][iS]
            + A3ZZR * A1LQZZI * I[141][i][iS]
            + A3ZZI * A1LQZZI * I[142][i][iS]
            + A2ZZR * A1LQZZI * I[143][i][iS]
            + A2ZZI * A1LQZZI * I[144][i][iS]
            + A3ZZR * A1LQZZI * I[145][i][iS]
            + A3ZZI * A1LQZZI * I[146][i][iS]
            + A2ZZR * A1LQZZI * I[147][i][iS]
            + A2ZZI * A1LQZZI * I[148][i][iS]
            + A3ZZR * A1LQZZI * I[149][i][iS]
            + A3ZZI * A1LQZZI * I[150][i][iS]
            + A1L1ZZR * A1LQZZI * I[151][i][iS]
            + A1L1ZZI * A1LQZZI * I[152][i][iS]
            + A1LQZZR * A1LQZZI * I[153][i][iS];
      ...
      // double LTotal = SignalLikelihood * (1 - F[Is7TeV][StateIndex] - FZJ[Is7TeV][StateIndex])
      //    + BackgroundLikelihood * F[Is7TeV][StateIndex]
      //    + BackgroundZJLikelihood * FZJ[Is7TeV][StateIndex];
   ...
   for(int i = 0; i < 4; i++)
   {
      ...
      for(int j = 0; j < 2; j++)
      {
         ...
         if(EventCount[j][i] > 0)
         {
            double PoissonMean = NS * SigmaMu + NB + NZJ + NggZZ;
   ...
   // cout << F[0][0] << " " << F[1][0] << " " << LogTotal << endl;
...
FitResultSummary FitClass::DoFit(FitConfiguration configuration)
{
   ...
   Worker->SetTolerance(1e-5);
   Worker->SetStrategy(0);
   ...
   // EventCount[0][0] = SignalStateCount[0][0] * DrawRandom(0.9, 1.1) + BackgroundStateCount[0][0] * DrawRandom(0.9, 1.1) + ZJStateCount[0][0] + ggZZStateCount[0][0];
   // EventCount[0][1] = SignalStateCount[0][1] * DrawRandom(0.9, 1.1) + BackgroundStateCount[0][1] * DrawRandom(0.9, 1.1) + ZJStateCount[0][1] + ggZZStateCount[0][1];
   // EventCount[0][2] = SignalStateCount[0][2] * DrawRandom(0.9, 1.1) + BackgroundStateCount[0][2] * DrawRandom(0.9, 1.1) + ZJStateCount[0][2] + ggZZStateCount[0][2];
   // EventCount[0][3] = SignalStateCount[0][3] * DrawRandom(0.9, 1.1) + BackgroundStateCount[0][3] * DrawRandom(0.9, 1.1) + ZJStateCount[0][3] + ggZZStateCount[0][3];
   // EventCount[1][0] = SignalStateCount[1][0] * DrawRandom(0.9, 1.1) + BackgroundStateCount[1][0] * DrawRandom(0.9, 1.1) + ZJStateCount[1][0] + ggZZStateCount[1][0];
   // EventCount[1][1] = SignalStateCount[1][1] * DrawRandom(0.9, 1.1) + BackgroundStateCount[1][1] * DrawRandom(0.9, 1.1) + ZJStateCount[1][1] + ggZZStateCount[1][1];
   // EventCount[1][2] = SignalStateCount[1][2] * DrawRandom(0.9, 1.1) + BackgroundStateCount[1][2] * DrawRandom(0.9, 1.1) + ZJStateCount[1][2] + ggZZStateCount[1][2];
   // EventCount[1][3] = SignalStateCount[1][3] * DrawRandom(0.9, 1.1) + BackgroundStateCount[1][3] * DrawRandom(0.9, 1.1) + ZJStateCount[1][3] + ggZZStateCount[1][3];
   ...
   StepSize[12] = (configuration.FloatAA[6] == true) ? 0.1 : 0;
   StepSize[13] = (configuration.FloatPhase[6] == true) ? 0.1 : 0;
   StepSize[14] = (configuration.FloatAA[7] == true) ? 0.1 : 0;
   StepSize[15] = (configuration.FloatPhase[7] == true) ? 0.1 : 0;
   StepSize[16] = (configuration.FloatCount[0][0] == true) ? 1 : 0;
   StepSize[17] = (configuration.FloatCount[0][1] == true) ? 1 : 0;
   StepSize[18] = (configuration.FloatCount[0][2] == true) ? 1 : 0;
   StepSize[19] = (configuration.FloatCount[0][3] == true) ? 1 : 0;
   StepSize[20] = (configuration.FloatCount[1][0] == true) ? 1 : 0;
   StepSize[21] = (configuration.FloatCount[1][1] == true) ? 1 : 0;
   StepSize[22] = (configuration.FloatCount[1][2] == true) ? 1 : 0;
   StepSize[23] = (configuration.FloatCount[1][3] == true) ? 1 : 0;
   StepSize[24] = (configuration.FloatF[0][0] == true) ? 0.01 : 0;
   StepSize[25] = (configuration.FloatF[0][1] == true) ? 0.01 : 0;
   StepSize[26] = (configuration.FloatF[0][2] == true) ? 0.01 : 0;
   StepSize[27] = (configuration.FloatF[0][3] == true) ? 0.01 : 0;
   StepSize[28] = (configuration.FloatF[1][0] == true) ? 0.01 : 0;
   StepSize[29] = (configuration.FloatF[1][1] == true) ? 0.01 : 0;
   StepSize[30] = (configuration.FloatF[1][2] == true) ? 0.01 : 0;
   StepSize[31] = (configuration.FloatF[1][3] == true) ? 0.01 : 0;
   StepSize[32] = (configuration.FloatFZJ[0][0] == true) ? 0.05 : 0;
   StepSize[33] = (configuration.FloatFZJ[0][1] == true) ? 0.10 : 0;
   StepSize[34] = (configuration.FloatFZJ[0][2] == true) ? 0.10 : 0;
   StepSize[35] = (configuration.FloatFZJ[0][3] == true) ? 0.05 : 0;
   StepSize[36] = (configuration.FloatFZJ[1][0] == true) ? 0.05 : 0;
   StepSize[37] = (configuration.FloatFZJ[1][1] == true) ? 0.10 : 0;
   StepSize[38] = (configuration.FloatFZJ[1][2] == true) ? 0.10 : 0;
   StepSize[39] = (configuration.FloatFZJ[1][3] == true) ? 0.05 : 0;
   StepSize[40] = (configuration.FloatFggZZ[0][0] == true) ? 0.01 : 0;
   StepSize[41] = (configuration.FloatFggZZ[0][1] == true) ? 0.01 : 0;
   StepSize[42] = (configuration.FloatFggZZ[0][2] == true) ? 0.01 : 0;
   StepSize[43] = (configuration.FloatFggZZ[0][3] == true) ? 0.01 : 0;
   StepSize[44] = (configuration.FloatFggZZ[1][0] == true) ? 0.01 : 0;
   StepSize[45] = (configuration.FloatFggZZ[1][1] == true) ? 0.01 : 0;
   StepSize[46] = (configuration.FloatFggZZ[1][2] == true) ? 0.01 : 0;
   StepSize[47] = (configuration.FloatFggZZ[1][3] == true) ? 0.01 : 0;
   StepSize[48] = (configuration.FloatN[0] == true) ? 0.01 : 0;   // up-down
   StepSize[49] = (configuration.FloatN[1] == true) ? 0.01 : 0;   // wide-narrow
   StepSize[50] = (configuration.FloatN[2] == true) ? 0.01 : 0;   // spectrum
   StepSize[51] = (configuration.FloatN[3] == true) ? 0.01 : 0;   // spectrum
   StepSize[52] = (configuration.FloatN[4] == true) ? 0.01 : 0;   // mass
   StepSize[53] = (configuration.FloatN[5] == true) ? 0.01 : 0;   // ZX
   StepSize[54] = (configuration.FloatN[6] == true) ? 0.01 : 0;
   StepSize[55] = (configuration.FloatMu == true) ? 0.01 : 0;   // Sigma / Sigma_SM
   ...
   Worker->SetLimitedVariable(12, "A1L1ZZ",      configuration.AAInitialValue[6], StepSize[12], -1000, 1000);
   Worker->SetLimitedVariable(13, "A1L1ZZPhase", configuration.PhaseInitialValue[6], StepSize[13], -PI * 10, PI * 10);
   Worker->SetLimitedVariable(14, "A1LQZZ",      configuration.AAInitialValue[7], StepSize[14], -1000, 1000);
   Worker->SetLimitedVariable(15, "A1LQZZPhase", configuration.PhaseInitialValue[7], StepSize[15], -PI * 10, PI * 10);
   Worker->SetLimitedVariable(16, "Nem8TeV",     configuration.CountInitialValue[0][0], StepSize[16], 0, 10000);
   Worker->SetLimitedVariable(17, "Nme8TeV",     configuration.CountInitialValue[0][1], StepSize[17], 0, 10000);
   Worker->SetLimitedVariable(18, "Nee8TeV",     configuration.CountInitialValue[0][2], StepSize[18], 0, 10000);
   Worker->SetLimitedVariable(19, "Nmm8TeV",     configuration.CountInitialValue[0][3], StepSize[19], 0, 10000);
   Worker->SetLimitedVariable(20, "Nem7TeV",     configuration.CountInitialValue[1][0], StepSize[20], 0, 10000);
   Worker->SetLimitedVariable(21, "Nme7TeV",     configuration.CountInitialValue[1][1], StepSize[21], 0, 10000);
   Worker->SetLimitedVariable(22, "Nee7TeV",     configuration.CountInitialValue[1][2], StepSize[22], 0, 10000);
   Worker->SetLimitedVariable(23, "Nmm7TeV",     configuration.CountInitialValue[1][3], StepSize[23], 0, 10000);
   Worker->SetLimitedVariable(24, "Fem8TeV",     configuration.FInitialValue[0][0], StepSize[24], 0, 0.34);
   Worker->SetLimitedVariable(25, "Fme8TeV",     configuration.FInitialValue[0][1], StepSize[25], 0, 1);
   Worker->SetLimitedVariable(26, "Fee8TeV",     configuration.FInitialValue[0][2], StepSize[26], 0, 1);
   Worker->SetLimitedVariable(27, "Fmm8TeV",     configuration.FInitialValue[0][3], StepSize[27], 0, 1);
   Worker->SetLimitedVariable(28, "Fem7TeV",     configuration.FInitialValue[1][0], StepSize[28], 0, 1);
   Worker->SetLimitedVariable(29, "Fme7TeV",     configuration.FInitialValue[1][1], StepSize[29], 0, 1);
   Worker->SetLimitedVariable(30, "Fee7TeV",     configuration.FInitialValue[1][2], StepSize[30], 0, 1);
   Worker->SetLimitedVariable(31, "Fmm7TeV",     configuration.FInitialValue[1][3], StepSize[31], 0, 1);
   Worker->SetLimitedVariable(32, "FZJem8TeV",   configuration.FZJInitialValue[0][0], StepSize[32], 0.17, 1);
   Worker->SetLimitedVariable(33, "FZJme8TeV",   configuration.FZJInitialValue[0][1], StepSize[33], 0, 1);
   Worker->SetLimitedVariable(34, "FZJee8TeV",   configuration.FZJInitialValue[0][2], StepSize[34], 0, 1);
   Worker->SetLimitedVariable(35, "FZJmm8TeV",   configuration.FZJInitialValue[0][3], StepSize[35], 0, 1);
   Worker->SetLimitedVariable(36, "FZJem7TeV",   configuration.FZJInitialValue[1][0], StepSize[36], 0, 1);
   Worker->SetLimitedVariable(37, "FZJme7TeV",   configuration.FZJInitialValue[1][1], StepSize[37], 0, 1);
   Worker->SetLimitedVariable(38, "FZJee7TeV",   configuration.FZJInitialValue[1][2], StepSize[38], 0, 1);
   Worker->SetLimitedVariable(39, "FZJmm7TeV",   configuration.FZJInitialValue[1][3], StepSize[39], 0, 1);
   Worker->SetLimitedVariable(40, "FggZZem8TeV", configuration.FggZZInitialValue[0][0], StepSize[40], 0, 1);
   Worker->SetLimitedVariable(41, "FggZZme8TeV", configuration.FggZZInitialValue[0][1], StepSize[41], 0, 1);
   Worker->SetLimitedVariable(42, "FggZZee8TeV", configuration.FggZZInitialValue[0][2], StepSize[42], 0, 1);
   Worker->SetLimitedVariable(43, "FggZZmm8TeV", configuration.FggZZInitialValue[0][3], StepSize[43], 0, 1);
   Worker->SetLimitedVariable(44, "FggZZem7TeV", configuration.FggZZInitialValue[1][0], StepSize[44], 0, 1);
   Worker->SetLimitedVariable(45, "FggZZme7TeV", configuration.FggZZInitialValue[1][1], StepSize[45], 0, 1);
   Worker->SetLimitedVariable(46, "FggZZee7TeV", configuration.FggZZInitialValue[1][2], StepSize[46], 0, 1);
   Worker->SetLimitedVariable(47, "FggZZmm7TeV", configuration.FggZZInitialValue[1][3], StepSize[47], 0, 1);
   Worker->SetLimitedVariable(48, "N1",          configuration.NInitialValue[0], StepSize[48], -5, 5);
   Worker->SetLimitedVariable(49, "N2",          configuration.NInitialValue[1], StepSize[49], -5, 5);
   Worker->SetLimitedVariable(50, "N3",          configuration.NInitialValue[2], StepSize[50], -5, 5);
   Worker->SetLimitedVariable(51, "N4",          configuration.NInitialValue[3], StepSize[51], -5, 5);
   Worker->SetLimitedVariable(52, "N5",          configuration.NInitialValue[4], StepSize[52], -5, 5);
   Worker->SetLimitedVariable(53, "N6",          configuration.NInitialValue[5], StepSize[53], -5, 5);
   Worker->SetLimitedVariable(54, "N7",          configuration.NInitialValue[6], StepSize[54], -5, 5);
   Worker->SetLimitedVariable(55, "Mu",          configuration.MuInitialValue, StepSize[55], 0, 1000);
   ...
   TrueParameters[12] = configuration.AAInitialValue[5];
   TrueParameters[13] = configuration.PhaseInitialValue[5];
   TrueParameters[14] = configuration.AAInitialValue[5];
   TrueParameters[15] = configuration.PhaseInitialValue[5];
   TrueParameters[16] = EventCount[0][0];
   TrueParameters[17] = EventCount[0][1];
   TrueParameters[18] = EventCount[0][2];
   TrueParameters[19] = EventCount[0][3];
   TrueParameters[20] = EventCount[1][0];
   TrueParameters[21] = EventCount[1][1];
   TrueParameters[22] = EventCount[1][2];
   TrueParameters[23] = EventCount[1][3];
   TrueParameters[24] = ((EventCount[0][0] > 0) ? (BackgroundStateCount[0][0] / EventCount[0][0]) : 0);
   TrueParameters[25] = ((EventCount[0][1] > 0) ? (BackgroundStateCount[0][1] / EventCount[0][1]) : 0);
   TrueParameters[26] = ((EventCount[0][2] > 0) ? (BackgroundStateCount[0][2] / EventCount[0][2]) : 0);
   TrueParameters[27] = ((EventCount[0][3] > 0) ? (BackgroundStateCount[0][3] / EventCount[0][3]) : 0);
   TrueParameters[28] = ((EventCount[1][0] > 0) ? (BackgroundStateCount[1][0] / EventCount[1][0]) : 0);
   TrueParameters[29] = ((EventCount[1][1] > 0) ? (BackgroundStateCount[1][1] / EventCount[1][1]) : 0);
   TrueParameters[30] = ((EventCount[1][2] > 0) ? (BackgroundStateCount[1][2] / EventCount[1][2]) : 0);
   TrueParameters[31] = ((EventCount[1][3] > 0) ? (BackgroundStateCount[1][3] / EventCount[1][3]) : 0);
   TrueParameters[32] = ((EventCount[0][0] > 0) ? (ZJStateCount[0][0] / EventCount[0][0]) : 0);
   TrueParameters[33] = ((EventCount[0][1] > 0) ? (ZJStateCount[0][1] / EventCount[0][1]) : 0);
   TrueParameters[34] = ((EventCount[0][2] > 0) ? (ZJStateCount[0][2] / EventCount[0][2]) : 0);
   TrueParameters[35] = ((EventCount[0][3] > 0) ? (ZJStateCount[0][3] / EventCount[0][3]) : 0);
   TrueParameters[36] = ((EventCount[1][0] > 0) ? (ZJStateCount[1][0] / EventCount[1][0]) : 0);
   TrueParameters[37] = ((EventCount[1][1] > 0) ? (ZJStateCount[1][1] / EventCount[1][1]) : 0);
   TrueParameters[38] = ((EventCount[1][2] > 0) ? (ZJStateCount[1][2] / EventCount[1][2]) : 0);
   TrueParameters[39] = ((EventCount[1][3] > 0) ? (ZJStateCount[1][3] / EventCount[1][3]) : 0);
   TrueParameters[40] = ((EventCount[0][0] > 0) ? (ggZZStateCount[0][0] / EventCount[0][0]) : 0);
   TrueParameters[41] = ((EventCount[0][1] > 0) ? (ggZZStateCount[0][1] / EventCount[0][1]) : 0);
   TrueParameters[42] = ((EventCount[0][2] > 0) ? (ggZZStateCount[0][2] / EventCount[0][2]) : 0);
   TrueParameters[43] = ((EventCount[0][3] > 0) ? (ggZZStateCount[0][3] / EventCount[0][3]) : 0);
   TrueParameters[44] = ((EventCount[1][0] > 0) ? (ggZZStateCount[1][0] / EventCount[1][0]) : 0);
   TrueParameters[45] = ((EventCount[1][1] > 0) ? (ggZZStateCount[1][1] / EventCount[1][1]) : 0);
   TrueParameters[46] = ((EventCount[1][2] > 0) ? (ggZZStateCount[1][2] / EventCount[1][2]) : 0);
   TrueParameters[47] = ((EventCount[1][3] > 0) ? (ggZZStateCount[1][3] / EventCount[1][3]) : 0);
   for(int i = 48; i < 55; i++)
      TrueParameters[i] = 0;
   TrueParameters[55] = 1;
   ...
   Result.AA[6] = Parameters[12];         Result.AAError[6] = Errors[12];
   Result.Phase[6] = Parameters[13];      Result.PhaseError[6] = Errors[13];
   Result.AA[7] = Parameters[14];         Result.AAError[7] = Errors[14];
   Result.Phase[7] = Parameters[15];      Result.PhaseError[7] = Errors[15];
   Result.Count[0][0] = Parameters[16];   Result.CountError[0][0] = Errors[16];
   Result.Count[0][1] = Parameters[17];   Result.CountError[0][1] = Errors[17];
   Result.Count[0][2] = Parameters[18];   Result.CountError[0][2] = Errors[18];
   Result.Count[0][3] = Parameters[19];   Result.CountError[0][3] = Errors[19];
   Result.Count[1][0] = Parameters[20];   Result.CountError[1][0] = Errors[20];
   Result.Count[1][1] = Parameters[21];   Result.CountError[1][1] = Errors[21];
   Result.Count[1][2] = Parameters[22];   Result.CountError[1][2] = Errors[22];
   Result.Count[1][3] = Parameters[23];   Result.CountError[1][3] = Errors[23];
   Result.F[0][0] = Parameters[24];       Result.FError[0][0] = Errors[24];
   Result.F[0][1] = Parameters[25];       Result.FError[0][1] = Errors[25];
   Result.F[0][2] = Parameters[26];       Result.FError[0][2] = Errors[26];
   Result.F[0][3] = Parameters[27];       Result.FError[0][3] = Errors[27];
   Result.F[1][0] = Parameters[28];       Result.FError[1][0] = Errors[28];
   Result.F[1][1] = Parameters[29];       Result.FError[1][1] = Errors[29];
   Result.F[1][2] = Parameters[30];       Result.FError[1][2] = Errors[30];
   Result.F[1][3] = Parameters[31];       Result.FError[1][3] = Errors[31];
   Result.FZJ[0][0] = Parameters[32];     Result.FZJError[0][0] = Errors[32];
   Result.FZJ[0][1] = Parameters[33];     Result.FZJError[0][1] = Errors[33];
   Result.FZJ[0][2] = Parameters[34];     Result.FZJError[0][2] = Errors[34];
   Result.FZJ[0][3] = Parameters[35];     Result.FZJError[0][3] = Errors[35];
   Result.FZJ[1][0] = Parameters[36];     Result.FZJError[1][0] = Errors[36];
   Result.FZJ[1][1] = Parameters[37];     Result.FZJError[1][1] = Errors[37];
   Result.FZJ[1][2] = Parameters[38];     Result.FZJError[1][2] = Errors[38];
   Result.FZJ[1][3] = Parameters[39];     Result.FZJError[1][3] = Errors[39];
   Result.FggZZ[0][0] = Parameters[40];   Result.FggZZError[0][0] = Errors[40];
   Result.FggZZ[0][1] = Parameters[41];   Result.FggZZError[0][1] = Errors[41];
   Result.FggZZ[0][2] = Parameters[42];   Result.FggZZError[0][2] = Errors[42];
   Result.FggZZ[0][3] = Parameters[43];   Result.FggZZError[0][3] = Errors[43];
   Result.FggZZ[1][0] = Parameters[44];   Result.FggZZError[1][0] = Errors[44];
   Result.FggZZ[1][1] = Parameters[45];   Result.FggZZError[1][1] = Errors[45];
   Result.FggZZ[1][2] = Parameters[46];   Result.FggZZError[1][2] = Errors[46];
   Result.FggZZ[1][3] = Parameters[47];   Result.FggZZError[1][3] = Errors[47];
   Result.N[0] = Parameters[48];          Result.NError[0] = Errors[48];
   Result.N[1] = Parameters[49];          Result.NError[1] = Errors[49];
   Result.N[2] = Parameters[50];          Result.NError[2] = Errors[50];
   Result.N[3] = Parameters[51];          Result.NError[3] = Errors[51];
   Result.N[4] = Parameters[52];          Result.NError[4] = Errors[52];
   Result.N[5] = Parameters[53];          Result.NError[5] = Errors[53];
   Result.N[6] = Parameters[54];          Result.NError[6] = Errors[54];
   ...
   Result.Mu = Parameters[55];
   Result.MuError = Errors[55];
