...
FitConfiguration::FitConfiguration(string FloatAs, string FloatPhases,
   ...
   vector<double> NggZZSigma7TeV, vector<double> NggZZSigma8TeV,
                                   double Mu,
                                   bool ConstrainA2ZZPositive,
                                   bool ConstrainA3ZZPositive
  )
{
   SetFloatAs(FloatAs);
   SetFloatPhases(FloatPhases);
   ...
   SetConstrainPositiveCouplings(ConstrainA2ZZPositive,ConstrainA3ZZPositive);
}
...
void FitConfiguration::SetConstrainPositiveCouplings(bool tmpConstrainA2ZZPositive, bool tmpConstrainA3ZZPositive)
{
  ConstrainA2ZZPositive = tmpConstrainA2ZZPositive;
  ConstrainA3ZZPositive = tmpConstrainA3ZZPositive;
}
...
FitResultSummary FitClass::DoFit(FitConfiguration configuration)
{
  ...
  if (!Worker) cout << "Worker is not created\n";

   Worker->SetPrintLevel(10);
   ...
   if (!configuration.ConstrainA2ZZPositive) {
     Worker->SetLimitedVariable(0,  "A2ZZA1ZZ",    configuration.AAInitialValue[0], StepSize[0], -1000, 1000);
   } else {
     Worker->SetLimitedVariable(0,  "A2ZZA1ZZ",    configuration.AAInitialValue[0], StepSize[0], 0, 1000);
     cout << "Constraining A2ZZ to be positive\n";
     cout << "Initial Value = " << configuration.AAInitialValue[0] << "\n";
   }
   Worker->SetLimitedVariable(1,  "A2ZZPhase",   configuration.PhaseInitialValue[0], StepSize[1], -PI * 10, PI * 10);
   if (!configuration.ConstrainA3ZZPositive) {
     Worker->SetLimitedVariable(2,  "A3ZZA1ZZ",    configuration.AAInitialValue[1], StepSize[2], -1000, 1000);
   } else {
     Worker->SetLimitedVariable(2,  "A3ZZA1ZZ",    configuration.AAInitialValue[1], StepSize[2], 0, 1000);
     cout << "Constraining A3ZZ to be positive\n";
   }
   ...
   Worker->SetLimitedVariable(24, "Fem8TeV",     configuration.FInitialValue[0][0], StepSize[24], 0, 1);
   ...
   Worker->SetLimitedVariable(32, "FZJem8TeV",   configuration.FZJInitialValue[0][0], StepSize[32], 0, 1);
