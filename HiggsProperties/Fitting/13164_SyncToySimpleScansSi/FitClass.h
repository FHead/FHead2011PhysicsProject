...
public:
   ...
   FitConfiguration(string FloatAs, string FloatPhases, string FloatCounts7TeV, string FloatCounts8TeV,
      ...
      vector<double> NggZZSigma7TeV, vector<double> NggZZSigma8TeV,
                    double Mu,
                    bool ConstrainA2ZZPositive = false,
                    bool ConstrainA3ZZPositive = false
      );
   ~FitConfiguration();
   ...
   void SetConstrainPositiveCouplings(bool tmpConstrainA2ZZPositive, bool tmpConstrainA3ZZPositive);
