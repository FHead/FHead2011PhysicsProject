...
int main(int argc, char *argv[])
{
   ...
   ReadEvents(SignalEM[1],     SignalME[1],     SignalEE[1],     SignalMM[1],     SignalFileName[1],     false, DEFAULT_PROCESS, 1, true,  false);
   ...
   ReadEvents(SignalEM[0],     SignalME[0],     SignalEE[0],     SignalMM[0],     SignalFileName[0],     false, DEFAULT_PROCESS, 1, false, false);
      ...
      for(int iC = 0; iC < (int)Configurations.size(); iC++)
      {
         ...
         if(iC == 0)
         {
            ...
            for(int iB = 1; iB <= HScanFA3.GetNbinsX(); iB++)
            {
               ...
               double S2 = A2A1 * A2A1 / 3.276 / 3.276;
               double S3 = A3A1 * A3A1 / 5.042 / 5.042;
               double A1L1A1 = sqrt((1 + S2 + S3) / (1 - fabs(FA1L1)) * fabs(FA1L1) * 0.000120071 * 0.000120071);
               if(FA1L1 < 0)
                  A1L1A1 = -A1L1A1;
