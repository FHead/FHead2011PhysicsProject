...
int main(int argc, char *argv[])
{
   ...
   if(argc < 21)
   {
      cerr << "Usage: " << argv[0]
         ...
         << " ConstrainA2ZZPositive ConstrainA3ZZPositive"
         << endl;
      return -1;
   }
   ...
   string constrainA2ZZPositive = argv[21];
   string constrainA3ZZPositive = argv[22];
   ...
   for (int i=0; i < NS7.size(); ++i) NS7[i] = NS7[i]*lumiMultiple;
   for (int i=0; i < NB7.size(); ++i) NB7[i] = NB7[i]*lumiMultiple;
   for (int i=0; i < NZJ7.size(); ++i) NZJ7[i] = NZJ7[i]*lumiMultiple;
   for (int i=0; i < NggZZ7.size(); ++i) NggZZ7[i] = NggZZ7[i]*lumiMultiple;
   for (int i=0; i < NS8.size(); ++i) NS8[i] = NS8[i]*lumiMultiple;
   for (int i=0; i < NB8.size(); ++i) NB8[i] = NB8[i]*lumiMultiple;
   for (int i=0; i < NZJ8.size(); ++i) NZJ8[i] = NZJ8[i]*lumiMultiple;
   for (int i=0; i < NggZZ8.size(); ++i) NggZZ8[i] = NggZZ8[i]*lumiMultiple;
   cout << "Lumi Factor: " << lumiMultiple << "\n";
...
//    string Fs = "YNYYYNYYYNYY";
   ...
   FitConfiguration Configuration(
     ...
     ListToVector(4, 
                  (NS7Prime[0] + NB7Prime[0] + NZJ7Prime[0] + NggZZ7Prime[0]), 
                  (NS7Prime[1] + NB7Prime[1] + NZJ7Prime[1] + NggZZ7Prime[1]),
                  (NS7Prime[2] + NB7Prime[2] + NZJ7Prime[2] + NggZZ7Prime[2]), 
                  (NS7Prime[3] + NB7Prime[3] + NZJ7Prime[3] + NggZZ7Prime[3])),   /* Event Counts */
     ListToVector(4, 
                  (NS8Prime[0] + NB8Prime[0] + NZJ8Prime[0] + NggZZ8Prime[0]),
                  (NS8Prime[1] + NB8Prime[1] + NZJ8Prime[1] + NggZZ8Prime[1]),
                  (NS8Prime[2] + NB8Prime[2] + NZJ8Prime[2] + NggZZ8Prime[2]), 
                  (NS8Prime[3] + NB8Prime[3] + NZJ8Prime[3] + NggZZ8Prime[3])),   /* Event Counts */
     ...
     1,                                                                             /* Mu */
     bool(constrainA2ZZPositive == "Y" || constrainA2ZZPositive == "y"),
     bool(constrainA3ZZPositive == "Y" || constrainA3ZZPositive == "y")
     );      

   cout << "\nFit Configuration Summary\n";
   cout << "Model Parameters Floated : " << As << "\n";
   cout << "Model Complex Phases Floated : " << Phases << "\n";
   cout << "Fs Floated : " << FloatFs << "\n";
   cout << "\n\n";
