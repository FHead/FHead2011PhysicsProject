...
int main(int argc, char *argv[])
{
   ...
   HasBadEvent[0] = ReadEvents(SignalEM[1],     SignalME[1],     SignalEE[1],     SignalMM[1],     SignalFileName[1],     true,  P, 1, true,  false, 0, false, false);
   HasBadEvent[1] = ReadEvents(BackgroundEM[1], BackgroundME[1], BackgroundEE[1], BackgroundMM[1], BackgroundFileName[1], true,  P, 1, true,  false, 0, false, false);
   HasBadEvent[2] = ReadEvents(ggZZEM[1],       ggZZME[1],       ggZZEE[1],       ggZZMM[1],       ggZZFileName[1],       false, P, 1, true,  false, 0, false, true);
   HasBadEvent[3] = ReadEvents(ZJEM[1],         ZJME[1],         ZJEE[1],         ZJMM[1],         ZJFileName[1],         false, P, 6e-6, true,  false, 0, false, false);
   HasBadEvent[4] = ReadEvents(SignalEM[0],     SignalME[0],     SignalEE[0],     SignalMM[0],     SignalFileName[0],     true,  P, 1, false, false, 0, false, false);
   HasBadEvent[5] = ReadEvents(BackgroundEM[0], BackgroundME[0], BackgroundEE[0], BackgroundMM[0], BackgroundFileName[0], true,  P, 1, false, false, 0, false, false);
   HasBadEvent[6] = ReadEvents(ggZZEM[0],       ggZZME[0],       ggZZEE[0],       ggZZMM[0],       ggZZFileName[0],       false, P, 1, false, false, 0, false, true);
   HasBadEvent[7] = ReadEvents(ZJEM[0],         ZJME[0],         ZJEE[0],         ZJMM[0],         ZJFileName[0],         false, P, 6e-6, false, false, 0, false, false);
   ...
   Fits.SignalStateCount[1][1]      = PullEvents(Events, SignalME[1],     NS7[1],    NSSigma7[1],    false);
   ...
   Fits.SignalStateCount[0][1]      = PullEvents(Events, SignalME[0],     NS8[1],    NSSigma8[1],    false);
   ...
   Fits.BackgroundStateCount[1][1]  = PullEvents(Events, BackgroundME[1], NB7[1],    NBSigma7[1],    false);
   ...
   Fits.BackgroundStateCount[0][1]  = PullEvents(Events, BackgroundME[0], NB8[1],    NBSigma8[1],    false);
   Fits.BackgroundStateCount[0][2]  = PullEvents(Events, BackgroundEE[0], NB8[2],    NBSigma8[2],    true);
   Fits.BackgroundStateCount[0][3]  = PullEvents(Events, BackgroundMM[0], NB8[3],    NBSigma8[3],    true);
   Fits.ZJStateCount[1][0]          = PullEvents(Events, ZJEM[1],         NZJ7[0],   NZJSigma7[0],   true);
   Fits.ZJStateCount[1][1]          = PullEvents(Events, ZJME[1],         NZJ7[1],   NZJSigma7[1],   true);
   ...
   Fits.ZJStateCount[0][1]          = PullEvents(Events, ZJME[0],         NZJ8[1],   NZJSigma8[1],   true);
   ...
   Fits.ggZZStateCount[1][1]        = PullEvents(Events, ggZZME[1],       NggZZ7[1], NggZZSigma7[1], true);
   ...
   Fits.ggZZStateCount[0][1]        = PullEvents(Events, ggZZME[0],       NggZZ8[1], NggZZSigma8[1], true);
