...
public:
   FitConfiguration();
   FitConfiguration(string IsWeighted,
      string FloatAs, string FloatPhases, string FloatCounts7TeV, string FloatCounts8TeV,
...
public:
   ...
   void AddPoint(double v[154][13], double i[154][13], double v2[2][13], double i2[2][13],
      double weight, EventParameters &Event, std::string State, std::string SqrtS);
   void ClearPoints();
