...
int main(int argc, char *argv[])
{
   ...
   HasBadEvent[0] = ReadEvents(SignalEM[1],     SignalME[1],     SignalEE[1],     SignalMM[1],     SignalFileName[1],     false, DEFAULT_PROCESS, 1, true,  false, TargetToyNumber, false);
   HasBadEvent[1] = ReadEvents(BackgroundEM[1], BackgroundME[1], BackgroundEE[1], BackgroundMM[1], BackgroundFileName[1], false,  0, 1, true,  false, TargetToyNumber, false);
   HasBadEvent[2] = ReadEvents(ggZZEM[1],       ggZZME[1],       ggZZEE[1],       ggZZMM[1],       ggZZFileName[1],       false,  1, 1, true,  false, TargetToyNumber, false);
   HasBadEvent[3] = ReadEvents(ZJEM[1],         ZJME[1],         ZJEE[1],         ZJMM[1],         ZJFileName[1],         false,  2, 1, true,  false, TargetToyNumber, false);
   HasBadEvent[4] = ReadEvents(SignalEM[0],     SignalME[0],     SignalEE[0],     SignalMM[0],     SignalFileName[0],     false, DEFAULT_PROCESS, 1, false, false, TargetToyNumber, false);
   HasBadEvent[5] = ReadEvents(BackgroundEM[0], BackgroundME[0], BackgroundEE[0], BackgroundMM[0], BackgroundFileName[0], false,  0, 1, false, false, TargetToyNumber, false);
   HasBadEvent[6] = ReadEvents(ggZZEM[0],       ggZZME[0],       ggZZEE[0],       ggZZMM[0],       ggZZFileName[0],       false,  1, 1, false, false, TargetToyNumber, false);
   HasBadEvent[7] = ReadEvents(ZJEM[0],         ZJME[0],         ZJEE[0],         ZJMM[0],         ZJFileName[0],         false,  2, 1, false, false, TargetToyNumber, false);
   ...
   for(int i = 1; i <= 127; i++)
   {
      ...
      string Fs = "NNNNNNNNNNNN";   // FB(EM, ME, EE, MM), FZJ(EM, ME, EE, MM), FggZZ(EM, ME, EE, MM)
