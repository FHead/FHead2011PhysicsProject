...
bool ReadEvents(std::vector<SingleEvent> &EventsEM, std::vector<SingleEvent> &EventsME,
   ...
   int TargetToy = -1, bool EMMETogether = false);
bool ReadEventsSeparate(std::vector<SingleEvent> &Events, 
                        std::string FileName, 
                        int NEventsPerJob, int JobNumber,                        
                        bool Capital, int Process = DEFAULT_PROCESS,
                        bool Is7TeV = false, int Channel = 0, bool AlternativeWeight = false,
                        bool EMMETogether = false);
