...
FitResultSummary FitClass::DoFit(FitConfiguration configuration)
{
   ...
   if(configuration.FloatAA[6] == true)         Worker->SetLimitedVariable(12, "A1L1ZZ",      configuration.AAInitialValue[6], StepSize[12], -1000, 1000);
   ...
   if(configuration.FloatCount[0][0] == true)   Worker->SetLimitedVariable(16, "Nem8TeV",     configuration.CountInitialValue[0][0], StepSize[16], 0, 10000);
   if(configuration.FloatCount[0][1] == true)   Worker->SetLimitedVariable(17, "Nme8TeV",     configuration.CountInitialValue[0][1], StepSize[17], 0, 10000);
   if(configuration.FloatCount[0][2] == true)   Worker->SetLimitedVariable(18, "Nee8TeV",     configuration.CountInitialValue[0][2], StepSize[18], 0, 10000);
   if(configuration.FloatCount[0][3] == true)   Worker->SetLimitedVariable(19, "Nmm8TeV",     configuration.CountInitialValue[0][3], StepSize[19], 0, 10000);
   if(configuration.FloatCount[1][0] == true)   Worker->SetLimitedVariable(20, "Nem7TeV",     configuration.CountInitialValue[1][0], StepSize[20], 0, 10000);
   if(configuration.FloatCount[1][1] == true)   Worker->SetLimitedVariable(21, "Nme7TeV",     configuration.CountInitialValue[1][1], StepSize[21], 0, 10000);
   if(configuration.FloatCount[1][2] == true)   Worker->SetLimitedVariable(22, "Nee7TeV",     configuration.CountInitialValue[1][2], StepSize[22], 0, 10000);
   if(configuration.FloatCount[1][3] == true)   Worker->SetLimitedVariable(23, "Nmm7TeV",     configuration.CountInitialValue[1][3], StepSize[23], 0, 10000);
