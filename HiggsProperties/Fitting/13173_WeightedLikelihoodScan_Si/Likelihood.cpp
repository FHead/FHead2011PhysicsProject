...
int main(int argc, char *argv[])
{
   ...
   HasBadEvent[0] = ReadEvents(SignalEM[1],     SignalME[1],     SignalEE[1],     SignalMM[1],     SignalFileName[1],     true,  P, 1, true,  false, 0, false);
   HasBadEvent[1] = ReadEvents(BackgroundEM[1], BackgroundME[1], BackgroundEE[1], BackgroundMM[1], BackgroundFileName[1], true,  P, 1, true,  false, 0, false);
   // HasBadEvent[2] = ReadEvents(ggZZEM[1],       ggZZME[1],       ggZZEE[1],       ggZZMM[1],       ggZZFileName[1],       false, P, 1e-4, true,  false, 0, false);
   // HasBadEvent[3] = ReadEvents(ZJEM[1],         ZJME[1],         ZJEE[1],         ZJMM[1],         ZJFileName[1],         false, P, 6e-6, true,  false, 0, false);
   HasBadEvent[4] = ReadEvents(SignalEM[0],     SignalME[0],     SignalEE[0],     SignalMM[0],     SignalFileName[0],     true,  P, 1, false, false, 0, false);
   HasBadEvent[5] = ReadEvents(BackgroundEM[0], BackgroundME[0], BackgroundEE[0], BackgroundMM[0], BackgroundFileName[0], true,  P, 1, false, false, 0, false);
   // HasBadEvent[6] = ReadEvents(ggZZEM[0],       ggZZME[0],       ggZZEE[0],       ggZZMM[0],       ggZZFileName[0],       false, P, 1e-4, false, false, 0, false);
   // HasBadEvent[7] = ReadEvents(ZJEM[0],         ZJME[0],         ZJEE[0],         ZJMM[0],         ZJFileName[0],         false, P, 6e-6, false, false, 0, false);
   ...
   cout << "Stats: " << SignalEM[0].size() / NS8Prime[0]
      << " " << SignalME[0].size() / NS8Prime[1]
      << " " << SignalEE[0].size() / NS8Prime[2]
      << " " << SignalMM[0].size() / NS8Prime[3] << endl;
   cout << "Stats: " << BackgroundEM[0].size() / NB8Prime[0]
      << " " << BackgroundME[0].size() / NB8Prime[1]
      << " " << BackgroundEE[0].size() / NB8Prime[2]
      << " " << BackgroundMM[0].size() / NB8Prime[3] << endl;
   cout << "Stats: " << ZJEM[0].size() / NZJ8Prime[0]
      << " " << ZJME[0].size() / NZJ8Prime[1]
      << " " << ZJEE[0].size() / NZJ8Prime[2]
      << " " << ZJMM[0].size() / NZJ8Prime[3] << endl;
   cout << "Stats: " << ggZZEM[0].size() / NggZZ8Prime[0]
      << " " << ggZZME[0].size() / NggZZ8Prime[1]
      << " " << ggZZEE[0].size() / NggZZ8Prime[2]
      << " " << ggZZMM[0].size() / NggZZ8Prime[3] << endl;

   // vector<double> Total8 = ListToVector(4, 0, 0, 0, 0);
   // Total8 = SumVector(Total8, NS8Prime);
   // Total8 = SumVector(Total8, NB8Prime);
   // Total8 = SumVector(Total8, NZJ8Prime);
   // Total8 = SumVector(Total8, NggZZ8Prime);
   // cout << "EM " << NB8Prime[0] / Total8[0] << " " << NZJ8Prime[0] / Total8[0] << " " << NggZZ8Prime[0] / Total8[0] << endl;
   // cout << "ME " << NB8Prime[1] / Total8[1] << " " << NZJ8Prime[1] / Total8[1] << " " << NggZZ8Prime[1] / Total8[1] << endl;
   // cout << "EE " << NB8Prime[2] / Total8[2] << " " << NZJ8Prime[2] / Total8[2] << " " << NggZZ8Prime[2] / Total8[2] << endl;
   // cout << "MM " << NB8Prime[3] / Total8[3] << " " << NZJ8Prime[3] / Total8[3] << " " << NggZZ8Prime[3] / Total8[3] << endl;
   ...
   cout << "Stats: " << SignalEM[1].size() / NS7Prime[0]
      << " " << SignalME[1].size() / NS7Prime[1]
      << " " << SignalEE[1].size() / NS7Prime[2]
      << " " << SignalMM[1].size() / NS7Prime[3] << endl;
   cout << "Stats: " << BackgroundEM[1].size() / NB7Prime[0]
      << " " << BackgroundME[1].size() / NB7Prime[1]
      << " " << BackgroundEE[1].size() / NB7Prime[2]
      << " " << BackgroundMM[1].size() / NB7Prime[3] << endl;
   cout << "Stats: " << ZJEM[1].size() / NZJ7Prime[0]
      << " " << ZJME[1].size() / NZJ7Prime[1]
      << " " << ZJEE[1].size() / NZJ7Prime[2]
      << " " << ZJMM[1].size() << " " << NZJ7Prime[3] << endl;
   cout << "Stats: " << ggZZEM[1].size() / NggZZ7Prime[0]
      << " " << ggZZME[1].size() / NggZZ7Prime[1]
      << " " << ggZZEE[1].size() / NggZZ7Prime[2]
      << " " << ggZZMM[1].size() / NggZZ7Prime[3] << endl;

   // vector<double> Total7 = ListToVector(4, 0, 0, 0, 0);
   // Total7 = SumVector(Total7, NS7Prime);
   // Total7 = SumVector(Total7, NB7Prime);
   // Total7 = SumVector(Total7, NZJ7Prime);
   // Total7 = SumVector(Total7, NggZZ7Prime);
   // cout << "EM " << NB7Prime[0] / Total7[0] << " " << NZJ7Prime[0] / Total7[0] << " " << NggZZ7Prime[0] / Total7[0] << endl;
   // cout << "ME " << NB7Prime[1] / Total7[1] << " " << NZJ7Prime[1] / Total7[1] << " " << NggZZ7Prime[1] / Total7[1] << endl;
   // cout << "EE " << NB7Prime[2] / Total7[2] << " " << NZJ7Prime[2] / Total7[2] << " " << NggZZ7Prime[2] / Total7[2] << endl;
   // cout << "MM " << NB7Prime[3] / Total7[3] << " " << NZJ7Prime[3] / Total7[3] << " " << NggZZ7Prime[3] / Total7[3] << endl;
   ...
   Fits.SignalStateCount[1][1]      = PullAndReweightEvents(Events, SignalEM[1],     NS7[1]);
   ...
   Fits.SignalStateCount[0][1]      = PullAndReweightEvents(Events, SignalEM[0],     NS8[1]);
   ...
   Fits.BackgroundStateCount[1][1]  = PullAndReweightEvents(Events, BackgroundEM[1], NB7[1]);
   ...
   Fits.BackgroundStateCount[0][1]  = PullAndReweightEvents(Events, BackgroundEM[0], NB8[1]);
   ...
   Fits.ZJStateCount[1][1]          = PullAndReweightEvents(Events, ZJEM[1],         NZJ7[1]);
   ...
   Fits.ZJStateCount[0][1]          = PullAndReweightEvents(Events, ZJEM[0],         NZJ8[1]);
   ...
   Fits.ggZZStateCount[1][1]        = PullAndReweightEvents(Events, ggZZEM[1],       NggZZ7[1]);
   ...
   Fits.ggZZStateCount[0][1]        = PullAndReweightEvents(Events, ggZZEM[0],       NggZZ8[1]);
...
//    }
   ...
   TH1D HScanFA3("HScanFA3", "FA3Scan", 200, -1, 1);   
