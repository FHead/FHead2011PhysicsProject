...
echo Compiling RunLikelihoodBatch
g++ LikelihoodBatch.cpp `root-config --glibs` `root-config --cflags` -o RunLikelihoodBatch \
   -I$WorkspaceBase/CommonCode/include/ $WorkspaceBase/CommonCode/library/AngleConversion.o \
   -I$Home/RootMacros $Home/RootMacros/Code/library/* FitClass.o $WorkspaceBase/CommonCode/library/Lists.o \
   M4lSpectrum.o FileIO.o -g

echo Compiling CombineLikelihoodJobs
g++ CombineLikelihoodJobs.cpp `root-config --glibs` `root-config --cflags` -o CombineLikelihoodJobs \
   -I$WorkspaceBase/CommonCode/include/ $WorkspaceBase/CommonCode/library/AngleConversion.o \
   -I$Home/RootMacros $Home/RootMacros/Code/library/* FitClass.o $WorkspaceBase/CommonCode/library/Lists.o \
   M4lSpectrum.o FileIO.o -g

echo Compiling CombineLikelihood
g++ CombineLikelihood.cpp `root-config --glibs` `root-config --cflags` -o CombineLikelihood \
   -I$WorkspaceBase/CommonCode/include/ $WorkspaceBase/CommonCode/library/AngleConversion.o \
   -I$Home/RootMacros $Home/RootMacros/Code/library/* FitClass.o $WorkspaceBase/CommonCode/library/Lists.o \
   M4lSpectrum.o FileIO.o -g
