...
int main(int argc, char *argv[])
{
   ...
   FudgeFactors[0] = DrawRandom(0.9, 1.1);
   FudgeFactors[1] = DrawRandom(0.9, 1.1);
   FudgeFactors[2] = DrawRandom(0.9, 1.1);
   FudgeFactors[3] = DrawRandom(0.9, 1.1);
   FudgeFactors[4] = DrawRandom(0.9, 1.1);
   FudgeFactors[5] = DrawRandom(0.9, 1.1);
   FudgeFactors[6] = DrawRandom(0.9, 1.1);
   FudgeFactors[7] = DrawRandom(0.9, 1.1);
   ...
   for(int i = 0; i <= 127; i++)
   {
      ...
      string Fs = "YNYYNNNNNNNN";   // FB(EM, ME, EE, MM), FZJ(EM, ME, EE, MM), FggZZ(EM, ME, EE, MM)
   ...
   BranchList = BranchList + ":rFem7:rFme7:rFee7:rFmm7:rFem8:rFme8:rFee8:rFmm8";               // 144
   ...
   for(int i = 0; i < (int)Results.size(); i++)
   {
      ...
      Array[136] = rFem7 * FudgeFactors[0];   Array[140] = rFem8 * FudgeFactors[4];
      Array[137] = rFme7 * FudgeFactors[1];   Array[141] = rFme8 * FudgeFactors[5];
      Array[138] = rFee7 * FudgeFactors[2];   Array[142] = rFee8 * FudgeFactors[6];
      Array[139] = rFmm7 * FudgeFactors[3];   Array[143] = rFmm8 * FudgeFactors[7];
   ...
   for(int iE = 0; iE < EntryCount; iE++)
   {
      ...
      else
      {
         for(int j = 0; j < 13; j++)
         {
            ...
            if(Is7TeV == true && State == "em" && FudgeFactors != NULL)    Integral[0][j] *= FudgeFactors[0];
            if(Is7TeV == true && State == "me" && FudgeFactors != NULL)    Integral[0][j] *= FudgeFactors[1];
            if(Is7TeV == true && State == "ee" && FudgeFactors != NULL)    Integral[0][j] *= FudgeFactors[2];
            if(Is7TeV == true && State == "mm" && FudgeFactors != NULL)    Integral[0][j] *= FudgeFactors[3];
            if(Is7TeV == false && State == "em" && FudgeFactors != NULL)   Integral[0][j] *= FudgeFactors[4];
            if(Is7TeV == false && State == "me" && FudgeFactors != NULL)   Integral[0][j] *= FudgeFactors[5];
            if(Is7TeV == false && State == "ee" && FudgeFactors != NULL)   Integral[0][j] *= FudgeFactors[6];
            if(Is7TeV == false && State == "mm" && FudgeFactors != NULL)   Integral[0][j] *= FudgeFactors[7];
