...
int main(int argc, char *argv[])
{
   ...
   */
   ...
   while(Good == true)
   {
      ...
      HasBadEvent[1] = ReadEvents(BackgroundEM[1], BackgroundME[1], BackgroundEE[1], BackgroundMM[1], BackgroundFileName[1],  true,  DEFAULT_PROCESS, 1, true,  false, TargetToyNumber, false);
      ...
      HasBadEvent[5] = ReadEvents(BackgroundEM[0], BackgroundME[0], BackgroundEE[0], BackgroundMM[0], BackgroundFileName[0],  true,  DEFAULT_PROCESS, 1, false, false, TargetToyNumber, false);
