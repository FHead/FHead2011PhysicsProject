...
int main(int argc, char *argv[])
{
   ...
   */
   ...
   while(Good == true)
   {
      ...
      HasBadEvent[0] = ReadEvents(SignalEM[1],     SignalME[1],     SignalEE[1],     SignalMM[1],     SignalFileName[1],      true, DEFAULT_PROCESS, 1, true,  true, TargetToyNumber, false);
      ...
      HasBadEvent[4] = ReadEvents(SignalEM[0],     SignalME[0],     SignalEE[0],     SignalMM[0],     SignalFileName[0],      true, DEFAULT_PROCESS, 1, false, true, TargetToyNumber, false);
