   ...
   int FillInJacobian)
{
   ...
   for(int iE = 0; iE < EntryCount; iE++)
   {
      ...
      if(EntryCount < 10000 || (iE % (EntryCount / 10000) == 0))
      {
         Bar.Update(iE);
         Bar.Print();
      }
      ...
      int Start = 5;
      // if(FileName.find("Old") != string::npos)   // TODO TODO TODO
      //    Start = 1;
...
bool WillBeSwapped(LeptonVectors &Leptons)
{
   ...
   double M32 = (Leptons.Lepton12 + Leptons.Lepton12).GetMass();
   double M34 = (Leptons.Lepton12 + Leptons.Lepton22).GetMass();
