...
int main(int argc, char *argv[])
{
   ...
   */
   ...
   for(int i = 0; i <= 127; i++)
   {
      ...
      string Counts = "YYNN";   // EM, ME, EE, MM
   ...
   while(Good == true)
   {
      ...
      HasBadEvent[0] = ReadEvents(SignalEM[1],     SignalME[1],     SignalEE[1],     SignalMM[1],     SignalFileName[1],      true, DEFAULT_PROCESS, 1, true, true, TargetToyNumber, false, true, false, 1, JACOBIAN_SIGNAL);
      ...
      HasBadEvent[1] = ReadEvents(BackgroundEM[1], BackgroundME[1], BackgroundEE[1], BackgroundMM[1], BackgroundFileName[1],  true,  DEFAULT_PROCESS, 1, true,  false, TargetToyNumber, false, true, false, 0.5, JACOBIAN_BACKGROUND);
      ...
      HasBadEvent[2] = ReadEvents(ggZZEM[1],       ggZZME[1],       ggZZEE[1],       ggZZMM[1],       ggZZFileName[1],        false, DEFAULT_PROCESS, 1e-4, true,  false, TargetToyNumber, false);
      ...
      HasBadEvent[3] = ReadEvents(ZJEM[1],         ZJME[1],         ZJEE[1],         ZJMM[1],         ZJFileName[1],          false, DEFAULT_PROCESS, 6e-6, true,  false, TargetToyNumber, false);
      ...
      HasBadEvent[4] = ReadEvents(SignalEM[0],     SignalME[0],     SignalEE[0],     SignalMM[0],     SignalFileName[0],      true, DEFAULT_PROCESS, 1, false, true, TargetToyNumber, false, true, false, 1, JACOBIAN_SIGNAL);
      ...
      HasBadEvent[5] = ReadEvents(BackgroundEM[0], BackgroundME[0], BackgroundEE[0], BackgroundMM[0], BackgroundFileName[0],  true,  DEFAULT_PROCESS, 1, false, false, TargetToyNumber, false, true, false, 0.5, JACOBIAN_BACKGROUND);
      ...
      HasBadEvent[6] = ReadEvents(ggZZEM[0],       ggZZME[0],       ggZZEE[0],       ggZZMM[0],       ggZZFileName[0],        false, DEFAULT_PROCESS, 1e-4, false, false, TargetToyNumber, false);
      ...
      HasBadEvent[7] = ReadEvents(ZJEM[0],         ZJME[0],         ZJEE[0],         ZJMM[0],         ZJFileName[0],          false, DEFAULT_PROCESS, 6e-6, false, false, TargetToyNumber, false);
