...
int main(int argc, char *argv[])
{
   ...
   */
   ...
   while(Good == true)
   {
      ...
      HasBadEvent[0] = ReadEvents(SignalEM[1],     SignalME[1],     SignalEE[1],     SignalMM[1],     SignalFileName[1],      true, DEFAULT_PROCESS, true, true, TargetToyNumber, false, true, false, 2, JACOBIAN_SIGNAL);
      Fits.SignalStateCount[1][0]      = PullAndReweightEvents(Events, SignalEM[1],     NS7[0]);
      Fits.SignalStateCount[1][1]      = PullAndReweightEvents(Events, SignalME[1],     NS7[1]);
      ...
      // HasBadEvent[1] = ReadEvents(BackgroundEM[1], BackgroundME[1], BackgroundEE[1], BackgroundMM[1], BackgroundFileName[1],  true,  DEFAULT_PROCESS, true,  false, TargetToyNumber, false, true, false, 1, JACOBIAN_BACKGROUND);
      // Fits.BackgroundStateCount[1][0]  = PullAndReweightEvents(Events, BackgroundEM[1], NB7[0]);
      // Fits.BackgroundStateCount[1][1]  = PullAndReweightEvents(Events, BackgroundME[1], NB7[1]);
      ...
      // HasBadEvent[2] = ReadEvents(ggZZEM[1],       ggZZME[1],       ggZZEE[1],       ggZZMM[1],       ggZZFileName[1],        false, DEFAULT_PROCESS, true,  false, TargetToyNumber, false);
      // Fits.ggZZStateCount[1][0]        = PullAndReweightEvents(Events, ggZZEM[1],       NggZZ7[0]);
      // Fits.ggZZStateCount[1][1]        = PullAndReweightEvents(Events, ggZZME[1],       NggZZ7[1]);
      ...
      // HasBadEvent[3] = ReadEvents(ZJEM[1],         ZJME[1],         ZJEE[1],         ZJMM[1],         ZJFileName[1],          false, DEFAULT_PROCESS, true,  false, TargetToyNumber, false);
      // Fits.ZJStateCount[1][0]          = PullAndReweightEvents(Events, ZJEM[1],         NZJ7[0]);
      // Fits.ZJStateCount[1][1]          = PullAndReweightEvents(Events, ZJME[1],         NZJ7[1]);
      ...
      HasBadEvent[4] = ReadEvents(SignalEM[0],     SignalME[0],     SignalEE[0],     SignalMM[0],     SignalFileName[0],      true, DEFAULT_PROCESS, false, true, TargetToyNumber, false, true, false, 2, JACOBIAN_SIGNAL);
      Fits.SignalStateCount[0][0]      = PullAndReweightEvents(Events, SignalEM[0],     NS8[0]);
      Fits.SignalStateCount[0][1]      = PullAndReweightEvents(Events, SignalME[0],     NS8[1]);
      ...
      // HasBadEvent[5] = ReadEvents(BackgroundEM[0], BackgroundME[0], BackgroundEE[0], BackgroundMM[0], BackgroundFileName[0],  true,  DEFAULT_PROCESS, false, false, TargetToyNumber, false, true, false, 1, JACOBIAN_BACKGROUND);
      // Fits.BackgroundStateCount[0][0]  = PullAndReweightEvents(Events, BackgroundEM[0], NB8[0]);
      // Fits.BackgroundStateCount[0][1]  = PullAndReweightEvents(Events, BackgroundME[0], NB8[1]);
      ...
      // HasBadEvent[6] = ReadEvents(ggZZEM[0],       ggZZME[0],       ggZZEE[0],       ggZZMM[0],       ggZZFileName[0],        false, DEFAULT_PROCESS, false, false, TargetToyNumber, false);
      // Fits.ggZZStateCount[0][0]        = PullAndReweightEvents(Events, ggZZEM[0],       NggZZ8[0]);
      // Fits.ggZZStateCount[0][1]        = PullAndReweightEvents(Events, ggZZME[0],       NggZZ8[1]);
      ...
      // HasBadEvent[7] = ReadEvents(ZJEM[0],         ZJME[0],         ZJEE[0],         ZJMM[0],         ZJFileName[0],          false, DEFAULT_PROCESS, false, false, TargetToyNumber, false);
      // Fits.ZJStateCount[0][0]          = PullAndReweightEvents(Events, ZJEM[0],         NZJ8[0]);
      // Fits.ZJStateCount[0][1]          = PullAndReweightEvents(Events, ZJME[0],         NZJ8[1]);
      ...
      for(int iC = 0; iC < (int)Configurations.size(); iC++)
      {
         ...
         Configurations[iC].SetFloatMu("N");   // TODO
         ResultTemp[0] = Fits.DoFit(Configurations[iC]);
         
         Configurations[iC].MuInitialValue = ResultTemp[0].Mu;
         
         Configurations[iC].SetFloatNs("NNNNNNN");
         Configurations[iC].SetFloatFractions(0, "YYYYYYYYNNNN");
         Configurations[iC].SetFloatFractions(1, "YYYYYYYYNNNN");
