...
int main(int argc, char *argv[])
{
   ...
   */
   ...
   while(Good == true)
   {
      ...
      for(int i = 0; i < (int)Events.size(); i++)
         Fits.AddPoint(Events[i]);
      ExportSimpleTree("SyncGGZZ7TeV.root", Events);
      Events.clear();
      ...
      for(int i = 0; i < (int)Events.size(); i++)
         Fits.AddPoint(Events[i]);
      ExportSimpleTree("SyncZX7TeV.root", Events);
      Events.clear();
      ...
      for(int i = 0; i < (int)Events.size(); i++)
         Fits.AddPoint(Events[i]);
      ExportSimpleTree("SyncSignal8TeV.root", Events);
      Events.clear();
      ...
      for(int i = 0; i < (int)Events.size(); i++)
         Fits.AddPoint(Events[i]);
      ExportSimpleTree("SyncBackground8TeV.root", Events);
      Events.clear();
      ...
      for(int i = 0; i < (int)Events.size(); i++)
         Fits.AddPoint(Events[i]);
      ExportSimpleTree("SyncGGZZ8TeV.root", Events);
      Events.clear();
      ...
      for(int i = 0; i < (int)Events.size(); i++)
         Fits.AddPoint(Events[i]);
      ExportSimpleTree("SyncZX8TeV.root", Events);
      Events.clear();
