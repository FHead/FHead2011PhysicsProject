   ...
   for(int iS = 0; iS < SampleSize; iS++)
   {
      ...
      for(int i = 0; i < 5; i++)
      {
         Value[i] = A1ZZR   * A1ZZR   * V[1][i][iS]
            ...
            + A1ZZR   * A2ZZR   * V[6][i][iS]
            + A1ZZR   * A2ZZI   * V[7][i][iS]
            + A1ZZR   * A3ZZR   * V[8][i][iS]
            + A1ZZR   * A3ZZI   * V[9][i][iS]
            + A2ZZR   * A2ZZI   * V[10][i][iS]
            + A2ZZR   * A3ZZR   * V[11][i][iS]
            + A2ZZR   * A3ZZI   * V[12][i][iS]
            + A2ZZI   * A3ZZR   * V[13][i][iS]
            + A2ZZI   * A3ZZI   * V[14][i][iS]
            + A3ZZR   * A3ZZI   * V[15][i][iS]
            ;
         Integral[i] = A1ZZR   * A1ZZR   * I[1][i][iS]
            ...
            + A1ZZR   * A2ZZR   * I[6][i][iS]
            + A1ZZR   * A2ZZI   * I[7][i][iS]
            + A1ZZR   * A3ZZR   * I[8][i][iS]
            + A1ZZR   * A3ZZI   * I[9][i][iS]
            + A2ZZR   * A2ZZI   * I[10][i][iS]
            + A2ZZR   * A3ZZR   * I[11][i][iS]
            + A2ZZR   * A3ZZI   * I[12][i][iS]
            + A2ZZI   * A3ZZR   * I[13][i][iS]
            + A2ZZI   * A3ZZI   * I[14][i][iS]
            + A3ZZR   * A3ZZI   * I[15][i][iS]
            ;
      ...
      if(BackgroundZJLikelihood < 0 || BackgroundZJLikelihood != BackgroundZJLikelihood)
         BackgroundZJLikelihood = 0;
      if(BackgroundggLikelihood < 0 || BackgroundggLikelihood != BackgroundggLikelihood)
         BackgroundggLikelihood = 0;
      ...
      if(S[iS] == "me")   StateIndex = 1;   // EMME Fix TODO
...
void FitClass::AddPointReduced(double v[16][13], double i[16][13], double v2[2][13], double i2[2][13],
   EventParameters &Event, string State, string SqrtS, double Weight)
{
