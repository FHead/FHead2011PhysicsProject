...
public:
   int SampleSize;
   std::vector<double> V[16][13];   // Background = 0, Signal = 1-153; second index = CUDWNHSFCABCD
   std::vector<double> I[16][13];   // same as above
...
public:
   ...
   void AddPointReduced(double v[16][13], double i[16][13], double v2[2][13], double i2[2][13],
      EventParameters &Event, std::string State, std::string SqrtS, double Weight);
   void ClearPoints();
