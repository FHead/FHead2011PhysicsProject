...
BaseDir=/home/yichen/PhysicsWorkspace/HiggsProperties/Fitting/13314_WeightedLikelihoodScan2/
WorkDir=`pwd`
...
F2=`echo $BinMin $BinMax $BinCount $ID | awk '{print $1 + ($2-$1)/($3-1)*($4-1)}'`
F3=0
FL=0
...
cp -r $BaseDir/HadoopTrees $WorkDir/
...
B7=HadoopTrees/BackgroundAll7TeV.root
Z7=HadoopTrees/HZZEventFitFormat_MC_ZJets_8TeV.root
G7=HadoopTrees/HZZEventFitFormat_ggZZAll.root
# S8=Trees/SignalAll8TeV.root
B8=HadoopTrees/BackgroundAll8TeV.root
Z8=HadoopTrees/HZZEventFitFormat_MC_ZJets_8TeV.root
G8=HadoopTrees/HZZEventFitFormat_ggZZAll.root

S7=HadoopTrees/Signal7TeVAll.root
S8=HadoopTrees/Signal8TeVA.root
