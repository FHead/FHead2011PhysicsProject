#ifndef FITCLASS_H_13222_JAIKSDJFHKLASDNHGKASNGKLSENDGKAJSKDGJASDGJASDKGJAKSDJGK
#define FITCLASS_H_13222_JAIKSDJFHKLASDNHGKASNGKLSENDGKAJSKDGJASDGJASDKGJAKSDJGK
...
public:
   bool GuessInitialFValue;
public:
   FitConfiguration();
   FitConfiguration(string IsWeighted, string FloatAs, string FloatPhases, string FloatCounts7TeV, string FloatCounts8TeV,
   ...
   FitConfiguration(string IsWeighted, string FloatAs, string FloatPhases, string FloatCounts7TeV, string FloatCounts8TeV,
      ...
      double Mu);
   ~FitConfiguration();
   void SetWeighted(string IsWeighted);
...
public:
   ...
   double TruthNLL, BestNLL, BestNLLNoPenalty;
   double Mu, MuError;
   int FitStatus;
};
...
public:
   int SampleSize;
   std::vector<double> V[29][13];   // Background = 0, Signal = 1-153; second index = CUDWNHSFCABCD
   std::vector<double> I[29][13];   // same as above
   ...
   double SignalStateCount[2][4];
   double BackgroundStateCount[2][4];
   double ZJStateCount[2][4];
   double ggZZStateCount[2][4];
   bool UsePenalty;
   void SetUsePenalty(bool Penalty);
public:
   bool WeightedDataset;
...
public:
   ...
   void AddPoint(ReducedSingleEvent &event);
   void AddPoint(double v[154][13], double i[154][13], double v2[2][13], double i2[2][13],
      EventParameters &Event, std::string State, std::string SqrtS, double Weight);
   void AddPointReduced(double v[29][13], double i[29][13], double v2[2][13], double i2[2][13],
      EventParameters &Event, std::string State, std::string SqrtS, double Weight);
   void ClearPoints();
