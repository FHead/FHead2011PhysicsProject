...
int main()
{
   ...
   // double Efficiencies[11] = {0.727693, 0.590503, 0.590509, 0.797016, 0.759701, 0.999653, 0.799547, 0.797664, 0.601295, 0.462625, 0.355952};
   double Efficiencies[11] = {0.727693, 0.590503, 0.590509, 0.797016, 0.759701, 0.999653, 0.799547, 0.797664, 0.601295, 0.462625 / 0.3740104 * 0.601295, 0.355952 / 0.3740104 * 0.601295};
   int Color[11] = {kBlack, kRed, kBlue, kGreen - 3, kCyan, kYellow, kYellow - 3, kGreen, 6, kMagenta, kCyan - 3};
   string Labels[11] = {"A", "B", "C", "A+B+C", "A+B+C-#Upsilon", "Full", "A'", "Full'", "A_{0}", "J", "K"};

   TGraphErrors GA2ZZ[11], GA2ZZNoEfficiency[11];
   TGraphErrors GA3ZZ[11], GA3ZZNoEfficiency[11];
   TGraphErrors GA2ZA[11], GA2ZANoEfficiency[11];
   TGraphErrors GA3ZA[11], GA3ZANoEfficiency[11];
   TGraphErrors GA2AA[11], GA2AANoEfficiency[11];
   TGraphErrors GA3AA[11], GA3AANoEfficiency[11];
   ...
   for(int i = 0; i < 11; i++)
   {
      for(int j = 0; j < N; j++)
      {
         ...
         TFile File(Form("Trees/ResultBoth_A1ZZ_%c_%d.root", 'A' + i, Counts[j]));
