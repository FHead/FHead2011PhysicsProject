...
do
   ...
   do
      ...
      do
         ...
         cd Test
         sh ../Run.sh $SEMFile $SEMSize $SEEFile $SEESize $BEMFile -1 $BEEFile -1 $CutString $JobLabel
         cd ..
         ...
         cd Test
         sh ../Run.sh $SEMFile $SEMSize $SEEFile -1 $BEMFile -1 $BEEFile -1 $CutString $JobLabel
         cd ..
         ...
         cd Test
         sh ../Run.sh $SEMFile -1 $SEEFile $SEESize $BEMFile -1 $BEEFile -1 $CutString $JobLabel
         cd ..
