...
int main(int argc, char *argv[])
{
   ...
   if(argc <= 18)
   {
      cerr << "Usage: " << argv[0]
         ...
         << " A2ZZ A3ZZ A4ZZ A5ZZ YT YTA MT GWW MW"
         << endl;
      return -1;
   }
   ...
   for(int i = 1; i <= 255; i++)
   {
      ...
      if((i / 8) % 2 == 1)           continue;
      if((i / 64) % 2 == 1)          continue;
      if((i / 256) % 2 == 1)         continue;
      if(!(i % 8 == 0 || i % 8 == 7 || i < 8))   continue;
      ...
      if(TrueFem <= 0)   TrueFem = 0;
      if(TrueFee <= 0)   TrueFee = 0;
      ...
      Configurations.push_back(FitConfiguration(As, Phases, Fs, "NN",
         ...
         ListToVector(4, TrueFem, 0, TrueFee, 0),
         ListToVector(2, 0, 0),
         1.00));
   }
         ...
         if(Temp.FloatFem == true || Temp.FloatFme == true || Temp.FloatFee == true || Temp.FloatFmm == true)
         {
            ...
            Temp.SetInitialRatios(
               ListToVector(9,
                  ...
                  ResultTemp.YTA, ResultTemp.YTA, ResultTemp.MT,
   ...
   BranchList = BranchList + ":YT:YTA:MT";
   ...
   BranchList = BranchList + ":YTError:YTAError:MTError";
   ...
   for(int i = 0; i < (int)Results.size(); i++)
   {
      ...
      Array[5] = Results[i].YTA;          Array[18] = Results[i].YTAError;
