...
do
   ...
   do
      ...
      hadd -f CollectedResults/ResultEM_PointA_${i}_${j}.root Result/FitResult_JobEM_PointA_*_${i}_${j}.root
      hadd -f CollectedResults/ResultEE_PointA_${i}_${j}.root Result/FitResult_JobEE_PointA_*_${i}_${j}.root
