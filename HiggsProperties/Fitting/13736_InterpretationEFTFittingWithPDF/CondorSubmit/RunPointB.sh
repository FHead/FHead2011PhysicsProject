...
BaseDir=/home/yichen/PhysicsWorkspace/HiggsProperties/Fitting/13736_InterpretationEFTFittingWithPDF/
WorkDir=`pwd`
...
echo    $CutLabel \\
echo    0.005 0 0.0035 1.5 1 173.21 2 79.95
time ./PerformFits \
   $SEMFile $SEMSize $BEMFile $BEMSize \
   $SEEFile $SEESize $BEEFile $BEESize \
   $CutLabel \
   0.005 0 0.0035 1.5 1 173.21 2 79.95
