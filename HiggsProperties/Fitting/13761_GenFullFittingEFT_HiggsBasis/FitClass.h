...
public:
   ...
   bool FloatCZZ;         double CZZInitialValue;
   bool FloatCZZD;        double CZZDInitialValue;
   bool FloatCZA;         double CZAInitialValue;
   bool FloatCZAD;        double CZADInitialValue;
   bool FloatCAA;         double CAAInitialValue;
   bool FloatCAAD;        double CAADInitialValue;
...
public:
   ...
   double CZZ, CZZError;
   double CZZD, CZZDError;
   double CZA, CZAError;
   double CZAD, CZADError;
   double CAA, CAAError;
   double CAAD, CAADError;
   double Fem, FemError;
   double Fme, FmeError;
   double Fee, FeeError;
   double Fmm, FmmError;
