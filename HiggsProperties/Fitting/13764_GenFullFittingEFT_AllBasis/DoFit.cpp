...
int main(int argc, char *argv[])
{
   ...
   vector<string> AVVConfigurations;
   AVVConfigurations.push_back("YYYYYYYY");
   AVVConfigurations.push_back("YYNYYNYY");

   vector<string> HiggsConfigurations;
   HiggsConfigurations.push_back("NNYNNNNN");
   HiggsConfigurations.push_back("NNNYNNNN");
   HiggsConfigurations.push_back("NNNNYNNN");
   HiggsConfigurations.push_back("NNNNNYNN");
   HiggsConfigurations.push_back("NNNNNNYN");
   HiggsConfigurations.push_back("NNNNNNNY");
   HiggsConfigurations.push_back("NNYYYYYY");
   HiggsConfigurations.push_back("NYNNNNNN");
   HiggsConfigurations.push_back("NYYYYYYY");

   vector<string> WarsawConfigurations;
   WarsawConfigurations.push_back("NNYYYYYY");
   WarsawConfigurations.push_back("YNNNNNNN");
   WarsawConfigurations.push_back("YNYYYYYY");
   ...
   for(int i = 0; i < AVVConfigurations.size(); i++)
   {
      ...
      Configurations.push_back(FitConfiguration(As, Fs, AValues, ListToVector(4, TrueFem, 0, TrueFee, 0), false, BASIS_AVV));
      Configurations.push_back(FitConfiguration(As, Fs, AValues, ListToVector(4, TrueFem, 0, TrueFee, 0), true, BASIS_AVV));
   }
   for(int i = 0; i < HiggsConfigurations.size(); i++)
   {
      ...
      Configurations.push_back(FitConfiguration(As, Fs, AValues, ListToVector(4, TrueFem, 0, TrueFee, 0), false, BASIS_HIGGS));
      Configurations.push_back(FitConfiguration(As, Fs, AValues, ListToVector(4, TrueFem, 0, TrueFee, 0), true, BASIS_HIGGS));
   }
   for(int i = 0; i < WarsawConfigurations.size(); i++)
   {
      ...
      Configurations.push_back(FitConfiguration(As, Fs, AValues, ListToVector(4, TrueFem, 0, TrueFee, 0), false, BASIS_WARSAW));
      Configurations.push_back(FitConfiguration(As, Fs, AValues, ListToVector(4, TrueFem, 0, TrueFee, 0), true, BASIS_WARSAW));
   }
