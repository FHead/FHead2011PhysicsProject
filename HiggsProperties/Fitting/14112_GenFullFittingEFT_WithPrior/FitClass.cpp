...
double FitClass::CalculateLogLikelihoodAll(const double *Parameters) const
{
   ...
   if(UsePriors[3] == true)   // RHto4l
   {
      ...
      if(Basis == BASIS_HIGGS && NoSquareMode == true)     RHto4l = GetRHto4l_NoSquare_Higgs(A);
      if(Basis == BASIS_WARSAW && NoSquareMode == true)    RHto4l = GetRHto4l_NoSquare_Warsaw(A);
      if(Basis == BASIS_AVV && NoSquareMode == false)      RHto4l = GetRHto4l_WithSquare_AVV(A);
      if(Basis == BASIS_HIGGS && NoSquareMode == false)    RHto4l = GetRHto4l_WithSquare_Higgs(A);
      if(Basis == BASIS_WARSAW && NoSquareMode == false)   RHto4l = GetRHto4l_WithSquare_Warsaw(A);
