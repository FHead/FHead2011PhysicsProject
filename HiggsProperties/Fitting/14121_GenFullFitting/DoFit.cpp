...
int main(int argc, char *argv[])
{
   ...
   AVVConfigurations.push_back("YYYYYNYY");   AVVPriors.push_back("NNNN");
   ...
   AVVConfigurations.push_back("YYYYYNYY");   AVVPriors.push_back("YNNY");
   ...
   AVVConfigurations.push_back("YYYYYYYY");   AVVPriors.push_back("YNNN");
   AVVConfigurations.push_back("YYYYYNYY");   AVVPriors.push_back("YNNN");
   AVVConfigurations.push_back("YYNYYNYY");   AVVPriors.push_back("YNNN");
   AVVConfigurations.push_back("NYNNYNNY");   AVVPriors.push_back("YNNN");
   AVVConfigurations.push_back("YYYYYYYY");   AVVPriors.push_back("NNNY");
   AVVConfigurations.push_back("YYYYYNYY");   AVVPriors.push_back("NNNY");
   AVVConfigurations.push_back("YYNYYNYY");   AVVPriors.push_back("NNNY");
   AVVConfigurations.push_back("NYNNYNNY");   AVVPriors.push_back("NNNY");
   ...
   HiggsConfigurations.push_back("NYNNNNNN");   HiggsPriors.push_back("YNNY");
   HiggsConfigurations.push_back("NYYYYYYY");   HiggsPriors.push_back("YNNY");
   HiggsConfigurations.push_back("NNYYYYYY");   HiggsPriors.push_back("YNNN");
   HiggsConfigurations.push_back("NNNYNYNY");   HiggsPriors.push_back("YNNN");
   HiggsConfigurations.push_back("NYNNNNNN");   HiggsPriors.push_back("YNNN");
   HiggsConfigurations.push_back("NYYYYYYY");   HiggsPriors.push_back("YNNN");
   HiggsConfigurations.push_back("NNYYYYYY");   HiggsPriors.push_back("NNNY");
   HiggsConfigurations.push_back("NNNYNYNY");   HiggsPriors.push_back("NNNY");
   HiggsConfigurations.push_back("NYNNNNNN");   HiggsPriors.push_back("NNNY");
   HiggsConfigurations.push_back("NYYYYYYY");   HiggsPriors.push_back("NNNY");
   ...
   WarsawConfigurations.push_back("YNYYYYYY");   WarsawPriors.push_back("YNNY");
   WarsawConfigurations.push_back("NNNYNYNY");   WarsawPriors.push_back("YNNY");
   WarsawConfigurations.push_back("NNYYYYYY");   WarsawPriors.push_back("YNNN");
   WarsawConfigurations.push_back("YNYYYYYY");   WarsawPriors.push_back("YNNN");
   WarsawConfigurations.push_back("NNNYNYNY");   WarsawPriors.push_back("YNNN");
   WarsawConfigurations.push_back("NNYYYYYY");   WarsawPriors.push_back("NNNY");
   WarsawConfigurations.push_back("YNYYYYYY");   WarsawPriors.push_back("NNNY");
   WarsawConfigurations.push_back("NNNYNYNY");   WarsawPriors.push_back("NNNY");

   vector<string> LoopConfigurations, LoopPriors;
   LoopConfigurations.push_back("NNNYYNNN");   LoopPriors.push_back("NNNN");
   LoopConfigurations.push_back("NNNYYNYN");   LoopPriors.push_back("NNNN");
   LoopConfigurations.push_back("YYYNNNYN");   LoopPriors.push_back("NNNN");
   LoopConfigurations.push_back("NNNNNNYN");   LoopPriors.push_back("NNNN");
   LoopConfigurations.push_back("NNNNYNYN");   LoopPriors.push_back("NNNN");
   LoopConfigurations.push_back("NNNYNNYN");   LoopPriors.push_back("NNNN");
   LoopConfigurations.push_back("YYYYYNNN");   LoopPriors.push_back("NNNN");
   LoopConfigurations.push_back("YYYYYNYN");   LoopPriors.push_back("NNNN");
   LoopConfigurations.push_back("YYYNYNYN");   LoopPriors.push_back("NNNN");
   ...
   for(int i = 0; i < LoopConfigurations.size(); i++)
   {
      ...
      Configurations.push_back(FitConfiguration(As, Fs, AValues, ListToVector(4, TrueFem, 0, TrueFee, 0), false, BASIS_LOOP, LoopPriors[i]));
   }
