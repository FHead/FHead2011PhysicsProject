...
int main(int argc, char *argv[])
{
   ...
   BranchList = BranchList + ":Prior4:Prior5:Prior6:Prior7";       // 46
   ...
   for(int i = 0; i < (int)Results.size(); i++)
   {
      ...
      Array[42] = Results[i].UsedPriors[4];
      Array[43] = Results[i].UsedPriors[5];
      Array[44] = Results[i].UsedPriors[6];
      Array[45] = Results[i].UsedPriors[7];
