   ...
   do
      ...
      do
         ...
         do
            ...
            SEMFile=TreeLinks/ggtoHto2e2mu_${tag}_125GeV_noPDF_Full_${ii}.root
            SEEFile=TreeLinks/ggtoHto4e_${tag}_125GeV_noPDF_Full_${ii}.root
            BEMFile=Dummy.root
            BEEFile=Dummy.root
            Energy=0TeV
   ...
   do
      ...
      do
         ...
         do
            ...
            SEMFile=TreeLinks/ggtoHto2e2mu_${tag}_115to135GeV_ggPDF_13TeV_GenCuts_${ii}.root
            SEEFile=Dummy.root
            BEMFile=Dummy.root
            BEEFile=Dummy.root
            Energy=0TeV
