   ...
   do
      ...
      do
         ...
         do
            ...
            BEMSize1=`echo $BEMSize | MultiplyConst 0.66666`
            BEESize1=`echo $BEESize | MultiplyConst 0.66666`
            BEMSize2=`echo $BEMSize | MultiplyConst 0.33333`
            BEESize2=`echo $BEESize | MultiplyConst 0.33333`
