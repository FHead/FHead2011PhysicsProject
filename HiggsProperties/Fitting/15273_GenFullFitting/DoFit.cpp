...
int main(int argc, char *argv[])
{
   ...
   for(int i = 0; i < (int)Results.size(); i++)
   {
      ...
      Array[38] = Results[i].UUbarDDbarRatio[0];
      Array[39] = Results[i].UUbarDDbarRatio[1];
      Array[40] = Results[i].UUbarDDbarRatio[2];
      Array[41] = Results[i].UUbarDDbarRatio[3];

      Array[42] = Results[i].UsedPriors[0];
      Array[43] = Results[i].UsedPriors[1];
      Array[44] = Results[i].UsedPriors[2];
      Array[45] = Results[i].UsedPriors[3];
      Array[46] = Results[i].UsedPriors[4];
