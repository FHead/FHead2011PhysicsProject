...
BaseDir=/home/yichen/PhysicsWorkspace/HiggsProperties/Fitting/15326_GenFullFitting/
WorkDir=`pwd`
...
time ./PerformFits \
   ...
   0 0 0 0.0158 0 0 -0.0127 0 \
   -1 0 173.21 2 79.95 N N N
