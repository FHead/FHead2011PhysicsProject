   ...
   do
      ...
      do
         ...
         do
            ...
            SEMFile=Trees15352/ggtoHto2e2mu_${tag}_115to135GeV_ggPDF_13TeV_GenCuts_${ii}.root
            SEEFile=Trees15352/ggtoHto4e_${tag}_115to135GeV_ggPDF_13TeV_GenCuts_${ii}.root
