...
do
   ...
   for k in 50 200 800 3200 12800
   do
      for j in A J
      do
         for i in PointD:150 PointE:150
         do
            ...
            jj=`echo ${ii} | Modulo 30 | AddConst 1`
            ...
            SEMFile=Trees15454/ggtoHto2e2mu_${tag}_115to135GeV_ggPDF_13TeV_GenCuts_${ii}.root
            SEEFile=Trees15454/ggtoHto4e_${tag}_115to135GeV_ggPDF_13TeV_GenCuts_${ii}.root
            BEMFile1=Trees15254/uuto2e2mu_115to135GeV_uubarPDF_13TeV_GenCuts_${jj}.root
            BEEFile1=Trees15254/uuto4e_115to135GeV_uubarPDF_13TeV_GenCuts_${jj}.root
            BEMFile2=Trees15254/ddto2e2mu_115to135GeV_ddbarPDF_13TeV_GenCuts_${jj}.root
            BEEFile2=Trees15254/ddto4e_115to135GeV_ddbarPDF_13TeV_GenCuts_${jj}.root
            Energy=13TeV
