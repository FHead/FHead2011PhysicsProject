...
double FitClass::CalculateLogLikelihoodAll(const double *Parameters) const
{
   ...
   else if(Basis == BASIS_LOOP)
   {
      ...
      double A2ZA = InterpretedA2ZA_Roberto15352(C);
      double A3ZA = InterpretedA3ZA_Roberto15352(C);
      double A2AA = InterpretedA2AA_Roberto15352(C);
      double A3AA = InterpretedA3AA_Roberto15352(C);
