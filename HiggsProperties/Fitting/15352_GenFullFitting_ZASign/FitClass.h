...
public:
   FitConfiguration();
   FitConfiguration(string FloatAs, string FloatFractions, string Priors, vector<double> UUbarDDbarRateRatio);
   FitConfiguration(string FloatAs, string FloatFractions,
      vector<double> Ratios, vector<double> Fractions, bool Mode, int BasisChoice, string Priors, vector<double> UUbarDDbarRateRatio);
   ~FitConfiguration();
...
public:
   ...
   void AddPoint(double vs[16][16], double is[16][16], double vb[2], double ib[2], EventParameters &Event, std::string State);
   void ClearPoints();
   int PointCount();
