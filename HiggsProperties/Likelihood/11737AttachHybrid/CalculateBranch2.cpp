...
int main(int argc, char *argv[])
{
   ...
   CalculatorEM.SetSimpleMassIntegralStep(150);
   CalculatorEM.SetSimpleMassIntegralWindow(0.9);
   ...
   CalculatorEE.SetSimpleMassIntegralStep(150);
   CalculatorEE.SetSimpleMassIntegralWindow(0.9);
   ...
   for(int iEvent = StartEvent; iEvent < EventCount && iEvent <= EndEvent; iEvent++)
   {
      ...
      // cout << l1id << " " << l2id << " " << l3id << " " << l4id << endl;
      // cout << Leptons;
      // cout << Angles;
      // cout << Leptons.Lepton11 + Leptons.Lepton12 + Leptons.Lepton21 + Leptons.Lepton22 << endl;
      ...
      if(PassBaselineCut(Angles) == true)
      {
         ...
         {
            CalculatorEE.SimpleMassIntegral(Angles);
