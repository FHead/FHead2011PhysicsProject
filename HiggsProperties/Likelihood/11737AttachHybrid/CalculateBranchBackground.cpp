...
void SubtractForInterference(vector<double> &Value);
...
void SubtractForInterference(vector<double> &Value)
{
   Value[6-1] = Value[6-1] - Value[1-1] - Value[2-1];
   Value[7-1] = Value[7-1] - Value[1-1] - Value[3-1];
   Value[8-1] = Value[8-1] - Value[1-1] - Value[4-1];
   Value[9-1] = Value[9-1] - Value[1-1] - Value[5-1];
   Value[10-1] = Value[10-1] - Value[2-1] - Value[3-1];
   Value[11-1] = Value[11-1] - Value[2-1] - Value[4-1];
   Value[12-1] = Value[12-1] - Value[2-1] - Value[5-1];
   Value[13-1] = Value[13-1] - Value[3-1] - Value[4-1];
   Value[14-1] = Value[14-1] - Value[3-1] - Value[5-1];
   Value[15-1] = Value[15-1] - Value[4-1] - Value[5-1];
}
