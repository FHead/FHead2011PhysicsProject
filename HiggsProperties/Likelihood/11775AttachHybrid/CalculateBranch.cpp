...
int main(int argc, char *argv[])
{
   ...
   for(int iEvent = StartEvent; iEvent < EventCount && iEvent <= EndEvent; iEvent++)
   {
      ...
      if(PassBaselineCut(Angles) == true)
      {
         if(l1id == 11 && l3id == 11)
         {
            CalculatorEE.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorUpEE.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorDownEE.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorWideEE.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorNarrowEE.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorEE.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorUpEE.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorDownEE.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorWideEE.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorNarrowEE.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            ...
            CalculatorEE.SetSimpleMassIntegralWindow(true, 20 / AlternativeAngles.ZMass);
            CalculatorUpEE.SetSimpleMassIntegralWindow(true, 20 / AlternativeAngles.ZMass);
            CalculatorDownEE.SetSimpleMassIntegralWindow(true, 20 / AlternativeAngles.ZMass);
            CalculatorWideEE.SetSimpleMassIntegralWindow(true, 20 / AlternativeAngles.ZMass);
            CalculatorNarrowEE.SetSimpleMassIntegralWindow(true, 20 / AlternativeAngles.ZMass);
            CalculatorEE.SetSimpleMassIntegralWindow(false, 20 / AlternativeAngles.Z2Mass);
            CalculatorUpEE.SetSimpleMassIntegralWindow(false, 20 / AlternativeAngles.Z2Mass);
            CalculatorDownEE.SetSimpleMassIntegralWindow(false, 20 / AlternativeAngles.Z2Mass);
            CalculatorWideEE.SetSimpleMassIntegralWindow(false, 20 / AlternativeAngles.Z2Mass);
            CalculatorNarrowEE.SetSimpleMassIntegralWindow(false, 20 / AlternativeAngles.Z2Mass);
         ...
         if(l1id == 11 && l3id == 13)
         {
            CalculatorEM.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorUpEM.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorDownEM.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorWideEM.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorNarrowEM.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorEM.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorUpEM.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorDownEM.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorWideEM.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorNarrowEM.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
         ...
         if(l1id == 13 && l3id == 11)
         {
            CalculatorME.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorUpME.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorDownME.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorWideME.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorNarrowME.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorME.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorUpME.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorDownME.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorWideME.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorNarrowME.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
         ...
         if(l1id == 13 && l3id == 13)
         {
            CalculatorMM.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorUpMM.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorDownMM.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorWideMM.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorNarrowMM.SetSimpleMassIntegralWindow(true, 20 / Angles.ZMass);
            CalculatorMM.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorUpMM.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorDownMM.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorWideMM.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            CalculatorNarrowMM.SetSimpleMassIntegralWindow(false, 20 / Angles.Z2Mass);
            ...
            CalculatorMM.SetSimpleMassIntegralWindow(true, 20 / AlternativeAngles.ZMass);
            CalculatorUpMM.SetSimpleMassIntegralWindow(true, 20 / AlternativeAngles.ZMass);
            CalculatorDownMM.SetSimpleMassIntegralWindow(true, 20 / AlternativeAngles.ZMass);
            CalculatorWideMM.SetSimpleMassIntegralWindow(true, 20 / AlternativeAngles.ZMass);
            CalculatorNarrowMM.SetSimpleMassIntegralWindow(true, 20 / AlternativeAngles.ZMass);
            CalculatorMM.SetSimpleMassIntegralWindow(false, 20 / AlternativeAngles.Z2Mass);
            CalculatorUpMM.SetSimpleMassIntegralWindow(false, 20 / AlternativeAngles.Z2Mass);
            CalculatorDownMM.SetSimpleMassIntegralWindow(false, 20 / AlternativeAngles.Z2Mass);
            CalculatorWideMM.SetSimpleMassIntegralWindow(false, 20 / AlternativeAngles.Z2Mass);
            CalculatorNarrowMM.SetSimpleMassIntegralWindow(false, 20 / AlternativeAngles.Z2Mass);
