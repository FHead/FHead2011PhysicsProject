...
int main(int argc, char *argv[])
{
   ...
   CalculatorEM.SetSimpleMassIntegralStep(120);
   ...
   CalculatorEE.SetSimpleMassIntegralStep(120);
   ...
   for(int iEvent = StartEvent; iEvent < EventCount && iEvent <= EndEvent; iEvent++)
   {
      ...
      if(PassBaselineCut(Angles) == true)
      {
         if(l1id == 11 && l3id == 11)
         {
            ...
            CalculatorUpEE.SetSimpleMassIntegralWindow(true, 30);
            CalculatorDownEE.SetSimpleMassIntegralWindow(true, 30);
            CalculatorWideEE.SetSimpleMassIntegralWindow(true, 30);
            CalculatorNarrowEE.SetSimpleMassIntegralWindow(true, 30);
            CalculatorEE.SetSimpleMassIntegralWindow(false, 45);
            CalculatorUpEE.SetSimpleMassIntegralWindow(false, 45);
            CalculatorDownEE.SetSimpleMassIntegralWindow(false, 45);
            CalculatorWideEE.SetSimpleMassIntegralWindow(false, 45);
            CalculatorNarrowEE.SetSimpleMassIntegralWindow(false, 45);
         ...
         if(l1id == 11 && l3id == 13)
         {
            ...
            CalculatorUpEM.SetSimpleMassIntegralWindow(true, 30);
            CalculatorDownEM.SetSimpleMassIntegralWindow(true, 30);
            CalculatorWideEM.SetSimpleMassIntegralWindow(true, 30);
            CalculatorNarrowEM.SetSimpleMassIntegralWindow(true, 30);
            CalculatorEM.SetSimpleMassIntegralWindow(false, 45);
            CalculatorUpEM.SetSimpleMassIntegralWindow(false, 45);
            CalculatorDownEM.SetSimpleMassIntegralWindow(false, 45);
            CalculatorWideEM.SetSimpleMassIntegralWindow(false, 45);
            CalculatorNarrowEM.SetSimpleMassIntegralWindow(false, 45);
         ...
         if(l1id == 13 && l3id == 11)
         {
            CalculatorME.SetSimpleMassIntegralWindow(true, 30);
            CalculatorUpME.SetSimpleMassIntegralWindow(true, 30);
            CalculatorDownME.SetSimpleMassIntegralWindow(true, 30);
            CalculatorWideME.SetSimpleMassIntegralWindow(true, 30);
            CalculatorNarrowME.SetSimpleMassIntegralWindow(true, 30);
            CalculatorME.SetSimpleMassIntegralWindow(false, 45);
            CalculatorUpME.SetSimpleMassIntegralWindow(false, 45);
            CalculatorDownME.SetSimpleMassIntegralWindow(false, 45);
            CalculatorWideME.SetSimpleMassIntegralWindow(false, 45);
            CalculatorNarrowME.SetSimpleMassIntegralWindow(false, 45);
         ...
         if(l1id == 13 && l3id == 13)
         {
            CalculatorMM.SetSimpleMassIntegralWindow(true, 30);
            CalculatorUpMM.SetSimpleMassIntegralWindow(true, 30);
            CalculatorDownMM.SetSimpleMassIntegralWindow(true, 30);
            CalculatorWideMM.SetSimpleMassIntegralWindow(true, 30);
            CalculatorNarrowMM.SetSimpleMassIntegralWindow(true, 30);
            CalculatorMM.SetSimpleMassIntegralWindow(false, 45);
            CalculatorUpMM.SetSimpleMassIntegralWindow(false, 45);
            CalculatorDownMM.SetSimpleMassIntegralWindow(false, 45);
            CalculatorWideMM.SetSimpleMassIntegralWindow(false, 45);
            CalculatorNarrowMM.SetSimpleMassIntegralWindow(false, 45);
