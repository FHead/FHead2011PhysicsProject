...
for i in EventB.root Madgraph2e2mu_part1.root Madgraph2e2mu_part2.root \
   Madgraph2e2mu_part3.root Madgraph2e2mu_part4.root \
   Madgraph2e2mu_part5.root Madgraph2e2mu_part6.root
do
   echo $i
