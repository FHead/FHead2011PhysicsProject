...
int main(int argc, char *argv[])
{
   ...
   CalculatorUpEM.SetSimpleMassIntegralStep(60);      CalculatorDownEM.SetSimpleMassIntegralStep(30);
   CalculatorUpME.SetSimpleMassIntegralStep(60);      CalculatorDownME.SetSimpleMassIntegralStep(30);
   CalculatorUpEE.SetSimpleMassIntegralStep(60);      CalculatorDownEE.SetSimpleMassIntegralStep(30);
   CalculatorUpMM.SetSimpleMassIntegralStep(60);      CalculatorDownMM.SetSimpleMassIntegralStep(30);
