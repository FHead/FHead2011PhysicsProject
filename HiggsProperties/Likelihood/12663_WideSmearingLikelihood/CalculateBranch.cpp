...
int main(int argc, char *argv[])
{
   ...
   CalculatorEM.SetEfficiency12(GetElectronEfficiencyPtEta8TeV);
   CalculatorEM.SetEfficiency34(GetMuonEfficiencyPtEta8TeV);
   ...
   CalculatorEM.SetIntegralCRange(0.50, 1.75);
   ...
   // CalculatorEM.SetDebugPrintIntegrand(true);
   ...
   CalculatorME.SetEfficiency12(GetMuonEfficiencyPtEta8TeV);
   CalculatorME.SetEfficiency34(GetElectronEfficiencyPtEta8TeV);
   CalculatorME.SetSmear12(SmearMuonCentral8TeV);
   CalculatorME.SetSmear34(SmearElectronCentral8TeV);

   CalculatorEE.SetEfficiency12(GetElectronEfficiencyPtEta8TeV);
   CalculatorEE.SetEfficiency34(GetElectronEfficiencyPtEta8TeV);
   ...
   CalculatorEE.SetIntegralCRange(0.50, 1.75);
   ...
   CalculatorMM.SetEfficiency12(GetMuonEfficiencyPtEta8TeV);
   CalculatorMM.SetEfficiency34(GetMuonEfficiencyPtEta8TeV);
   ...
   for(int iEvent = StartEvent; iEvent < EventCount && iEvent <= EndEvent; iEvent++)
   {
      ...
      if(PassBaselineCut(Angles) == true)
      {
         if(l1id == 11 && l3id == 11)
         {
            ...
            IntegralHard = CalculatorHardEE.PassThroughMode(Angles);
            IntegralSoft = CalculatorSoftEE.PassThroughMode(Angles);
            IntegralForward = CalculatorForwardEE.PassThroughMode(Angles);
            IntegralCentral = CalculatorCentralEE.PassThroughMode(Angles);
            ...
            AlternativeIntegralHard = CalculatorHardEE.PassThroughMode(AlternativeAngles);
            AlternativeIntegralSoft = CalculatorSoftEE.PassThroughMode(AlternativeAngles);
            AlternativeIntegralForward = CalculatorForwardEE.PassThroughMode(AlternativeAngles);
            AlternativeIntegralCentral = CalculatorCentralEE.PassThroughMode(AlternativeAngles);
         ...
         if(l1id == 11 && l3id == 13)
         {
            ...
            IntegralHard = CalculatorHardEM.PassThroughMode(Angles);
            IntegralSoft = CalculatorSoftEM.PassThroughMode(Angles);
            IntegralForward = CalculatorForwardEM.PassThroughMode(Angles);
            IntegralCentral = CalculatorCentralEM.PassThroughMode(Angles);
         ...
         if(l1id == 13 && l3id == 11)
         {
            ...
            IntegralHard = CalculatorHardME.PassThroughMode(Angles);
            IntegralSoft = CalculatorSoftME.PassThroughMode(Angles);
            IntegralForward = CalculatorForwardME.PassThroughMode(Angles);
            IntegralCentral = CalculatorCentralME.PassThroughMode(Angles);
         ...
         if(l1id == 13 && l3id == 13)
         {
            ...
            IntegralHard = CalculatorHardMM.PassThroughMode(Angles);
            IntegralSoft = CalculatorSoftMM.PassThroughMode(Angles);
            IntegralForward = CalculatorForwardMM.PassThroughMode(Angles);
            IntegralCentral = CalculatorCentralMM.PassThroughMode(Angles);
            ...
            AlternativeIntegralHard = CalculatorHardMM.PassThroughMode(AlternativeAngles);
            AlternativeIntegralSoft = CalculatorSoftMM.PassThroughMode(AlternativeAngles);
            AlternativeIntegralForward = CalculatorForwardMM.PassThroughMode(AlternativeAngles);
            AlternativeIntegralCentral = CalculatorCentralMM.PassThroughMode(AlternativeAngles);
