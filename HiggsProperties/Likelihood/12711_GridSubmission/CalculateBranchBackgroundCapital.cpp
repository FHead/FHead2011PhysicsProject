...
int main(int argc, char *argv[])
{
   ...
   if(argc <= 5)
   {
      ...
      cerr << "FlavorTreatment:" << endl;
      cerr << "   1 = em" << endl;
      cerr << "   2 = me" << endl;
      cerr << "   3 = ee" << endl;
      cerr << "   4 = mm" << endl;
      cerr << "   others = take from tree" << endl;
      return -1;
   }
   ...
   double zzmass, z1mass, z2mass, theta0, phi0,
      theta1, theta2, phi;
   Tree->SetBranchAddress("MH", &zzmass);
   Tree->SetBranchAddress("M1", &z1mass);
   Tree->SetBranchAddress("M2", &z2mass);
