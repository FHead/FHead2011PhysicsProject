...
int main(int argc, char *argv[])
{
   ...
   CalculatorEM.SetMECalculator(CalculateDDbarBackground2e2mu);
   ...
   // CalculatorEE.SetMECalculator(CalculateBackground4e_Roberto12253);
   CalculatorEE.SetMECalculator(CalculateDDbarBackground4e);
