...
int main(int argc, char *argv[])
{
   ...
   CalculatorEM[0].SetEfficiency12(GetElectronEfficiencyPtEta8TeV);
   CalculatorEM[0].SetEfficiency34(GetMuonEfficiencyPtEta8TeV);
   CalculatorEM[0].SetSmear12(SmearElectronCentral8TeV);
   CalculatorEM[0].SetSmear34(SmearMuonCentral8TeV);
   ...
   for(int i = 0; i < 4; i++)
   {
      ...
      CalculatorME[i].SetEfficiency12(GetMuonEfficiencyPtEta8TeV);
      CalculatorME[i].SetEfficiency34(GetElectronEfficiencyPtEta8TeV);
      CalculatorME[i].SetSmear12(SmearMuonCentral8TeV);
      CalculatorME[i].SetSmear34(SmearElectronCentral8TeV);
   }

   CalculatorEE[0].SetEfficiency12(GetElectronEfficiencyPtEta8TeV);
   CalculatorEE[0].SetEfficiency34(GetElectronEfficiencyPtEta8TeV);
   CalculatorEE[0].SetSmear12(SmearElectronCentral8TeV);
   CalculatorEE[0].SetSmear34(SmearElectronCentral8TeV);
   ...
   for(int i = 0; i < 4; i++)
   {
      ...
      CalculatorMM[i].SetEfficiency12(GetMuonEfficiencyPtEta8TeV);
      CalculatorMM[i].SetEfficiency34(GetMuonEfficiencyPtEta8TeV);
      CalculatorMM[i].SetSmear12(SmearMuonCentral8TeV);
      CalculatorMM[i].SetSmear34(SmearMuonCentral8TeV);
   }
   ...
   for(int i = 0; i < 4; i++)
   {
      ...
      CalculatorUpEM[i].SetSmear12(SmearElectronUp8TeV);    CalculatorDownEM[i].SetSmear12(SmearElectronDown8TeV);
      CalculatorUpEM[i].SetSmear34(SmearMuonUp8TeV);        CalculatorDownEM[i].SetSmear34(SmearMuonDown8TeV);
      CalculatorUpME[i] = CalculatorME[i];                  CalculatorDownME[i] = CalculatorME[i];
      CalculatorUpME[i].SetSmear12(SmearMuonUp8TeV);        CalculatorDownME[i].SetSmear12(SmearMuonDown8TeV);
      CalculatorUpME[i].SetSmear34(SmearElectronUp8TeV);    CalculatorDownME[i].SetSmear34(SmearElectronDown8TeV);
      CalculatorUpEE[i] = CalculatorEE[i];                  CalculatorDownEE[i] = CalculatorEE[i];
      CalculatorUpEE[i].SetSmear12(SmearElectronUp8TeV);    CalculatorDownEE[i].SetSmear12(SmearElectronDown8TeV);
      CalculatorUpEE[i].SetSmear34(SmearElectronUp8TeV);    CalculatorDownEE[i].SetSmear34(SmearElectronDown8TeV);
      CalculatorUpMM[i] = CalculatorMM[i];                  CalculatorDownMM[i] = CalculatorMM[i];
      CalculatorUpMM[i].SetSmear12(SmearMuonUp8TeV);        CalculatorDownMM[i].SetSmear12(SmearMuonDown8TeV);
      CalculatorUpMM[i].SetSmear34(SmearMuonUp8TeV);        CalculatorDownMM[i].SetSmear34(SmearMuonDown8TeV);

      CalculatorWideEM[i] = CalculatorEM[i];                CalculatorNarrowEM[i] = CalculatorEM[i];
      CalculatorWideEM[i].SetSmear12(SmearElectronWide8TeV);CalculatorNarrowEM[i].SetSmear12(SmearElectronNarrow8TeV);
      CalculatorWideEM[i].SetSmear34(SmearMuonWide8TeV);    CalculatorNarrowEM[i].SetSmear34(SmearMuonNarrow8TeV);
      CalculatorWideME[i] = CalculatorME[i];                CalculatorNarrowME[i] = CalculatorME[i];
      CalculatorWideME[i].SetSmear12(SmearMuonWide8TeV);    CalculatorNarrowME[i].SetSmear12(SmearMuonNarrow8TeV);
      CalculatorWideME[i].SetSmear34(SmearElectronWide8TeV);CalculatorNarrowME[i].SetSmear34(SmearElectronNarrow8TeV);
      CalculatorWideEE[i] = CalculatorEE[i];                CalculatorNarrowEE[i] = CalculatorEE[i];
      CalculatorWideEE[i].SetSmear12(SmearElectronWide8TeV);CalculatorNarrowEE[i].SetSmear12(SmearElectronNarrow8TeV);
      CalculatorWideEE[i].SetSmear34(SmearElectronWide8TeV);CalculatorNarrowEE[i].SetSmear34(SmearElectronNarrow8TeV);
      CalculatorWideMM[i] = CalculatorMM[i];                CalculatorNarrowMM[i] = CalculatorMM[i];
      CalculatorWideMM[i].SetSmear12(SmearMuonWide8TeV);    CalculatorNarrowMM[i].SetSmear12(SmearMuonNarrow8TeV);
      CalculatorWideMM[i].SetSmear34(SmearMuonWide8TeV);    CalculatorNarrowMM[i].SetSmear34(SmearMuonNarrow8TeV);
