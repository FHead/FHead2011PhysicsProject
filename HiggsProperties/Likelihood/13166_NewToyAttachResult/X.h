...
// Wed May 21 10:09:14 2014 by ROOT version 5.34/01
// from TTree Tree/Tree
// found on file: Source2/13142_SignalToyGeneration_13143_8TeV_Run3_EE.root
//////////////////////////////////////////////////////////
...
#ifdef X_cxx
X::X(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Source2/13142_SignalToyGeneration_13143_8TeV_Run3_EE.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Source2/13142_SignalToyGeneration_13143_8TeV_Run3_EE.root");
      }
...
Int_t X::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t X::LoadTree(Long64_t entry)
{
