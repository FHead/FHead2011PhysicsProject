...
int main(int argc, char *argv[])
{
   ...
   if(argc <= 5)
   {
      ...
      cerr << "   example: " << argv[0] << " A.root 0 100 -1 14" << endl;
      cerr << "   Energy of \"0\" means that the thing is at rest" << endl;
      return -1;
   }
   ...
   cerr << "[Notice] Running with all positive zprime-lepton coupling (vectorial)" << endl;
   ...
   if(Energy == "14")
      ...
      CalculatorEM.SetPTYDensity(GetPTYDensityGG_MZ_CTEQ6l1_13TeV_13432);
   else if(Energy == "0")
   ...
   if(Energy == "14")
      ...
      CalculatorEE.SetPTYDensity(GetPTYDensityGG_MZ_CTEQ6l1_13TeV_13432);
   else if(Energy == "0")
   ...
   if(OneSignal == false)
      ...
      CalculatorEE.SetMECalculator(MEEE[0][0]);
