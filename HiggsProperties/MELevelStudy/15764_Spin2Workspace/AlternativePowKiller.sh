cat $1 \
   ...
   | sed "s/pow(C12,-2)/(1.0\/C12\/C12)/g" \
   | sed "s/pow(C13,-2)/(1.0\/C13\/C13)/g" \
   | sed "s/pow(C14,-2)/(1.0\/C14\/C14)/g" \
   | sed "s/pow(C15,-2)/(1.0\/C15\/C15)/g" \
   | sed "s/pow(C16,-2)/(1.0\/C16\/C16)/g" \
   | sed "s/pow(C23,-2)/(1.0\/C23\/C23)/g" \
   | sed "s/pow(C24,-2)/(1.0\/C24\/C24)/g" \
   | sed "s/pow(C25,-2)/(1.0\/C25\/C25)/g" \
   | sed "s/pow(C26,-2)/(1.0\/C26\/C26)/g" \
   | sed "s/pow(C34,-2)/(1.0\/C34\/C34)/g" \
   | sed "s/pow(C35,-2)/(1.0\/C35\/C35)/g" \
   | sed "s/pow(C36,-2)/(1.0\/C36\/C36)/g" \
   | sed "s/pow(C45,-2)/(1.0\/C45\/C45)/g" \
   | sed "s/pow(C46,-2)/(1.0\/C46\/C46)/g" \
   | sed "s/pow(C56,-2)/(1.0\/C56\/C56)/g" \
   ...
   | sed "s/pow(-(MZ\*MZ) + 2\*C12,2)/(MZMZC12*MZMZC12)/g" \
   | sed "s/pow(-(MZ\*MZ) + 2\*C34,2)/(MZMZC34*MZMZC34)/g" \
   | sed "s/pow(-(MZ\*MZ) + 2\*C36,2)/(MZMZC36*MZMZC36)/g" \
   | sed "s/pow((MZ\*MZ) - 2\*C36,2)/(MZMZC36*MZMZC36)/g" \
   | sed "s/pow(-(MZ\*MZ) + 2\*C45,2)/(MZMZC45*MZMZC45)/g" \
   | sed "s/pow((MZ\*MZ) - 2\*C45,2)/(MZMZC45*MZMZC45)/g" \
   | sed "s/pow((MZ\*MZ) - 2\*C56,2)/(MZMZC56*MZMZC56)/g" \
   | sed "s/pow((MZ\*MZ)\*(wZ\*wZ) + (MZMZC12\*MZMZC12),-1)/iMZMZwZwZMZMZC12/g" \
   | sed "s/pow((MZ\*MZ)\*(wZ\*wZ) + (MZMZC34\*MZMZC34),-1)/iMZMZwZwZMZMZC34/g" \
   | sed "s/pow((MZ\*MZ)\*(wZ\*wZ) + (MZMZC36\*MZMZC36),-1)/iMZMZwZwZMZMZC36/g" \
   | sed "s/pow((MZ\*MZ)\*(wZ\*wZ) + (MZMZC45\*MZMZC45),-1)/iMZMZwZwZMZMZC45/g" \
   | sed "s/pow((MZ\*MZ)\*(wZ\*wZ) + (MZMZC56\*MZMZC56),-1)/iMZMZwZwZMZMZC56/g" \
   | sed "/pow((MZ\*MZ)\*(wZ\*wZ)/{N;s/[ ]*//g;s/\n//;s/pow((MZ\*MZ)\*(wZ\*wZ)+(MZMZC12\*MZMZC12),-1)/iMZMZwZwZMZMZC12/g}" \
   | sed "/pow((MZ\*MZ)\*(wZ\*wZ)/{N;s/[ ]*//g;s/\n//;s/pow((MZ\*MZ)\*(wZ\*wZ)+(MZMZC34\*MZMZC34),-1)/iMZMZwZwZMZMZC34/g}" \
   | sed "/pow((MZ\*MZ)\*(wZ\*wZ)/{N;s/[ ]*//g;s/\n//;s/pow((MZ\*MZ)\*(wZ\*wZ)+(MZMZC36\*MZMZC36),-1)/iMZMZwZwZMZMZC36/g}" \
   | sed "/pow((MZ\*MZ)\*(wZ\*wZ)/{N;s/[ ]*//g;s/\n//;s/pow((MZ\*MZ)\*(wZ\*wZ)+(MZMZC45\*MZMZC45),-1)/iMZMZwZwZMZMZC45/g}" \
   | sed "/pow((MZ\*MZ)\*(wZ\*wZ)/{N;s/[ ]*//g;s/\n//;s/pow((MZ\*MZ)\*(wZ\*wZ)+(MZMZC56\*MZMZC56),-1)/iMZMZwZwZMZMZC56/g}" \
   | sed "s/A[123][AVZ][AVZ][RI]/1/g" \
   | tr -d '\\'

   #COMMENT
   #COMMENT | sed '/(-MZ + pow(2,0.5)\*pow(C12,0.5))\*$/{N;s/(-MZ + pow(2,0.5)\*pow(C12,0.5))\*\n[ ]*(MZ + pow(2,0.5)\*pow(C12,0.5))/(-MZ*MZ + 2*C12)/}' \
   #COMMENT | sed '/(-MZ + pow(2,0.5)\*pow(C34,0.5))\*$/{N;s/(-MZ + pow(2,0.5)\*pow(C34,0.5))\*\n[ ]*(MZ + pow(2,0.5)\*pow(C34,0.5))/(-MZ*MZ + 2*C34)/}' \
   #COMMENT | sed '/(-MZ + pow(2,0.5)\*pow(C36,0.5))\*$/{N;s/(-MZ + pow(2,0.5)\*pow(C36,0.5))\*\n[ ]*(MZ + pow(2,0.5)\*pow(C36,0.5))/(-MZ*MZ + 2*C36)/}' \
   #COMMENT | sed '/(MZ - pow(2,0.5)\*pow(C36,0.5))\*$/{N;s/(MZ - pow(2,0.5)\*pow(C36,0.5))\*\n[ ]*(MZ + pow(2,0.5)\*pow(C36,0.5))/(MZ*MZ - 2*C36)/}' \
   #COMMENT | sed '/(-MZ + pow(2,0.5)\*pow(C45,0.5))\*$/{N;s/(-MZ + pow(2,0.5)\*pow(C45,0.5))\*\n[ ]*(MZ + pow(2,0.5)\*pow(C45,0.5))/(-MZ*MZ + 2*C45)/}' \
   #COMMENT | sed '/(MZ - pow(2,0.5)\*pow(C45,0.5))\*$/{N;s/(MZ - pow(2,0.5)\*pow(C45,0.5))\*\n[ ]*(MZ + pow(2,0.5)\*pow(C45,0.5))/(MZ*MZ - 2*C45)/}' \
   #COMMENT | sed '/(MZ - pow(2,0.5)\*pow(C56,0.5))\*$/{N;s/(MZ - pow(2,0.5)\*pow(C56,0.5))\*\n[ ]*(MZ + pow(2,0.5)\*pow(C56,0.5))/(MZ*MZ - 2*C56)/}' \
   #COMMENT | sed '/(pow(2,0.5)\*pow(C34,0.5) - pow(2,0.5)\*pow(C36,0.5))\*$/{N;s/(pow(2,0.5)\*pow(C34,0.5) - pow(2,0.5)\*pow(C36,0.5))\*\n[ ]*(pow(2,0.5)\*pow(C34,0.5) + pow(2,0.5)\*pow(C36,0.5))/(2*C34-2*C36)/}' \
   #COMMENT | sed '/(pow(2,0.5)\*pow(C34,0.5) - pow(2,0.5)\*pow(C45,0.5))\*$/{N;s/(pow(2,0.5)\*pow(C34,0.5) - pow(2,0.5)\*pow(C45,0.5))\*\n[ ]*(pow(2,0.5)\*pow(C34,0.5) + pow(2,0.5)\*pow(C45,0.5))/(2*C34-2*C45)/}' \
   #COMMENT | tr -d '\'


   #COMMENT | sed "s/-(MZ\*MZ) + 2\*C12/(-MZMZC12)/g" | sed "s/pow((-MZMZC12),2)/(MZMZC12*MZMZC12)/g"\
   #COMMENT | sed "s/-(MZ\*MZ) + 2\*C34/(-MZMZC34)/g" | sed "s/pow((-MZMZC34),2)/(MZMZC34*MZMZC34)/g" \
   #COMMENT | sed "s/-(MZ\*MZ) + 2\*C36/(-MZMZC36)/g" | sed "s/pow((-MZMZC36),2)/(MZMZC36*MZMZC36)/g" \
   #COMMENT | sed "s/(MZ\*MZ) - 2\*C36/MZMZC36/g" | sed "s/pow(MZMZC36,2)/(MZMZC36*MZMZC36)/g" \
   #COMMENT | sed "s/-(MZ\*MZ) + 2\*C45/(-MZMZC45)/g" | sed "s/pow((-MZMZC45),2)/(MZMZC45*MZMZC45)/g" \
   #COMMENT | sed "s/(MZ\*MZ) - 2\*C45/MZMZC45/g" | sed "s/pow(MZMZC45,2)/(MZMZC45*MZMZC45)/g" \
   #COMMENT | sed "s/(MZ\*MZ) - 2\*C56/MZMZC56/g" | sed "s/pow(MZMZC56,2)/(MZMZC56*MZMZC56)/g" \
