...
int main()
{
   ...
   HWorld.GetYaxis()->SetTitleOffset(0.4);
   HWorld.GetXaxis()->SetTitleSize(0.1);
   HWorld.GetYaxis()->SetTitleSize(0.1);
   HWorld.GetXaxis()->SetLabelSize(0.065);
   HWorld.GetYaxis()->SetLabelSize(0.1);
   ...
   G2.Draw("p");
   G3.Draw("p");
   C.SaveAs("MassAttractorExample.png");
   C.SaveAs("MassAttractorExample.C");
   C.SaveAs("MassAttractorExample.eps");
   C.SaveAs("MassAttractorExample.pdf");
