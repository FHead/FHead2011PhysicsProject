...
int main()
{
   ...
   TGraphErrors *A2AA_1 = (TGraphErrors *)File.Get("A2AA_BothS_I_Lumi_FloatA2A3");
   TGraphErrors *A2AA_2 = (TGraphErrors *)File.Get("A2AA_BothS_A_Lumi_FloatA2A3");
   TGraphErrors *A2AA_3 = (TGraphErrors *)File.Get("A2AA_BothS_B_Lumi_FloatA2A3");
   TGraphErrors *A2AA_4 = (TGraphErrors *)File.Get("A2AA_BothS_C_Lumi_FloatA2A3");
   TGraphErrors *A2AA_5 = (TGraphErrors *)File.Get("A2AA_BothS_D_Lumi_FloatA2A3");
   TGraphErrors *A2AA_6 = (TGraphErrors *)File.Get("A2AA_BothS_H_Lumi_FloatA2A3");
   TGraphErrors *A2AA_7 = (TGraphErrors *)File.Get("A2AA_BothS_J_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_1 = (TGraphErrors *)File.Get("A2ZA_BothS_I_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_2 = (TGraphErrors *)File.Get("A2ZA_BothS_A_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_3 = (TGraphErrors *)File.Get("A2ZA_BothS_B_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_4 = (TGraphErrors *)File.Get("A2ZA_BothS_C_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_5 = (TGraphErrors *)File.Get("A2ZA_BothS_D_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_6 = (TGraphErrors *)File.Get("A2ZA_BothS_H_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_7 = (TGraphErrors *)File.Get("A2ZA_BothS_J_Lumi_FloatA2A3");
