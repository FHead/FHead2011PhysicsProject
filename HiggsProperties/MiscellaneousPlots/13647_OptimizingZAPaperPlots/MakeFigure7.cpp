...
int main()
{
   ...
   TGraphErrors *A2AA_AS = (TGraphErrors *)File.Get("A2AA_BothS_I_Lumi_FloatA2A3");
   TGraphErrors *A2AA_AB = (TGraphErrors *)File.Get("A2AA_Both_I_Lumi_FloatA2A3");
   TGraphErrors *A2AA_JS = (TGraphErrors *)File.Get("A2AA_BothS_H_Lumi_FloatA2A3");
   TGraphErrors *A2AA_JB = (TGraphErrors *)File.Get("A2AA_Both_H_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_AS = (TGraphErrors *)File.Get("A2ZA_BothS_I_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_AB = (TGraphErrors *)File.Get("A2ZA_Both_I_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_JS = (TGraphErrors *)File.Get("A2ZA_BothS_H_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_JB = (TGraphErrors *)File.Get("A2ZA_Both_H_Lumi_FloatA2A3");
