...
int main()
{
   ...
   TFile File2("AllGraphs1GeV.root");

   TGraphErrors *A2AA_IS = (TGraphErrors *)File.Get("A2AA_BothS_I_Lumi_FloatA2A3");
   TGraphErrors *A2AA_IB = (TGraphErrors *)File.Get("A2AA_Both_I_Lumi_FloatA2A3");
   TGraphErrors *A2AA_JS = (TGraphErrors *)File.Get("A2AA_BothS_J_Lumi_FloatA2A3");
   TGraphErrors *A2AA_JB = (TGraphErrors *)File.Get("A2AA_Both_J_Lumi_FloatA2A3");
   TGraphErrors *A2AA_JH = (TGraphErrors *)File2.Get("A2AA_Both_J_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_IS = (TGraphErrors *)File.Get("A2ZA_BothS_I_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_IB = (TGraphErrors *)File.Get("A2ZA_Both_I_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_JS = (TGraphErrors *)File.Get("A2ZA_BothS_J_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_JB = (TGraphErrors *)File.Get("A2ZA_Both_J_Lumi_FloatA2A3");
   TGraphErrors *A2ZA_JH = (TGraphErrors *)File2.Get("A2ZA_Both_J_Lumi_FloatA2A3");
   ...
   Legend.AddEntry(A2AA_JH, "Relaxed - #Upsilon (S (1 GeV)+B)", "l");
   Legend.AddEntry(A2AA_JB, "Relaxed - #Upsilon (S+B)", "l");
   Legend.Draw();

   Canvas.SaveAs("Figure7PPrimeAA.png");
   Canvas.SaveAs("Figure7PPrimeAA.C");
   Canvas.SaveAs("Figure7PPrimeAA.eps");
   Canvas.SaveAs("Figure7PPrimeAA.pdf");
   ...
   Canvas.SaveAs("Figure7PPrimeZA.png");
   Canvas.SaveAs("Figure7PPrimeZA.C");
   Canvas.SaveAs("Figure7PPrimeZA.eps");
   Canvas.SaveAs("Figure7PPrimeZA.pdf");
