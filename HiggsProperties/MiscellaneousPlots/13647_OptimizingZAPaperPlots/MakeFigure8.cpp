...
int main()
{
   ...
   TGraphErrors *A2ZZ = (TGraphErrors *)File.Get("A2ZZ_Both_H_Count_FloatA2A3");
   TGraphErrors *A3ZZ = (TGraphErrors *)File.Get("A3ZZ_Both_H_Count_FloatA2A3");
   TGraphErrors *A2ZA = (TGraphErrors *)File.Get("A2ZA_Both_H_Count_FloatA2A3");
   TGraphErrors *A3ZA = (TGraphErrors *)File.Get("A3ZA_Both_H_Count_FloatA2A3");
   TGraphErrors *A2AA = (TGraphErrors *)File.Get("A2AA_Both_H_Count_FloatA2A3");
   TGraphErrors *A3AA = (TGraphErrors *)File.Get("A3AA_Both_H_Count_FloatA2A3");
