{
   ...
   TGraph *A2AA_A = (TGraph *)File.Get("A2AA_Both_I_Count_FloatA2A3");
   TGraph *A3AA_A = (TGraph *)File.Get("A3AA_Both_I_Count_FloatA2A3");
   ...
   {
      double EventCount = 0;
      double MeanX = -0.008, MeanY = 0, SigmaX_A, SigmaY_A, SigmaX_J, SigmaY_J;
      ...
      C.SaveAs(Form("Contours/ContourIJ_%05d.png", (int)EventCount));
      C.SaveAs(Form("Contours/ContourIJ_%05d.C",   (int)EventCount));
      C.SaveAs(Form("Contours/ContourIJ_%05d.eps", (int)EventCount));
      C.SaveAs(Form("Contours/ContourIJ_%05d.pdf", (int)EventCount));
   }
}
