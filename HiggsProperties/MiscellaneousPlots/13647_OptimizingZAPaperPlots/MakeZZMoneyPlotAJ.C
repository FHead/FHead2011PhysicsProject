{
   ...
   TGraph *A2AA_A = (TGraph *)File.Get("A2ZZ_Both_I_Count_FloatA2A3");
   TGraph *A3AA_A = (TGraph *)File.Get("A3ZZ_Both_I_Count_FloatA2A3");
   TGraph *A2AA_J = (TGraph *)File.Get("A2ZZ_Both_J_Count_FloatA2A3");
   TGraph *A3AA_J = (TGraph *)File.Get("A3ZZ_Both_J_Count_FloatA2A3");
   ...
   for(int i = 0; i < 10; i++)
   {
      ...
      Legend.AddEntry(&Ellipse1, "Golden channel fits (Relaxed - #Upsilon)", "fl");
      ...
      C.SaveAs(Form("ZZContours/ContourIJ_%05d.png", (int)EventCount));
      C.SaveAs(Form("ZZContours/ContourIJ_%05d.C",   (int)EventCount));
      C.SaveAs(Form("ZZContours/ContourIJ_%05d.eps", (int)EventCount));
      C.SaveAs(Form("ZZContours/ContourIJ_%05d.pdf", (int)EventCount));
   }
}
