{
   ...
   ResultTree->SetAlias("N", "(FemError == 0 && FmeError == 0 && FeeError == 0 && FmmError == 0)");
   ResultTree->SetAlias("Y", "(FemError > 0 || FmeError > 0 || FeeError > 0 || FmmError > 0)");
   ...
   ResultTree->SetAlias("FA1", "(1/(1+A3ZZ*A3ZZ/25+A2ZZ*A2ZZ/9))");
   ResultTree->SetAlias("FA2", "(A2ZZ*A2ZZ/9/(1+A3ZZ*A3ZZ/25+A2ZZ*A2ZZ/9)*sign(A2ZZ))");
   ResultTree->SetAlias("FA3", "(A3ZZ*A3ZZ/25/(1+A3ZZ*A3ZZ/25+A2ZZ*A2ZZ/9)*sign(A3ZZ))");
   ...
   ResultTree->SetAlias("NBem", "Fem*(Sem+Bem)");
   ResultTree->SetAlias("NBme", "Fme*(Sme+Bme)");
   ResultTree->SetAlias("NBee", "Fee*(See+Bee)");
   ResultTree->SetAlias("NBmm", "Fmm*(Smm+Bmm)");
