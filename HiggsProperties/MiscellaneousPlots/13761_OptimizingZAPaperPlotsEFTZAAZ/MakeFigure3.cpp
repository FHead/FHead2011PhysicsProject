...
int main()
{
   ...
   TGraphErrors *A2AA_EM = (TGraphErrors *)File.Get("A2AA_EMS_I_Count_YYNYYNYY_Point0");
   TGraphErrors *A2AA_EE = (TGraphErrors *)File.Get("A2AA_EES_I_Count_YYNYYNYY_Point0");
