...
int main()
{
   ...
   Explanations1[1] = "AVV_A3ZA_BothS_A_Count_NYNNYNNY_NoSquare_NYNN_Point0";
   Explanations1[2] = "";
   ...
   Explanations1[10] = "NYNN: what prior is floated";
   ...
   Explanations2[7] = "RWWZZ, RZA, RAA, RHto4l";
   ...
   while((Key = (TKey*)Next()))
   {
      ...
      PsFile.AddPlot(G, "apl", true, true);
   }
