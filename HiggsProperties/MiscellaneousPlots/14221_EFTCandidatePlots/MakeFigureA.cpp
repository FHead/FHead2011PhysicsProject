...
int main()
{
   ...
   TGraph *G1J = (TGraph *)File.Get("AVV_A2ZZ_Both_J_Count_YYYYYYYY_WithSquare_NNNNN_PointA");
   TGraph *G2J = (TGraph *)File.Get("AVV_A3ZZ_Both_J_Count_YYYYYYYY_WithSquare_NNNNN_PointA");
   TGraph *G3J = (TGraph *)File.Get("AVV_A4ZZ_Both_J_Count_YYYYYYYY_WithSquare_NNNNN_PointA");
   TGraph *G4J = (TGraph *)File.Get("AVV_A2ZA_Both_J_Count_YYYYYYYY_WithSquare_NNNNN_PointA");
   TGraph *G5J = (TGraph *)File.Get("AVV_A3ZA_Both_J_Count_YYYYYYYY_WithSquare_NNNNN_PointA");
   TGraph *G6J = (TGraph *)File.Get("AVV_A4ZA_Both_J_Count_YYYYYYYY_WithSquare_NNNNN_PointA");
   TGraph *G7J = (TGraph *)File.Get("AVV_A2AA_Both_J_Count_YYYYYYYY_WithSquare_NNNNN_PointA");
   TGraph *G8J = (TGraph *)File.Get("AVV_A3AA_Both_J_Count_YYYYYYYY_WithSquare_NNNNN_PointA");
