...
int main(int argc, char *argv[])
{
   ...
   C.SaveAs(("Plots/FigureF" + Suffix + ".png").c_str());
   C.SaveAs(("Plots/FigureF" + Suffix + ".C").c_str());
   C.SaveAs(("Plots/FigureF" + Suffix + ".eps").c_str());
   C.SaveAs(("Plots/FigureF" + Suffix + ".pdf").c_str());
