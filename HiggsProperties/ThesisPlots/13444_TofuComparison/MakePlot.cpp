...
int main()
{
   ...
   TFile F1("MeowTofu.root");
   TFile F2("ResultTree.root");

   TTree *T1 = (TTree *)F1.Get("Tree");
   TTree *T2 = (TTree *)F2.Get("Tree");

   T1->SetAlias("Cut", "(min(min(L1PT, L2PT), min(L3PT, L4PT)) > 7 && (max(max(L1PT,L2PT),max(L3PT,L4PT))) > 20 && (max(max(max(L1PT+L2PT,L1PT+L3PT),max(L1PT+L4PT,L2PT+L3PT)),max(L2PT+L4PT,L3PT+L4PT))) > 30 && MH > 115 && MH < 135 && M1 > 40 && M2 > 12 && abs(L1Eta) < 2.4 && abs(L2Eta) < 2.4 && abs(L3Eta) < 2.4 && abs(L4Eta) < 2.4) * Weight[0][0] * M1 * M2 / MH / MH / MH");
   T2->SetAlias("Cut", "(min(min(L1PT, L2PT), min(L3PT, L4PT)) > 7 && (max(max(L1PT,L2PT),max(L3PT,L4PT))) > 20 && (max(max(max(L1PT+L2PT,L1PT+L3PT),max(L1PT+L4PT,L2PT+L3PT)),max(L2PT+L4PT,L3PT+L4PT))) > 30 && MH > 115 && MH < 135 && M1 > 40 && M2 > 12 && abs(L1Eta) < 2.4 && abs(L2Eta) < 2.4 && abs(L3Eta) < 2.4 && abs(L4Eta) < 2.4)");
   ...
   HWorld1.SetMaximum(0.25);
   HWorld2.SetMinimum(0);
   HWorld2.SetMaximum(0.06);
   HWorld3.SetMinimum(0);
   HWorld3.SetMaximum(0.08);
   ...
   Legend.AddEntry(HMH2, "Smeared tofu", "l");
