...
int main()
{
   ...
   TFile F1("Background.root");
   TFile F2("BackgroundSmeared.root");

   TTree *T1 = (TTree *)F1.Get("Tree");
   TTree *T2 = (TTree *)F2.Get("Tree");

   T1->SetAlias("Cut", "(min(min(L1PT, L2PT), min(L3PT, L4PT)) > 7 && (max(max(L1PT,L2PT),max(L3PT,L4PT))) > 20 && (max(max(max(L1PT+L2PT,L1PT+L3PT),max(L1PT+L4PT,L2PT+L3PT)),max(L2PT+L4PT,L3PT+L4PT))) > 30 && MH > 115 && MH < 135 && M1 > 40 && M2 > 12 && abs(L1Eta) < 2.4 && abs(L2Eta) < 2.4 && abs(L3Eta) < 2.4 && abs(L4Eta) < 2.4) * Weight[0][0] * M1 * M2 * sin(Theta0) * sin(Theta1) * sin(Theta2) / MH / SamplingWeight * (log(Weight[0][0] / SamplingWeight) < 0)");
   T2->SetAlias("Cut", "(min(min(L1PT, L2PT), min(L3PT, L4PT)) > 7 && (max(max(L1PT,L2PT),max(L3PT,L4PT))) > 20 && (max(max(max(L1PT+L2PT,L1PT+L3PT),max(L1PT+L4PT,L2PT+L3PT)),max(L2PT+L4PT,L3PT+L4PT))) > 30 && MH > 115 && MH < 135 && M1 > 40 && M2 > 12 && abs(L1Eta) < 2.4 && abs(L2Eta) < 2.4 && abs(L3Eta) < 2.4 && abs(L4Eta) < 2.4) * Weight * (log(Weight) < 0)");
   ...
   cout << "MH" << endl;
   T1->Draw("MH>>HMH1", "Cut", "error", MAX);
   T2->Draw("MH>>HMH2", "Cut", "error", MAX);
   cout << "M1" << endl;
   T1->Draw("M1>>HM11", "Cut", "error", MAX);
   T2->Draw("M1>>HM12", "Cut", "error", MAX);
   cout << "M2" << endl;
   T1->Draw("M2>>HM21", "Cut", "error", MAX);
   T2->Draw("M2>>HM22", "Cut", "error", MAX);
   cout << "Phi0" << endl;
   T1->Draw("Phi0-2*3.1415926535*(Phi0>3.1415926535)+2*3.1415926535*(Phi0<-3.1415926535)>>HPhi01", "Cut", "error", MAX);
   T2->Draw("Phi0-2*3.1415926535*(Phi0>3.1415926535)+2*3.1415926535*(Phi0<-3.1415926535)>>HPhi02", "Cut", "error", MAX);
   cout << "Theta0" << endl;
   T1->Draw("cos(Theta0)>>HCosTheta01", "Cut", "error", MAX);
   T2->Draw("cos(Theta0)>>HCosTheta02", "Cut", "error", MAX);
   cout << "Phi" << endl;
   T1->Draw("Phi-2*3.1415926535*(Phi>3.1415926535)>>HPhi1", "Cut", "error", MAX);
   T2->Draw("Phi-2*3.1415926535*(Phi>3.1415926535)>>HPhi2", "Cut", "error", MAX);
   cout << "Theta1" << endl;
   T1->Draw("cos(Theta1)>>HCosTheta11", "Cut", "error", MAX);
   T2->Draw("cos(Theta1)>>HCosTheta12", "Cut", "error", MAX);
   cout << "Theta2" << endl;
   T1->Draw("cos(Theta2)>>HCosTheta21", "Cut", "error", MAX);
   T2->Draw("cos(Theta2)>>HCosTheta22", "Cut", "error", MAX);
   cout << "HPhi" << endl;
   T1->Draw("HPhi-2*3.1415926535*(HPhi>3.1415926535)>>HPhiH1", "Cut", "error", MAX);
   T2->Draw("HPhi-2*3.1415926535*(HPhi>3.1415926535)>>HPhiH2", "Cut", "error", MAX);
   cout << "HPT" << endl;
   T1->Draw("HPT>>HPTH1", "Cut", "error", MAX);
   T2->Draw("HPT>>HPTH2", "Cut", "error", MAX);
   cout << "HY" << endl;
   T1->Draw("HY>>HYH1", "Cut", "error", MAX);
   T2->Draw("HY>>HYH2", "Cut", "error", MAX);
   cout << "PhiOffset" << endl;
   T1->Draw("PhiOffset-2*3.1415926535*(PhiOffset>3.1415926535)+2*3.1415926535*(PhiOffset<-3.1415926535)>>HPhiOffset1", "Cut", "error", MAX);
   T2->Draw("PhiOffset-2*3.1415926535*(PhiOffset>3.1415926535)+2*3.1415926535*(PhiOffset<-3.1415926535)>>HPhiOffset2", "Cut", "error", MAX);
   ...
   HWorld1.SetMaximum(0.1);
   HWorld2.SetMinimum(0);
   HWorld2.SetMaximum(0.15);
   ...
   HMH2->Draw("hist same");
   Legend.Draw();
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections1.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections1.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections1.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections1.pdf");

   HWorld2.Draw();
   HM11->Draw("error same");
   HM12->Draw("hist same");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections2.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections2.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections2.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections2.pdf");

   HWorld3.Draw();
   HM21->Draw("error same");
   HM22->Draw("hist same");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections3.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections3.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections3.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections3.pdf");

   HWorld4.Draw();
   HPhi01->Draw("error same");
   HPhi02->Draw("hist same");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections4.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections4.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections4.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections4.pdf");

   HWorld5.Draw();
   HCosTheta01->Draw("error same");
   HCosTheta02->Draw("hist same");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections5.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections5.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections5.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections5.pdf");

   HWorld6.Draw();
   HPhi1->Draw("error same");
   HPhi2->Draw("hist same");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections6.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections6.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections6.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections6.pdf");

   HWorld7.Draw();
   HCosTheta11->Draw("error same");
   HCosTheta12->Draw("hist same");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections7.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections7.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections7.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections7.pdf");

   HWorld8.Draw();
   HCosTheta21->Draw("error same");
   HCosTheta22->Draw("hist same");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections8.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections8.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections8.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections8.pdf");

   HWorld9.Draw();
   HPhiH1->Draw("error same");
   HPhiH2->Draw("hist same");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections9.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections9.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections9.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections9.pdf");

   HWorld10.Draw();
   HPTH1->Draw("error same");
   HPTH2->Draw("hist same");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections10.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections10.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections10.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections10.pdf");

   HWorld11.Draw();
   HYH1->Draw("error same");
   HYH2->Draw("hist same");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections11.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections11.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections11.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections11.pdf");

   HWorld12.Draw();
   HPhiOffset1->Draw("error same");
   HPhiOffset2->Draw("hist same");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections12.png");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections12.C");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections12.eps");
   C.SaveAs("MultiDimensionalValidation-Likelihood-BackgroundProjections12.pdf");
