...
int main(int argc, char *argv[])
{
   ...
   string Labels[] = {"A_{1}^{ZZ} / A_{1}^{ZZ}", "A_{2}^{ZZ} / A_{1}^{ZZ}",
      "A_{3}^{ZZ} / A_{1}^{ZZ}", "A_{2}^{Z#gamma} / A_{1}^{ZZ}",
      "A_{3}^{Z#gamma} / A_{1}^{ZZ}", "A_{2}^{#gamma#gamma} / A_{1}^{ZZ}",
      "A_{3}^{#gamma#gamma} / A_{1}^{ZZ}", "F_{B}"};
   ...
   for(int iN = 0; iN < 2; iN++)
   {
      for(int iF = 0; iF < 2; iF++)
      {
         ...
         for(int iC = 1; iC <= 8; iC++)
         {
            ...
            C.SaveAs(Form("Plots/CoolPlot%s_%s_%s_%s_%d.png", (DoO ? "O" : ""), argv[2], NNString.c_str(), FString.c_str(), iC));
            C.SaveAs(Form("Plots/CoolPlot%s_%s_%s_%s_%d.eps", (DoO ? "O" : ""), argv[2], NNString.c_str(), FString.c_str(), iC));
            C.SaveAs(Form("Plots/CoolPlot%s_%s_%s_%s_%d.C",   (DoO ? "O" : ""), argv[2], NNString.c_str(), FString.c_str(), iC));
            C.SaveAs(Form("Plots/CoolPlot%s_%s_%s_%s_%d.pdf", (DoO ? "O" : ""), argv[2], NNString.c_str(), FString.c_str(), iC));
