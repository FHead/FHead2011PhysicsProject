...
int main()
{
   ...
   TFile F1("CMSSignal.root");
   TFile F2("SmearedSignal.root");
   TFile F3("ResultTree_30000.root");
   ...
   T1->SetAlias("Cut", "Channel == 1");
   T2->SetAlias("Cut", "(min(min(L1PT, L2PT), min(L3PT, L4PT)) > 7 && (max(max(L1PT,L2PT),max(L3PT,L4PT))) > 20 && (max(max(max(L1PT+L2PT,L1PT+L3PT),max(L1PT+L4PT,L2PT+L3PT)),max(L2PT+L4PT,L3PT+L4PT))) > 30 && MH > 115 && MH < 135 && M1 > 40 && M2 > 12 && abs(L1Eta) < 2.4 && abs(L2Eta) < 2.4 && abs(L3Eta) < 2.4 && abs(L4Eta) < 2.4) * Weight * MH * MH * MH * MH * MH * MH * MH * MH");
   T3->SetAlias("Cut", "(min(min(L1PT, L2PT), min(L3PT, L4PT)) > 7 && (max(max(L1PT,L2PT),max(L3PT,L4PT))) > 20 && (max(max(max(L1PT+L2PT,L1PT+L3PT),max(L1PT+L4PT,L2PT+L3PT)),max(L2PT+L4PT,L3PT+L4PT))) > 30 && MH > 115 && MH < 135 && M1 > 40 && M2 > 12 && abs(L1Eta) < 2.4 && abs(L2Eta) < 2.4 && abs(L3Eta) < 2.4 && abs(L4Eta) < 2.4) * Weight * MH * MH * MH * MH * MH * MH * MH * MH");

   int BinCount = 50;
   TH1D *HMH1 = new TH1D("HMH1", "", BinCount, 115, 135);   HMH1->Sumw2();
   TH1D *HMH2 = new TH1D("HMH2", "", BinCount, 115, 135);   HMH2->Sumw2();
   TH1D *HMH3 = new TH1D("HMH3", "", BinCount, 115, 135);   HMH3->Sumw2();
   TH1D *HM11 = new TH1D("HM11", "", BinCount, 40, 100);   HM11->Sumw2();
   TH1D *HM12 = new TH1D("HM12", "", BinCount, 40, 100);   HM12->Sumw2();
   TH1D *HM13 = new TH1D("HM13", "", BinCount, 40, 100);   HM13->Sumw2();
   TH1D *HM21 = new TH1D("HM21", "", BinCount, 12, 70);   HM21->Sumw2();
   TH1D *HM22 = new TH1D("HM22", "", BinCount, 12, 70);   HM22->Sumw2();
   TH1D *HM23 = new TH1D("HM23", "", BinCount, 12, 70);   HM23->Sumw2();
   ...
   Y1 = ThesisNDCMappingRegularX(0.85);
   X2 = ThesisNDCMappingRegularX(0.85);
   Y2 = ThesisNDCMappingRegularX(0.65);
   ...
   Legend.AddEntry(HMH1, "CMS sample", "lp");
   ...
   HMH3->Draw("hist same");
   Legend.Draw();
   C.SaveAs("DetectorParameterization-Validation-Projections1.png");
   C.SaveAs("DetectorParameterization-Validation-Projections1.C");
   C.SaveAs("DetectorParameterization-Validation-Projections1.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections1.pdf");

   HWorld2.Draw();
   HM11->Draw("error same");
   HM12->Draw("hist same");
   HM13->Draw("hist same");
   C.SaveAs("DetectorParameterization-Validation-Projections2.png");
   C.SaveAs("DetectorParameterization-Validation-Projections2.C");
   C.SaveAs("DetectorParameterization-Validation-Projections2.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections2.pdf");

   HWorld3.Draw();
   HM21->Draw("error same");
   HM22->Draw("hist same");
   HM23->Draw("hist same");
   C.SaveAs("DetectorParameterization-Validation-Projections3.png");
   C.SaveAs("DetectorParameterization-Validation-Projections3.C");
   C.SaveAs("DetectorParameterization-Validation-Projections3.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections3.pdf");

   HWorld4.Draw();
   HPhi01->Draw("error same");
   HPhi02->Draw("hist same");
   C.SaveAs("DetectorParameterization-Validation-Projections4.png");
   C.SaveAs("DetectorParameterization-Validation-Projections4.C");
   C.SaveAs("DetectorParameterization-Validation-Projections4.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections4.pdf");

   HWorld5.Draw();
   HCosTheta01->Draw("error same");
   HCosTheta02->Draw("hist same");
   C.SaveAs("DetectorParameterization-Validation-Projections5.png");
   C.SaveAs("DetectorParameterization-Validation-Projections5.C");
   C.SaveAs("DetectorParameterization-Validation-Projections5.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections5.pdf");

   HWorld6.Draw();
   HPhi1->Draw("error same");
   HPhi2->Draw("hist same");
   C.SaveAs("DetectorParameterization-Validation-Projections6.png");
   C.SaveAs("DetectorParameterization-Validation-Projections6.C");
   C.SaveAs("DetectorParameterization-Validation-Projections6.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections6.pdf");

   HWorld7.Draw();
   HCosTheta11->Draw("error same");
   HCosTheta12->Draw("hist same");
   C.SaveAs("DetectorParameterization-Validation-Projections7.png");
   C.SaveAs("DetectorParameterization-Validation-Projections7.C");
   C.SaveAs("DetectorParameterization-Validation-Projections7.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections7.pdf");

   HWorld8.Draw();
   HCosTheta21->Draw("error same");
   HCosTheta22->Draw("hist same");
   C.SaveAs("DetectorParameterization-Validation-Projections8.png");
   C.SaveAs("DetectorParameterization-Validation-Projections8.C");
   C.SaveAs("DetectorParameterization-Validation-Projections8.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections8.pdf");

   HWorld9.Draw();
   HPhiH1->Draw("error same");
   HPhiH2->Draw("hist same");
   C.SaveAs("DetectorParameterization-Validation-Projections9.png");
   C.SaveAs("DetectorParameterization-Validation-Projections9.C");
   C.SaveAs("DetectorParameterization-Validation-Projections9.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections9.pdf");

   HWorld10.Draw();
   HPTH1->Draw("error same");
   HPTH2->Draw("hist same");
   C.SaveAs("DetectorParameterization-Validation-Projections10.png");
   C.SaveAs("DetectorParameterization-Validation-Projections10.C");
   C.SaveAs("DetectorParameterization-Validation-Projections10.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections10.pdf");

   HWorld11.Draw();
   HYH1->Draw("error same");
   HYH2->Draw("hist same");
   C.SaveAs("DetectorParameterization-Validation-Projections11.png");
   C.SaveAs("DetectorParameterization-Validation-Projections11.C");
   C.SaveAs("DetectorParameterization-Validation-Projections11.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections11.pdf");

   HWorld12.Draw();
   HPhiOffset1->Draw("error same");
   HPhiOffset2->Draw("hist same");
   C.SaveAs("DetectorParameterization-Validation-Projections12.png");
   C.SaveAs("DetectorParameterization-Validation-Projections12.C");
   C.SaveAs("DetectorParameterization-Validation-Projections12.eps");
   C.SaveAs("DetectorParameterization-Validation-Projections12.pdf");
