...
int main(int argc, char *argv[])
{
   ...
   Calculator.SetMECalculator(CalculateA3ZARA3ZARSignal);
   Calculator.SetMECalculator(CalculateA3ZAIA3ZAISignal);
   Calculator.SetMECalculator(CalculateA2AARA2AARSignal);
   Calculator.SetMECalculator(CalculateA2AAIA2AAISignal);
   Calculator.SetMECalculator(CalculateA3AARA3AARSignal);
   Calculator.SetMECalculator(CalculateA3AAIA3AAISignal);
   Calculator.SetMECalculator(CalculateA2ZARA3ZARSignal);
   Calculator.SetMECalculator(CalculateA2ZARA3ZAISignal);
   Calculator.SetMECalculator(CalculateA2ZARA2AARSignal);
   Calculator.SetMECalculator(CalculateA2ZARA2AAISignal);
   Calculator.SetMECalculator(CalculateA2ZARA3AARSignal);
   Calculator.SetMECalculator(CalculateA2ZARA3AAISignal);
   Calculator.SetMECalculator(CalculateA3ZARA3ZAISignal);
   Calculator.SetMECalculator(CalculateA3ZARA2AARSignal);
   Calculator.SetMECalculator(CalculateA3ZARA2AAISignal);
   Calculator.SetMECalculator(CalculateA3ZARA3AARSignal);
   Calculator.SetMECalculator(CalculateA3ZARA3AAISignal);
   Calculator.SetMECalculator(CalculateA3ZAIA2AARSignal);
   Calculator.SetMECalculator(CalculateA3ZAIA2AAISignal);
   Calculator.SetMECalculator(CalculateA3ZAIA3AARSignal);
   Calculator.SetMECalculator(CalculateA3ZAIA3AAISignal);
   Calculator.SetMECalculator(CalculateA2AARA2AAISignal);
   Calculator.SetMECalculator(CalculateA2AARA3AARSignal);
   Calculator.SetMECalculator(CalculateA2AARA3AAISignal);
   Calculator.SetMECalculator(CalculateA2AAIA3AARSignal);
   Calculator.SetMECalculator(CalculateA2AAIA3AAISignal);
   Calculator.SetMECalculator(CalculateA3AARA3AAISignal);
