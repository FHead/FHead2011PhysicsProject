...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('__INPUTFILE__')
)
...
process.pfNoPileUpJME = cms.EDProducer("TPPFCandidatesOnPFCandidates",
    bottomCollection = cms.InputTag("PFCand"),
...
process.PFCandCHS = cms.EDFilter("CandPtrSelector", src = cms.InputTag("packedPFCandidates"), cut = cms.string("fromPV() > 1"))
# process.PFCand = cms.EDFilter("CandPtrSelector", src = cms.InputTag("packedPFCandidates"), cut = cms.string("1"))
...
process.ak4pfchs = cms.EDAnalyzer("JetResponseAnalyzer",
    ...
    srcPFCandidates = cms.InputTag("PFCandCHS"),
...
# process.pfNoPileUpJMETask = cms.Task(process.PFCand, process.goodOfflinePrimaryVertices, process.pfNoPileUpJME, process.pfPileUpJME)
process.pfNoPileUpJMETask = cms.Task(process.goodOfflinePrimaryVertices, process.PFCandCHS)
