...
process.GlobalTag.globaltag = cms.string('101X_dataRun2_v7')
...
try:
    ...
    inputFiles = cms.untracked.vstring(
          '/store/mc/RunIISummer18DR/QCD_Pt-15to7000_TuneCP5_Flat_13TeV_pythia8/AODSIM/FlatPU0to70_101X_upgrade2018_realistic_v7-v2/70000/FED6701D-586E-E811-B66E-0CC47A4D76A2.root'
	    )
...
if doProducer:
    ...
    process.TFileService.fileName=cms.string('/tmp/chenyi/JRA.root')
