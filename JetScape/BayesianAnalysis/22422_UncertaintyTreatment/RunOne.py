...
CommandList = ["python3", "MakeBaselinePlots.py", "--N", str(args.N), "--Nu", str(args.Nu), "--Model", args.Model, "--KernelChoice", args.KernelChoice, "--Alpha", str(args.Alpha), "--CovType", args.CovType]
