...
int main(int argc, char *argv[])
{
   ...
   TExec Exe1("Exe1", "double S1[2] = {0.000, 1.000}; double R1[2] = {1.000, 1.000}; double G1[2] = {1.000, 0.200}; double B1[2] = {1.000, 0.200}; TColor::CreateGradientColorTable(2, S1, R1, G1, B1, 99, 1.0);"); 
   TExec Exe2("Exe2", "double S1[2] = {0.000, 1.000}; double R1[2] = {1.000, 0.200}; double G1[2] = {1.000, 0.200}; double B1[2] = {1.000, 1.000}; TColor::CreateGradientColorTable(2, S1, R1, G1, B1, 99, 0.8);"); 
   TExec Exe3("Exe3", "double S1[2] = {0.000, 1.000}; double R1[2] = {1.000, 0.200}; double G1[2] = {1.000, 1.000}; double B1[2] = {1.000, 0.200}; TColor::CreateGradientColorTable(2, S1, R1, G1, B1, 99, 0.7);"); 
