...
int main(int argc, char *argv[])
{
   ...
   Latex.DrawLatex(PadX0 + PadX * 3, PadY0 + PadY + PadTop * 0.5, "#font[62]{JETSCAPE}");
   ...
   TExec Exe2("Exe2", "double S2[3] = {0.000, 0.200, 1.000}; double R2[3] = {1.000, 1.000, 1.000}; double G2[3] = {1.000, 0.300, 0.200}; double B2[3] = {1.000, 0.300, 0.200}; TColor::CreateGradientColorTable(3, S2, R2, G2, B2, 99, 1.0);");
