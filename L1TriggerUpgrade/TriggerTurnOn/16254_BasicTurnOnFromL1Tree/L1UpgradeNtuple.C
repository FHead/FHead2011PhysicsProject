...
{ 
   std::string FileName = "Result/" + FileBase;
   ...
   TFile *total=new TFile(FileName.c_str(), "RECREATE");
   ...
   TH1D *hTkEG12eta = new TH1D("htkeg12eta","",30, -3, 3);
   TH1D *hTkEG15eta = new TH1D("htkeg15eta","",30, -3, 3);
   TH1D *hTkEG20eta = new TH1D("htkeg20eta","",30, -3, 3);
   TH1D *hTkEG25eta = new TH1D("htkeg25eta","",30, -3, 3);
   TH1D *hTkEG30eta = new TH1D("htkeg30eta","",30, -3, 3);
   ...
   TH1D *hTkEM12eta = new TH1D("htkem12eta","",30, -3, 3);
   TH1D *hTkEM15eta = new TH1D("htkem15eta","",30, -3, 3);
   TH1D *hTkEM20eta = new TH1D("htkem20eta","",30, -3, 3);
   TH1D *hTkEM25eta = new TH1D("htkem25eta","",30, -3, 3);
   TH1D *hTkEM30eta = new TH1D("htkem30eta","",30, -3, 3);
   ...
   TH1D *hTkIsoEG12eta = new TH1D("hTkIsoeg12eta","",30, -3, 3);
   TH1D *hTkIsoEG15eta = new TH1D("hTkIsoeg15eta","",30, -3, 3);
   TH1D *hTkIsoEG20eta = new TH1D("hTkIsoeg20eta","",30, -3, 3);
   TH1D *hTkIsoEG25eta = new TH1D("hTkIsoeg25eta","",30, -3, 3);
   TH1D *hTkIsoEG30eta = new TH1D("hTkIsoeg30eta","",30, -3, 3);
         ...
         if (ipho==1) {
            if ( (photon.Pt()>2.) && (fabs(photon.Eta())<2.4) ) {
               ...
               if (iP>=0) {  // if found a match within 0.5
                  ...
                  if (l1upgrade_->tkEMEt.at(iP)>12.) hTkEM12eta->Fill(photon.Eta());
                  if (l1upgrade_->tkEMEt.at(iP)>15.) hTkEM15eta->Fill(photon.Eta());
                  if (l1upgrade_->tkEMEt.at(iP)>20.) hTkEM20eta->Fill(photon.Eta());
                  if (l1upgrade_->tkEMEt.at(iP)>25.) hTkEM25eta->Fill(photon.Eta());
                  if (l1upgrade_->tkEMEt.at(iP)>30.) hTkEM30eta->Fill(photon.Eta());
               }
            ...
            if (iEG>=0) {  // if found a match within 0.5
               ...
               if (l1upgrade_->tkEGEt.at(iEG)>12.) hTkEG12eta->Fill(electron.Eta());
               if (l1upgrade_->tkEGEt.at(iEG)>15.) hTkEG15eta->Fill(electron.Eta());
               if (l1upgrade_->tkEGEt.at(iEG)>20.) hTkEG20eta->Fill(electron.Eta());
               if (l1upgrade_->tkEGEt.at(iEG)>25.) hTkEG25eta->Fill(electron.Eta());
               if (l1upgrade_->tkEGEt.at(iEG)>30.) hTkEG30eta->Fill(electron.Eta());
            ...
            if (iEG>=0) { 
               ...
               if (l1upgrade_->tkIsoEGEt.at(iEG)>12.) hTkIsoEG12eta->Fill(electron.Eta());
               if (l1upgrade_->tkIsoEGEt.at(iEG)>15.) hTkIsoEG15eta->Fill(electron.Eta());
               if (l1upgrade_->tkIsoEGEt.at(iEG)>20.) hTkIsoEG20eta->Fill(electron.Eta());
               if (l1upgrade_->tkIsoEGEt.at(iEG)>25.) hTkIsoEG25eta->Fill(electron.Eta());
               if (l1upgrade_->tkIsoEGEt.at(iEG)>30.) hTkIsoEG30eta->Fill(electron.Eta());
            }
            // ----------------------------------------------------------------------------------------------
            ...
            hTkEG12eta->Sumw2(); hTkIsoEG12eta->Sumw2();
            hTkEG15eta->Sumw2(); hTkIsoEG15eta->Sumw2();
            hTkEG20eta->Sumw2(); hTkIsoEG20eta->Sumw2();
            hTkEG25eta->Sumw2(); hTkIsoEG25eta->Sumw2();
            hTkEG30eta->Sumw2(); hTkIsoEG30eta->Sumw2();

            hTkEMgen->Sumw2();hTkEMgeneta->Sumw2();hTkEM12->Sumw2();hTkEM15->Sumw2();hTkEM20->Sumw2();hTkEM25->Sumw2();hTkEM30->Sumw2();hTkEM12eta->Sumw2();hTkEM15eta->Sumw2();hTkEM20eta->Sumw2();hTkEM25eta->Sumw2();hTkEM30eta->Sumw2();
            ...
            hTkEM12eta->SetDirectory(dirEG);hTkEM15eta->SetDirectory(dirEG); hTkEM20eta->SetDirectory(dirEG);hTkEM25eta->SetDirectory(dirEG);hTkEM30eta->SetDirectory(dirEG);
            ...
            hTkEG12eta->SetDirectory(dirEG); hTkIsoEG12eta->SetDirectory(dirEG);
            hTkEG15eta->SetDirectory(dirEG); hTkIsoEG15eta->SetDirectory(dirEG);
            hTkEG20eta->SetDirectory(dirEG); hTkIsoEG20eta->SetDirectory(dirEG);
            hTkEG25eta->SetDirectory(dirEG); hTkIsoEG25eta->SetDirectory(dirEG);
            hTkEG30eta->SetDirectory(dirEG); hTkIsoEG30eta->SetDirectory(dirEG);
            // -----------------------------------------------------------------------
