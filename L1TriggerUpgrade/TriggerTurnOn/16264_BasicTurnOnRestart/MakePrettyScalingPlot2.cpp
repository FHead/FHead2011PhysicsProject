...
int main()
{
   ...
   TGraph *G140TylerLow = (TGraph *)File.Get("WENu140TylerLowA");
   TGraph *G140TylerHigh = (TGraph *)File.Get("WENu140TylerHighA");
   ...
   TLegend Legend(0.45, 0.15, 0.8, 0.4);
   Legend.SetTextFont(42);
   Legend.SetTextSize(0.035);
   Legend.SetFillStyle(0);
   Legend.AddEntry(G140, "Old (95%)", "pl");
   Legend.AddEntry(G140Tyler, "New (95%)", "pl");
   Legend.AddEntry(G140TylerLow, "New (|#eta| < 1.0, 90%)", "pl");
   Legend.AddEntry(G140TylerHigh, "New (|#eta| > 1.0, 60%)", "pl");
   Legend.Draw();
   ...
   Latex.DrawLatex(0.16, 0.70, Form("New (|#eta| < 1.0): %.2f + %.2f x", FLine.GetParameter(0), FLine.GetParameter(1)));
   
   G140TylerHigh->Fit(&FLine, "0");
   Latex.SetTextColor(kGreen);
   Latex.DrawLatex(0.16, 0.65, Form("New (|#eta| > 1.0): %.2f + %.2f x", FLine.GetParameter(0), FLine.GetParameter(1)));

   Canvas.SaveAs("PrettyScalingPlot2.png");
   Canvas.SaveAs("PrettyScalingPlot2.C");
   Canvas.SaveAs("PrettyScalingPlot2.eps");
   Canvas.SaveAs("PrettyScalingPlot2.pdf");
