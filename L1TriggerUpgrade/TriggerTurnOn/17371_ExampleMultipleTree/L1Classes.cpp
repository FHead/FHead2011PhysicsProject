...
#define R__DICTIONARY_FILENAME L1Classes
...
"/afs/cern.ch/work/c/chenyi/PhysicsWorkspace/L1TriggerUpgrade/TriggerTurnOn/17371_ExampleMultipleTree/",
0
    };
...
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisCSCTFDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisCSCTFDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisCaloTPDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisCaloTPDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisDTTFDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisDTTFDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisEventDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisEventDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisGCTDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisGCTDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisGMTDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisGMTDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisGTDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisGTDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisGeneratorDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisGeneratorDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisL1ExtraDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisL1ExtraDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisL1MenuDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisL1MenuDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisRCTDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisRCTDataFormat;}
namespace L1Analysis{class __attribute__((annotate("$clingAutoload$include/L1AnalysisRecoClusterDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisRecoClusterDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisRecoJetDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisRecoJetDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisRecoMetDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisRecoMetDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisRecoMuonDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisRecoMuonDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisRecoTrackDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisRecoTrackDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisRecoVertexDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisRecoVertexDataFormat;}
namespace L1Analysis{class __attribute__((annotate("$clingAutoload$include/L1AnalysisSimulationDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisSimulationDataFormat;}
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisL1ExtraUpgradeDataFormat.h")))  __attribute__((annotate("$clingAutoload$L1Classes.h")))  L1AnalysisL1ExtraUpgradeDataFormat;}
)DICTFWDDCLS";
