#ifndef MESSENGER_V10_21232
#define MESSENGER_V10_21232
...
#include "L1AnalysisPhaseIIDataFormatV10.h"
...
class L1PhaseIITreeV10Messenger;
...
public:
   ...
   ~L1PhaseIITreeV10Messenger();
   void SetBranchAddress();
   bool GetEntry(int Entry);
   vector<double> GetRegionFromEta(vector<double> &Eta);
   string Version() { return "V10"; }
