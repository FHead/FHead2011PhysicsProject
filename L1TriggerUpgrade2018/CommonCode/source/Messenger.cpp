...
L1PhaseIITreeV10Messenger::L1PhaseIITreeV10Messenger(TFile &File, string TreeName)
{
   Tree = (TTree *)File.Get(TreeName.c_str());
...
L1PhaseIITreeV10Messenger::~L1PhaseIITreeV10Messenger()
{
}
   
void L1PhaseIITreeV10Messenger::SetBranchAddress()
{
   if(Tree == NULL)
      return;
...
bool L1PhaseIITreeV10Messenger::GetEntry(int Entry)
{
   if(Tree == NULL)
      return false;
...
vector<double> L1PhaseIITreeV10Messenger::GetRegionFromEta(vector<double> &Eta)
{
