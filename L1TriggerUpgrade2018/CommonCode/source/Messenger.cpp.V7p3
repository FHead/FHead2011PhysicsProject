...
L1PhaseIITreeV7p3Messenger::L1PhaseIITreeV7p3Messenger(TFile &File, string TreeName)
{
   Tree = (TTree *)File.Get(TreeName.c_str());
...
L1PhaseIITreeV7p3Messenger::~L1PhaseIITreeV7p3Messenger()
{
}
   
void L1PhaseIITreeV7p3Messenger::SetBranchAddress()
{
   if(Tree == NULL)
      return;
...
bool L1PhaseIITreeV7p3Messenger::GetEntry(int Entry)
{
   if(Tree == NULL)
      return false;
   ...
   FillObject(TkTau, P->nTkTau,
      ...
      &P->tkTauBx, &P->tkTauTrkIso, &P->tkTauzVtx, &D0,
      &D0, &D0, &D0, &D0,
      &D0);
   ...
   FillObject(TkGlbMuon, P->nTkGlbMuons,
      ...
      &P->tkGlbMuonQuality, &D0, &D0, &P->tkGlbMuonChg,
      &D0);
   ...
   FillObject(TkMuon, P->nTkMuons,
      ...
      &P->tkMuonQuality, &P->tkMuonRegion, &D0, &P->tkMuonChg,
      &D0);
   ...
   FillObject(TkMuonStub, P->nTkMuonStubs,
      ...
      &P->tkMuonStubsQuality, &P->tkMuonStubsRegion, &D0, &P->tkMuonStubsChg,
      &D0);
