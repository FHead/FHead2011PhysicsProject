...
double FitTurnOn(PdfFileHelper &PdfFile, TH1D *H1, TH1D *H2, double Target = TARGET,
   bool tanh = false, bool noweight = false);
...
double FitTurnOn(PdfFileHelper &PdfFile, TH1D *H1, TH1D *H2, double Target, bool tanh, bool noweight)
{
   cout << H1 << " " << H2 << endl;
   ...
   Fit.SetParameters(0.3, 50, 0.02, 1.0);
