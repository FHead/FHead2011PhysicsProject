...
int main(int argc, char *argv[])
{
   ...
   TDirectory *EGElectronLargeDRDirectory = OutputFile.mkdir("EGElectronLargeDR", "EG (Electron)");
   TDirectory *EGPhotonLargeDRDirectory = OutputFile.mkdir("EGPhotonLargeDR", "EG (Photon)");
   TDirectory *TkEGLargeDRDirectory     = OutputFile.mkdir("TkEGLargeDR",     "TkEG (Electron)");
   TDirectory *TkEMLargeDRDirectory     = OutputFile.mkdir("TkEMLargeDR",     "TkEM (Photon)");
   ...
   Histograms HEGElectronNoMatch  (75,  0, 150,  30, -3.5, 3.5, 200, 0, 5.0, EGThresholds,    "EGElectronNoMatch");

   Histograms HEGPhoton           (75,  0, 150,  30, -3.5, 3.5, 200, 0, 5.0, EGThresholds,    "EGPhoton");
   Histograms HEGPhotonNoMatch    (75,  0, 150,  30, -3.5, 3.5, 200, 0, 5.0, EGThresholds,    "EGPhotonNoMatch");
   ...
   Histograms HTkEMNoMatch        (75,  0, 150,  30, -3.5, 3.5, 200, 0, 0.8, EGThresholds,    "TkEMNoMatch");
   ...
   Histograms HTkEMIsoNoMatch     (75,  0, 150,  30, -3.5, 3.5, 200, 0, 0.8, EGThresholds,    "TkEMIsoNoMatch");
   ...
   Histograms HTkIsoEMIsoNoMatch  (75,  0, 150,  30, -3.5, 3.5, 200, 0, 0.8, EGThresholds,    "TkIsoEMIsoNoMatch");

   Histograms HEGElectronLargeDR        (75,  0, 150,  30, -3.5, 3.5, 200, 0, 2.5, EGThresholds,    "EGElectronLargeDR");
   Histograms HEGElectronLargeDRNoMatch (75,  0, 150,  30, -3.5, 3.5, 200, 0, 2.5, EGThresholds,    "EGElectronLargeDRNoMatch");

   Histograms HEGPhotonLargeDR        (75,  0, 150,  30, -3.5, 3.5, 200, 0, 0.8, EGThresholds,    "EGPhotonLargeDR");
   Histograms HEGPhotonLargeDRNoMatch (75,  0, 150,  30, -3.5, 3.5, 200, 0, 0.8, EGThresholds,    "EGPhotonDRNoMatch");

   Histograms HTkEGLargeDR        (75,  0, 150,  30, -3.5, 3.5, 200, 0, 2.5, EGThresholds,    "TkEGLargeDR");
   Histograms HTkEGLargeDRNoMatch (75,  0, 150,  30, -3.5, 3.5, 200, 0, 2.5, EGThresholds,    "TkEGLargeDRNoMatch");

   Histograms HTkEMLargeDR        (75,  0, 150,  30, -3.5, 3.5, 200, 0, 0.8, EGThresholds,    "TkEMLargeDR");
   Histograms HTkEMLargeDRNoMatch (75,  0, 150,  30, -3.5, 3.5, 200, 0, 0.8, EGThresholds,    "TkEMLargeDRNoMatch");
   ...
   for(string InputFileName : InputFileNames)
   {
      ...
      for(int iE = 0; iE < EntryCount; iE++)
      {
         ...
         GenericObject BestL1EGElectron      = BestInRange(MPhaseII.EG,          BestElectron,      2.4, 0.2, QUAL_ODD);
         GenericObject BestL1EGPhoton        = BestInRange(MPhaseII.EG,          BestPhoton,        2.4, 0.2, QUAL_ODD);
         GenericObject BestL1TkEG            = BestInRange(MPhaseII.TkEG,        BestElectron,      2.4, 0.2, QUAL_ODD);
         GenericObject BestL1TkEM            = BestInRange(MPhaseII.TkEM,        BestPhoton,        2.4, 0.2, QUAL_ODD);
         GenericObject BestL1TkEGIso         = BestInRange(MPhaseII.TkEG,        BestElectron,      2.4, 0.2, QUAL_ODD);
         GenericObject BestL1TkEMIso         = BestInRange(MPhaseII.TkEM,        BestPhoton,        2.4, 0.2, QUAL_ODD);
         
         GenericObject BestL1EGElectronLargeDR = BestInRange(MPhaseII.EG,        BestElectron,      2.4, 0.8, QUAL_ODD);
         GenericObject BestL1EGPhotonLargeDR = BestInRange(MPhaseII.EG,          BestPhoton,        2.4, 0.8, QUAL_ODD);
         GenericObject BestL1TkEGLargeDR     = BestInRange(MPhaseII.TkEG,        BestElectron,      2.4, 0.8, QUAL_ODD);
         GenericObject BestL1TkEMLargeDR     = BestInRange(MPhaseII.TkEM,        BestPhoton,        2.4, 0.8, QUAL_ODD);
         ...
         FillHistograms(HEGElectron,     HEGElectronNoMatch,   BestL1EGElectron.P,  BestElectron,    BestL1EGElectron.Iso);
         FillHistograms(HEGPhoton,       HEGPhotonNoMatch,     BestL1EGPhoton.P,    BestPhoton,      BestL1EGPhoton.Iso);
         ...
         if((BestL1TkEG.P.GetAbsEta() < 1.5 && BestL1TkEG.Iso < 0.12) || (BestL1TkEG.P.GetAbsEta() > 1.5 && BestL1TkEG.Iso < 0.30))
         FillHistograms(HTkIsoEGIso,     HTkIsoEGIsoNoMatch,   BestL1TkEG.P,        BestIsoElectron, BestL1TkEG.Iso);
         if((BestL1TkEM.P.GetAbsEta() < 1.5 && BestL1TkEM.Iso < 0.28) || (BestL1TkEM.P.GetAbsEta() > 1.5 && BestL1TkEM.Iso < 0.36))
         FillHistograms(HTkIsoEMIso,     HTkIsoEMIsoNoMatch,   BestL1TkEM.P,        BestIsoPhoton,   BestL1TkEM.Iso);
         FillHistograms(HEGElectronLargeDR,    HEGElectronLargeDRNoMatch,  BestL1EGElectronLargeDR.P, BestElectron,    BestL1EGElectronLargeDR.Iso);
         FillHistograms(HEGPhotonLargeDR,    HEGPhotonLargeDRNoMatch,  BestL1EGPhotonLargeDR.P, BestPhoton,      BestL1EGPhotonLargeDR.Iso);
         FillHistograms(HTkEGLargeDR,    HTkEGLargeDRNoMatch,  BestL1TkEGLargeDR.P, BestElectron,    BestL1TkEGLargeDR.Iso);
         FillHistograms(HTkEMLargeDR,    HTkEMLargeDRNoMatch,  BestL1TkEMLargeDR.P, BestPhoton,      BestL1TkEMLargeDR.Iso);
   ...
   HEGElectronNoMatch.Write(EGElectronDirectory);
   HEGPhoton.Write(EGPhotonDirectory);
   HEGPhotonNoMatch.Write(EGPhotonDirectory);
   ...
   HEGElectronLargeDR.Write(EGElectronLargeDRDirectory);
   HEGElectronLargeDRNoMatch.Write(EGElectronLargeDRDirectory);
   HEGPhotonLargeDR.Write(EGPhotonLargeDRDirectory);
   HEGPhotonLargeDRNoMatch.Write(EGPhotonLargeDRDirectory);
   HTkEGLargeDR.Write(TkEGLargeDRDirectory);
   HTkEGLargeDRNoMatch.Write(TkEGLargeDRDirectory);
   HTkEMLargeDR.Write(TkEMLargeDRDirectory);
   HTkEMLargeDRNoMatch.Write(TkEMLargeDRDirectory);
