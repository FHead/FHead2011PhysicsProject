...
int main(int argc, char *argv[])
{
   ...
   Histograms HTkMuon         (75,  0, 150,  30, -2.5, 2.5, 200, 0, 5.0, MuonThresholds, "TkMuon");
   ...
   Histograms HTkMuonIso      (75,  0, 150,  30, -2.5, 2.5, 200, 0, 5.0, MuonThresholds, "TkMuonIso");
   ...
   for(string InputFileName : InputFileNames)
   {
      ...
      L1PhaseIITreeV3p2Messenger MPhaseII(File, "l1PhaseIITree/L1PhaseIITree");
      ...
      for(int iE = 0; iE < EntryCount; iE++)
      {
         ...
         FillHistograms(HTkEGLoose,       BestL1TkEGLoose.P,      BestElectron,      BestL1TkEGLoose.Iso);
         ...
         FillHistograms(HTkEGLooseIso,    BestL1TkEGLoose.P,      BestIsoElectron,   BestL1TkEGLoose.Iso);
         ...
         FillHistograms(HTkIsoEGLooseIso, BestL1TkEGLoose.P,      BestIsoElectron,   BestL1TkEGLoose.Iso);
         if(PassL1TkEMIso)
         ...
         FillHistograms(HTkEGLooseLDR,    BestL1TkEGLooseLDR.P,   BestElectron,      BestL1TkEGLooseLDR.Iso);
