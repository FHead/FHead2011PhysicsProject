...
int main(int argc, char *argv[])
{
   ...
   bool DoMBOReport = CL.GetBool("DoMBOReport", false);
   ...
   {
      PdfFile.AddTextPage("DR Plots");
      AddSimplePlot(PdfFile, File, "TkMuonBOLargeDR/TkMuonBOLargeDR_DR_000000");
      PdfFile.AddTextPage("Efficiency Plots");
      AddEfficiencyPlot(PdfFile, File, "TkMuonBOIso/TkMuonBOIso_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonBOIso/TkMuonBOIso_EtaPT30_000000");
   }
   if(DoE == true)
   {
