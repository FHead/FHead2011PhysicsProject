...
int main(int argc, char *argv[])
{
   ...
   if(DoMuon == true)
   {
      ProcessFile(PdfFile, InputFileName, "MuonIso",      MuonThresholds, Reference, "MuonIso",   "PT", TYPE_FIT);
      ProcessFile(PdfFile, InputFileName, "MuonKFIso",    MuonThresholds, Reference, "MuonKFIso", "PT", TYPE_SMOOTH_TIGHT);
      ...
      ProcessFile(PdfFile, InputFileName, "TkMuonBOIso",  MuonThresholds, Reference, "TkMuonBOIso", "PT", TYPE_SMOOTH_TIGHT);
   ...
   if(DoE == true)
   {
      ...
      ProcessFile(PdfFile, InputFileName, "TkEGIso",      EGThresholds,   Reference, "TkEG",      "PT", TYPE_SMOOTH_TIGHT);
      ProcessFile(PdfFile, InputFileName, "TkEGIso",      EGThresholds,   Reference, "TkEG",      "PTEta15", TYPE_SMOOTH_TIGHT);
      ProcessFile(PdfFile, InputFileName, "TkEGIso",      EGThresholds,   Reference, "TkEG",      "PTEtaLarge", TYPE_SMOOTH_TIGHT);
      ProcessFile(PdfFile, InputFileName, "TkIsoEGIso",   EGThresholds,   Reference, "TkIsoEG",   "PT", TYPE_SMOOTH_TIGHT);
      ProcessFile(PdfFile, InputFileName, "TkIsoEGIso",   EGThresholds,   Reference, "TkIsoEG",   "PTEta15", TYPE_SMOOTH_TIGHT);
      ProcessFile(PdfFile, InputFileName, "TkIsoEGIso",   EGThresholds,   Reference, "TkIsoEG",   "PTEtaLarge", TYPE_SMOOTH_TIGHT);
      ProcessFile(PdfFile, InputFileName, "TkEGIso",      EGThresholds,   Reference, "TkEG",      "PT", TYPE_FIT);
      ProcessFile(PdfFile, InputFileName, "TkEGIso",      EGThresholds,   Reference, "TkEG",      "PTEta15", TYPE_FIT);
      ProcessFile(PdfFile, InputFileName, "TkEGIso",      EGThresholds,   Reference, "TkEG",      "PTEtaLarge", TYPE_FIT);
      ProcessFile(PdfFile, InputFileName, "TkIsoEGIso",   EGThresholds,   Reference, "TkIsoEG",   "PT", TYPE_FIT);
      ProcessFile(PdfFile, InputFileName, "TkIsoEGIso",   EGThresholds,   Reference, "TkIsoEG",   "PTEta15", TYPE_FIT);
      ProcessFile(PdfFile, InputFileName, "TkIsoEGIso",   EGThresholds,   Reference, "TkIsoEG",   "PTEtaLarge", TYPE_FIT);
   }
   if(DoG == true)
   {
   ...
   if(DoTau == true)
   {
      ...
      ProcessFile(PdfFile, InputFileName, "PFTau",        TauThresholds, Reference, "PFTau", "PT", TYPE_SMOOTH_TIGHT);
      ProcessFile(PdfFile, InputFileName, "PFTau",        TauThresholds, Reference, "PFTau", "PT", TYPE_FITFLOAT);
   }
