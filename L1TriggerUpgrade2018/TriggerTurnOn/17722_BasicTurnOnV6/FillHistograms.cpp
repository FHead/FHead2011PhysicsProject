...
int main(int argc, char *argv[])
{
   ...
   TDirectory *TkMuonBDirectory          = OutputFile.mkdir("TkMuonB",            "TkMuon (Muon, non-EMTF)");
   TDirectory *TkMuonODirectory          = OutputFile.mkdir("TkMuonO",            "TkMuon (Muon, non-EMTF)");
   ...
   TDirectory *TkMuonBIsoDirectory       = OutputFile.mkdir("TkMuonBIso",         "TkMuonB (Isolated muon)");
   TDirectory *TkMuonOIsoDirectory       = OutputFile.mkdir("TkMuonOIso",         "TkMuonO (Isolated muon)");
   ...
   TDirectory *TkMuonBLDRDirectory       = OutputFile.mkdir("TkMuonBLargeDR",     "TkMuonB (Muon)");
   TDirectory *TkMuonOLDRDirectory       = OutputFile.mkdir("TkMuonOLargeDR",     "TkMuonO (Muon)");
   ...
   TDirectory *PFIsoTauDirectory         = OutputFile.mkdir("PFIsoTau",           "PFIsoTau (Tau)");
   ...
   TDirectory *PFIsoTauLDRDirectory      = OutputFile.mkdir("PFIsoTauLargeDR",    "PFIsoTau (Tau)");
   ...
   for(string InputFileName : InputFileNames)
   {
      ...
      L1PhaseIITreeV6p3Messenger MPhaseII(File, "l1PhaseIITree/L1PhaseIITree");
      ...
      for(int iE = 0; iE < EntryCount; iE++)
      {
         ...
         GenericObject BestL1TkMuonB        = BestInRange(MPhaseII.TkMuon,      BestMuon,          2.4, 0.1, Qual, 1);
         GenericObject BestL1TkMuonO        = BestInRange(MPhaseII.TkMuon,      BestMuon,          2.4, 0.1, Qual, 2);
         ...
         GenericObject BestL1TkMuonBIso     = BestInRange(MPhaseII.TkMuon,      BestIsoMuon,       2.4, 0.1, Qual, 1);
         GenericObject BestL1TkMuonOIso     = BestInRange(MPhaseII.TkMuon,      BestIsoMuon,       2.4, 0.1, Qual, 2);
         ...
         GenericObject BestL1TkMuonBLDR     = BestInRange(MPhaseII.TkMuon,      BestMuon,          2.4, 1.0, Qual, 1);
         GenericObject BestL1TkMuonOLDR     = BestInRange(MPhaseII.TkMuon,      BestMuon,          2.4, 1.0, Qual, 2);
         ...
         GenericObject BestL1PFTau          = BestInRange(MPhaseII.PFTau,       BestTau,           2.1, 0.3, Qual);
         ...
         GenericObject BestL1PFTauLDR       = BestInRange(MPhaseII.PFTau,       BestTau,           2.1, 1.0, Qual);
