...
int main(int argc, char *argv[])
{
   ...
   {
      PdfFile.AddTextPage("DR Plots");
      AddSimplePlot(PdfFile, File, "TkMuonELargeDR/TkMuonELargeDR_DR_000000");
      PdfFile.AddTextPage("Efficiency Plots");
      AddEfficiencyPlot(PdfFile, File, "TkMuonEIso/TkMuonEIso_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonEIso/TkMuonEIso_EtaPT30_000000");
   }
   if(DoMBReport == true)
   {
      PdfFile.AddTextPage("DR Plots");
      AddSimplePlot(PdfFile, File, "TkMuonBLargeDR/TkMuonBLargeDR_DR_000000");
      PdfFile.AddTextPage("Efficiency Plots");
      AddEfficiencyPlot(PdfFile, File, "TkMuonBIso/TkMuonBIso_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonBIso/TkMuonBIso_EtaPT30_000000");
   }
   if(DoMOReport == true)
   {
      PdfFile.AddTextPage("DR Plots");
      AddSimplePlot(PdfFile, File, "TkMuonOLargeDR/TkMuonOLargeDR_DR_000000");
      PdfFile.AddTextPage("Efficiency Plots");
      AddEfficiencyPlot(PdfFile, File, "TkMuonOIso/TkMuonOIso_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonOIso/TkMuonOIso_EtaPT30_000000");
   }
   if(DoE == true)
   {
      ...
      AddEfficiencyPlot(PdfFile, File, "TkIsoEGIso/TkIsoEGIso_PT_000000",
                                       "TkEGIso/TkEGIsoNoMatch_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEGIso/TkIsoEGIso_PTEta15_000000",
                                       "TkEGIso/TkEGIsoNoMatch_PTEta15_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEGIso/TkIsoEGIso_PTEtaLarge_000000",
                                       "TkEGIso/TkEGIsoNoMatch_PTEtaLarge_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEGIso/TkIsoEGIso_Eta_000000",
                                       "TkEGIso/TkEGIsoNoMatch_Eta_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEGIso/TkIsoEGIso_EtaPT20_000000",
                                       "TkEGIso/TkEGIsoNoMatch_EtaPT20_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEGIso/TkIsoEGIso_EtaPT25_000000",
                                       "TkEGIso/TkEGIsoNoMatch_EtaPT25_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEGIso/TkIsoEGIso_EtaPT200_000000",
                                       "TkEGIso/TkEGIsoNoMatch_EtaPT200_000000");
   ...
   if(DoG == true)
   {
      ...
      AddEfficiencyPlot(PdfFile, File, "TkIsoEMIso/TkIsoEMIso_PT_000000",
                                       "TkEMIso/TkEMIsoNoMatch_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEMIso/TkIsoEMIso_PTEta15_000000",
                                       "TkEMIso/TkEMIsoNoMatch_PTEta15_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEMIso/TkIsoEMIso_PTEtaLarge_000000",
                                       "TkEMIso/TkEMIsoNoMatch_PTEtaLarge_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEMIso/TkIsoEMIso_Eta_000000",
                                       "TkEMIso/TkEMIsoNoMatch_Eta_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEMIso/TkIsoEMIso_EtaPT20_000000",
                                       "TkEMIso/TkEMIsoNoMatch_EtaPT20_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEMIso/TkIsoEMIso_EtaPT25_000000",
                                       "TkEMIso/TkEMIsoNoMatch_EtaPT25_000000");
      AddEfficiencyPlot(PdfFile, File, "TkIsoEMIso/TkIsoEMIso_EtaPT200_000000",
                                       "TkEMIso/TkEMIsoNoMatch_EtaPT200_000000");
      ...
      AddSimplePlot(PdfFile, File, "TkIsoEMLargeDR/TkIsoEMLargeDR_DR_000000");
      AddSimplePlot(PdfFile, File, "TkIsoEMLargeDR/TkIsoEMLargeDR_DRPT10_000000");
      AddSimplePlot(PdfFile, File, "TkIsoEMLargeDR/TkIsoEMLargeDR_DRPT20_000000");
      AddSimplePlot(PdfFile, File, "TkIsoEMLargeDR/TkIsoEMLargeDR_DREta15_000000");
      AddSimplePlot(PdfFile, File, "TkIsoEMLargeDR/TkIsoEMLargeDR_DRPT10Eta15_000000");
      AddSimplePlot(PdfFile, File, "TkIsoEMLargeDR/TkIsoEMLargeDR_DRPT20Eta15_000000");
      AddSimplePlot(PdfFile, File, "TkIsoEMLargeDR/TkIsoEMLargeDR_DREtaLarge_000000");
      AddSimplePlot(PdfFile, File, "TkIsoEMLargeDR/TkIsoEMLargeDR_DRPT10EtaLarge_000000");
      AddSimplePlot(PdfFile, File, "TkIsoEMLargeDR/TkIsoEMLargeDR_DRPT20EtaLarge_000000");
   }
   if(DoM == true)
   {
      PdfFile.AddTextPage("Gen Isolation Plots");
      ...
      AddEfficiencyPlot(PdfFile, File, "TkMuonIso/TkMuonIso_EtaPT3to5_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonIso/TkMuonIso_EtaPT3to10_000000");
   ...
   if(DoT == true)
   {
      ...
      PdfFile.AddTextPage("DR Plots");
      AddSimplePlot(PdfFile, File, "TauLargeDR/TauLargeDR_DR_000000");
      AddSimplePlot(PdfFile, File, "TauLargeDR/TauLargeDR_DRPT10_000000");
      AddSimplePlot(PdfFile, File, "TkTauLargeDR/TkTauLargeDR_DR_000000");
      AddSimplePlot(PdfFile, File, "TkTauLargeDR/TkTauLargeDR_DRPT10_000000");
      AddSimplePlot(PdfFile, File, "PFTauLargeDR/PFTauLargeDR_DR_000000");
      AddSimplePlot(PdfFile, File, "PFTauLargeDR/PFTauLargeDR_DRPT10_000000");
      AddSimplePlot(PdfFile, File, "PFIsoTauLargeDR/PFIsoTauLargeDR_DR_000000");
      AddSimplePlot(PdfFile, File, "PFIsoTauLargeDR/PFIsoTauLargeDR_DRPT10_000000");
      PdfFile.AddTextPage("Efficiency Plots");
