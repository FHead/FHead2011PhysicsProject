...
int BestIndexInRange(vector<GenericObject> &List, FourVector &Reference, double MinEta = -1, double MaxEta = 999, double DRMax = 0.5, int Qual = QUAL_NONE, int Type = -1);
GenericObject BestInRange(vector<GenericObject> &List, FourVector &Reference, double MinEta = -1, double MaxEta = 999, double DRMax = 0.5, int Qual = QUAL_NONE, int Type = -1, double IsoBB = -1, double IsoEC = -1);
