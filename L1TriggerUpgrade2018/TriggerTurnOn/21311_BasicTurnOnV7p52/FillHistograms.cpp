      ...
      for(int iE = 0; iE < EntryCount; iE++)
      {
         ...
         for(int i = 0; i < N; i++)
         {
            ...
            if(C.InputObject == "Gen")
               ...
               Best = BestInRange(MPhaseII.Jet, Ref, C.AbsEtaMin, C.AbsEtaMax, C.PTMin, C.DRCut, Quality, Range, C.IsolationBB, C.IsolationEC);
            ...
            else if(C.InputObject == "TkMuonStubS12")
               Best = BestInRange(MPhaseII.TkMuonStubS12, Ref, C.AbsEtaMin, C.AbsEtaMax, C.PTMin, C.DRCut, Quality, Range, C.IsolationBB, C.IsolationEC);
            ...
            else if(C.InputObject == "TkElectronPV")
            {
               ...
               Best = BestInRange(MPhaseII.Tau, Ref, C.AbsEtaMin, C.AbsEtaMax, C.PTMin, C.DRCut, Quality, Range, C.IsolationBB, C.IsolationEC);
