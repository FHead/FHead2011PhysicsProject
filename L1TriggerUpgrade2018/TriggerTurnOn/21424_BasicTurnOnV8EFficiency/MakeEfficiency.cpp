...
int main(int argc, char *argv[])
{
   ...
   {
      PdfFile.AddTextPage("TkMuonStubsS12");
      PdfFile.AddTextPage("DR Plots");
      AddSimplePlot(PdfFile, File, "TkMuonStubS12LDR_DR_000000");
      AddSimplePlot(PdfFile, File, "TkMuonStubS12LDR_DRPT10_000000");
      PdfFile.AddTextPage("Efficiency Plots");
      AddEfficiencyPlot(PdfFile, File, "TkMuonStubS12Iso_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonStubS12Iso_Eta_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonStubS12Iso_EtaPT15_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonStubS12Iso_EtaPT3to15_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonStubS12BarrelIso_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonStubS12BarrelIso_Eta_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonStubS12BarrelIso_EtaPT15_000000");
      AddEfficiencyPlot(PdfFile, File, "TkMuonStubS12BarrelIso_EtaPT3to15_000000");
   }
   if(DoEG == true)
   {
   ...
   {
      PdfFile.AddTextPage("PuppiJet (Min25)");
      PdfFile.AddTextPage("DR plots");
      AddSimplePlot(PdfFile, File, "PuppiJetLDR25_DR_000000");
      AddSimplePlot(PdfFile, File, "PuppiJetLDR25_DRPT50_000000");
      PdfFile.AddTextPage("Efficiency Plots");
      AddEfficiencyPlot(PdfFile, File, "PuppiJet25_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "PuppiJet25_Eta_000000");
      AddEfficiencyPlot(PdfFile, File, "PuppiJet25_EtaPT100_000000");
      AddEfficiencyPlot(PdfFile, File, "PuppiJetWide25_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "PuppiJetWide25_Eta_000000");
      AddEfficiencyPlot(PdfFile, File, "PuppiJetWide25_EtaPT100_000000");
      AddEfficiencyPlot(PdfFile, File, "PuppiJetForward25_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "PuppiJetForward25_Eta_000000");
      AddEfficiencyPlot(PdfFile, File, "PuppiJetForward25_EtaPT100_000000");
   }
   if(DoPuppiHT == true)
   {
   ...
   if(DoTkTau == true)
   {
      PdfFile.AddTextPage("TkTau");
      PdfFile.AddTextPage("DR plots");
      AddSimplePlot(PdfFile, File, "TkTauLDR_DR_000000");
      AddSimplePlot(PdfFile, File, "TkTauLDR_DRPT20_000000");
      AddSimplePlot(PdfFile, File, "TkTauLDR_DRPT50_000000");
      PdfFile.AddTextPage("Efficiency Plots");
      AddEfficiencyPlot(PdfFile, File, "TkTau_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "TkTau_Eta_000000");
      AddEfficiencyPlot(PdfFile, File, "TkTau_EtaPT30_000000");
   }
   if(DoCaloTkTau == true)
   {
      PdfFile.AddTextPage("CaloTkTau");
      PdfFile.AddTextPage("DR plots");
      AddSimplePlot(PdfFile, File, "CaloTkTauLDR_DR_000000");
      AddSimplePlot(PdfFile, File, "CaloTkTauLDR_DRPT20_000000");
      AddSimplePlot(PdfFile, File, "CaloTkTauLDR_DRPT50_000000");
      PdfFile.AddTextPage("Efficiency Plots");
      AddEfficiencyPlot(PdfFile, File, "CaloTkTau_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "CaloTkTau_Eta_000000");
      AddEfficiencyPlot(PdfFile, File, "CaloTkTau_EtaPT30_000000");
   }
   if(DoTkEGTau == true)
   {
      PdfFile.AddTextPage("TkEGTau");
      PdfFile.AddTextPage("DR plots");
      AddSimplePlot(PdfFile, File, "TkEGTauLDR_DR_000000");
      AddSimplePlot(PdfFile, File, "TkEGTauLDR_DRPT20_000000");
      AddSimplePlot(PdfFile, File, "TkEGTauLDR_DRPT50_000000");
      PdfFile.AddTextPage("Efficiency Plots");
      AddEfficiencyPlot(PdfFile, File, "TkEGTau_PT_000000");
      AddEfficiencyPlot(PdfFile, File, "TkEGTau_Eta_000000");
      AddEfficiencyPlot(PdfFile, File, "TkEGTau_EtaPT30_000000");
   }
