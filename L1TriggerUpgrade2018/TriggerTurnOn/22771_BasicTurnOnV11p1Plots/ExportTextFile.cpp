...
int main(int argc, char *argv[])
{
   DataHelper DHFile("CurvesV11p1.dh");
   
   ofstream OutputFile("ScalingsV11p1.txt");
   ...
   {
      PV("TkMuon", {"TkMuonB", "TkMuonQualO", "TkMuonE"}),
      PV("StandaloneMuon", {"StandaloneMuonIsoB", "StandaloneMuonQualIsoO", "StandaloneMuonIsoE"})
   };
