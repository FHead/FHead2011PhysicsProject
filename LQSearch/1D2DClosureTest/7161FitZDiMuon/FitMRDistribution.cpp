...
int main(int argc, char *argv[])
{
   ...
   CutsToTry.push_back(0.40 * 0.40);
   // CutsToTry.push_back(0.45 * 0.45);
   CutsToTry.push_back(0.50 * 0.50);
   CutsToTry.push_back(0.55 * 0.55);
   CutsToTry.push_back(0.60 * 0.60);
