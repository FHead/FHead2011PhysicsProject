...
void JetPTThresholdEfficiency(string InputFileName, string OutputBase)
{
   ...
   HPercentagePassTCHEL.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHEM.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHET.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHPL.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHPM.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHPT.Scale(1.0 / ProcessedEvent);
   
   HPercentagePassTCHELTCHEL.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHELTCHEM.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHELTCHET.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHELTCHPL.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHELTCHPM.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHELTCHPT.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHEMTCHEM.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHEMTCHET.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHEMTCHPL.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHEMTCHPM.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHEMTCHPT.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHETTCHET.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHETTCHPL.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHETTCHPM.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHETTCHPT.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHPLTCHPL.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHPLTCHPM.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHPLTCHPT.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHPMTCHPM.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHPMTCHPT.Scale(1.0 / ProcessedEvent);
   HPercentagePassTCHPTTCHPT.Scale(1.0 / ProcessedEvent);
