...
void JetPTThresholdEfficiency(string InputFileName, string OutputBase, double CrossSection)
{
   ...
   for(int iEntry = 1; iEntry <= EntryCount; iEntry++)
   {
      ...
      double GammaMRStar = Get2011MR(Groups[0], Groups[1]);
      double RStar = Get2011R(Groups[0], Groups[1], PFMET);
      HMRVsR.Fill(GammaMRStar, RStar);

      if(GammaMRStar > 400 && RStar > 0.5)
      {
   ...
   HCountPassTCHEL.Write();
   HCountPassTCHEM.Write();
   HCountPassTCHET.Write();
   HCountPassTCHPL.Write();
   HCountPassTCHPM.Write();
   HCountPassTCHPT.Write();
   
   HYieldPassTCHEL.Write();
   HYieldPassTCHEM.Write();
   HYieldPassTCHET.Write();
   HYieldPassTCHPL.Write();
   HYieldPassTCHPM.Write();
   HYieldPassTCHPT.Write();

   HCountPassTCHELTCHEL.Write();
   HCountPassTCHELTCHEM.Write();
   HCountPassTCHELTCHET.Write();
   HCountPassTCHELTCHPL.Write();
   HCountPassTCHELTCHPM.Write();
   HCountPassTCHELTCHPT.Write();
   HCountPassTCHEMTCHEM.Write();
   HCountPassTCHEMTCHET.Write();
   HCountPassTCHEMTCHPL.Write();
   HCountPassTCHEMTCHPM.Write();
   HCountPassTCHEMTCHPT.Write();
   HCountPassTCHETTCHET.Write();
   HCountPassTCHETTCHPL.Write();
   HCountPassTCHETTCHPM.Write();
   HCountPassTCHETTCHPT.Write();
   HCountPassTCHPLTCHPL.Write();
   HCountPassTCHPLTCHPM.Write();
   HCountPassTCHPLTCHPT.Write();
   HCountPassTCHPMTCHPM.Write();
   HCountPassTCHPMTCHPT.Write();
   HCountPassTCHPTTCHPT.Write();
   
   HYieldPassTCHELTCHEL.Write();
   HYieldPassTCHELTCHEM.Write();
   HYieldPassTCHELTCHET.Write();
   HYieldPassTCHELTCHPL.Write();
   HYieldPassTCHELTCHPM.Write();
   HYieldPassTCHELTCHPT.Write();
   HYieldPassTCHEMTCHEM.Write();
   HYieldPassTCHEMTCHET.Write();
   HYieldPassTCHEMTCHPL.Write();
   HYieldPassTCHEMTCHPM.Write();
   HYieldPassTCHEMTCHPT.Write();
   HYieldPassTCHETTCHET.Write();
   HYieldPassTCHETTCHPL.Write();
   HYieldPassTCHETTCHPM.Write();
   HYieldPassTCHETTCHPT.Write();
   HYieldPassTCHPLTCHPL.Write();
   HYieldPassTCHPLTCHPM.Write();
   HYieldPassTCHPLTCHPT.Write();
   HYieldPassTCHPMTCHPM.Write();
   HYieldPassTCHPMTCHPT.Write();
   HYieldPassTCHPTTCHPT.Write();
