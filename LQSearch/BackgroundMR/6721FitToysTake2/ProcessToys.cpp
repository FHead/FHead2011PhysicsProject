...
int main()
{
   ...
   TH1D HParameterAError("HParameterAError", "Error on parameter A distribution", 75, 0.00016, 0.00020);
   TH1D HParameterBError("HParameterBError", "Error on parameter B distribution", 75, 0.0012, 0.0016);
