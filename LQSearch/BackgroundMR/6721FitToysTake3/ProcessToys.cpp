...
int main()
{
   ...
   TH1D HParameterA("HParameterA", "Parameter A distribution", 75, 0.0025, 0.0065);
   TH1D HParameterB("HParameterB", "Parameter B distribution", 75, 0.04, 0.065);
   TH1D HParameterAError("HParameterAError", "Error on parameter A distribution", 75, 0.00030, 0.00042);
   TH1D HParameterBError("HParameterBError", "Error on parameter B distribution", 75, 0.0024, 0.0033);
