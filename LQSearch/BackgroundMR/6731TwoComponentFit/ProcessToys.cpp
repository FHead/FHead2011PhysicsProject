...
int main()
{
   ...
   DHFile2["A2"]["Mean"] = HParameterA2.GetFunction("gaus")->GetParameter(1);
   DHFile2["A2"]["MeanError"] = HParameterA2.GetFunction("gaus")->GetParError(1);
   DHFile2["A2"]["Sigma"] = HParameterA2.GetFunction("gaus")->GetParameter(2);
   DHFile2["A2"]["SigmaError"] = HParameterA2.GetFunction("gaus")->GetParError(2);
   DHFile2["A2Error"]["Mean"] = HParameterA2Error.GetFunction("gaus")->GetParameter(1);
   DHFile2["A2Error"]["MeanError"] = HParameterA2Error.GetFunction("gaus")->GetParError(1);
   DHFile2["A2Error"]["Sigma"] = HParameterA2Error.GetFunction("gaus")->GetParameter(2);
   DHFile2["A2Error"]["SigmaError"] = HParameterA2Error.GetFunction("gaus")->GetParError(2);
   DHFile2["A2Pull"]["Mean"] = HParameterA2Pull.GetFunction("gaus")->GetParameter(1);
   DHFile2["A2Pull"]["MeanError"] = HParameterA2Pull.GetFunction("gaus")->GetParError(1);
   DHFile2["A2Pull"]["Sigma"] = HParameterA2Pull.GetFunction("gaus")->GetParameter(2);
   DHFile2["A2Pull"]["SigmaError"] = HParameterA2Pull.GetFunction("gaus")->GetParError(2);
   DHFile2["B2"]["Mean"] = HParameterB2.GetFunction("gaus")->GetParameter(1);
   DHFile2["B2"]["MeanError"] = HParameterB2.GetFunction("gaus")->GetParError(1);
   DHFile2["B2"]["Sigma"] = HParameterB2.GetFunction("gaus")->GetParameter(2);
   DHFile2["B2"]["SigmaError"] = HParameterB2.GetFunction("gaus")->GetParError(2);
   DHFile2["B2Error"]["Mean"] = HParameterB2Error.GetFunction("gaus")->GetParameter(1);
   DHFile2["B2Error"]["MeanError"] = HParameterB2Error.GetFunction("gaus")->GetParError(1);
   DHFile2["B2Error"]["Sigma"] = HParameterB2Error.GetFunction("gaus")->GetParameter(2);
   DHFile2["B2Error"]["SigmaError"] = HParameterB2Error.GetFunction("gaus")->GetParError(2);
   DHFile2["B2Pull"]["Mean"] = HParameterB2Pull.GetFunction("gaus")->GetParameter(1);
   DHFile2["B2Pull"]["MeanError"] = HParameterB2Pull.GetFunction("gaus")->GetParError(1);
   DHFile2["B2Pull"]["Sigma"] = HParameterB2Pull.GetFunction("gaus")->GetParameter(2);
   DHFile2["B2Pull"]["SigmaError"] = HParameterB2Pull.GetFunction("gaus")->GetParError(2);
