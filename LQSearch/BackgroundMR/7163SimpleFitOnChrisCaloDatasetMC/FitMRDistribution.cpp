...
void FitWithRCut(string FileName, vector<double> RCuts, DataHelper &DHFile, string State,
...
int main(int argc, char *argv[])
{
   ...
   // FitWithRCut("Samples/Wjets.root", CutsToTry, DHFile, "WJets_Mu", 250, 3500, 3, false, -1);
   ...
   CutsToTry.push_back(0.25);
   CutsToTry.push_back(0.36);
   FitWithRCut("Samples/Wjets.root", CutsToTry, DHFile, "WJets_E", 250, 3500, 4, false, -1);
   
   CutsToTry.clear();
   CutsToTry.push_back(0.16);
   CutsToTry.push_back(0.25);
   CutsToTry.push_back(0.36);
   // FitWithRCut("Samples/Wjets.root", CutsToTry, DHFile, "WJets_E_LowStart", 150, 3500, 4, false, -1);
   ...
   CutsToTry.push_back(0.25);
   CutsToTry.push_back(0.36);
   // FitWithRCut("Samples/Wjets.root", CutsToTry, DHFile, "WJets_Had", 250, 3500, 5, false, -1);
   ...
   int BoxNumber, bool OneComponent, int BTagRequirement)
{
   ...
   RooRealVar R("RSQ", "R^{2}", RCut, 200);
   RooRealVar BOX_NUM("BOX_NUM", "Box number", -100, 100);
   RooRealVar BTAG_NUM("BTAG_NUM", "BTag number", -100, 100);
   RooRealVar WPU("WPU", "WPU", -1000, 1000);
   RooArgSet TreeVarSet(MR, R, BOX_NUM, BTAG_NUM, WPU);
   ...
   // RooDataSet FullDataset("Dataset", "MR Dataset", Tree, TreeVarSet, "", "WPU");
   ...
   if(OneComponent == true)
      Component1.fitTo(*Dataset, Range("FitRange"), SumW2Error(false));
   else
      Model->fitTo(*Dataset, Range("FitRange"), SumW2Error(false));
   ...
   RooPlot *FinalResultPlot = MR.frame(Bins(50), Name("FitResults"), Title(""), AutoRange(*Dataset));
   ...
   double MRLowerBound, double MRUpperBound, int BoxNumber, bool OneComponent, int BTagRequirement)
{
   ...
   //    RCuts[0], BoxNumber, MRLowerBound, MRUpperBound, BTagString.c_str()), "WPU");
   RooDataSet Dataset("Dataset", "MR Dataset", Tree, TreeVarSet,
      Form("RSQ > %f && BOX_NUM == %d && MR > %f && MR < %f && %s",
   ...
   for(int i = 0; i < (int)RCuts.size(); i++)
   {
      ...
      Fraction.push_back(new RooRealVar(Form("Fraction_%d", i), Form("Fraction_%d", i),
         1 - SingleFitResults[i].F, 0.0, 1.0));
   ...
   RooPlot *FinalResultPlot2 = MR.frame(Bins(50), Name("FitResults2"), Title("MR, Simultaneous fit"), Range(250, 2000));
   ...
   TLegend legend(0.75, 0.95, 0.95, 0.65);
   ...
   FinalResultCanvas2.SaveAs("MRSimultaneousFitComparison.png");
   FinalResultCanvas2.SaveAs("MRSimultaneousFitComparison.C");
   FinalResultCanvas2.SaveAs("MRSimultaneousFitComparison.eps");
   ...
   ABBand1Canvas.SaveAs("ABBand1Canvas.png");
   ABBand1Canvas.SaveAs("ABBand1Canvas.C");
   ABBand1Canvas.SaveAs("ABBand1Canvas.eps");
   ...
   ABBand2Canvas.SaveAs("ABBand2Canvas.png");
   ABBand2Canvas.SaveAs("ABBand2Canvas.C");
   ABBand2Canvas.SaveAs("ABBand2Canvas.eps");
   ...
   RatioBandCanvas1.SaveAs("RatioBandCanvas1.png");
   RatioBandCanvas1.SaveAs("RatioBandCanvas1.C");
   RatioBandCanvas1.SaveAs("RatioBandCanvas1.eps");
   ...
   RatioBandCanvas2.SaveAs("RatioBandCanvas2.png");
   RatioBandCanvas2.SaveAs("RatioBandCanvas2.C");
   RatioBandCanvas2.SaveAs("RatioBandCanvas2.eps");
