...
int main(int argc, char *argv[])
{
   ...
   CutsToTry.push_back(0.33);
   CutsToTry.push_back(0.36);
   CutsToTry.push_back(0.40);
   CutsToTry.push_back(0.43);

   PsFileHelper PsFile("DataFit.ps");
   PsFile.AddTextPage("Fit data in the muon box");
   FitWithRCut(PsFile, "DataAll.root", CutsToTry);
   PsFile.AddTimeStampPage();
   PsFile.Close();

   PsFileHelper PsFile2("TTbarFit.ps");
   PsFile2.AddTextPage("Fit ttbar in the muon box");
   FitWithRCut(PsFile2, "TTbar.root", CutsToTry);
