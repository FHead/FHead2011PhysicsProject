...
int main(int argc, char *argv[])
{
   ...
   RooPlot ParameterABPlot1(0.008, 0.016, 0, 0.02);
   RooPlot ParameterABPlot2(0.000, 0.012, 0, 0.02);
...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts)
{
   ...
   RooRealVar ParameterA1("ParameterA1", "s1 = \"a1\" + b1 R^2", 0.010, 0.009, 0.011);
   RooRealVar ParameterB1("ParameterB1", "s1 = a1 + \"b1\" R^2", 0.060, 0.059, 0.061);
   ...
   RooRealVar ParameterA2("ParameterA2", "s2 = \"a2\" + b2 R^2", 0.006, 0, 1);
   RooRealVar ParameterB2("ParameterB2", "s2 = a2 + \"b2\" R^2", 0.0168, 0, 1);
