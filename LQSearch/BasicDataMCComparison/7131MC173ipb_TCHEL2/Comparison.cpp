...
void ReadSample(string Input, string OutputBase, double CrossSection, double Luminosity)
{
   ...
   TH1D HPFJetGammaMRStar_RStar025("HPFJetGammaMRStar_RStar025",
      "MR*** from calo system (RStar > 0.25);MR*** (GeV/c^2)", 40, 0, 2000);
   TH1D HPFJetGammaMRStar_RStar03("HPFJetGammaMRStar_RStar03",
      "MR*** from calo system (RStar > 0.3);MR*** (GeV/c^2)", 40, 0, 2000);
   TH1D HPFJetGammaMRStar_RStar038("HPFJetGammaMRStar_RStar038",
      "MR*** from calo system (RStar > 0.38);MR*** (GeV/c^2)", 40, 0, 2000);
   TH1D HPFJetGammaMRStar_RStar04("HPFJetGammaMRStar_RStar04",
      "MR*** from calo system (RStar > 0.4);MR*** (GeV/c^2)", 40, 0, 2000);
   TH1D HPFJetGammaMRStar_RStar043("HPFJetGammaMRStar_RStar043",
      "MR*** from calo system (RStar > 0.43);MR*** (GeV/c^2)", 40, 0, 2000);
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      if(RStar > 0.25)
         HPFJetGammaMRStar_RStar025.Fill(MRStar * GammaRStar, Factor);
      if(RStar > 0.3)
         HPFJetGammaMRStar_RStar03.Fill(MRStar * GammaRStar, Factor);
      if(RStar > 0.38)
         HPFJetGammaMRStar_RStar038.Fill(MRStar * GammaRStar, Factor);
      if(RStar > 0.4)
         HPFJetGammaMRStar_RStar04.Fill(MRStar * GammaRStar, Factor);
      if(RStar > 0.43)
         HPFJetGammaMRStar_RStar043.Fill(MRStar * GammaRStar, Factor);
      if(RStar > 0.5)
   ...
   HPFJetGammaMRStar_RStar025.Write();
   HPFJetGammaMRStar_RStar03.Write();
   HPFJetGammaMRStar_RStar038.Write();
   HPFJetGammaMRStar_RStar04.Write();
   HPFJetGammaMRStar_RStar043.Write();
   ...
   PsFile.AddPlot(HPFJetGammaMRStar_RStar025, "", true);
   PsFile.AddPlot(HPFJetGammaMRStar_RStar03, "", true);
   PsFile.AddPlot(HPFJetGammaMRStar_RStar038, "", true);
   PsFile.AddPlot(HPFJetGammaMRStar_RStar04, "", true);
   PsFile.AddPlot(HPFJetGammaMRStar_RStar043, "", true);
