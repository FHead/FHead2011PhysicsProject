...
int main()
{
   ...
   ReadSample("NewSamples/DoubleMuMay10ReRecov1_All.root", "DataPlots", -1, 240.1);
...
void ReadSample(string Input, string OutputBase, double CrossSection, double Luminosity)
{
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      if(M.GoodMuonCountTight < 2)   // two tight muons!
         continue;
      ...
      FourVector Muon2P;
      Muon1P.SetPtEtaPhiMass(M.Muon2PT, M.Muon2Eta, M.Muon2Phi, 0.104);
