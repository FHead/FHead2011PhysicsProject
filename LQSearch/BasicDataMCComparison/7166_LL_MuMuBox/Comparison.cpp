...
int main()
{
   ...
   ReadSample("Samples/DoubleMuMay10ReRecov1_All_New.root", "DataPlotsNew", -1, 240.1);
   ...
   // ReadSample("Samples/VVJetsTo4L_TuneD6T_7TeV-madgraph-tauola_All.root", "VV", 42.39, 240.1);   // Production
   // ReadSample("Samples/PhotonVJets_7TeV-madgraph_All.root", "GammaVJet", 173, 240.1);   // Production
   // ReadSample("Samples/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_All.root", "DY50", 3048, 240.1);   // NNLO
   // ReadSample("Samples/ZinvisibleJets_7TeV-madgraph_All.root", "Znunu", 3048 * 6, 240.1);   // guessed
   // ReadSample("Samples/QCD_TuneD6T_HT-50To100_7TeV-madgraph_All.root", "QCD1", 30000000, 240.1);   // production
   // ReadSample("Samples/QCD_TuneD6T_HT-100To250_7TeV-madgraph_All.root", "QCD2", 7000000, 240.1);   // production
   // ReadSample("Samples/QCD_TuneD6T_HT-250To500_7TeV-madgraph_All.root", "QCD3", 171000, 240.1);   // production
   // ReadSample("Samples/QCD_TuneD6T_HT-500To1000_7TeV-madgraph_All.root", "QCD4", 5200, 240.1);   // production
   // ReadSample("Samples/QCD_TuneD6T_HT-1000_7TeV-madgraph_All.root", "QCD5", 83, 240.1);   // production
}
