...
int main()
{
   ...
   /*
   ReadSample("SamplesSuperNew/MuHadRun2011Av4_All.root", "DataPlotsPart1", -1, 545.8);
   ReadSample("SamplesNew/MuHadRun2011Av4_166864_167746_All.root", "DataPlotsPart2", -1, 267.8);
   ReadSample("Samples/TTJets_TuneZ2_7TeV-madgraph-tauola_All.root", "TTbar", 165, 813.6);   // NNLL
   ReadSample("Samples/WJetsToLNu_TuneZ2_7TeV-madgraph-tauola_All.root", "W", 31314, 813.6);   // NNLO
   ReadSample("Samples/VVJetsTo4L_TuneD6T_7TeV-madgraph-tauola_All.root", "VV", 42.39, 813.6);   // Production
   ReadSample("Samples/PhotonVJets_7TeV-madgraph_All.root", "GammaVJet", 173, 813.6);   // Production
   ReadSample("Samples/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_All.root", "DY50", 3048, 813.6);   // NNLO
   ReadSample("Samples/ZinvisibleJets_7TeV-madgraph_All.root", "Znunu", 3048 * 6, 813.6);   // guessed
   ReadSample("Samples/QCD_TuneD6T_HT-50To100_7TeV-madgraph_All.root", "QCD1", 30000000, 813.6);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-100To250_7TeV-madgraph_All.root", "QCD2", 7000000, 813.6);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-250To500_7TeV-madgraph_All.root", "QCD3", 171000, 813.6);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-500To1000_7TeV-madgraph_All.root", "QCD4", 5200, 813.6);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-1000_7TeV-madgraph_All.root", "QCD5", 83, 813.6);   // production
   */
   ReadSample("SamplesNewW/WENu.root", "WENu", 789.9, 813.6);   // pythia
   ReadSample("SamplesNewW/WMuNu.root", "WMuNu", 789.9, 813.6);   // pythia
   ReadSample("SamplesNewW/WTauNu.root", "WTauNu", 789.9, 813.6);   // pythia
}
...
void ReadSample(string Input, string OutputBase, double CrossSection, double Luminosity)
{
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      if(M.GoodMuonCountTight < 1)   // tight muon!!!
         continue;
      if(M.Muon1PT < 20)
         continue;
      ...
      if(BTagLooseCount < 2)   // double loose
         continue;
