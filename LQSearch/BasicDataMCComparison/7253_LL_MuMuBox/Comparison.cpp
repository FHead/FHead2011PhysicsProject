...
int main()
{
   ...
   ReadSample("Samples/DoubleMuMay10ReRecov1_All.root", "DataPlotsReReco", -1, 176.311);
   ReadSample("Samples/DoubleMuRun2011Av4_All.root", "DataPlotsPrompt", -1, 363.672);
   ReadSample("Samples/TTJets_TuneZ2_7TeV-madgraph-tauola_All.root", "TTbar", 165, 539.983);   // NNLL
   ReadSample("Samples/WJetsToLNu_TuneZ2_7TeV-madgraph-tauola_All.root", "W", 31314, 539.983);   // NNLO
   ReadSample("Samples/VVJetsTo4L_TuneD6T_7TeV-madgraph-tauola_All.root", "VV", 4.8, 539.983);   // Production
   ReadSample("Samples/PhotonVJets_7TeV-madgraph_All.root", "GammaVJet", 173, 539.983);   // Production
   ReadSample("Samples/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_All.root", "DY50", 3048, 539.983);   // NNLO
   ReadSample("Samples/ZinvisibleJets_7TeV-madgraph_All.root", "Znunu", 3048 * 6, 539.983);   // guessed
   ReadSample("Samples/QCD_TuneD6T_HT-50To100_7TeV-madgraph_All.root", "QCD1", 30000000, 539.983);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-100To250_7TeV-madgraph_All.root", "QCD2", 7000000, 539.983);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-250To500_7TeV-madgraph_All.root", "QCD3", 171000, 539.983);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-500To1000_7TeV-madgraph_All.root", "QCD4", 5200, 539.983);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-1000_7TeV-madgraph_All.root", "QCD5", 83, 539.983);   // production
}
...
void ReadSample(string Input, string OutputBase, double CrossSection, double Luminosity)
{
   ...
   TH1D HMRNew("HMRNew", "MR (new);MR (new) (GeV/c^2)", 50, 0, 1000);
   TH1D HR2New("HR2New", "R^{2} (new);R^{2} (new)", 50, 0, 1);
   TH1D HMRNew_RNew02("HMRNew_RNew02",
      "MR (new) (R (new) > 0.2);MR (new) (GeV/c^2)", 50, 0, 1000);
   TH1D HMRNew_RNew03("HMRNew_RNew03",
      "MR (new) (R (new) > 0.3);MR (new) (GeV/c^2)", 50, 0, 1000);
   TH1D HMRNew_RNew04("HMRNew_RNew04",
      "MR (new) (R (new) > 0.4);MR (new) (GeV/c^2)", 50, 0, 1000);
   TH1D HMRNew_RNew05("HMRNew_RNew05",
      "MR (new) (R (new) > 0.5);MR (new) (GeV/c^2)", 50, 0, 1000);
   TH1D HMRNew_RNew06("HMRNew_RNew06",
      "MR (new) (R (new) > 0.6);MR (new) (GeV/c^2)", 50, 0, 1000);
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      // if(M.GoodMuonCountTight < 1 || M.Muon1PT < 20 || M.GoodMuonCountLoose < 2 || M.Muon2PT < 10)
      //    continue;
      
      if(M.GoodMuonCountTight < 1 || M.Muon1PT < 20 || M.GoodMuonCountLoose < 2 || M.Muon2PT < 20)
         continue;

      if(M.GoodElectronCount80 >= 1 && M.Electron1PT > 20)   // tight electron, 20 GeV
         continue;

      int LooseCount = 0;
      for(int i = 0; i < M.CaloJetCount && i < 100; i++)
         if(M.CaloJetPT[i] > 80 && fabs(M.CaloJetEta[i]) < 3 && M.CaloJetTCHETag[i] > 1.7)
