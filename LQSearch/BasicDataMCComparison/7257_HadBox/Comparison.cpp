...
int main()
{
   ...
   ReadSample("Samples/HTRun2011Av4_All.root", "DataPlots", -1, 863.339);
   ReadSample("Samples/TTJets_TuneZ2_7TeV-madgraph-tauola_All.root", "TTbar", 165, 863.339);   // NNLL
   ReadSample("Samples/WJetsToLNu_TuneZ2_7TeV-madgraph-tauola_All.root", "W", 31314, 863.339);   // NNLO
   ReadSample("Samples/VVJetsTo4L_TuneD6T_7TeV-madgraph-tauola_All.root", "VV", 4.8, 863.339);   // Production
   ReadSample("Samples/PhotonVJets_7TeV-madgraph_All.root", "GammaVJet", 173, 863.339);   // Production
   ReadSample("Samples/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_All.root", "DY50", 3048, 863.339);   // NNLO
   ReadSample("Samples/ZinvisibleJets_7TeV-madgraph_All.root", "Znunu", 3048 * 6, 863.339);   // guessed
   ReadSample("Samples/QCD_TuneD6T_HT-50To100_7TeV-madgraph_All.root", "QCD1", 30000000, 863.339);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-100To250_7TeV-madgraph_All.root", "QCD2", 7000000, 863.339);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-250To500_7TeV-madgraph_All.root", "QCD3", 171000, 863.339);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-500To1000_7TeV-madgraph_All.root", "QCD4", 5200, 863.339);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-1000_7TeV-madgraph_All.root", "QCD5", 83, 863.339);   // production
}
...
void ReadSample(string Input, string OutputBase, double CrossSection, double Luminosity)
{
   ...
   TH1D HMRNew_RNew02("HMRNew_RNew02",
      "MR (new) (R (new) > 0.2, R^{2} (new) < 0.5);MR (new) (GeV/c^2)", 50, 0, 1000);
   TH1D HMRNew_RNew03("HMRNew_RNew03",
      "MR (new) (R (new) > 0.3, R^{2} (new) < 0.5);MR (new) (GeV/c^2)", 50, 0, 1000);
   TH1D HMRNew_RNew04("HMRNew_RNew04",
      "MR (new) (R (new) > 0.4, R^{2} (new) < 0.5);MR (new) (GeV/c^2)", 50, 0, 1000);
   TH1D HMRNew_RNew05("HMRNew_RNew05",
      "MR (new) (R (new) > 0.5, R^{2} (new) < 0.5);MR (new) (GeV/c^2)", 50, 0, 1000);
   TH1D HMRNew_RNew06("HMRNew_RNew06",
      "MR (new) (R (new) > 0.6, R^{2} (new) < 0.5);MR (new) (GeV/c^2)", 50, 0, 1000);
