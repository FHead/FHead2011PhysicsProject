...
int main()
{
   ...
   ReadSample("Samples/LQ200.root", "LQ200", 11.9, 1752.753);   // production
   ReadSample("Samples/LQ250.root", "LQ200", 3.47, 1752.753);   // production
   ReadSample("Samples/LQ350.root", "LQ200", 0.477, 1752.753);   // production
}
