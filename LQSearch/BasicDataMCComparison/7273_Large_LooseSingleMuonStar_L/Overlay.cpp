...
int main()
{
   ...
   Labels.push_back("Data (1767 pb^{-1})");
   ...
   OverlayHistogram(PsFile, Files, Labels, "HMRNew_RNew06");
   ...
   OverlayHistogram(PsFile, Files, Labels, "HMegaJetDeltaPhi_MRNew400_R2New050Up");
