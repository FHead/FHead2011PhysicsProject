...
void ReadSample(string Input, string OutputBase, double CrossSection, double Luminosity)
{
   ...
   TH1D HMRNew_RNew02("HMRNew_RNew02",
      "MR (new) (R^{2} (new) > 0.04, R^{2} (new) < 0.5);MR (new) (GeV/c^2)", 50, 0, 1500);
   TH1D HMRNew_RNew03("HMRNew_RNew03",
      "MR (new) (R^{2} (new) > 0.09, R^{2} (new) < 0.5);MR (new) (GeV/c^2)", 50, 0, 1500);
   TH1D HMRNew_RNew04("HMRNew_RNew04",
      "MR (new) (R^{2} (new) > 0.16, R^{2} (new) < 0.5);MR (new) (GeV/c^2)", 50, 0, 1500);
   TH1D HMRNew_RNew05("HMRNew_RNew05",
      "MR (new) (R^{2} (new) > 0.25, R^{2} (new) < 0.5);MR (new) (GeV/c^2)", 50, 0, 1500);
   TH1D HMRNew_RNew06("HMRNew_RNew06",
      "MR (new) (R^{2} (new) > 0.36, R^{2} (new) < 0.5);MR (new) (GeV/c^2)", 50, 0, 1500);
   TH1D HMRNew_R2New020("HMRNew_R2New020",
      "MR (new) (R^{2} (new) > 0.20, R^{2} (new) < 0.5);MR (new) (GeV/c^2)", 50, 0, 1500);
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      if(MRNew > 300 && R2New > 0.09)
      {
         ...
         if(MRNew > 400 && R2New > 0.5)
            HMegaJetDeltaPhi_MRNew400_R2New050Up.Fill(MegaJetDeltaPhi);

         if(MegaJetDeltaPhi < 0.25 && MRNew > 400 && R2New > 0.25)
            cout << M.RunNumber << " " << (long long)M.EventNumber << " " << M.LumiSection << endl;
      }
