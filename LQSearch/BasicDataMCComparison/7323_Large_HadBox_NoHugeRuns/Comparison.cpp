...
int main()
{
   ...
   ReadSample("Samples/TTJets_TuneZ2_7TeV-madgraph-tauola_All.root", "TTbar", 165, 1583.514);   // NNLL
   ReadSample("Samples/AllWJetsToLNu_Added.root", "W", 31314, 1583.514);   // NNLO
   ReadSample("Samples/VVJetsTo4L_TuneD6T_7TeV-madgraph-tauola_All.root", "VV", 4.8, 1583.514);   // Production
   ReadSample("Samples/PhotonVJets_7TeV-madgraph_All.root", "GammaVJet", 173, 1583.514);   // Production
   ReadSample("Samples/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_All.root", "DY50", 3048, 1583.514);   // NNLO
   ReadSample("Samples/ZinvisibleJets_7TeV-madgraph_All.root", "Znunu", 3048 * 6, 1583.514);   // guessed
   ReadSample("Samples/QCD_TuneD6T_HT-50To100_7TeV-madgraph_All.root", "QCD1", 30000000, 1583.514);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-100To250_7TeV-madgraph_All.root", "QCD2", 7000000, 1583.514);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-250To500_7TeV-madgraph_All.root", "QCD3", 171000, 1583.514);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-500To1000_7TeV-madgraph_All.root", "QCD4", 5200, 1583.514);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-1000_7TeV-madgraph_All.root", "QCD5", 83, 1583.514);   // production
   ReadSample("Samples/LQ200.root", "LQ200", 11.9, 1583.514);   // production
   ReadSample("Samples/LQ250.root", "LQ250", 3.47, 1583.514);   // production
   ReadSample("Samples/LQ350.root", "LQ350", 0.477, 1583.514);   // production
   ReadSample("Samples/LQ450.root", "LQ450", 0.0949, 1583.514);   // production
}
...
void ReadSample(string Input, string OutputBase, double CrossSection, double Luminosity)
{
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      int Run = (int)(M.RunNumber + 0.0001);
      if(Run == 172791 || Run == 172822 || Run == 172868)
         continue;
