...
int main()
{
   ...
   ReadSample("Samples/ZinvisibleJets_7TeV-madgraph_All.root", "Znunu", 4500, 1752.853);   // guessed
   ...
   */
   ...
   ReadSample("LQSamples/LQToBNutau_340.list.root", "LQ340", 0.477, 1752.853);   // production
