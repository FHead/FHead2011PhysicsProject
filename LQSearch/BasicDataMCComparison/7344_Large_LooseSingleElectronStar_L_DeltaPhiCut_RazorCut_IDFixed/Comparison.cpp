...
int main()
{
   ...
   ReadSample("DataSamples/ElectronHadRun2011Av4_Aug05v1_Run2011AV6_All.root", "DataPlots", -1, 1741.100);
   ReadSample("Samples/TTJets_TuneZ2_7TeV-madgraph-tauola_All.root", "TTbar", 165, 1741.100);   // NNLL
   ReadSample("Samples/AllWJetsToLNu_Added.root", "W", 31314, 1741.100);   // NNLO
   ReadSample("Samples/VVJetsTo4L_TuneD6T_7TeV-madgraph-tauola_All.root", "VV", 4.8, 1741.100);   // Production
   ReadSample("Samples/PhotonVJets_7TeV-madgraph_All.root", "GammaVJet", 173, 1741.100);   // Production
   ReadSample("Samples/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_All.root", "DY50", 3048, 1741.100);   // NNLO
   ReadSample("Samples/ZinvisibleJets_7TeV-madgraph_All.root", "Znunu", 3048 * 6, 1741.100);   // guessed
   ReadSample("Samples/QCD_TuneD6T_HT-50To100_7TeV-madgraph_All.root", "QCD1", 30000000, 1741.100);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-100To250_7TeV-madgraph_All.root", "QCD2", 7000000, 1741.100);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-250To500_7TeV-madgraph_All.root", "QCD3", 171000, 1741.100);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-500To1000_7TeV-madgraph_All.root", "QCD4", 5200, 1741.100);   // production
   ReadSample("Samples/QCD_TuneD6T_HT-1000_7TeV-madgraph_All.root", "QCD5", 83, 1741.100);   // production
}
...
void ReadSample(string Input, string OutputBase, double CrossSection, double Luminosity)
{
   ...
   TH1D HMRNew_R2New020("HMRNew_R2New020",
      "MR (new) (R2 (new) > 0.2);MR (new) (GeV/c^2)", 50, 0, 1500);
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      {
         if(R2New > 0.09 && MRNew > 300 && MegaJetDeltaPhi > 0.25)
         {
            if(M.CaloJetCount > 0)
