...
void ReadSample(string Input, string OutputBase, double CrossSection, double Luminosity)
{
   ...
   TH1D HR2New("HR2New", "R^{2} (new);R^{2} (new)", 50, 0, 1);
   TH1D HMRNew_RNew02("HMRNew_RNew02",
      "MR (new) (R^{2} (new) > 0.04);MR (new) (GeV/c^2)", 50, 0, 1500);
   TH1D HMRNew_R2New020("HMRNew_R2New020",
      "MR (new) (R^{2} (new) > 0.20);MR (new) (GeV/c^2)", 50, 0, 1500);
   TH1D HMRNew_RNew03("HMRNew_RNew03",
      "MR (new) (R^{2} (new) > 0.09);MR (new) (GeV/c^2)", 50, 0, 1500);
   TH1D HMRNew_RNew04("HMRNew_RNew04",
      "MR (new) (R^{2} (new) > 0.16);MR (new) (GeV/c^2)", 50, 0, 1500);
   TH1D HMRNew_RNew05("HMRNew_RNew05",
      "MR (new) (R^{2} (new) > 0.25);MR (new) (GeV/c^2)", 50, 0, 1500);
   TH1D HMRNew_RNew06("HMRNew_RNew06",
      "MR (new) (R^{2} (new) > 0.36);MR (new) (GeV/c^2)", 50, 0, 1500);
   TH1D HPFMET("HPFMET", "PF MET distribution;MET (GeV)", 50, 0, 1000);
   ...
   HMuon1PT.Sumw2();
   HElectron1PT.Sumw2();
   HLeadingCaloJetPT.Sumw2();
   HSubLeadingCaloJetPT.Sumw2();
   HMRNew.Sumw2();
   HR2New.Sumw2();
   HMRNew_RNew02.Sumw2();
   HMRNew_RNew03.Sumw2();
   ...
   HPFMET.Sumw2();
   HMegaJetDeltaPhi.Sumw2();
   HMegaJetDeltaPhi_MRNew400_R2New016.Sumw2();
   HMegaJetDeltaPhi_MRNew400_R2New025.Sumw2();
   HMegaJetDeltaPhi_MRNew400_R2New050Up.Sumw2();
