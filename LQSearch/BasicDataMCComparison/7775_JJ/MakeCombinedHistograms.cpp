   ...
   for(int k = 0; k < 4; k++)   // LQ 550 is weird
   {
      for(int i = 1; i < 9; i++)
      {
         ...
         for(int j = 0; j < 8; j++)
         {
            ...
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2000_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2014_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2014Restricted_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2020_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2020Restricted_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2025_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2025Restricted_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2030_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2035_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2040_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2045_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HMRJJ_R2050_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);

            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HR2JJ_MR000_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HR2JJ_MR100_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HR2JJ_MR200_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HR2JJ_MR300_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HR2JJ_MR400_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HR2JJ_MR400Restricted_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HR2JJ_MR400Restricted2_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
            MakeOverlay(PsFile, MCFiles, DataFile, SignalFiles[k], "HR2JJ_MR500_" + Category[i] + "_" + BTag[j], Labels, Luminosity, LQMasses[k]);
