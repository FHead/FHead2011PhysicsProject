...
int main();
void ExportToPDF(string InputFile, string OutputBase, double CrossSection = -1);
...
int main()
{
   ...
   ExportToPDF("LQ350_Output.root", "LQ350");
   ExportToPDF("LQ450_Output.root", "LQ450");
}

void ExportToPDF(string InputFile, string OutputBase, double CrossSection)
{
