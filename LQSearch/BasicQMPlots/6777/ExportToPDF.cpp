...
int main()
{
   ...
   ExportToPDF("Samples/DoubleMuMay10ReRecov1_ALL.root", "DoubleMuon");
   /*
   ExportToPDF("Samples/LQ450_LQ3Tree.root", "LQ450");
   ExportToPDF("Samples/LQ350_LQ3Tree.root", "LQ350");
   ExportToPDF("Samples/DYJetsToLL_TuneD6T_M-10To50_7TeV-madgraph-tauola_all.root", "DY1050");
   ExportToPDF("Samples/DYJetsToLL_TuneD6T_M-50_7TeV-madgraph-tauola_all.root", "DY50");
   ExportToPDF("Samples/PhotonVJets_7TeV-madgraph_all.root", "PhotonVJets");
   ExportToPDF("Samples/TTJets_TuneZ2_7TeV-madgraph-tauola_all.root", "TTJets");
   ExportToPDF("Samples/WJetsToLNu_TuneZ2_7TeV-madgraph-tauola_all.root", "WJets");
   ExportToPDF("Samples/WWtoAnything_TuneZ2_7TeV-pythia6-tauola_all.root", "WW");
   ExportToPDF("Samples/WZtoAnything_TuneZ2_7TeV-pythia6-tauola_all.root", "WZ");
   ExportToPDF("Samples/ZZtoAnything_TuneZ2_7TeV-pythia6-tauola_all.root", "ZZ");
   */
}
