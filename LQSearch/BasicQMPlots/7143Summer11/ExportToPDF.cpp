...
int main()
{
   ...
   ExportToPDF("Samples/LQ550.root", "LQ550");
   ExportToPDF("Samples/LQ450.root", "LQ450");
   ExportToPDF("Samples/LQ350.root", "LQ350");
   ExportToPDF("Samples/LQ250.root", "LQ250");
   ExportToPDF("Samples/LQ200.root", "LQ200");
}
