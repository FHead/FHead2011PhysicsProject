...
int main()
{
   ...
   HGammaMRStar_RStar02_DiJetAve30.GetYaxis()->SetTitle("a.u.");
   ...
   HGammaMRStar_RStar03_DiJetAve30.GetYaxis()->SetTitle("a.u.");
   ...
   HGammaMRStar_RStar04_DiJetAve30.GetYaxis()->SetTitle("a.u.");
   ...
   HGammaMRStar_RStar05_DiJetAve30.GetYaxis()->SetTitle("a.u.");
