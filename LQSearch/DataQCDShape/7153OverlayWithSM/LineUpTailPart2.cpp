...
int main()
{
   ...
   InputTree.SetBranchAddress("LeadingJetDeltaPhi", &LeadingJetDeltaPhi);
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      if(fabs(LeadingJetDeltaPhi) < 0.2)
         continue;
   ...
   TH1D *HTTbar_GammaMRStar_RStar02 = (TH1D *)FTTbar.Get("HCaloJetGammaMRStar_RStar02");
   TH1D *HTTbar_GammaMRStar_RStar03 = (TH1D *)FTTbar.Get("HCaloJetGammaMRStar_RStar03");
   TH1D *HTTbar_GammaMRStar_RStar04 = (TH1D *)FTTbar.Get("HCaloJetGammaMRStar_RStar04");
   TH1D *HTTbar_GammaMRStar_RStar05 = (TH1D *)FTTbar.Get("HCaloJetGammaMRStar_RStar05");
   ...
   TH1D *HW_GammaMRStar_RStar02 = (TH1D *)FW.Get("HCaloJetGammaMRStar_RStar02");
   TH1D *HW_GammaMRStar_RStar03 = (TH1D *)FW.Get("HCaloJetGammaMRStar_RStar03");
   TH1D *HW_GammaMRStar_RStar04 = (TH1D *)FW.Get("HCaloJetGammaMRStar_RStar04");
   TH1D *HW_GammaMRStar_RStar05 = (TH1D *)FW.Get("HCaloJetGammaMRStar_RStar05");
   ...
   TH1D *HWW_GammaMRStar_RStar02 = (TH1D *)FWW.Get("HCaloJetGammaMRStar_RStar02");
   TH1D *HWW_GammaMRStar_RStar03 = (TH1D *)FWW.Get("HCaloJetGammaMRStar_RStar03");
   TH1D *HWW_GammaMRStar_RStar04 = (TH1D *)FWW.Get("HCaloJetGammaMRStar_RStar04");
   TH1D *HWW_GammaMRStar_RStar05 = (TH1D *)FWW.Get("HCaloJetGammaMRStar_RStar05");
   ...
   TH1D *HWZ_GammaMRStar_RStar02 = (TH1D *)FWZ.Get("HCaloJetGammaMRStar_RStar02");
   TH1D *HWZ_GammaMRStar_RStar03 = (TH1D *)FWZ.Get("HCaloJetGammaMRStar_RStar03");
   TH1D *HWZ_GammaMRStar_RStar04 = (TH1D *)FWZ.Get("HCaloJetGammaMRStar_RStar04");
   TH1D *HWZ_GammaMRStar_RStar05 = (TH1D *)FWZ.Get("HCaloJetGammaMRStar_RStar05");
   ...
   TH1D *HZZ_GammaMRStar_RStar02 = (TH1D *)FZZ.Get("HCaloJetGammaMRStar_RStar02");
   TH1D *HZZ_GammaMRStar_RStar03 = (TH1D *)FZZ.Get("HCaloJetGammaMRStar_RStar03");
   TH1D *HZZ_GammaMRStar_RStar04 = (TH1D *)FZZ.Get("HCaloJetGammaMRStar_RStar04");
   TH1D *HZZ_GammaMRStar_RStar05 = (TH1D *)FZZ.Get("HCaloJetGammaMRStar_RStar05");
   ...
   TH1D *HGammaJet_GammaMRStar_RStar02 = (TH1D *)FGammaJet.Get("HCaloJetGammaMRStar_RStar02");
   TH1D *HGammaJet_GammaMRStar_RStar03 = (TH1D *)FGammaJet.Get("HCaloJetGammaMRStar_RStar03");
   TH1D *HGammaJet_GammaMRStar_RStar04 = (TH1D *)FGammaJet.Get("HCaloJetGammaMRStar_RStar04");
   TH1D *HGammaJet_GammaMRStar_RStar05 = (TH1D *)FGammaJet.Get("HCaloJetGammaMRStar_RStar05");
   ...
   TH1D *HDY10_GammaMRStar_RStar02 = (TH1D *)FDY10.Get("HCaloJetGammaMRStar_RStar02");
   TH1D *HDY10_GammaMRStar_RStar03 = (TH1D *)FDY10.Get("HCaloJetGammaMRStar_RStar03");
   TH1D *HDY10_GammaMRStar_RStar04 = (TH1D *)FDY10.Get("HCaloJetGammaMRStar_RStar04");
   TH1D *HDY10_GammaMRStar_RStar05 = (TH1D *)FDY10.Get("HCaloJetGammaMRStar_RStar05");
   ...
   TH1D *HDY50_GammaMRStar_RStar02 = (TH1D *)FDY50.Get("HCaloJetGammaMRStar_RStar02");
   TH1D *HDY50_GammaMRStar_RStar03 = (TH1D *)FDY50.Get("HCaloJetGammaMRStar_RStar03");
   TH1D *HDY50_GammaMRStar_RStar04 = (TH1D *)FDY50.Get("HCaloJetGammaMRStar_RStar04");
   TH1D *HDY50_GammaMRStar_RStar05 = (TH1D *)FDY50.Get("HCaloJetGammaMRStar_RStar05");
   ...
   Explanations.push_back("Require basic hcal noise filter and Calo jet ID");
   Explanations.push_back("Stuff reconstructed with Calo jet (AK5Jet in vecbos) and Calo MET");
   ...
   TCanvas C1;
   HGammaMRStar_RStar02_DiJetAve30.SetTitle("QCD shape as reconstructed from different triggers (R (new) > 0.2)");
   HGammaMRStar_RStar02_DiJetAve30.GetXaxis()->SetTitle("MR (new)");
   ...
   HGammaMRStar_RStar02_DiJetAve300.Draw("point error same");
   HGammaMRStar_RStar02_DiJetAve370.Draw("point error same");
   TLegend Legend(0.7, 0.85, 0.85, 0.5);
   ...
   Legend.Draw();
   l.DrawLatex(0.37, 0.77, s_latex);
   l.DrawLatex(0.37, 0.64, s_lumi);
   C1.SetLogy();
   PsFile.AddCanvas(C1);
   
   TCanvas C1S("C1S", "", 1024, 1024);
   HGammaMRStar_RStar02_DiJetAve30.Draw("point error");
   HGammaMRStar_RStar02_DiJetAve60.Draw("point error same");
   HGammaMRStar_RStar02_DiJetAve80.Draw("point error same");
   HGammaMRStar_RStar02_DiJetAve110.Draw("point error same");
   ...
   l.DrawLatex(0.37, 0.64, s_lumi);
   C1S.SetLogy();
   C1S.SaveAs("QCDShapeRStar02.png");
   C1S.SaveAs("QCDShapeRStar02.C");
   C1S.SaveAs("QCDShapeRStar02.eps");
   C1S.SaveAs("QCDShapeRStar02.pdf");
   
   TCanvas C2;
   HGammaMRStar_RStar03_DiJetAve30.SetTitle("QCD shape as reconstructed from different triggers (R (new) > 0.3)");
   HGammaMRStar_RStar03_DiJetAve30.GetXaxis()->SetTitle("MR (new)");
   ...
   C2.SetLogy();
   PsFile.AddCanvas(C2);
   C2.SaveAs("QCDShapeRStar03.png");
   C2.SaveAs("QCDShapeRStar03.C");
   C2.SaveAs("QCDShapeRStar03.eps");
   C2.SaveAs("QCDShapeRStar03.pdf");

   TCanvas C3;
   HGammaMRStar_RStar04_DiJetAve30.SetTitle("QCD shape as reconstructed from different triggers (R (new) > 0.4)");
   HGammaMRStar_RStar04_DiJetAve30.GetXaxis()->SetTitle("MR (new)");
   ...
   l.DrawLatex(0.37, 0.64, s_lumi);
   C3S.SetLogy();
   C3S.SaveAs("QCDShapeRStar04.png");
   C3S.SaveAs("QCDShapeRStar04.C");
   C3S.SaveAs("QCDShapeRStar04.eps");
   C3S.SaveAs("QCDShapeRStar04.pdf");

   TCanvas C4;
   HGammaMRStar_RStar05_DiJetAve30.SetTitle("QCD shape as reconstructed from different triggers (R (new) > 0.5)");
   HGammaMRStar_RStar05_DiJetAve30.GetXaxis()->SetTitle("MR (new)");
   ...
   C4.SetLogy();
   PsFile.AddCanvas(C4);
   C4.SaveAs("QCDShapeRStar05.png");
   C4.SaveAs("QCDShapeRStar05.C");
   C4.SaveAs("QCDShapeRStar05.eps");
   C4.SaveAs("QCDShapeRStar05.pdf");
