...
void PeekLQDistributions(string InputLQMass)
{
   ...
   ExplanationText.push_back("Official samples!!!  (Summer11)");
   ExplanationText.push_back("/LQToBNutau_M-400_7TeV-pythia6/Summer11-START311_V2-v2/GEN-SIM");
   ...
   TableOfContentItems.push_back("Single LQ distributions");
   TableOfContentItems.push_back("LQ pair distributions");
   TableOfContentItems.push_back("Neutrino (from LQ) distributions");
   TableOfContentItems.push_back("Neutrino pair (from LQ) distributions");
   TableOfContentItems.push_back("Event-wise neutrino counts");
   TableOfContentItems.push_back("B quark from LQ distributions");
   TableOfContentItems.push_back("B quark pair from LQ distributions");
   TableOfContentItems.push_back("Visible generated jets");
   TableOfContentItems.push_back("Charged generated jets");
   TableOfContentItems.push_back("Visible jet that's closest to immediate b quark from LQ");
   TableOfContentItems.push_back("Charged jet that's closest to immediate b quark from LQ");
   TableOfContentItems.push_back("MR, R from all visible particles");
   TableOfContentItems.push_back("MR, R from leading two generated jets");
   TableOfContentItems.push_back("MR, R from leading two generated jets, smeared");
   TableOfContentItems.push_back("MR, R from leading two charged jets");
   TableOfContentItems.push_back("MR, R from generated immediate b quarks");

   vector<string> LocationMarkers;
   LocationMarkers.push_back("SingleLQ");
   LocationMarkers.push_back("LQPair");
   LocationMarkers.push_back("NeutrinoFromLQ");
   LocationMarkers.push_back("NuPairFromLQ");
   LocationMarkers.push_back("EventNu");
   LocationMarkers.push_back("BFromLQ");
   LocationMarkers.push_back("BPairFromLQ");
   LocationMarkers.push_back("VisibleJet");
   LocationMarkers.push_back("ChargedJet");
   LocationMarkers.push_back("ClosestGenJet");
   LocationMarkers.push_back("ClosestChargedJet");
   LocationMarkers.push_back("VisibleMR");
   LocationMarkers.push_back("LeadingJetMR");
   LocationMarkers.push_back("SmearedJetMR");
   LocationMarkers.push_back("ChargedJetMR");
   LocationMarkers.push_back("BQuarkMR");

   PsFile.AddTableOfContentPage(TableOfContentItems, LocationMarkers);
   PsFile.InsertNamedDestination("TableOfContentPage");
   PsFile.SetAutomaticHomeButton(true, "TableOfContentPage", 50, 50, 75);
   ...
   TH1D HLQPairMass("HLQPairMass", "LQPair Mass;Mass (GeV)", 100, 0, 2000);
   ...
   TH1D HLQPairBetaT("HLQPairBetaT", "LQPair Transverse Beta", 100, 0, 1);
   TH1D HLQPairGammaT("HLQPairGammaT", "LQPair Transverse Gamma", 100, 1, 5);
   TH1D HLQPairBetaZ("HLQPairBetaZ", "LQPair Longitudinal Beta", 100, 0, 1);
   TH1D HLQPairGammaZ("HLQPairGammaZ", "LQPair Longitudinal Gamma", 100, 1, 5);
   ...
   for(int iEvent = 0; iEvent < NumberOfEvents; iEvent++)
   {
      ...
      if(LQIndex >= 0 && LQbarIndex >= 0)
      {
         ...
         double LQPairTP[4] = {0, 0, 0, 0};
         LQPairTP[0] = sqrt(GetPT(LQPairP) * GetPT(LQPairP) + GetMass2(LQPairP));
         LQPairTP[1] = LQPairP[1];
         LQPairTP[2] = LQPairP[2];
         LQPairTP[3] = 0;

         HLQPairBetaT.Fill(GetBeta(LQPairTP));
         HLQPairGammaT.Fill(GetGamma(LQPairTP));
         
         double LQPairZP[4] = {0, 0, 0, 0};
         LQPairZP[0] = sqrt(LQPairP[3] * LQPairP[3] + GetMass2(LQPairP));
         LQPairZP[1] = 0;
         LQPairZP[2] = 0;
         LQPairZP[3] = LQPairP[3];

         HLQPairBetaZ.Fill(GetBeta(LQPairZP));
         HLQPairGammaZ.Fill(GetGamma(LQPairZP));
      }
   ...
   PsFile.InsertNamedDestination("SingleLQ");
   ...
   PsFile.InsertNamedDestination("LQPair");
   ...
   PsFile.AddPlot(HLQPairBetaT, "", true);
   PsFile.AddPlot(HLQPairGammaT, "", true);
   PsFile.AddPlot(HLQPairBetaZ, "", true);
   PsFile.AddPlot(HLQPairGammaZ, "", true);

   PsFile.AddTextPage("Neutrino from LQ Distributions");
   PsFile.InsertNamedDestination("NeutrinoFromLQ");
   ...
   PsFile.InsertNamedDestination("NuPairFromLQ");
   ...
   PsFile.InsertNamedDestination("EventNu");
   ...
   PsFile.InsertNamedDestination("BFromLQ");
   ...
   PsFile.InsertNamedDestination("BPairFromLQ");
   ...
   PsFile.InsertNamedDestination("VisibleJet");
   ...
   PsFile.InsertNamedDestination("ChargedJet");
   ...
   PsFile.InsertNamedDestination("ClosestGenJet");
   ...
   PsFile.InsertNamedDestination("ClosestChargedJet");
   ...
   PsFile.InsertNamedDestination("VisibleMR");
   ...
   PsFile.InsertNamedDestination("LeadingJetMR");
   ...
   PsFile.InsertNamedDestination("SmearedJetMR");
   ...
   PsFile.InsertNamedDestination("ChargedJetMR");
   ...
   PsFile.InsertNamedDestination("BQuarkMR");
