...
void JetPTCutEfficiency(string InputFileName, string OutputBase)
{
   ...
   TH1D HCaloMET("HCaloMET", "Calo MET", BinCount, 0, METMaxBin);
   TH1D HPFMET("HPFMET", "PF MET", BinCount, 0, METMaxBin);
   ...
   for(int iEntry = 1; iEntry <= EntryCount; iEntry++)
   {
      ...
      double CaloMET = sqrt(M.CaloMET[0] * M.CaloMET[0] + M.CaloMET[1] * M.CaloMET[1]);
      double PFMET = sqrt(M.PFMET[0] * M.PFMET[0] + M.PFMET[1] * M.PFMET[1]);

      if(CaloMET >= METMaxBin)   CaloMET = METMaxBin - 0.0001;
      if(PFMET >= METMaxBin)   PFMET = METMaxBin - 0.0001;
   ...
   TH1D HCaloMETCutEfficiency("HCaloMETCutEfficiency", "Calo MET cut efficiency;Cut position",
      HCaloMET.GetNbinsX(), 0, METMaxBin);
   Get1DCumulativeHistogram(HCaloMET, HCaloMETCutEfficiency);
   HCaloMETCutEfficiency.Scale(1.0 / EntryCount);
   HCaloMETCutEfficiency.SetStats(0);
   
   TH1D HPFMETCutEfficiency("HPFMETCutEfficiency", "PF MET cut efficiency;Cut position",
      HPFMET.GetNbinsX(), 0, METMaxBin);
   Get1DCumulativeHistogram(HPFMET, HPFMETCutEfficiency);
   HPFMETCutEfficiency.Scale(1.0 / EntryCount);
   HPFMETCutEfficiency.SetStats(0);
   ...
   TableOfContentItems.push_back("MET cut efficiency");
   ...
   PsFile.AddPlot(HPFJet1PTCutEfficiency, "", false, false, true);
   PsFile.AddPlot(HPFJet2PTCutEfficiency, "", false, false, true);
   ...
   PsFile.AddPlot(HPFJet1CSVCutEfficiency, "", false, false, true);
   PsFile.AddPlot(HPFJet2CSVCutEfficiency, "", false, false, true);
   ...
   PsFile.AddPlot(HPFJet1CSVMCutEfficiency, "", false, false, true);
   PsFile.AddPlot(HPFJet2CSVMCutEfficiency, "", false, false, true);
   ...
   PsFile.AddPlot(HPFJet1TCHECutEfficiency, "", false, false, true);
   PsFile.AddPlot(HPFJet2TCHECutEfficiency, "", false, false, true);
   ...
   PsFile.AddPlot(HPFJet1TCHPCutEfficiency, "", false, false, true);
   PsFile.AddPlot(HPFJet2TCHPCutEfficiency, "", false, false, true);
   ...
   PsFile.AddTextPage("MET cut efficiency");
   PsFile.InsertNamedDestination("MET");
   PsFile.AddPlot(HCaloMETCutEfficiency, "", false, false, true);
   PsFile.AddPlot(HPFMETCutEfficiency, "", false, false, true);
