...
int main()
{
   ...
   TH1D HWorld("HWorld", ";M_{LQ} (GeV);Cross section (pb)", 10, 200, 550);
   ...
   */
   ...
   ExpectedTwoSigma.SetLineColor(kRed);
   ExpectedTwoSigma.SetLineWidth(3);
   ...
   ExpectedOneSigma.SetLineColor(kRed);
   ExpectedOneSigma.SetLineWidth(3);
   ...
   Legend.AddEntry(&D0Exclusion, "D0 exclusion (5.2 fb^{-1})", "f");
   Legend.Draw();
