...
int main()
{
   TGraph Expected, Observed, ExpectedBand, ObservedClosed;
   TGraph CDF, D0;
   ...
   TH2D HWorld("HWorld", ";m_{#tilde{b}} [GeV];m_{#tilde{#chi}^{0}} [GeV]", 50, 100, 550, 50, 50, 250);
   ...
   TLegend Legend(0.45, 0.60, 0.85, 0.80);
   Legend.SetFillStyle(0);
   Legend.SetTextFont(42);
   Legend.SetBorderSize(0);
   Legend.AddEntry(&Observed, "Observed Limit", "fl");
