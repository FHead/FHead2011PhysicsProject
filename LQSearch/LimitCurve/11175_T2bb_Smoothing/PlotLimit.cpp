...
int main()
{
   ...
   TH2D HExpected("HExpected", ";m_{#tilde{b}} [GeV];m_{#tilde{#chi}^{0}} [GeV];#sigma (pb)", 50, -12.5, 1237.5, 50, -12.5, 1237.5);
   TH2D HObserved("HObserved", ";m_{#tilde{b}} [GeV];m_{#tilde{#chi}^{0}} [GeV];#sigma (pb)", 50, -12.5, 1237.5, 50, -12.5, 1237.5);
   ...
   TGraph GExpectedNeutralino50, GExpectedNeutralino75, GExpectedNeutralino100;
   GExpectedNeutralino50.SetNameTitle("GExpectedNeutralino50",
      "Expected limit, neutralino mass = 50 GeV;Sbottom mass;#sigma (pb)");
   GExpectedNeutralino75.SetNameTitle("GExpectedNeutralino75",
      "Expected limit, neutralino mass = 75 GeV;Sbottom mass;#sigma (pb)");
   GExpectedNeutralino100.SetNameTitle("GExpectedNeutralino100",
      "Expected limit, neutralino mass = 100 GeV;Sbottom mass;#sigma (pb)");
   ...
   while(in)
   {
      ...
      if(m12 == 50 && exp != 0)   // bad practice x2
         GExpectedNeutralino50.SetPoint(GExpectedNeutralino50.GetN(), m0, exp);
      if(m12 == 75 && exp != 0)
         GExpectedNeutralino75.SetPoint(GExpectedNeutralino75.GetN(), m0, exp);
      if(m12 == 100 && exp != 0)
         GExpectedNeutralino100.SetPoint(GExpectedNeutralino100.GetN(), m0, exp);
   }
   ...
   FillInHoles(HExpected);
   FillInHoles(HObserved);
   FillInHoles(HExpectedPlus);
   FillInHoles(HExpectedMinus);

   HExpected.GetXaxis()->SetTitleOffset(1.2);
   HExpected.GetYaxis()->SetTitleOffset(1.4);
   HObserved.GetXaxis()->SetTitleOffset(1.2);
   HObserved.GetYaxis()->SetTitleOffset(1.4);
   ...
   HExpected.Draw("colz");
   TPaletteAxis *Palette = (TPaletteAxis *)HExpected.GetListOfFunctions()->FindObject("palette");
   ...
   HObserved.Draw("colz");
   Palette = (TPaletteAxis *)HObserved.GetListOfFunctions()->FindObject("palette");
   Palette->SetX1NDC(0.91);
   Palette->SetX2NDC(0.93);
   ...
   GExpectedNeutralino50.Write();
   GExpectedNeutralino75.Write();
   GExpectedNeutralino100.Write();

   HExpected.Write();
   HObserved.Write();
   HExpectedPlus.Write();
   HExpectedMinus.Write();
