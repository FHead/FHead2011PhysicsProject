...
int main(int argc, char *argv[])
{
   ...
   // BTaggingEfficiency("TTJets_TuneD6T.list", Tagger_SSVHE, 1.74, "ReproduceBTaggingEfficiency_SSVHEM");
   // BTaggingEfficiency("TTJets_TuneD6T.list", Tagger_SSVHE, 3.05, "ReproduceBTaggingEfficiency_SSVHET");
   // BTaggingEfficiency("TTJets_TuneD6T.list", Tagger_SSVHP, 2.0, "ReproduceBTaggingEfficiency_SSVHEP");
   // BTaggingEfficiency("TTJets_TuneD6T.list", Tagger_TCHE, 1.7, "ReproduceBTaggingEfficiency_TCHEL");
   // BTaggingEfficiency("TTJets_TuneD6T.list", Tagger_TCHE, 3.3, "ReproduceBTaggingEfficiency_TCHEM");
   // BTaggingEfficiency("TTJets_TuneD6T.list", Tagger_TCHE, 10.2, "ReproduceBTaggingEfficiency_TCHET");
   // BTaggingEfficiency("TTJets_TuneD6T.list", Tagger_TCHP, 1.19, "ReproduceBTaggingEfficiency_TCHPL");
   // BTaggingEfficiency("TTJets_TuneD6T.list", Tagger_TCHP, 1.93, "ReproduceBTaggingEfficiency_TCHPM");
   // BTaggingEfficiency("TTJets_TuneD6T.list", Tagger_TCHP, 3.41, "ReproduceBTaggingEfficiency_TCHPT");
   // BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_SSVHE, 1.74, "ReproduceBTaggingEfficiencyPU_SSVHEM");
   // BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_SSVHE, 1.74, "ReproduceBTaggingEfficiencyPUSmall_SSVHEM",
   //    0, 4);
   // BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_SSVHE, 1.74, "ReproduceBTaggingEfficiencyPUMedium_SSVHEM",
   //    5, 7);
   // BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_SSVHE, 1.74, "ReproduceBTaggingEfficiencyPULarge_SSVHEM",
   //    8, 1000);
   // BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_SSVHE, 3.05, "ReproduceBTaggingEfficiencyPU_SSVHET");
   // BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_SSVHP, 2.0, "ReproduceBTaggingEfficiencyPU_SSVHEP");
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_TCHE, 1.7, "ReproduceBTaggingEfficiencyPU_TCHEL");
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_TCHE, 1.7, "ReproduceBTaggingEfficiencyPUSmall_TCHEL",
      0, 4);
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_TCHE, 1.7, "ReproduceBTaggingEfficiencyPUMedium_TCHEL",
      5, 7);
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_TCHE, 1.7, "ReproduceBTaggingEfficiencyPULarge_TCHEL",
      8, 1000);
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_TCHE, 3.3, "ReproduceBTaggingEfficiencyPU_TCHEM");
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_TCHE, 10.2, "ReproduceBTaggingEfficiencyPU_TCHET");
   // BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_TCHP, 1.19, "ReproduceBTaggingEfficiencyPU_TCHPL");
   // BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_TCHP, 1.93, "ReproduceBTaggingEfficiencyPU_TCHPM");
   // BTaggingEfficiency("TTJets_Madgraph_Spring11.list", Tagger_TCHP, 3.41, "ReproduceBTaggingEfficiencyPU_TCHPT");
...
void BTaggingEfficiency(string InputList, int Tagger, double CutValue, string OutputBase, int PUMin, int PUMax)
{
   ...
   NTPTree->SetBranchStatus("nAK5PFJet", true);
   NTPTree->SetBranchStatus("etaAK5PFJet", true);
   NTPTree->SetBranchStatus("phiAK5PFJet", true);
   NTPTree->SetBranchStatus("energyAK5PFJet", true);
   NTPTree->SetBranchStatus("pxAK5PFJet", true);
   NTPTree->SetBranchStatus("pyAK5PFJet", true);
   NTPTree->SetBranchStatus("pzAK5PFJet", true);
   NTPTree->SetBranchStatus("neutral*AK5PFJet", true);
   NTPTree->SetBranchStatus("charged*AK5PFJet", true);
   NTPTree->SetBranchStatus("*MultiplicityAK5PFJet", true);
   NTPTree->SetBranchStatus("*BJetTagsAK5PFJet", true);
   ...
   case Tagger_TCHE:
      TaggerString = "TCHE";
      Tag = M.trackCountingHighEffBJetTagsAK5PFJet;
      break;
   case Tagger_TCHP:
      TaggerString = "TCHP";
      Tag = M.trackCountingHighPurBJetTagsAK5PFJet;
      break;
   case Tagger_JetProbability:
      TaggerString = "JetProbability";
      Tag = M.jetProbabilityBJetTagsAK5PFJet;
      break;
   case Tagger_JetBProbability:
      TaggerString = "JetBProbability";
      Tag = M.jetBProbabilityBJetTagsAK5PFJet;
      break;
   case Tagger_SSVHE:
      TaggerString = "SSVHE";
      Tag = M.simpleSecondaryVertexHighEffBJetTagsAK5PFJet;
      break;
   case Tagger_SSVHP:
      TaggerString = "SSVHP";
      Tag = M.simpleSecondaryVertexHighPurBJetTagsAK5PFJet;
      break;
   case Tagger_CSV:
      TaggerString = "CSV";
      Tag = M.combinedSecondaryVertexBJetTagsAK5PFJet;
      break;
   case Tagger_CSVMVA:
      TaggerString = "CSVMVA";
      Tag = M.combinedSecondaryVertexMVABJetTagsAK5PFJet;
      break;
   default:
   ...
   for(int iEvent = 0; iEvent < NumberOfEvents; iEvent++)
   {
      ...
      for(int i = 0; i < M.nAK5PFJet; i++)
      {
         ...
         if(M.pxAK5PFJet[i] * M.pxAK5PFJet[i] + M.pyAK5PFJet[i] * M.pyAK5PFJet[i] < 40 * 40)
            continue;
         if(M.etaAK5PFJet[i] > 2.4 || M.etaAK5PFJet[i] < -2.4)
            continue;
      ...
      if(GetDR(FinalBFromTP, ClosestPFJetToBHadronFromTP) < 0.25 &&
         GetDR(FinalBFromTBarP, ClosestPFJetToBHadronFromTBarP) < 0.25)
      {
         ...
         HBHadronVsClosestJetDEtaDPhiSelected.Fill(FinalBFromTBarP.GetEta() - ClosestPFJetToBHadronFromTBarP.GetEta(),
            GetDPhi(FinalBFromTBarP, ClosestPFJetToBHadronFromTBarP));
         HJetTagDistribution.Fill(Tag[ClosestPFJetToBHadronFromT]);
         HJetTagDistribution.Fill(Tag[ClosestPFJetToBHadronFromTBar]);
      }

      if(GetDR(FinalBFromTP, ClosestPFJetToBHadronFromTP) < 0.25 &&
         GetDR(FinalBFromTBarP, ClosestPFJetToBHadronFromTBarP) < 0.25)
      {
         HAllBJetPT.Fill(ClosestPFJetToBHadronFromTP.GetPT());
         if(Tag[ClosestPFJetToBHadronFromT] > CutValue)
            HTaggedBJetPT.Fill(ClosestPFJetToBHadronFromTP.GetPT());
         HAllBJetPTVsEta.Fill(ClosestPFJetToBHadronFromTP.GetPT(), ClosestPFJetToBHadronFromTP.GetEta());
         HAllBJetPT.Fill(ClosestPFJetToBHadronFromTBarP.GetPT());
         if(Tag[ClosestPFJetToBHadronFromTBar] > CutValue)
            HTaggedBJetPT.Fill(ClosestPFJetToBHadronFromTBarP.GetPT());
         HAllBJetPTVsEta.Fill(ClosestPFJetToBHadronFromTBarP.GetPT(), ClosestPFJetToBHadronFromTBarP.GetEta());
      
         double JECPercentage = 0.05;

         HAllBJetPTJECPlus.Fill(ClosestPFJetToBHadronFromTP.GetPT() * (1 + JECPercentage));
         if(Tag[ClosestPFJetToBHadronFromT] > CutValue)
            HTaggedBJetPTJECPlus.Fill(ClosestPFJetToBHadronFromTP.GetPT() * (1 + JECPercentage));
         HAllBJetPTJECPlus.Fill(ClosestPFJetToBHadronFromTBarP.GetPT() * (1 + JECPercentage));
         if(Tag[ClosestPFJetToBHadronFromTBar] > CutValue)
            HTaggedBJetPTJECPlus.Fill(ClosestPFJetToBHadronFromTBarP.GetPT() * (1 + JECPercentage));
         
         HAllBJetPTJECMinus.Fill(ClosestPFJetToBHadronFromTP.GetPT() * (1 - JECPercentage));
         if(Tag[ClosestPFJetToBHadronFromT] > CutValue)
            HTaggedBJetPTJECMinus.Fill(ClosestPFJetToBHadronFromTP.GetPT() * (1 - JECPercentage));
         HAllBJetPTJECMinus.Fill(ClosestPFJetToBHadronFromTBarP.GetPT() * (1 - JECPercentage));
         if(Tag[ClosestPFJetToBHadronFromTBar] > CutValue)
            HTaggedBJetPTJECMinus.Fill(ClosestPFJetToBHadronFromTBarP.GetPT() * (1 - JECPercentage));
         
         HAllBJetEta.Fill(ClosestPFJetToBHadronFromTP.GetEta());
         if(Tag[ClosestPFJetToBHadronFromT] > CutValue)
            HTaggedBJetEta.Fill(ClosestPFJetToBHadronFromTP.GetEta());
         HAllBJetEta.Fill(ClosestPFJetToBHadronFromTBarP.GetEta());
         if(Tag[ClosestPFJetToBHadronFromTBar] > CutValue)
            HTaggedBJetEta.Fill(ClosestPFJetToBHadronFromTBarP.GetEta());
      
         HAllBJetPhi.Fill(ClosestPFJetToBHadronFromTP.GetPhi());
         if(Tag[ClosestPFJetToBHadronFromT] > CutValue)
            HTaggedBJetPhi.Fill(ClosestPFJetToBHadronFromTP.GetPhi());
         HAllBJetPhi.Fill(ClosestPFJetToBHadronFromTBarP.GetPhi());
         if(Tag[ClosestPFJetToBHadronFromTBar] > CutValue)
            HTaggedBJetPhi.Fill(ClosestPFJetToBHadronFromTBarP.GetPhi());
      }
      
      if(GetDR(FinalBFromTP, ClosestPFJetToBHadronFromTP) < 0.1 &&
         GetDR(FinalBFromTBarP, ClosestPFJetToBHadronFromTBarP) < 0.1)
      {
         HAllBJetPTTightDR.Fill(ClosestPFJetToBHadronFromTP.GetPT());
         if(Tag[ClosestPFJetToBHadronFromT] > CutValue)
            HTaggedBJetPTTightDR.Fill(ClosestPFJetToBHadronFromTP.GetPT());
         HAllBJetPTTightDR.Fill(ClosestPFJetToBHadronFromTBarP.GetPT());
         if(Tag[ClosestPFJetToBHadronFromTBar] > CutValue)
            HTaggedBJetPTTightDR.Fill(ClosestPFJetToBHadronFromTBarP.GetPT());
      }   
      
      if(GetDR(FinalBFromTP, ClosestPFJetToBHadronFromTP) < 0.4 &&
         GetDR(FinalBFromTBarP, ClosestPFJetToBHadronFromTBarP) < 0.4)
      {
         HAllBJetPTLooseDR.Fill(ClosestPFJetToBHadronFromTP.GetPT());
         if(Tag[ClosestPFJetToBHadronFromT] > CutValue)
            HTaggedBJetPTLooseDR.Fill(ClosestPFJetToBHadronFromTP.GetPT());
         HAllBJetPTLooseDR.Fill(ClosestPFJetToBHadronFromTBarP.GetPT());
         if(Tag[ClosestPFJetToBHadronFromTBar] > CutValue)
            HTaggedBJetPTLooseDR.Fill(ClosestPFJetToBHadronFromTBarP.GetPT());
      }   
   }
