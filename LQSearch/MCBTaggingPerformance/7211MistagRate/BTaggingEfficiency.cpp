...
int main(int argc, char *argv[])
{
   ...
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", 1.7, "ReproduceBTaggingEfficiencyPU_TCHEL");
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", 1.7, "ReproduceBTaggingEfficiencyPUSmall_TCHEL",
      0, 4);
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", 1.7, "ReproduceBTaggingEfficiencyPUMedium_TCHEL",
      5, 7);
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", 1.7, "ReproduceBTaggingEfficiencyPULarge_TCHEL",
      8, 1000);
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", 3.3, "ReproduceBTaggingEfficiencyPU_TCHEM");
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", 10.2, "ReproduceBTaggingEfficiencyPU_TCHET");
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", 10.2, "ReproduceBTaggingEfficiencyPUSmall_TCHET",
      0, 4);
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", 10.2, "ReproduceBTaggingEfficiencyPUMedium_TCHET",
      5, 7);
   BTaggingEfficiency("TTJets_Madgraph_Spring11.list", 10.2, "ReproduceBTaggingEfficiencyPULarge_TCHET",
      8, 1000);
...
void BTaggingEfficiency(string InputList, double CutValue, string OutputBase, int PUMin, int PUMax)
{
   ...
   float *Tag = M.trackCountingHighEffBJetTagsAK5PFPUcorrJet;
   ...
   ExplanationText.push_back("Estimate mis-tag rate from ttbar events!");
   ...
   for(int iEvent = 0; iEvent < NumberOfEvents; iEvent++)
   {
      ...
      vector<FourVector> BMeson, LowBMeson;
      ...
      vector<int> GoodJets, PureJets, ExclusiveJets, SmallRadiusJets, LowJets;
      vector<FourVector> GoodJetsP, PureJetsP, ExclusiveJetsP, SmallRadiusJetsP, LowJetsP;
      int AllJetCount = 0;
