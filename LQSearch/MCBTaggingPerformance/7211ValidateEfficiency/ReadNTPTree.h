...
public :
   ...
   Int_t           orbitNumber;
   Int_t           nPU;
   Float_t         zpositionPU[20];   //[nPU]
   Float_t         sumpTLowpTPU[20];   //[nPU]
   Float_t         sumpTHighpTPU[20];   //[nPU]
   Int_t           nTracksLowpTPU[20];   //[nPU]
   Int_t           nTracksHighpTPU[20];   //[nPU]
   Int_t           nMc;
   ...
   Int_t           nEle;
   Int_t           chargeEle[502];   //[nEle]
   Float_t         energyEle[502];   //[nEle]
   Float_t         thetaEle[502];   //[nEle]
   Float_t         etaEle[502];   //[nEle]
   Float_t         phiEle[502];   //[nEle]
   Float_t         pxEle[502];   //[nEle]
   Float_t         pyEle[502];   //[nEle]
   Float_t         pzEle[502];   //[nEle]
   Float_t         vertexXEle[502];   //[nEle]
   Float_t         vertexYEle[502];   //[nEle]
   Float_t         vertexZEle[502];   //[nEle]
   Int_t           fiducialFlagsEle[502];   //[nEle]
   Int_t           recoFlagsEle[502];   //[nEle]
   Int_t           energyCorrectionsEle[502];   //[nEle]
   Int_t           superClusterIndexEle[502];   //[nEle]
   Int_t           PFsuperClusterIndexEle[502];   //[nEle]
   Int_t           trackIndexEle[502];   //[nEle]
   Int_t           gsfTrackIndexEle[502];   //[nEle]
   Float_t         convDistEle[502];   //[nEle]
   Float_t         convDcotEle[502];   //[nEle]
   Float_t         convRadiusEle[502];   //[nEle]
   Int_t           convTrackIndexEle[502];   //[nEle]
   Int_t           scPixChargeEle[502];   //[nEle]
   Int_t           classificationEle[502];   //[nEle]
   Int_t           standardClassificationEle[502];   //[nEle]
   Float_t         fbremEle[502];   //[nEle]
   Int_t           nbremsEle[502];   //[nEle]
   Float_t         hOverEEle[502];   //[nEle]
   Float_t         eSuperClusterOverPEle[502];   //[nEle]
   Float_t         eSeedOverPoutEle[502];   //[nEle]
   Float_t         deltaEtaAtVtxEle[502];   //[nEle]
   Float_t         deltaPhiAtVtxEle[502];   //[nEle]
   Float_t         deltaEtaAtCaloEle[502];   //[nEle]
   Float_t         deltaPhiAtCaloEle[502];   //[nEle]
   Float_t         tipEle[502];   //[nEle]
   Float_t         dr03TkSumPtEle[502];   //[nEle]
   Float_t         dr03EcalRecHitSumEtEle[502];   //[nEle]
   Float_t         dr03HcalTowerSumEtEle[502];   //[nEle]
   Float_t         dr04TkSumPtEle[502];   //[nEle]
   Float_t         dr04EcalRecHitSumEtEle[502];   //[nEle]
   Float_t         dr04HcalTowerSumEtEle[502];   //[nEle]
   Float_t         scBasedEcalSum03Ele[502];   //[nEle]
   Float_t         scBasedEcalSum04Ele[502];   //[nEle]
   Int_t           eleIdCutsEle[502];   //[nEle]
   Int_t           eleIdCutsHWWEle[502];   //[nEle]
   Float_t         eleIdLikelihoodEle[502];   //[nEle]
   Float_t         pflowMVAEle[502];   //[nEle]
   Int_t           nPFEle;
   Int_t           chargePFEle[520];   //[nPFEle]
   Float_t         energyPFEle[520];   //[nPFEle]
   Float_t         thetaPFEle[520];   //[nPFEle]
   Float_t         etaPFEle[520];   //[nPFEle]
   Float_t         phiPFEle[520];   //[nPFEle]
   Float_t         pxPFEle[520];   //[nPFEle]
   Float_t         pyPFEle[520];   //[nPFEle]
   Float_t         pzPFEle[520];   //[nPFEle]
   Float_t         vertexXPFEle[520];   //[nPFEle]
   Float_t         vertexYPFEle[520];   //[nPFEle]
   Float_t         vertexZPFEle[520];   //[nPFEle]
   Float_t         MvaOutputPFEle[520];   //[nPFEle]
   Float_t         PS1EnergyPFEle[520];   //[nPFEle]
   Float_t         PS2EnergyPFEle[520];   //[nPFEle]
   Float_t         EcalEnergyPFEle[520];   //[nPFEle]
   Float_t         HcalEnergyPFEle[520];   //[nPFEle]
   Float_t         RawEcalEnergyPFEle[520];   //[nPFEle]
   Float_t         RawHcalEnergyPFEle[520];   //[nPFEle]
   Float_t         PositionAtEcalXPFEle[520];   //[nPFEle]
   Float_t         PositionAtEcalYPFEle[520];   //[nPFEle]
   Float_t         PositionAtEcalZPFEle[520];   //[nPFEle]
   Int_t           gsfTrackIndexPFEle[520];   //[nPFEle]
   Int_t           trackIndexPFEle[520];   //[nPFEle]
   Float_t         convDistPFEle[520];   //[nPFEle]
   Float_t         convDcotPFEle[520];   //[nPFEle]
   Float_t         convRadiusPFEle[520];   //[nPFEle]
   Int_t           convTrackIndexPFEle[520];   //[nPFEle]
   Float_t         deltaEtaAtVtxEgPFEle[520];   //[nPFEle]
   Float_t         deltaPhiAtVtxEgPFEle[520];   //[nPFEle]
   Float_t         chIso03vetoPFEle[520];   //[nPFEle]
   Float_t         chIso04vetoPFEle[520];   //[nPFEle]
   Float_t         chIso05vetoPFEle[520];   //[nPFEle]
   Float_t         chIso03noVetoPFEle[520];   //[nPFEle]
   Float_t         chIso04noVetoPFEle[520];   //[nPFEle]
   Float_t         chIso05noVetoPFEle[520];   //[nPFEle]
   Float_t         chIso03vetoNVCPFEle[520];   //[nPFEle]
   Float_t         chIso04vetoNVCPFEle[520];   //[nPFEle]
   Float_t         chIso05vetoNVCPFEle[520];   //[nPFEle]
   Float_t         chIso03noVetoNVCPFEle[520];   //[nPFEle]
   Float_t         chIso04noVetoNVCPFEle[520];   //[nPFEle]
   Float_t         chIso05noVetoNVCPFEle[520];   //[nPFEle]
   Float_t         nhIso03vetoPFEle[520];   //[nPFEle]
   Float_t         nhIso04vetoPFEle[520];   //[nPFEle]
   Float_t         nhIso05vetoPFEle[520];   //[nPFEle]
   Float_t         nhIso03vetoTJPFEle[520];   //[nPFEle]
   Float_t         nhIso04vetoTJPFEle[520];   //[nPFEle]
   Float_t         nhIso05vetoTJPFEle[520];   //[nPFEle]
   Float_t         nhIso03noVetoPFEle[520];   //[nPFEle]
   Float_t         nhIso04noVetoPFEle[520];   //[nPFEle]
   Float_t         nhIso05noVetoPFEle[520];   //[nPFEle]
   Float_t         phIso03vetoPFEle[520];   //[nPFEle]
   Float_t         phIso04vetoPFEle[520];   //[nPFEle]
   Float_t         phIso05vetoPFEle[520];   //[nPFEle]
   Float_t         phIso03vetoTJPFEle[520];   //[nPFEle]
   Float_t         phIso04vetoTJPFEle[520];   //[nPFEle]
   Float_t         phIso05vetoTJPFEle[520];   //[nPFEle]
   Float_t         phIso03noVetoPFEle[520];   //[nPFEle]
   Float_t         phIso04noVetoPFEle[520];   //[nPFEle]
   Float_t         phIso05noVetoPFEle[520];   //[nPFEle]
   Int_t           nSC;
   Int_t           nBCSC[520];   //[nSC]
   Int_t           nCrystalsSC[520];   //[nSC]
   Float_t         rawEnergySC[520];   //[nSC]
   Float_t         energySC[520];   //[nSC]
   Float_t         esEnergySC[520];   //[nSC]
   Float_t         etaSC[520];   //[nSC]
   Float_t         thetaSC[520];   //[nSC]
   Float_t         phiSC[520];   //[nSC]
   Float_t         phiWidthSC[520];   //[nSC]
   Float_t         etaWidthSC[520];   //[nSC]
   Float_t         e3x3SC[520];   //[nSC]
   Float_t         e5x5SC[520];   //[nSC]
   Float_t         eMaxSC[520];   //[nSC]
   Float_t         e2x2SC[520];   //[nSC]
   Float_t         e2ndSC[520];   //[nSC]
   Float_t         e1x5SC[520];   //[nSC]
   Float_t         e2x5MaxSC[520];   //[nSC]
   Float_t         e4SwissCrossSC[520];   //[nSC]
   Float_t         covIEtaIEtaSC[520];   //[nSC]
   Float_t         covIEtaIPhiSC[520];   //[nSC]
   Float_t         covIPhiIPhiSC[520];   //[nSC]
   Float_t         sMajSC[520];   //[nSC]
   Float_t         sMinSC[520];   //[nSC]
   Float_t         alphaSC[520];   //[nSC]
   Float_t         hOverESC[520];   //[nSC]
   Int_t           recoFlagSC[520];   //[nSC]
   Int_t           channelStatusSC[520];   //[nSC]
   Float_t         timeSC[520];   //[nSC]
   Float_t         chi2SC[520];   //[nSC]
   Float_t         seedEnergySC[520];   //[nSC]
   Float_t         seedXSC[520];   //[nSC]
   Float_t         seedYSC[520];   //[nSC]
   Int_t           idClosProblSC[520];   //[nSC]
   Int_t           sevClosProblSC[520];   //[nSC]
   Float_t         fracClosProblSC[520];   //[nSC]
   Float_t         scBasedEcalSum03SC[520];   //[nSC]
   Float_t         scBasedEcalSum04SC[520];   //[nSC]
   Float_t         ecalRecHitSumEtConeDR03SC[520];   //[nSC]
   Float_t         hcalTowerSumEtConeDR03SC[520];   //[nSC]
   Float_t         trkSumPtSolidConeDR03SC[520];   //[nSC]
   Float_t         ecalRecHitSumEtConeDR04SC[520];   //[nSC]
   Float_t         hcalTowerSumEtConeDR04SC[520];   //[nSC]
   Float_t         trkSumPtSolidConeDR04SC[520];   //[nSC]
   Int_t           nPFSC;
   Int_t           nBCPFSC[520];   //[nPFSC]
   Int_t           nCrystalsPFSC[520];   //[nPFSC]
   Float_t         rawEnergyPFSC[520];   //[nPFSC]
   Float_t         energyPFSC[520];   //[nPFSC]
   Float_t         esEnergyPFSC[520];   //[nPFSC]
   Float_t         etaPFSC[520];   //[nPFSC]
   Float_t         thetaPFSC[520];   //[nPFSC]
   Float_t         phiPFSC[520];   //[nPFSC]
   Float_t         phiWidthPFSC[520];   //[nPFSC]
   Float_t         etaWidthPFSC[520];   //[nPFSC]
   Float_t         e3x3PFSC[520];   //[nPFSC]
   Float_t         e5x5PFSC[520];   //[nPFSC]
   Float_t         eMaxPFSC[520];   //[nPFSC]
   Float_t         e2x2PFSC[520];   //[nPFSC]
   Float_t         e2ndPFSC[520];   //[nPFSC]
   Float_t         e1x5PFSC[520];   //[nPFSC]
   Float_t         e2x5MaxPFSC[520];   //[nPFSC]
   Float_t         e4SwissCrossPFSC[520];   //[nPFSC]
   Float_t         covIEtaIEtaPFSC[520];   //[nPFSC]
   Float_t         covIEtaIPhiPFSC[520];   //[nPFSC]
   Float_t         covIPhiIPhiPFSC[520];   //[nPFSC]
   Float_t         sMajPFSC[520];   //[nPFSC]
   Float_t         sMinPFSC[520];   //[nPFSC]
   Float_t         alphaPFSC[520];   //[nPFSC]
   Float_t         hOverEPFSC[520];   //[nPFSC]
   Int_t           recoFlagPFSC[520];   //[nPFSC]
   Int_t           channelStatusPFSC[520];   //[nPFSC]
   Float_t         timePFSC[520];   //[nPFSC]
   Float_t         chi2PFSC[520];   //[nPFSC]
   Float_t         seedEnergyPFSC[520];   //[nPFSC]
   Float_t         seedXPFSC[520];   //[nPFSC]
   Float_t         seedYPFSC[520];   //[nPFSC]
   Int_t           idClosProblPFSC[520];   //[nPFSC]
   Int_t           sevClosProblPFSC[520];   //[nPFSC]
   Float_t         fracClosProblPFSC[520];   //[nPFSC]
   Float_t         scBasedEcalSum03PFSC[520];   //[nPFSC]
   Float_t         scBasedEcalSum04PFSC[520];   //[nPFSC]
   Int_t           nTrack;
   ...
   Int_t           nGsfTrack;
   Float_t         pxGsfTrack[210];   //[nGsfTrack]
   Float_t         pyGsfTrack[210];   //[nGsfTrack]
   Float_t         pzGsfTrack[210];   //[nGsfTrack]
   Int_t           vtxIndexGsfTrack[210];   //[nGsfTrack]
   Float_t         vtxWeightGsfTrack[210];   //[nGsfTrack]
   Float_t         impactPar3DGsfTrack[210];   //[nGsfTrack]
   Float_t         impactPar3DErrorGsfTrack[210];   //[nGsfTrack]
   Float_t         transvImpactParGsfTrack[210];   //[nGsfTrack]
   Float_t         transvImpactParErrorGsfTrack[210];   //[nGsfTrack]
   Float_t         chargeGsfTrack[210];   //[nGsfTrack]
   Float_t         ptErrorGsfTrack[210];   //[nGsfTrack]
   Float_t         trackValidHitsGsfTrack[210];   //[nGsfTrack]
   Float_t         trackLostHitsGsfTrack[210];   //[nGsfTrack]
   Float_t         trackNormalizedChi2GsfTrack[210];   //[nGsfTrack]
   Int_t           qualityMaskGsfTrack[210];   //[nGsfTrack]
   Float_t         trackVxGsfTrack[210];   //[nGsfTrack]
   Float_t         trackVyGsfTrack[210];   //[nGsfTrack]
   Float_t         trackVzGsfTrack[210];   //[nGsfTrack]
   Float_t         pxAtOuterGsfTrack[210];   //[nGsfTrack]
   Float_t         pyAtOuterGsfTrack[210];   //[nGsfTrack]
   Float_t         pzAtOuterGsfTrack[210];   //[nGsfTrack]
   Float_t         xAtOuterGsfTrack[210];   //[nGsfTrack]
   Float_t         yAtOuterGsfTrack[210];   //[nGsfTrack]
   Float_t         zAtOuterGsfTrack[210];   //[nGsfTrack]
   Float_t         pxAtInnerGsfTrack[210];   //[nGsfTrack]
   Float_t         pyAtInnerGsfTrack[210];   //[nGsfTrack]
   Float_t         pzAtInnerGsfTrack[210];   //[nGsfTrack]
   Float_t         xAtInnerGsfTrack[210];   //[nGsfTrack]
   Float_t         yAtInnerGsfTrack[210];   //[nGsfTrack]
   Float_t         zAtInnerGsfTrack[210];   //[nGsfTrack]
   Float_t         recHitsSizeGsfTrack[210];   //[nGsfTrack]
   Int_t           pixelHitsGsfTrack[210];   //[nGsfTrack]
   Int_t           expInnerLayersGsfTrack[210];   //[nGsfTrack]
   Int_t           numberOfValidPixelBarrelHitsGsfTrack[210];   //[nGsfTrack]
   Int_t           numberOfValidPixelEndcapHitsGsfTrack[210];   //[nGsfTrack]
   Int_t           numberOfValidStripTIBHitsGsfTrack[210];   //[nGsfTrack]
   Int_t           numberOfValidStripTIDHitsGsfTrack[210];   //[nGsfTrack]
   Int_t           numberOfValidStripTOBHitsGsfTrack[210];   //[nGsfTrack]
   Int_t           numberOfValidStripTECHitsGsfTrack[210];   //[nGsfTrack]
   Int_t           chargeModeGsfTrack[210];   //[nGsfTrack]
   Float_t         pxModeGsfTrack[210];   //[nGsfTrack]
   Float_t         pyModeGsfTrack[210];   //[nGsfTrack]
   Float_t         pzModeGsfTrack[210];   //[nGsfTrack]
   Int_t           recoFlagsGsfTrack[210];   //[nGsfTrack]
   Int_t           nGlobalMuonTrack;
   Float_t         pxGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         pyGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         pzGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Int_t           vtxIndexGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         vtxWeightGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         impactPar3DGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         impactPar3DErrorGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         transvImpactParGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         transvImpactParErrorGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         chargeGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         ptErrorGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         trackValidHitsGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         trackLostHitsGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         trackNormalizedChi2GlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Int_t           qualityMaskGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         trackVxGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         trackVyGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         trackVzGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         pxAtOuterGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         pyAtOuterGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         pzAtOuterGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         xAtOuterGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         yAtOuterGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         zAtOuterGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         pxAtInnerGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         pyAtInnerGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         pzAtInnerGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         xAtInnerGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         yAtInnerGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         zAtInnerGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Float_t         recHitsSizeGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Int_t           pixelHitsGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Int_t           expInnerLayersGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Int_t           numberOfValidPixelBarrelHitsGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Int_t           numberOfValidPixelEndcapHitsGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTIBHitsGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTIDHitsGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTOBHitsGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTECHitsGlobalMuonTrack[30];   //[nGlobalMuonTrack]
   Int_t           nSTAMuonTrack;
   Float_t         pxSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         pySTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         pzSTAMuonTrack[30];   //[nSTAMuonTrack]
   Int_t           vtxIndexSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         vtxWeightSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         impactPar3DSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         impactPar3DErrorSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         transvImpactParSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         transvImpactParErrorSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         chargeSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         ptErrorSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         trackValidHitsSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         trackLostHitsSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         trackNormalizedChi2STAMuonTrack[30];   //[nSTAMuonTrack]
   Int_t           qualityMaskSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         trackVxSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         trackVySTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         trackVzSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         pxAtOuterSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         pyAtOuterSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         pzAtOuterSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         xAtOuterSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         yAtOuterSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         zAtOuterSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         pxAtInnerSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         pyAtInnerSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         pzAtInnerSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         xAtInnerSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         yAtInnerSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         zAtInnerSTAMuonTrack[30];   //[nSTAMuonTrack]
   Float_t         recHitsSizeSTAMuonTrack[30];   //[nSTAMuonTrack]
   Int_t           pixelHitsSTAMuonTrack[30];   //[nSTAMuonTrack]
   Int_t           expInnerLayersSTAMuonTrack[30];   //[nSTAMuonTrack]
   Int_t           numberOfValidPixelBarrelHitsSTAMuonTrack[30];   //[nSTAMuonTrack]
   Int_t           numberOfValidPixelEndcapHitsSTAMuonTrack[30];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTIBHitsSTAMuonTrack[30];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTIDHitsSTAMuonTrack[30];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTOBHitsSTAMuonTrack[30];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTECHitsSTAMuonTrack[30];   //[nSTAMuonTrack]
   Int_t           nPV;
   Float_t         PVxPV[300];   //[nPV]
   Float_t         PVyPV[300];   //[nPV]
   Float_t         PVzPV[300];   //[nPV]
   Float_t         PVErrxPV[300];   //[nPV]
   Float_t         PVErryPV[300];   //[nPV]
   Float_t         PVErrzPV[300];   //[nPV]
   Float_t         SumPtPV[300];   //[nPV]
   Float_t         ndofPV[300];   //[nPV]
   Float_t         chi2PV[300];   //[nPV]
   Int_t           nMuon;
   Int_t           chargeMuon[80];   //[nMuon]
   Float_t         energyMuon[80];   //[nMuon]
   Float_t         thetaMuon[80];   //[nMuon]
   Float_t         etaMuon[80];   //[nMuon]
   Float_t         phiMuon[80];   //[nMuon]
   Float_t         pxMuon[80];   //[nMuon]
   Float_t         pyMuon[80];   //[nMuon]
   Float_t         pzMuon[80];   //[nMuon]
   Float_t         vertexXMuon[80];   //[nMuon]
   Float_t         vertexYMuon[80];   //[nMuon]
   Float_t         vertexZMuon[80];   //[nMuon]
   Int_t           trackIndexMuon[80];   //[nMuon]
   Int_t           standAloneTrackIndexMuon[80];   //[nMuon]
   Int_t           combinedTrackIndexMuon[80];   //[nMuon]
   Int_t           muonIdMuon[80];   //[nMuon]
   Float_t         sumPt03Muon[80];   //[nMuon]
   Float_t         emEt03Muon[80];   //[nMuon]
   Float_t         hadEt03Muon[80];   //[nMuon]
   Float_t         hoEt03Muon[80];   //[nMuon]
   Float_t         nTrk03Muon[80];   //[nMuon]
   Float_t         nJets03Muon[80];   //[nMuon]
   Float_t         sumPt05Muon[80];   //[nMuon]
   Float_t         emEt05Muon[80];   //[nMuon]
   Float_t         hadEt05Muon[80];   //[nMuon]
   Float_t         hoEt05Muon[80];   //[nMuon]
   Float_t         nTrk05Muon[80];   //[nMuon]
   Float_t         nJets05Muon[80];   //[nMuon]
   Float_t         EcalExpDepoMuon[80];   //[nMuon]
   Float_t         HcalExpDepoMuon[80];   //[nMuon]
   Float_t         HoExpDepoMuon[80];   //[nMuon]
   Float_t         emS9Muon[80];   //[nMuon]
   Float_t         hadS9Muon[80];   //[nMuon]
   Float_t         hoS9Muon[80];   //[nMuon]
   Float_t         CaloCompMuon[80];   //[nMuon]
   Int_t           nPFTau;
   Int_t           isNonNullPFTau[310];   //[nPFTau]
   Int_t           chargePFTau[310];   //[nPFTau]
   Float_t         energyPFTau[310];   //[nPFTau]
   Float_t         etPFTau[310];   //[nPFTau]
   Float_t         momentumPFTau[310];   //[nPFTau]
   Float_t         thetaPFTau[310];   //[nPFTau]
   Float_t         ptPFTau[310];   //[nPFTau]
   Float_t         etaPFTau[310];   //[nPFTau]
   Float_t         phiPFTau[310];   //[nPFTau]
   Float_t         pxPFTau[310];   //[nPFTau]
   Float_t         pyPFTau[310];   //[nPFTau]
   Float_t         pzPFTau[310];   //[nPFTau]
   Float_t         vertexXPFTau[310];   //[nPFTau]
   Float_t         vertexYPFTau[310];   //[nPFTau]
   Float_t         vertexZPFTau[310];   //[nPFTau]
   Float_t         massPFTau[310];   //[nPFTau]
   Float_t         mtPFTau[310];   //[nPFTau]
   Int_t           pdgIdPFTau[310];   //[nPFTau]
   Int_t           nDauPFTau[310];   //[nPFTau]
   Float_t         theTauDiscrByLeadTrackFindingPFTau[310];   //[nPFTau]
   Float_t         theTauDiscrByLeadTrackPtCutPFTau[310];   //[nPFTau]
   Float_t         theTauDiscrByTrackIsoPFTau[310];   //[nPFTau]
   Float_t         theTauDiscrByEcalIsoPFTau[310];   //[nPFTau]
   Float_t         theTauDiscrAgainstMuonsPFTau[310];   //[nPFTau]
   Float_t         theTauDiscrAgainstElectronsPFTau[310];   //[nPFTau]
   Float_t         theTauDiscrByTaNCPFTau[310];   //[nPFTau]
   Float_t         theTauDiscrByTaNCfrHalfPercentPFTau[310];   //[nPFTau]
   Float_t         theTauDiscrByTaNCfrOnePercentPFTau[310];   //[nPFTau]
   Float_t         theTauDiscrByTaNCfrQuarterPercentPFTau[310];   //[nPFTau]
   Float_t         theTauDiscrByTaNCfrTenthPercentPFTau[310];   //[nPFTau]
   Float_t         isolationPFChargedHadrCandsPtSumPFTau[310];   //[nPFTau]
   Float_t         isolationPFGammaCandsEtSumPFTau[310];   //[nPFTau]
   Float_t         emFractionPFTau[310];   //[nPFTau]
   Float_t         hcalTotOverPLeadPFTau[310];   //[nPFTau]
   Float_t         hcal3x3OverPLeadPFTau[310];   //[nPFTau]
   Float_t         ecalStripSumEOverPLeadPFTau[310];   //[nPFTau]
   Float_t         bremsRecoveryEOverPLeadPFTau[310];   //[nPFTau]
   Int_t           nMet;
   ...
   Int_t           nAK5Jet;
   Int_t           chargeAK5Jet[201];   //[nAK5Jet]
   Float_t         energyAK5Jet[201];   //[nAK5Jet]
   Float_t         thetaAK5Jet[201];   //[nAK5Jet]
   Float_t         etaAK5Jet[201];   //[nAK5Jet]
   Float_t         phiAK5Jet[201];   //[nAK5Jet]
   Float_t         pxAK5Jet[201];   //[nAK5Jet]
   Float_t         pyAK5Jet[201];   //[nAK5Jet]
   Float_t         pzAK5Jet[201];   //[nAK5Jet]
   Float_t         vertexXAK5Jet[201];   //[nAK5Jet]
   Float_t         vertexYAK5Jet[201];   //[nAK5Jet]
   Float_t         vertexZAK5Jet[201];   //[nAK5Jet]
   Float_t         emFracAK5Jet[201];   //[nAK5Jet]
   Float_t         hadFracAK5Jet[201];   //[nAK5Jet]
   Int_t           IdAK5Jet[201];   //[nAK5Jet]
   Int_t           nHitAK5Jet[201];   //[nAK5Jet]
   Int_t           nHit90AK5Jet[201];   //[nAK5Jet]
   Float_t         fHPDAK5Jet[201];   //[nAK5Jet]
   Float_t         covEtaEtaAK5Jet[201];   //[nAK5Jet]
   Float_t         covPhiPhiAK5Jet[201];   //[nAK5Jet]
   Float_t         fLSAK5Jet[201];   //[nAK5Jet]
   Float_t         fOOTAK5Jet[201];   //[nAK5Jet]
   Float_t         combinedSecondaryVertexBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         combinedSecondaryVertexMVABJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         jetBProbabilityBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         jetProbabilityBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         simpleSecondaryVertexHighEffBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         simpleSecondaryVertexHighPurBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         softMuonBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         softMuonByIP3dBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         softMuonByPtBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         softElectronBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         softElectronByIP3dBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         softElectronByPtBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         trackCountingHighPurBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         trackCountingHighEffBJetTagsAK5Jet[201];   //[nAK5Jet]
   Float_t         uncorrEnergyAK5Jet[201];   //[nAK5Jet]
   Int_t           nAK5PFJet;
   Int_t           chargeAK5PFJet[310];   //[nAK5PFJet]
   Float_t         energyAK5PFJet[310];   //[nAK5PFJet]
   Float_t         thetaAK5PFJet[310];   //[nAK5PFJet]
   Float_t         etaAK5PFJet[310];   //[nAK5PFJet]
   Float_t         phiAK5PFJet[310];   //[nAK5PFJet]
   Float_t         pxAK5PFJet[310];   //[nAK5PFJet]
   Float_t         pyAK5PFJet[310];   //[nAK5PFJet]
   Float_t         pzAK5PFJet[310];   //[nAK5PFJet]
   Float_t         vertexXAK5PFJet[310];   //[nAK5PFJet]
   Float_t         vertexYAK5PFJet[310];   //[nAK5PFJet]
   Float_t         vertexZAK5PFJet[310];   //[nAK5PFJet]
   Float_t         chargedHadronEnergyAK5PFJet[310];   //[nAK5PFJet]
   Float_t         neutralHadronEnergyAK5PFJet[310];   //[nAK5PFJet]
   Float_t         photonEnergyAK5PFJet[310];   //[nAK5PFJet]
   Float_t         electronEnergyAK5PFJet[310];   //[nAK5PFJet]
   Float_t         muonEnergyAK5PFJet[310];   //[nAK5PFJet]
   Float_t         HFHadronEnergyAK5PFJet[310];   //[nAK5PFJet]
   Float_t         HFEMEnergyAK5PFJet[310];   //[nAK5PFJet]
   Int_t           chargedHadronMultiplicityAK5PFJet[310];   //[nAK5PFJet]
   Int_t           neutralHadronMultiplicityAK5PFJet[310];   //[nAK5PFJet]
   Int_t           photonMultiplicityAK5PFJet[310];   //[nAK5PFJet]
   Int_t           electronMultiplicityAK5PFJet[310];   //[nAK5PFJet]
   Int_t           muonMultiplicityAK5PFJet[310];   //[nAK5PFJet]
   Int_t           HFHadronMultiplicityAK5PFJet[310];   //[nAK5PFJet]
   Int_t           HFEMMultiplicityAK5PFJet[310];   //[nAK5PFJet]
   Float_t         chargedEmEnergyAK5PFJet[310];   //[nAK5PFJet]
   Float_t         neutralEmEnergyAK5PFJet[310];   //[nAK5PFJet]
   Float_t         combinedSecondaryVertexBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         combinedSecondaryVertexMVABJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         jetBProbabilityBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         jetProbabilityBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         simpleSecondaryVertexHighEffBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         simpleSecondaryVertexHighPurBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         softMuonBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         softMuonByIP3dBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         softMuonByPtBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         softElectronBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         softElectronByIP3dBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         softElectronByPtBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         trackCountingHighPurBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         trackCountingHighEffBJetTagsAK5PFJet[310];   //[nAK5PFJet]
   Float_t         uncorrEnergyAK5PFJet[310];   //[nAK5PFJet]
   Float_t         rmsCandAK5PFJet[310];   //[nAK5PFJet]
   Float_t         ptDAK5PFJet[310];   //[nAK5PFJet]
   Int_t           nAK5PFPUcorrJet;
   Int_t           chargeAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         energyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         thetaAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         etaAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         phiAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         pxAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         pyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         pzAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         vertexXAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         vertexYAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         vertexZAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         chargedHadronEnergyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         neutralHadronEnergyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         photonEnergyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         electronEnergyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         muonEnergyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         HFHadronEnergyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         HFEMEnergyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Int_t           chargedHadronMultiplicityAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Int_t           neutralHadronMultiplicityAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Int_t           photonMultiplicityAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Int_t           electronMultiplicityAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Int_t           muonMultiplicityAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Int_t           HFHadronMultiplicityAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Int_t           HFEMMultiplicityAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         chargedEmEnergyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         neutralEmEnergyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         combinedSecondaryVertexBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         combinedSecondaryVertexMVABJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         jetBProbabilityBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         jetProbabilityBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         simpleSecondaryVertexHighEffBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         simpleSecondaryVertexHighPurBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         softMuonBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         softMuonByIP3dBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         softMuonByPtBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         softElectronBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         softElectronByIP3dBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         softElectronByPtBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         trackCountingHighPurBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         trackCountingHighEffBJetTagsAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         uncorrEnergyAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         rmsCandAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Float_t         ptDAK5PFPUcorrJet[310];   //[nAK5PFPUcorrJet]
   Int_t           nAK5GenJet;
   Int_t           chargeAK5GenJet[600];   //[nAK5GenJet]
   Float_t         energyAK5GenJet[600];   //[nAK5GenJet]
   Float_t         thetaAK5GenJet[600];   //[nAK5GenJet]
   Float_t         etaAK5GenJet[600];   //[nAK5GenJet]
   Float_t         phiAK5GenJet[600];   //[nAK5GenJet]
   Float_t         pxAK5GenJet[600];   //[nAK5GenJet]
   Float_t         pyAK5GenJet[600];   //[nAK5GenJet]
   Float_t         pzAK5GenJet[600];   //[nAK5GenJet]
   Float_t         vertexXAK5GenJet[600];   //[nAK5GenJet]
   Float_t         vertexYAK5GenJet[600];   //[nAK5GenJet]
   Float_t         vertexZAK5GenJet[600];   //[nAK5GenJet]
   Double_t        genPtHat;
