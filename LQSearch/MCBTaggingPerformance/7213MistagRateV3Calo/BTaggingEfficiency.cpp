...
void BTaggingEfficiency(string InputList, double CutValue, string OutputBase, int PUMin, int PUMax)
{
   ...
   NTPTree->SetBranchStatus("neutral*AK5Jet", true);
   NTPTree->SetBranchStatus("charged*AK5Jet", true);
   NTPTree->SetBranchStatus("*MultiplicityAK5Jet", true);
   ...
   for(int iEvent = 0; iEvent < NumberOfEvents; iEvent++)
   {
      ...
      {
         FourVector JetP(M.energyAK5Jet[i], M.pxAK5Jet[i],
            M.pyAK5Jet[i], M.pzAK5Jet[i]);
