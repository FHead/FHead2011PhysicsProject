...
int main(int argc, char *argv[])
{
   ...
   BTaggingEfficiency("WJetsV3.list", 1.7, "ReproduceBTaggingEfficiencyPU_TCHEL");
   /*
   BTaggingEfficiency("WJetsV3.list", 1.7, "ReproduceBTaggingEfficiencyPUSmall_TCHEL", 0, 4);
   BTaggingEfficiency("WJetsV3.list", 1.7, "ReproduceBTaggingEfficiencyPUMedium_TCHEL", 5, 7);
   BTaggingEfficiency("WJetsV3.list", 1.7, "ReproduceBTaggingEfficiencyPULarge_TCHEL", 8, 1000);
   */
   // BTaggingEfficiency("WJetsV3.list", 3.3, "ReproduceBTaggingEfficiencyPU_TCHEM");
   // BTaggingEfficiency("WJetsV3.list", 10.2, "ReproduceBTaggingEfficiencyPU_TCHET");
   /*
   BTaggingEfficiency("WJetsV3.list", 10.2, "ReproduceBTaggingEfficiencyPUSmall_TCHET", 0, 4);
   BTaggingEfficiency("WJetsV3.list", 10.2, "ReproduceBTaggingEfficiencyPUMedium_TCHET", 5, 7);
   BTaggingEfficiency("WJetsV3.list", 10.2, "ReproduceBTaggingEfficiencyPULarge_TCHET", 8, 1000);
   */
