input1=BackgroundMRDistribution.cpp
output1=ProduceMRTree
input2=FitMRDistribution.cpp
output2=DoFit
input3=MakePlots.cpp
output3=RunPlots
...
# echo "g++ $input2 $AllLibs $AllFlags $AllInclude -o $output2"
# g++ $input2 $AllLibs $AllFlags $AllInclude -o $output2
echo "g++ $input3 $AllLibs $AllFlags $AllInclude -o $output3"
g++ $input3 $AllLibs $AllFlags $AllInclude -o $output3
