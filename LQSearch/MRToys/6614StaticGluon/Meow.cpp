   ...
   const double VisibleMass, const double InvisibleMass)
{
   ...
   for(int iEntry = 0; iEntry < 100000; iEntry++)
   {
      ...
      VisibleChild1[0] = sqrt(VisibleChild1[1] * VisibleChild1[1] + VisibleChild1[2] * VisibleChild1[2] + VisibleChild1[3] * VisibleChild1[3]); 
      VisibleChild2[0] = sqrt(VisibleChild2[1] * VisibleChild2[1] + VisibleChild2[2] * VisibleChild2[2] + VisibleChild2[3] * VisibleChild2[3]); 
