...
int main(int argc, char *argv[])
{
   ...
   PsFileHelper PsFile("MRToy9_StaticGluon_UEDiJetHemispheres.ps");
   PsFile.AddTextPage("Toys to understand MR better - part 9");
   ...
   Explanations.push_back("MR is reconstructed by the two hemispheres.  Gamma CM is always 1.1");
   ...
   const double BottomMass, const double NuMass, const double UEJetMomentum, const double UEJetZBoostGamma)
{
   ...
   for(int iEntry = 0; iEntry < 1000000; iEntry++)
   {
      ...
      double VisibleHalf1[4] = {0, 0, 0, 0};
      double VisibleHalf2[4] = {0, 0, 0, 0};
      SplitIntoHalf(Bottom1P, Bottom2P, UEJet1, UEJet2, VisibleHalf1, VisibleHalf2);
