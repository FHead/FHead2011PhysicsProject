...
void MakePlot()
{
   ...
   TH2D *HQCD = (TH2D *)FQCD.Get("HPFJetGammaMRStarVsRStar");
   TH2D *HW = (TH2D *)FW.Get("HPFJetGammaMRStarVsRStar");
   TH2D *HTTbar = (TH2D *)FTTbar.Get("HPFJetGammaMRStarVsRStar");
   TH2D *HLM1 = (TH2D *)FLM1.Get("HPFJetGammaMRStarVsRStar");
   ...
   HQCD->GetYaxis()->SetTitle("R");
   HW->GetYaxis()->SetTitle("R");
   HTTbar->GetYaxis()->SetTitle("R");
   HLM1->GetYaxis()->SetTitle("R");
