...
void RecoLevelReference(string InputLQMass)
{
   ...
   TH1D HCombinedSecondaryVertexBTagNonLeadingPFPUCorrectedJet("HCombinedSecondaryVertexBTagNonLeadingPFPUCorrectedJet",
      "combined secondary vertex b tag for PF PU corrected jet", 100, 0, 1.5);
   TH1D HCombinedSecondaryVertexMVABTagNonLeadingPFPUCorrectedJet("HCombinedSecondaryVertexMVABTagNonLeadingPFPUCorrectedJet",
   ...
   TH1D HSimpleSecondaryVertexHighEffBTagNonLeadingPFPUCorrectedJet("HSimpleSecondaryVertexHighEffBTagNonLeadingPFPUCorrectedJet",
      "simple secondary vertex high eff. b tag for PF PU corrected jet", 100, 0, 6);
   TH1D HSimpleSecondaryVertexHighPurBTagNonLeadingPFPUCorrectedJet("HSimpleSecondaryVertexHighPurBTagNonLeadingPFPUCorrectedJet",
   ...
   TH1D HCombinedSecondaryVertexMVABTagLeadingPFPUCorrectedJet("HCombinedSecondaryVertexMVABTagLeadingPFPUCorrectedJet",
   ...
   TH1D HSimpleSecondaryVertexHighEffBTagLeadingPFPUCorrectedJet("HSimpleSecondaryVertexHighEffBTagLeadingPFPUCorrectedJet",
      "simple secondary vertex high eff. b tag for leading PF PU corrected jet", 100, 0, 6);
   TH1D HSimpleSecondaryVertexHighPurBTagLeadingPFPUCorrectedJet("HSimpleSecondaryVertexHighPurBTagLeadingPFPUCorrectedJet",
   ...
   TH1D HCombinedSecondaryVertexBTagSubLeadingPFPUCorrectedJet("HCombinedSecondaryVertexBTagSubLeadingPFPUCorrectedJet",
      "combined secondary vertex b tag for leading PF PU corrected jet", 100, 0, 1.5);
   TH1D HCombinedSecondaryVertexMVABTagSubLeadingPFPUCorrectedJet("HCombinedSecondaryVertexMVABTagSubLeadingPFPUCorrectedJet",
      "combined secondary vertex MVA b tag for leading PF PU corrected jet", 100, 0, 1.5);
   ...
   TH1D HJetProbabilityBTagSubLeadingPFPUCorrectedJet("HJetProbabilityBTagSubLeadingPFPUCorrectedJet",
      "jet probability b tag for leading PF PU corrected jet", 100, 0, 2);
   TH1D HSimpleSecondaryVertexHighEffBTagSubLeadingPFPUCorrectedJet("HSimpleSecondaryVertexHighEffBTagSubLeadingPFPUCorrectedJet",
      "simple secondary vertex high eff. b tag for leading PF PU corrected jet", 100, 0, 6);
   TH1D HSimpleSecondaryVertexHighPurBTagSubLeadingPFPUCorrectedJet("HSimpleSecondaryVertexHighPurBTagSubLeadingPFPUCorrectedJet",
      "simple secondary vertex high pur. b tag for leading PF PU corrected jet", 100, 0, 6);
   ...
   TH1D HPFPUCorrectedJetR("HPFPUCorrectedJetR", "R from leading two PF PU corrected jets (and PF MET)", 100, 0, 1.5);
   TH2D HPFPUCorrectedJetMRVsR("HPFPUCorrectedJetMRVsR", "MR vs. R from PF system;MR;R", 100, 0, 1000, 100, 0, 1.5);
   ...
   TH1D HPFPUCorrectedJetRCutEfficiency("HPFPUCorrectedJetRCutEfficiency", "PF PU corrected jet R cut efficiency", 20, 0, 20);
   for(int i = 0; i < 20; i++)
   ...
   for(int iEvent = 0; iEvent < NumberOfEvents; iEvent++)
   {
      ...
      double LeadingPFPUCorrectedJetP[4] = {0, 0, 0, 0};
      double SubLeadingPFPUCorrectedJetP[4] = {0, 0, 0, 0};
      ...
      {
         double JetP[4] = {M.energyAK5PFPUcorrJet[i], M.pxAK5PFPUcorrJet[i],
            M.pyAK5PFPUcorrJet[i], M.pzAK5PFPUcorrJet[i]};
         double UncorrectedJetP[4] = {M.energyAK5PFJet[i], M.pxAK5PFJet[i], M.pyAK5PFJet[i], M.pzAK5PFJet[i]};
         
         HPFJetVsPFPUCorrectedJetPT.Fill(GetPT(UncorrectedJetP), GetPT(JetP));
         HPUCorrectionVsJetPT.Fill(GetPT(JetP) - GetPT(UncorrectedJetP), GetPT(JetP));
         ...
         HPTPFPUCorrectedJet.Fill(GetPT(JetP));
         HEtaPFPUCorrectedJet.Fill(M.etaAK5PFPUcorrJet[i]);
         HPhiPFPUCorrectedJet.Fill(M.phiAK5PFPUcorrJet[i]);
         
         if(GetPT(JetP) >= 15)   NPFPUCorrectedJet15 = NPFPUCorrectedJet15 + 1;
         if(GetPT(JetP) >= 30)   NPFPUCorrectedJet30 = NPFPUCorrectedJet30 + 1;
         if(GetPT(JetP) >= 50)   NPFPUCorrectedJet50 = NPFPUCorrectedJet50 + 1;
         if(GetPT(JetP) >= 100)   NPFPUCorrectedJet100 = NPFPUCorrectedJet100 + 1;
         if(GetPT(JetP) >= 150)   NPFPUCorrectedJet150 = NPFPUCorrectedJet150 + 1;

         SortPFPUCorrectedJet.insert(pair<double, int>(GetPT(JetP), i));
      }
      ...
      {
         HLeadingPFPUCorrectedJetPT.Fill(GetPT(LeadingPFPUCorrectedJetP));
         HLeadingPFPUCorrectedJetPhi.Fill(GetPhi(LeadingPFPUCorrectedJetP));
         HLeadingPFPUCorrectedJetEta.Fill(GetEta(LeadingPFPUCorrectedJetP));
         
         HCombinedSecondaryVertexBTagLeadingPFPUCorrectedJet.Fill(M.combinedSecondaryVertexBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HCombinedSecondaryVertexMVABTagLeadingPFPUCorrectedJet.Fill(M.combinedSecondaryVertexMVABJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HJetBProbabilityBTagLeadingPFPUCorrectedJet.Fill(M.jetBProbabilityBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HJetProbabilityBTagLeadingPFPUCorrectedJet.Fill(M.jetProbabilityBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HSimpleSecondaryVertexHighEffBTagLeadingPFPUCorrectedJet.Fill(M.simpleSecondaryVertexHighEffBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HSimpleSecondaryVertexHighPurBTagLeadingPFPUCorrectedJet.Fill(M.simpleSecondaryVertexHighPurBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HSoftMuonBTagLeadingPFPUCorrectedJet.Fill(M.softMuonBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HSoftMuonByIP3DBTagLeadingPFPUCorrectedJet.Fill(M.softMuonByIP3dBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HSoftMuonByPtBTagLeadingPFPUCorrectedJet.Fill(M.softMuonByPtBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HSoftElectronBTagLeadingPFPUCorrectedJet.Fill(M.softElectronBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HSoftElectronByIP3DBTagLeadingPFPUCorrectedJet.Fill(M.softElectronByIP3dBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HSoftElectronByPtBTagLeadingPFPUCorrectedJet.Fill(M.softElectronByPtBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HTrackCountingHighPurBTagLeadingPFPUCorrectedJet.Fill(M.trackCountingHighPurBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
         HTrackCountingHighEffBTagLeadingPFPUCorrectedJet.Fill(M.trackCountingHighEffBJetTagsAK5PFPUcorrJet[LeadingPFPUCorrectedJetIndex]);
      }
      if(SubLeadingPFPUCorrectedJetIndex >= 0)
      {
         HSubLeadingPFPUCorrectedJetPT.Fill(GetPT(SubLeadingPFPUCorrectedJetP));
         HSubLeadingPFPUCorrectedJetPhi.Fill(GetPhi(SubLeadingPFPUCorrectedJetP));
         HSubLeadingPFPUCorrectedJetEta.Fill(GetEta(SubLeadingPFPUCorrectedJetP));
         
         HCombinedSecondaryVertexBTagSubLeadingPFPUCorrectedJet.Fill(M.combinedSecondaryVertexBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HCombinedSecondaryVertexMVABTagSubLeadingPFPUCorrectedJet.Fill(M.combinedSecondaryVertexMVABJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HJetBProbabilityBTagSubLeadingPFPUCorrectedJet.Fill(M.jetBProbabilityBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HJetProbabilityBTagSubLeadingPFPUCorrectedJet.Fill(M.jetProbabilityBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HSimpleSecondaryVertexHighEffBTagSubLeadingPFPUCorrectedJet.Fill(M.simpleSecondaryVertexHighEffBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HSimpleSecondaryVertexHighPurBTagSubLeadingPFPUCorrectedJet.Fill(M.simpleSecondaryVertexHighPurBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HSoftMuonBTagSubLeadingPFPUCorrectedJet.Fill(M.softMuonBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HSoftMuonByIP3DBTagSubLeadingPFPUCorrectedJet.Fill(M.softMuonByIP3dBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HSoftMuonByPtBTagSubLeadingPFPUCorrectedJet.Fill(M.softMuonByPtBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HSoftElectronBTagSubLeadingPFPUCorrectedJet.Fill(M.softElectronBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HSoftElectronByIP3DBTagSubLeadingPFPUCorrectedJet.Fill(M.softElectronByIP3dBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HSoftElectronByPtBTagSubLeadingPFPUCorrectedJet.Fill(M.softElectronByPtBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HTrackCountingHighPurBTagSubLeadingPFPUCorrectedJet.Fill(M.trackCountingHighPurBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
         HTrackCountingHighEffBTagSubLeadingPFPUCorrectedJet.Fill(M.trackCountingHighEffBJetTagsAK5PFPUcorrJet[SubLeadingPFPUCorrectedJetIndex]);
      }
      if(LeadingPFPUCorrectedJetIndex >= 0 && SubLeadingPFPUCorrectedJetIndex >= 0)
      {
         HLeadingTwoPFPUCorrectedJetsPTVsPT.Fill(GetPT(LeadingPFPUCorrectedJetP), GetPT(SubLeadingPFPUCorrectedJetP));
      ...
      for(multimap<double, int>::iterator iter = SortPFPUCorrectedJet.begin(); iter != SortPFPUCorrectedJet.end(); iter++)
      {
         ...
         HCombinedSecondaryVertexBTagNonLeadingPFPUCorrectedJet.Fill(M.combinedSecondaryVertexBJetTagsAK5PFPUcorrJet[i]);
         HCombinedSecondaryVertexMVABTagNonLeadingPFPUCorrectedJet.Fill(M.combinedSecondaryVertexMVABJetTagsAK5PFPUcorrJet[i]);
         HJetBProbabilityBTagNonLeadingPFPUCorrectedJet.Fill(M.jetBProbabilityBJetTagsAK5PFPUcorrJet[i]);
         HJetProbabilityBTagNonLeadingPFPUCorrectedJet.Fill(M.jetProbabilityBJetTagsAK5PFPUcorrJet[i]);
         HSimpleSecondaryVertexHighEffBTagNonLeadingPFPUCorrectedJet.Fill(M.simpleSecondaryVertexHighEffBJetTagsAK5PFPUcorrJet[i]);
         HSimpleSecondaryVertexHighPurBTagNonLeadingPFPUCorrectedJet.Fill(M.simpleSecondaryVertexHighPurBJetTagsAK5PFPUcorrJet[i]);
      ...
      if(ClosestPFJetToBHadronFromLQ >= 0)
      {
         ...
         HGenBHadronClosestPFJetCSVM.Fill(M.combinedSecondaryVertexMVABJetTagsAK5PFJet[ClosestPFJetToBHadronFromLQ]);
      }
      if(ClosestPFJetToBHadronFromLQbar >= 0)
      {
         ...
         HGenBHadronClosestPFJetCSV.Fill(M.combinedSecondaryVertexBJetTagsAK5PFJet[ClosestPFJetToBHadronFromLQbar]);
         HGenBHadronClosestPFJetCSV.Fill(M.combinedSecondaryVertexMVABJetTagsAK5PFJet[ClosestPFJetToBHadronFromLQbar]);
      }
   }
   ...
   AddThreeHistogramOverlayPlot(PsFile,
      ...
      "simple secondary vertex b tag (high eff.) (PF PU corrected jet)", "non-leading", "leading", "sub-leading", "", true);
   AddThreeHistogramOverlayPlot(PsFile,
      ...
      "simple secondary vertex b tag (high pur.) (PF PU corrected jet)", "non-leading", "leading", "sub-leading", "", true);
   AddThreeHistogramOverlayPlot(PsFile,
