...
void RecoLevelReference(string InputLQMass = "250", string OutputFile = "output.root");
...
int main(int argc, char *argv[])
{
   ...
   if(argc > 1)
      InputLQMass = argv[1];
   RecoLevelReference(InputLQMass, "LQ" + InputLQMass + "_Histograms.root");

   return 0;
}

//---------------------------------------------------------------------------
void RecoLevelReference(string InputLQMass, string OutputFile)
{
   // Read inputs
   TFile F(("Samples/LQ3_" + InputLQMass + "_NTPTree.root").c_str());
   ...
   ExplanationText.push_back("Official summer11 samples");
   ExplanationText.push_back("Supposedly D6T tune with pythia 6");
   ExplanationText.push_back("Exported into v4 ntp tree using CMSSW423");
   ...
   TableOfContentItems.push_back("Closest PF PU corrected jet to \"final\" b-hadron");
   ...
   for(int iEvent = 0; iEvent < NumberOfEvents; iEvent++)
   {
      ...
      for(int i = 0; i < M.nAK5Jet; i++)
      {
         ...
         */
         ...
         if(M.etaAK5Jet[i] < -3 || M.etaAK5Jet[i] > 3)
            continue;
      ...
      for(multimap<double, int>::iterator iter = SortAK5Jet.begin(); iter != SortAK5Jet.end(); iter++)
      {
         ...
         HCombinedSecondaryVertexBTagNonLeadingCaloJet.Fill(M.combinedSecondaryVertexBJetTagsAK5Jet[i]);
         HCombinedSecondaryVertexMVABTagNonLeadingCaloJet.Fill(M.combinedSecondaryVertexMVABJetTagsAK5Jet[i]);
         HJetBProbabilityBTagNonLeadingCaloJet.Fill(M.jetBProbabilityBJetTagsAK5Jet[i]);
         HJetProbabilityBTagNonLeadingCaloJet.Fill(M.jetProbabilityBJetTagsAK5Jet[i]);
         HSimpleSecondaryVertexHighEffBTagNonLeadingCaloJet.Fill(
            M.simpleSecondaryVertexHighEffBJetTagsAK5Jet[i]);
         HSimpleSecondaryVertexHighPurBTagNonLeadingCaloJet.Fill(
            M.simpleSecondaryVertexHighPurBJetTagsAK5Jet[i]);
         HSoftMuonBTagNonLeadingCaloJet.Fill(M.softMuonBJetTagsAK5Jet[i]);
         HSoftMuonByIP3DBTagNonLeadingCaloJet.Fill(M.softMuonByIP3dBJetTagsAK5Jet[i]);
         HSoftMuonByPtBTagNonLeadingCaloJet.Fill(M.softMuonByPtBJetTagsAK5Jet[i]);
         // HSoftElectronBTagNonLeadingCaloJet.Fill(M.softElectronBJetTagsAK5Jet[i]);
         HSoftElectronByIP3DBTagNonLeadingCaloJet.Fill(M.softElectronByIP3dBJetTagsAK5Jet[i]);
         HSoftElectronByPtBTagNonLeadingCaloJet.Fill(M.softElectronByPtBJetTagsAK5Jet[i]);
         HTrackCountingHighPurBTagNonLeadingCaloJet.Fill(M.trackCountingHighPurBJetTagsAK5Jet[i]);
         HTrackCountingHighEffBTagNonLeadingCaloJet.Fill(M.trackCountingHighEffBJetTagsAK5Jet[i]);
      }
      ...
      for(int i = 0; i < M.nAK5PFPUcorrJet; i++)
      {
         ...
         FourVector UncorrectedJetP = JetP * M.uncorrEnergyAK5PFPUcorrJet[i] / M.energyAK5PFPUcorrJet[i];
      ...
      if(LeadingPFPUCorrectedJetIndex >= 0)
         HPFMETLeadingJetDPhi.Fill(GetDPhi(PFMETP, LeadingPFPUCorrectedJetP));
      if(LeadingPFPUCorrectedJetIndex >= 0 && SubLeadingPFPUCorrectedJetIndex >= 0)
      {
         FourVector LeadingTwoJetsP = LeadingPFPUCorrectedJetP + SubLeadingPFPUCorrectedJetP;
      ...
      if(FinalBHadronFromLQ >= 0)
      {
         ...
         ClosestPFJetToBHadronFromLQ = FindClosestJet(M.etaAK5PFPUcorrJet, M.phiAK5PFPUcorrJet, M.nAK5PFPUcorrJet,
         ...
         {
            ClosestPFJetToBHadronFromLQP = FourVector(M.energyAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQ],
               M.pxAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQ],
               M.pyAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQ],
               M.pzAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQ]);
         }
      }
      if(FinalBHadronFromLQbar >= 0)
      {
         ...
         ClosestPFJetToBHadronFromLQbar = FindClosestJet(M.etaAK5PFPUcorrJet, M.phiAK5PFPUcorrJet, M.nAK5PFPUcorrJet,
            EtaFinalBHadron, PhiFinalBHadron);
         ...
         {
            ClosestPFJetToBHadronFromLQbarP = FourVector(M.energyAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQbar],
               M.pxAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQbar],
               M.pyAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQbar],
               M.pzAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQbar]);
         }
      }
      ...
      if(ClosestPFJetToBHadronFromLQ >= 0)
      {
         ...
         HGenBHadronClosestPFJetTCHE.Fill(M.trackCountingHighEffBJetTagsAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQ]);
         HGenBHadronClosestPFJetTCHP.Fill(M.trackCountingHighPurBJetTagsAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQ]);
         HGenBHadronClosestPFJetCSV.Fill(M.combinedSecondaryVertexBJetTagsAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQ]);
         HGenBHadronClosestPFJetCSVM.Fill(
            M.combinedSecondaryVertexMVABJetTagsAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQ]);
      }
      if(ClosestPFJetToBHadronFromLQbar >= 0)
      {
         ...
         HGenBHadronClosestPFJetTCHE.Fill(M.trackCountingHighEffBJetTagsAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQbar]);
         HGenBHadronClosestPFJetTCHP.Fill(M.trackCountingHighPurBJetTagsAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQbar]);
         HGenBHadronClosestPFJetCSV.Fill(
            M.combinedSecondaryVertexBJetTagsAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQbar]);
         HGenBHadronClosestPFJetCSV.Fill(
            M.combinedSecondaryVertexMVABJetTagsAK5PFPUcorrJet[ClosestPFJetToBHadronFromLQbar]);
      }
   ...
   PsFile.AddPlot(HNPU, "text0 hist", true);   HNPU.Write();
   PsFile.AddPlot(HZPositionPU, "", false);   HZPositionPU.Write();
   PsFile.AddPlot(HNPV, "text0 hist", true);   HNPV.Write();
   PsFile.AddPlot(HPVZ, "", true);   HPVZ.Write();
   PsFile.AddPlot(HPVXY, "colz", false, true);   HPVXY.Write();
   PsFile.AddPlot(HPVXYSignificance, "", true);   HPVXYSignificance.Write();
   PsFile.AddPlot(HPVSumPT, "", true);   HPVSumPT.Write();
   PsFile.AddPlot(HPVndof, "", true);   HPVndof.Write();
   PsFile.AddPlot(HPVChi2, "", true);   HPVChi2.Write();
   PsFile.AddPlot(HNPUVsNPV, "colz text00", false);   HNPUVsNPV.Write();
   PsFile.AddPlot(HBestPVZ, "", true);   HBestPVZ.Write();
   PsFile.AddPlot(HBestPVXY, "colz", false, true);   HBestPVXY.Write();
   PsFile.AddPlot(HBestPVXYSignificance, "", false);   HBestPVXYSignificance.Write();
   PsFile.AddPlot(HBestPVSumPT, "", true);   HBestPVSumPT.Write();
   PsFile.AddPlot(HBestPVndof, "", true);   HBestPVndof.Write();
   PsFile.AddPlot(HBestPVChi2, "", true);   HBestPVChi2.Write();
   ...
   PsFile.AddPlot(HPTAK5Jet, "", true);   HPTAK5Jet.Write();
   PsFile.AddPlot(HEtaAK5Jet, "", false);
   PsFile.AddPlot(HPhiAK5Jet, "", false);
   PsFile.AddPlot(HLeadingAK5JetPT, "", true);   HLeadingAK5JetPT.Write();
   ...
   PsFile.AddPlot(HCaloMET, "", true);   HCaloMET.Write();
