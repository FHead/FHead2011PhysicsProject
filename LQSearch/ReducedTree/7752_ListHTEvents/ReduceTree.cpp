...
int main(int argc, char *argv[])
{
   ...
   TTree OutputTree("SuperReducedTree", "Super reduced tree for muhad");

   OutputTree.Branch("RunNumber", &M.RunNumber, "RunNumber/D");
   OutputTree.Branch("EventNumber", &M.EventNumber, "EventNumber/D");
   OutputTree.Branch("LumiSection", &M.LumiSection, "LumiSection/D");

   double MR, R, MR11, R11, MRPhoton, RPhoton, MRL, RL;
