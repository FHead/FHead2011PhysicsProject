...
int main()
{
   ...
   ReadSample("DataSamples/MuHadRun2011Av4_All.root", "DataPlots", -1, 778.791327808);
   ReadSample("MCSamples/TTJets_TuneZ2_7TeV-madgraph-tauola_All.root", "TTbar", 165, 778.791327808);   // NNLL
   ReadSample("MCSamples/WJetsToLNu_TuneZ2_7TeV-madgraph-tauola_All.root", "W", 31314, 778.791327808);   // NNLO
   ReadSample("MCSamples/VVJetsTo4L_TuneD6T_7TeV-madgraph-tauola_All.root", "VV", 4.8, 778.791327808);   // Production
   ReadSample("MCSamples/PhotonVJets_7TeV-madgraph_All.root", "GammaVJet", 173, 778.791327808);   // Production
   ReadSample("MCSamples/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_All.root", "DY50", 3048, 778.791327808);   // NNLO
   ReadSample("MCSamples/ZinvisibleJets_7TeV-madgraph_All.root", "Znunu", 3048 * 6, 778.791327808);   // guessed
   ReadSample("MCSamples/QCD_TuneD6T_HT-50To100_7TeV-madgraph_All.root", "QCD1", 30000000, 778.791327808);   // production
   ReadSample("MCSamples/QCD_TuneD6T_HT-100To250_7TeV-madgraph_All.root", "QCD2", 7000000, 778.791327808);   // production
   ReadSample("MCSamples/QCD_TuneD6T_HT-250To500_7TeV-madgraph_All.root", "QCD3", 171000, 778.791327808);   // production
   ReadSample("MCSamples/QCD_TuneD6T_HT-500To1000_7TeV-madgraph_All.root", "QCD4", 5200, 778.791327808);   // production
   ReadSample("MCSamples/QCD_TuneD6T_HT-1000_7TeV-madgraph_All.root", "QCD5", 83, 778.791327808);   // production
