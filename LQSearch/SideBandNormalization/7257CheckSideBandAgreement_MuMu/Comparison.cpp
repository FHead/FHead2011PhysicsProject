...
int main()
{
   ...
   ReadSample("DataSamples/DoubleMuMay10ReRecov1_All.root", "DataPlotsA", -1, 176.311);
   ReadSample("DataSamples/DoubleMuRun2011Av4_All.root", "DataPlotsB", -1, 393.672);
   ReadSample("MCSamples/TTJets_TuneZ2_7TeV-madgraph-tauola_All.root", "TTbar", 165, 569.983);   // NNLL
   ReadSample("MCSamples/WJetsToLNu_TuneZ2_7TeV-madgraph-tauola_All.root", "W", 31314, 569.983);   // NNLO
   ReadSample("MCSamples/VVJetsTo4L_TuneD6T_7TeV-madgraph-tauola_All.root", "VV", 4.8, 569.983);   // Production
   ReadSample("MCSamples/PhotonVJets_7TeV-madgraph_All.root", "GammaVJet", 173, 569.983);   // Production
   ReadSample("MCSamples/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_All.root", "DY50", 3048, 569.983);   // NNLO
   ReadSample("MCSamples/ZinvisibleJets_7TeV-madgraph_All.root", "Znunu", 3048 * 6, 569.983);   // guessed
   ReadSample("MCSamples/QCD_TuneD6T_HT-50To100_7TeV-madgraph_All.root", "QCD1", 30000000, 569.983);   // production
   ReadSample("MCSamples/QCD_TuneD6T_HT-100To250_7TeV-madgraph_All.root", "QCD2", 7000000, 569.983);   // production
   ReadSample("MCSamples/QCD_TuneD6T_HT-250To500_7TeV-madgraph_All.root", "QCD3", 171000, 569.983);   // production
   ReadSample("MCSamples/QCD_TuneD6T_HT-500To1000_7TeV-madgraph_All.root", "QCD4", 5200, 569.983);   // production
   ReadSample("MCSamples/QCD_TuneD6T_HT-1000_7TeV-madgraph_All.root", "QCD5", 83, 569.983);   // production
   ...
   */
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      if(M.GoodElectronCount != 0)   // no electron
         continue;
      if(M.GoodMuonCount < 2)   // want double muon
         continue;
      if(M.Muon1PT < 20 || M.Muon2PT < 20)
         continue;
