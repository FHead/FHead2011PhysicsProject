...
int main()
{
   ...
   TH2D HEfficiency("HEfficiency", ";m_{#tilde{b}} [GeV];m_{#tilde{#chi}^{0}} [GeV]", 48, 50, 1250, 48, 50, 1250);
   TH2D HEfficiencyZoomed("HEfficiencyZoomed", ";m_{#tilde{b}} [GeV];m_{#tilde{#chi}^{0}} [GeV]", 19, 50, 525, 19, 50, 525);
   TH2D HEfficiencyError("HEfficiencyError", "Efficiency error;sbottom;neutralino", 48, 50, 1250, 48, 50, 1250);
   TH2D HRelativeEfficiency("HRelativeEfficiency",
      ";m_{#tilde{b}} [GeV];m_{#tilde{#chi}^{0}} [GeV]", 48, 50, 1250, 48, 50, 1250);

   ifstream in("StitchedEfficiency");
   ...
   while(in)
   {
      ...
      HRelativeEfficiency.Fill(m0, m12, seff / eff);
   }
   ...
   FillInHoles(HRelativeEfficiency);
   ...
   PsFile.AddPlot(HRelativeEfficiency, "colz");   HRelativeEfficiency.Write();
   ...
   HEfficiencyZoomedClone->SetLineColor(kWhite);
   HEfficiencyZoomedClone->SetLineWidth(3);
