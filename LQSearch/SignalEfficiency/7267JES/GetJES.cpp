...
int main()
{
   ...
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.30);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.31);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.32);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.33);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.34);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.35);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.36);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.37);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.38);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.39);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.40);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.41);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.42);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.43);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.44);
   CheckSampleEfficiency("Samples/LQ350.root", 0.477 * 1000, 0.45);
   
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.30);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.31);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.32);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.33);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.34);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.35);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.36);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.37);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.38);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.39);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.40);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.41);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.42);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.43);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.44);
   CheckSampleEfficiency("Samples/LQ450.root", 0.0949 * 1000, 0.45);
...
void CheckSampleEfficiency(string InputFile, double ExpectedYield, double R2Min)
{
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 400 && R2New < 0.50)
         PassedWeight = PassedWeight + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 400 && R2NewUp < 0.50)
         PassedWeightUp = PassedWeightUp + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 400 && R2NewDown < 0.5)
         PassedWeightDown = PassedWeightDown + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 450 && R2New < 0.5)
         PassedWeightMR450 = PassedWeightMR450 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 450 && R2NewUp < 0.5)
         PassedWeightMR450Up = PassedWeightMR450Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 450 && R2NewDown < 0.5)
         PassedWeightMR450Down = PassedWeightMR450Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 500 && R2New < 0.5)
         PassedWeightMR500 = PassedWeightMR500 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 500 && R2NewUp < 0.5)
         PassedWeightMR500Up = PassedWeightMR500Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 500 && R2NewDown < 0.5)
         PassedWeightMR500Down = PassedWeightMR500Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 550 && R2New < 0.5)
         PassedWeightMR550 = PassedWeightMR550 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 550 && R2NewUp < 0.5)
         PassedWeightMR550Up = PassedWeightMR550Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 550 && R2NewDown < 0.5)
         PassedWeightMR550Down = PassedWeightMR550Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 600 && R2New < 0.5)
         PassedWeightMR600 = PassedWeightMR600 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 600 && R2NewUp < 0.5)
         PassedWeightMR600Up = PassedWeightMR600Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 600 && R2NewDown < 0.5)
         PassedWeightMR600Down = PassedWeightMR600Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 650 && R2New < 0.5)
         PassedWeightMR650 = PassedWeightMR650 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 650 && R2NewUp < 0.5)
         PassedWeightMR650Up = PassedWeightMR650Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 650 && R2NewDown < 0.5)
         PassedWeightMR650Down = PassedWeightMR650Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 700 && R2New < 0.5)
         PassedWeightMR700 = PassedWeightMR700 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 700 && R2NewUp < 0.5)
         PassedWeightMR700Up = PassedWeightMR700Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 700 && R2NewDown < 0.5)
         PassedWeightMR700Down = PassedWeightMR700Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 750 && R2New < 0.5)
         PassedWeightMR750 = PassedWeightMR750 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 750 && R2NewUp < 0.5)
         PassedWeightMR750Up = PassedWeightMR750Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 750 && R2NewDown < 0.5)
         PassedWeightMR750Down = PassedWeightMR750Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 800 && R2New < 0.5)
         PassedWeightMR800 = PassedWeightMR800 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 800 && R2New < 0.5)
         PassedWeightMR800Up = PassedWeightMR800Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 800 && R2New < 0.5)
