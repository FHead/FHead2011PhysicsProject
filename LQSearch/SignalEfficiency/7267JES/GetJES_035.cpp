...
void CheckSampleEfficiency(string InputFile, double ExpectedYield)
{
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= 0.35 && MRNew >= 400)
         PassedWeight = PassedWeight + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= 0.35 && MRNewUp >= 400)
         PassedWeightUp = PassedWeightUp + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= 0.35 && MRNewDown >= 400)
         PassedWeightDown = PassedWeightDown + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= 0.35 && MRNew >= 450)
         PassedWeightMR450 = PassedWeightMR450 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= 0.35 && MRNewUp >= 450)
         PassedWeightMR450Up = PassedWeightMR450Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= 0.35 && MRNewDown >= 450)
         PassedWeightMR450Down = PassedWeightMR450Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= 0.35 && MRNew >= 500)
         PassedWeightMR500 = PassedWeightMR500 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= 0.35 && MRNewUp >= 500)
         PassedWeightMR500Up = PassedWeightMR500Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= 0.35 && MRNewDown >= 500)
         PassedWeightMR500Down = PassedWeightMR500Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= 0.35 && MRNew >= 550)
         PassedWeightMR550 = PassedWeightMR550 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= 0.35 && MRNewUp >= 550)
         PassedWeightMR550Up = PassedWeightMR550Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= 0.35 && MRNewDown >= 550)
         PassedWeightMR550Down = PassedWeightMR550Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= 0.35 && MRNew >= 600)
         PassedWeightMR600 = PassedWeightMR600 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= 0.35 && MRNewUp >= 600)
         PassedWeightMR600Up = PassedWeightMR600Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= 0.35 && MRNewDown >= 600)
         PassedWeightMR600Down = PassedWeightMR600Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= 0.35 && MRNew >= 650)
         PassedWeightMR650 = PassedWeightMR650 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= 0.35 && MRNewUp >= 650)
         PassedWeightMR650Up = PassedWeightMR650Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= 0.35 && MRNewDown >= 650)
         PassedWeightMR650Down = PassedWeightMR650Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= 0.35 && MRNew >= 700)
         PassedWeightMR700 = PassedWeightMR700 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= 0.35 && MRNewUp >= 700)
         PassedWeightMR700Up = PassedWeightMR700Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= 0.35 && MRNewDown >= 700)
         PassedWeightMR700Down = PassedWeightMR700Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= 0.35 && MRNew >= 750)
         PassedWeightMR750 = PassedWeightMR750 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= 0.35 && MRNewUp >= 750)
         PassedWeightMR750Up = PassedWeightMR750Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= 0.35 && MRNewDown >= 750)
         PassedWeightMR750Down = PassedWeightMR750Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= 0.35 && MRNew >= 800)
         PassedWeightMR800 = PassedWeightMR800 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= 0.35 && MRNewUp >= 800)
         PassedWeightMR800Up = PassedWeightMR800Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= 0.35 && MRNewDown >= 800)
