...
int main()
{
   CheckSampleEfficiency("LQSamples/LQToBNutau_350.list.root", 1, 0.38);
   CheckSampleEfficiency("Samples/LQ350.root", 1, 0.38);
   CheckSampleEfficiency("LQSamples/LQToBNutau_350.list.root", 1, 0.35);
   CheckSampleEfficiency("Samples/LQ350.root", 1, 0.35);
   CheckSampleEfficiency("LQSamples/LQToBNutau_350.list.root", 1, 0.30);
   CheckSampleEfficiency("Samples/LQ350.root", 1, 0.30);
   
   double RCuts[] = {0.25, 0.30, 0.35, 0.38, 0.42};
   
   for(int i = 0; i < 5; i++)
   {
      CheckSampleEfficiency("LQSamples/LQToBNutau_200.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_210.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_220.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_230.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_240.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_260.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_270.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_280.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_290.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_310.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_320.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_330.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_340.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_350.list.root", 1, RCuts[i]);
      // CheckSampleEfficiency("LQSamples/LQToBNutau_400.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_450.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_500.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_550.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_600.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_750.list.root", 1, RCuts[i]);
      CheckSampleEfficiency("LQSamples/LQToBNutau_850.list.root", 1, RCuts[i]);
   }
