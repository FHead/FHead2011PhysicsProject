...
int main()
{
   ...
   */
   ...
   CheckSampleEfficiency("Samples/LQ250.root", 1, 0.25);
   CheckSampleEfficiency("LQSamples/LQToBNutau_350.list.root", 1, 0.25);
   CheckSampleEfficiency("LQSamples/LQToBNutau_450.list.root", 1, 0.25);
   CheckSampleEfficiency("LQSamples/LQToBNutau_200.list.root", 1, 0.25);
   CheckSampleEfficiency("LQSamples/LQToBNutau_550.list.root", 1, 0.25);
   
   for(int i = 0; i < 5; i++)
   {
      CheckSampleEfficiency("Samples/LQ250.root", 1, RCuts[i]);
...
void CheckSampleEfficiency(string InputFile, double ExpectedYield, double R2Min)
{
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      double WPU = M.GetCurrentWeight() * 0.96 * 0.96;   // 0.96 is from M tag
                                                         // BTV-11-004
      ...
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 450)
         PassedWeightMR450 = PassedWeightMR450 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 450)
         PassedWeightMR450Up = PassedWeightMR450Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 450)
         PassedWeightMR450Down = PassedWeightMR450Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 500)
         PassedWeightMR500 = PassedWeightMR500 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 500)
         PassedWeightMR500Up = PassedWeightMR500Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 500)
         PassedWeightMR500Down = PassedWeightMR500Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 550)
         PassedWeightMR550 = PassedWeightMR550 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 550)
         PassedWeightMR550Up = PassedWeightMR550Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 550)
         PassedWeightMR550Down = PassedWeightMR550Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 600)
         PassedWeightMR600 = PassedWeightMR600 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 600)
         PassedWeightMR600Up = PassedWeightMR600Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 600)
         PassedWeightMR600Down = PassedWeightMR600Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 650)
         PassedWeightMR650 = PassedWeightMR650 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 650)
         PassedWeightMR650Up = PassedWeightMR650Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 650)
         PassedWeightMR650Down = PassedWeightMR650Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 700)
         PassedWeightMR700 = PassedWeightMR700 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 700)
         PassedWeightMR700Up = PassedWeightMR700Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 700)
         PassedWeightMR700Down = PassedWeightMR700Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 750)
         PassedWeightMR750 = PassedWeightMR750 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 750)
         PassedWeightMR750Up = PassedWeightMR750Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 750)
         PassedWeightMR750Down = PassedWeightMR750Down + WPU;
      
      if(CaloJetCount60 >= 2 && JetPassBTagLoose >= 2 && R2New >= R2Min && MRNew >= 800)
         PassedWeightMR800 = PassedWeightMR800 + WPU;
      if(CaloJetCount60Up >= 2 && JetPassBTagLooseUp >= 2 && R2NewUp >= R2Min && MRNewUp >= 800)
         PassedWeightMR800Up = PassedWeightMR800Up + WPU;
      if(CaloJetCount60Down >= 2 && JetPassBTagLooseDown >= 2 && R2NewDown >= R2Min && MRNewDown >= 800)
   ...
   */
   ...
   cout << "   8.07%   " << PassedWeight / TotalWeight * 0.0807 << endl;
   cout << "   Total   "
      << sqrt((PassedWeightUp - PassedWeightDown)  * (PassedWeightUp - PassedWeightDown) / 4
      + 0.0807 * 0.0807 * PassedWeight * PassedWeight) / TotalWeight << endl;
   /*
