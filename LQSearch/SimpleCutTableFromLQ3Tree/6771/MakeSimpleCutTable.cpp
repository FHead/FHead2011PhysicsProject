...
int main(int argc, char *argv[])
{
   ...
   TH2D HExpectedYieldSummaryTranspose("HExpectedYieldSummaryTranspose", "Expected yield in 1/fb",
      11, 0, 11, Samples.size(), 0, Samples.size());
   ...
   HExpectedYieldSummary.GetYaxis()->SetBinLabel(9, "R 0.20");
   ...
   HExpectedYieldSummaryTranspose.GetXaxis()->SetBinLabel(7, "BetaR");
   HExpectedYieldSummaryTranspose.GetXaxis()->SetBinLabel(8, "MR 200");
   HExpectedYieldSummaryTranspose.GetXaxis()->SetBinLabel(9, "R 0.20");
   HExpectedYieldSummaryTranspose.GetXaxis()->SetBinLabel(10, "MR 400");
   HExpectedYieldSummaryTranspose.GetXaxis()->SetBinLabel(11, "R 0.4");
   ...
   for(int i = 0; i < (int)Samples.size(); i++)
   {
      ...
      HExpectedYieldSummary.SetBinContent(i + 1, 9, Samples[i].AfterR020Cut * Factor);
      HExpectedYieldSummary.SetBinContent(i + 1, 10, Samples[i].AfterMR400Cut * Factor);
      HExpectedYieldSummary.SetBinContent(i + 1, 11, Samples[i].AfterR050Cut * Factor);
      ...
      HExpectedYieldSummaryTranspose.SetBinContent(7, i + 1, Samples[i].AfterBetaRCut * Factor);
      HExpectedYieldSummaryTranspose.SetBinContent(8, i + 1, Samples[i].AfterMR200Cut * Factor);
      HExpectedYieldSummaryTranspose.SetBinContent(9, i + 1, Samples[i].AfterR020Cut * Factor);
      HExpectedYieldSummaryTranspose.SetBinContent(10, i + 1, Samples[i].AfterMR400Cut * Factor);
      HExpectedYieldSummaryTranspose.SetBinContent(11, i + 1, Samples[i].AfterR050Cut * Factor);
   }
   ...
   Canvas2D.Divide(2);
   Canvas2D.cd(1);
   TH2D *HSMOnly2D = (TH2D *)(Samples[2].HMRR->Clone("HSMOnly2D"));
   for(int i = 3; i < (int)Samples.size(); i++)
      HSMOnly2D->Add(Samples[i].HMRR);
   HSMOnly2D->SetTitle("MR vs. R, All SM background");
   HSMOnly2D->Draw("colz");
   HSMOnly2D->SetStats(0);
   Canvas2D.cd(2);
   Samples[0].HMRR->Draw("colz");
   Samples[0].HMRR->SetStats(0);
   Canvas2D.SaveAs("MRR.png");
   Canvas2D.SaveAs("MRR.C");
   Canvas2D.SaveAs("MRR.eps");
...
SampleCounts ReadSample(PsFileHelper &PsFile, string FileName, string Tag, double CrossSection)
{
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      double GammaMRStar = GetGammaRStar(Hemispheres[0], Hemispheres[1]) * MRStar;
   ...
   HCountHistogram.GetXaxis()->SetBinLabel(9, "R 0.20");
   HCountHistogram.GetXaxis()->SetBinLabel(10, "MR 400");
   HCountHistogram.GetXaxis()->SetBinLabel(11, "R 0.5");
   ...
   HCountHistogram.SetBinContent(9, Result.AfterR020Cut);
   HCountHistogram.SetBinContent(10, Result.AfterMR400Cut);
   HCountHistogram.SetBinContent(11, Result.AfterR050Cut);
