...
int main(int argc, char *argv[])
{
   ...
   Samples.push_back(ReadSample(PsFile, "Samples/DYJetsToLL_TuneD6T_M-50_7TeV-madgraph-tauola_all.root",
      "DY_50", 3048));
   Samples.push_back(ReadSample(PsFile, "QCDSamples/QCD_TuneD6T_HT-50To100_7TeV-madgraph_All.root",
      "QCD50", 30000000));
   Samples.push_back(ReadSample(PsFile, "QCDSamples/QCD_TuneD6T_HT-100To250_7TeV-madgraph_All.root",
      "QCD100", 7000000));
   Samples.push_back(ReadSample(PsFile, "QCDSamples/QCD_TuneD6T_HT-250To500_7TeV-madgraph_All.root",
      "QCD250", 171000));
   Samples.push_back(ReadSample(PsFile, "QCDSamples/QCD_TuneD6T_HT-500To1000_7TeV-madgraph_All.root",
      "QCD500", 5200));
   Samples.push_back(ReadSample(PsFile, "QCDSamples/QCD_TuneD6T_HT-1000_7TeV-madgraph_All.root",
      "QCD1000", 83));
