...
int main(int argc, char *argv[])
{
   ...
   Samples.push_back(ReadSample(PsFile, "Samples/VVJetsTo4L_TuneD6T_7TeV-madgraph-tauola_All.root", "VV", 67.1));
   ...
   Samples.push_back(ReadSample(PsFile, "Samples/DYJetsToLL_TuneD6T_M-50_7TeV-madgraph-tauola_All.root",
      "DY_50", 3048));
   Samples.push_back(ReadSample(PsFile, "Samples/ZinvisibleJets_7TeV-madgraph_All.root",
      "Znunu", 3048 * 6));   // roughly...
   ...
   for(int i = 0; i < (int)Samples.size(); i++)
   {
      ...
      // else
      //    Samples[i].HMRStar_RStar050Cut->SetFillColor(i + 1);
