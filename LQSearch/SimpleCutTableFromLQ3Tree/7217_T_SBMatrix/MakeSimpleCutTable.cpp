...
int main(int argc, char *argv[])
{
   ...
   Samples.push_back(ReadSample(PsFile, "BSamples/ArturBQCD_30To50_All.root", "BQCD30", 53100000 * 0.075));
   Samples.push_back(ReadSample(PsFile, "BSamples/ArturBQCD_50To150_All.root", "BQCD50", 7236000 * 0.09));
   Samples.push_back(ReadSample(PsFile, "BSamples/ArturBQCD_150_All.root", "BQCD150", 47620 * 0.114));
