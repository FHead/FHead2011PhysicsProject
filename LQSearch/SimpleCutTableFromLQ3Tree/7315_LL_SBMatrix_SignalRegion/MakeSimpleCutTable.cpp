...
int main(int argc, char *argv[])
{
   ...
   Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_340.list.root", "LQ340", 0.570));
   cout << "Done" << endl;
   /*
   Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_200.list.root", "LQ200", 11.9));
   // Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_210.list.root", "LQ210", 11.9));
   // Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_220.list.root", "LQ220", 11.9));
   // Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_230.list.root", "LQ230", 11.9));
   // Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_240.list.root", "LQ240", 11.9));
   Samples.push_back(ReadSample(PsFile, "Samples/LQ250.root", "LQ250", 3.47));
   // Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_260.list.root", "LQ260", 11.9));
   // Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_270.list.root", "LQ270", 11.9));
   Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_280.list.root", "LQ280", 1.82));
   // Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_290.list.root", "LQ290", 11.9));
   // Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_310.list.root", "LQ310", 11.9));
   Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_320.list.root", "LQ320", 0.824));
   // Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_330.list.root", "LQ330", 11.9));
   Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_340.list.root", "LQ340", 0.570));
   Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_350.list.root", "LQ350", 0.477));
   Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_400.list.root", "LQ400", 0.205));
   Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_450.list.root", "LQ450", 0.0949));
   Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_500.list.root", "LQ500", 0.0463));
   Samples.push_back(ReadSample(PsFile, "LQSamples/LQToBNutau_550.list.root", "LQ550", 0.0236));
   ...
   */
   ...
   {
      if(Samples[i].HMR != NULL)
         Samples[i].HMR->Write();
      if(Samples[i].HMRStar != NULL)
         Samples[i].HMRStar->Write();
      if(Samples[i].HR != NULL)
         Samples[i].HR->Write();
      if(Samples[i].HRStar != NULL)
         Samples[i].HRStar->Write();
      if(Samples[i].HMRStar_RStar020Cut != NULL)
         Samples[i].HMRStar_RStar020Cut->Write();
      if(Samples[i].HMR_R020Cut != NULL)
         Samples[i].HMR_R020Cut->Write();
      if(Samples[i].HMRR != NULL)
         Samples[i].HMRR->Write();
      if(Samples[i].HNewMRNewR2Matrix != NULL)
         Samples[i].HNewMRNewR2Matrix->Write();
      if(Samples[i].HMRStarRStar != NULL)
         Samples[i].HMRStarRStar->Write();
   }
   ...
   HExpectedYieldSummary.GetYaxis()->SetBinLabel(7, "MR (new) 200");
   HExpectedYieldSummary.GetYaxis()->SetBinLabel(8, "R (new) 0.20");
   HExpectedYieldSummary.GetYaxis()->SetBinLabel(9, "MR (new) 400");
   HExpectedYieldSummary.GetYaxis()->SetBinLabel(10, "R (new) 0.5");
   ...
   HExpectedYieldSummaryTranspose.GetXaxis()->SetBinLabel(7, "MR (new) 200");
   HExpectedYieldSummaryTranspose.GetXaxis()->SetBinLabel(8, "R (new) 0.20");
   HExpectedYieldSummaryTranspose.GetXaxis()->SetBinLabel(9, "MR (new) 400");
   HExpectedYieldSummaryTranspose.GetXaxis()->SetBinLabel(10, "R (new) 0.5");
   ...
   HSMOnly2D->Draw("colz");
   Canvas2D.cd(2);
   Samples[0].HMRStarRStar->Draw("colz");
...
SampleCounts ReadSample(PsFileHelper &PsFile, string FileName, string Tag, double CrossSection)
{
   ...
   Result.HMRStar = new TH1D(Form("HMRStar_%s", Tag.c_str()), Form("MR (new), (%s);MR (new)", Tag.c_str()), 40, 0, 1500);
   Result.HR = new TH1D(Form("HR_%s", Tag.c_str()), Form("R, (%s);R", Tag.c_str()), 40, 0, 1.5);
   Result.HRStar = new TH1D(Form("HRStar_%s", Tag.c_str()), Form("R (new), (%s);R (new)", Tag.c_str()), 40, 0, 1.5);
   ...
   Result.HMRStarRStar = new TH2D(Form("HMRStarRStar_%s", Tag.c_str()),
      Form("MR (new) vs. R (new), (%s);MR (new);R^{2} (new)", Tag.c_str()), 40, 0, 1500, 50, 0, 0.5);
   ...
   Result.HMRStar_RStar020Cut = new TH1D(Form("HMRStar_RStar020Cut_%s", Tag.c_str()),
      Form("MR (new), cut on R (new) 0.20 (%s);MR (new)", Tag.c_str()), 40, 0, 1500);
   ...
   Result.HMRStar_RStar050Cut = new TH1D(Form("HMRStar_RStar050Cut_%s", Tag.c_str()),
      Form("MR (new), cut on R (new) 0.50 (%s);MR (new)", Tag.c_str()), 40, 0, 1500);
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      Result.HMRStarRStar->Fill(MRStar, RStar * RStar, WPU);
   ...
   HCountHistogram.GetXaxis()->SetBinLabel(7, "MR (new) 200");
   HCountHistogram.GetXaxis()->SetBinLabel(8, "R (new) 0.20");
   HCountHistogram.GetXaxis()->SetBinLabel(9, "MR (new) 400");
   HCountHistogram.GetXaxis()->SetBinLabel(10, "R (new) 0.5");
