...
int main()
{
   ...
   // component 1
   srand(time(NULL));
   RooRealVar XHat1("XHat1", "XHat1", -10.922, -1000, 1000);
   RooRealVar YHat1("YHat1", "YHat1", -0.0815, -100, 100);
   RooRealVar B1("B1", "B1", 0.09089, 0, 100);
   RooRealVar X01("X01", "X01", DrawRandom(-30, 30));
   RooRealVar Y01("Y01", "Y01", DrawRandom(-0.1, 0.0));
   RooRealVar C1("C1", "C1", DrawRandom(0, 10));
   RooRealVar S1("S1", "S1", DrawRandom(0.01, 50));
   ...
   // component 2
   RooRealVar XHat2("XHat2", "XHat2", 191, -1000, 1000);
   RooRealVar YHat2("YHat2", "YHat2", -0.0022, -100, 100);
   RooRealVar B2("B2", "B2", 0.072, 0, 100);
   RooRealVar X02("X02", "X02", 139);
   RooRealVar Y02("Y02", "Y02", 0.112);
   RooRealVar C2("C2", "C2", 200);
   RooRealVar S2("S2", "S2", 0.001);
   RooDalglish Model2("Model2", "Model2", MR, Rsq, XHat2, YHat2, B2, X02, Y02, C2, S2, SigmaX, SigmaY, XOFF, YOFF);
