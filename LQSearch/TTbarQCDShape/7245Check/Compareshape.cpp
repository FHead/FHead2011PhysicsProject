...
int main(int argc, char *argv[])
{
   ...
   TH1D HMRNew("HMRNew", "MR (new);MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New005("HMRNew_R2New005", "MR (new), R^{2} (new) > 0.05;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New010("HMRNew_R2New010", "MR (new), R^{2} (new) > 0.10;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New015("HMRNew_R2New015", "MR (new), R^{2} (new) > 0.15;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New020("HMRNew_R2New020", "MR (new), R^{2} (new) > 0.20;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New025("HMRNew_R2New025", "MR (new), R^{2} (new) > 0.25;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New030("HMRNew_R2New030", "MR (new), R^{2} (new) > 0.30;MR (new)", 40, 0, 1600);
   ...
   TH1D HMRNew_L("HMRNew_L", "MR (new), single loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New005_L("HMRNew_R2New005_L", "MR (new), R^{2} (new) > 0.05, single loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New010_L("HMRNew_R2New010_L", "MR (new), R^{2} (new) > 0.10, single loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New015_L("HMRNew_R2New015_L", "MR (new), R^{2} (new) > 0.15, single loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New020_L("HMRNew_R2New020_L", "MR (new), R^{2} (new) > 0.20, single loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New025_L("HMRNew_R2New025_L", "MR (new), R^{2} (new) > 0.25, single loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New030_L("HMRNew_R2New030_L", "MR (new), R^{2} (new) > 0.30, single loose tag;MR (new)", 40, 0, 1600);
   ...
   TH1D HMRNew_LL("HMRNew_LL", "MR (new), double loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New005_LL("HMRNew_R2New005_LL", "MR (new), R^{2} (new) > 0.05, double loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New010_LL("HMRNew_R2New010_LL", "MR (new), R^{2} (new) > 0.10, double loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New011_LL("HMRNew_R2New011_LL", "MR (new), R^{2} (new) > 0.11, double loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New012_LL("HMRNew_R2New012_LL", "MR (new), R^{2} (new) > 0.12, double loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New013_LL("HMRNew_R2New013_LL", "MR (new), R^{2} (new) > 0.13, double loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New014_LL("HMRNew_R2New014_LL", "MR (new), R^{2} (new) > 0.14, double loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New015_LL("HMRNew_R2New015_LL", "MR (new), R^{2} (new) > 0.15, double loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New020_LL("HMRNew_R2New020_LL", "MR (new), R^{2} (new) > 0.20, double loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New025_LL("HMRNew_R2New025_LL", "MR (new), R^{2} (new) > 0.25, double loose tag;MR (new)", 40, 0, 1600);
   TH1D HMRNew_R2New030_LL("HMRNew_R2New030_LL", "MR (new), R^{2} (new) > 0.30, double loose tag;MR (new)", 40, 0, 1600);
   ...
   HMRNew_R2New011_LL.Sumw2();
   HMRNew_R2New012_LL.Sumw2();
   HMRNew_R2New013_LL.Sumw2();
   HMRNew_R2New014_LL.Sumw2();
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      if(LooseTagCount >= 2)
      {
         ...
         if(R2New > 0.11)   HMRNew_R2New011_LL.Fill(MRNew, WPU);
         if(R2New > 0.12)   HMRNew_R2New012_LL.Fill(MRNew, WPU);
         if(R2New > 0.13)   HMRNew_R2New013_LL.Fill(MRNew, WPU);
         if(R2New > 0.14)   HMRNew_R2New014_LL.Fill(MRNew, WPU);
   ...
   HMRNew_R2New011_LL.Write();
   HMRNew_R2New012_LL.Write();
   HMRNew_R2New013_LL.Write();
   HMRNew_R2New014_LL.Write();
