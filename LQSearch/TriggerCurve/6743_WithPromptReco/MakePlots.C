...
void MakePlots()
{
   ...
   Explanation.push_back("Prompt reco!!!  HT dataset");
   ...
   HMR_R025MR450.Sumw2();
   HMR_R025MR400.Sumw2();
   HMR_R025MR450.Divide(&HMR_R025MR400);
   PsFile.AddPlot(HMR_R025MR450, "hist error");
   ...
   GMRVsR_R025MR150.SetMarkerStyle(6);
