...
int main()
{
   ...
   TCanvas C2;
   HWorld.SetTitle("Triggers from each luminosity era");
   HWorld.Draw();
   ...
   TCanvas C2Square("C", "C", 1024, 1024);
   ...
   C2Square.SaveAs("TriggerCurves.png");
   C2Square.SaveAs("TriggerCurves.C");
   C2Square.SaveAs("TriggerCurves.eps");
   C2Square.SaveAs("TriggerCurves.pdf");
