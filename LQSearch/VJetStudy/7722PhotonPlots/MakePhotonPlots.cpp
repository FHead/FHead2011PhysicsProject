...
int main(int argc, char *argv[])
{
   ...
   TH1D HPhotonIsoBarrel("HPhotonIsoBarrel", "Barrel photon iso; pt", 100, 0, 100);
   TH1D HPhotonIsoEndcap("HPhotonIsoEndcap", "Endcap photon iso; pt", 100, 0, 100);
   ...
   TH1D HPhotonIsoBarrelWithSeed("HPhotonIsoBarrelWithSeed", "Barrel (with seed) photon iso; pt/pt", 100, 0, 100);
   TH1D HPhotonIsoEndcapWithSeed("HPhotonIsoEndcapWithSeed", "Endcap (with seed) photon iso; pt/pt", 100, 0, 100);
   ...
   TH1D HPhotonIsoBarrelNoSeed("HPhotonIsoBarrelNoSeed", "Barrel (no seed) photon iso; pt/pt", 100, 0, 100);
   TH1D HPhotonIsoEndcapNoSeed("HPhotonIsoEndcapNoSeed", "Endcap (no seed) photon iso; pt/pt", 100, 0, 100);

   TH1D HPhotonPTSelected("HPhotonPTSelected", "Selected photon PT", 100, 0, 300);
   TH1D HPhotonEtaSelected("HPhotonEtaSelected", "Selected photon Eta", 100, 0, 300);
   TH1D HPhotonPhiSelected("HPhotonPhiSelected", "Selected photon Phi", 100, 0, 300);
   TH1D HPhotonIsolationN1("HPhotonIsolationN1", "Photon isolation (N-1)", 100, 0, 100);
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      for(int i = 0; i < PhotonCount; i++)
      {
         ...
         if(Barrel == true && PT[i] > 30)   HPhotonSigmaIEtaIEtaBarrel.Fill(sqrt(SigmaIEtaIEta[i]));
         if(Endcap == true && PT[i] > 30)   HPhotonSigmaIEtaIEtaEndcap.Fill(sqrt(SigmaIEtaIEta[i]));
         ...
         if(Seed[i] == true)
         {
            ...
            if(Barrel == true && PT[i] > 30)   HPhotonSigmaIEtaIEtaBarrelWithSeed.Fill(sqrt(SigmaIEtaIEta[i]));
            if(Endcap == true && PT[i] > 30)   HPhotonSigmaIEtaIEtaEndcapWithSeed.Fill(sqrt(SigmaIEtaIEta[i]));
         ...
         if(Seed[i] == false)
         {
            ...
            if(Barrel == true && PT[i] > 30)   HPhotonSigmaIEtaIEtaBarrelNoSeed.Fill(sqrt(SigmaIEtaIEta[i]));
            if(Endcap == true && PT[i] > 30)   HPhotonSigmaIEtaIEtaEndcapNoSeed.Fill(sqrt(SigmaIEtaIEta[i]));
         ...
         if(Barrel == true && Seed[i] == false && sqrt(SigmaIEtaIEta[i]) < 0.011 && HoE[i] < 0.05 && Isolation < 6)
         {
         ...
         if(Barrel == true && Seed[i] == false && sqrt(SigmaIEtaIEta[i]) < 0.011 && HoE[i] < 0.05)
            HPhotonIsolationN1.Fill(Isolation);
         if(Barrel == true && Seed[i] == false && sqrt(SigmaIEtaIEta[i]) < 0.011 && Isolation < 6)
            HPhotonHoEN1.Fill(HoE[i]);
         if(Barrel == true && Seed[i] == false && HoE[i] < 0.05 && Isolation < 6)
            HPhotonSigmaIEtaIEtaN1.Fill(sqrt(SigmaIEtaIEta[i]));
      }
   }
   ...
   PsFile.AddPlot(HPhotonIsolationN1, "", true);
   PsFile.AddPlot(HPhotonHoEN1, "", true);
   PsFile.AddPlot(HPhotonSigmaIEtaIEtaN1, "", true);
