...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult)
{
   ...
   RooRealVar ParameterB1("ParameterB1", "s1 = a1 + \"b1\" R^2", 0.02, 0, 1);
   RooRealVar ParameterA2("ParameterA2", "s2 = \"a2\" + b2 R^2", 0, 0, 0.1);
   RooRealVar ParameterB2("ParameterB2", "s2 = a2 + \"b2\" R^2", 0, 0, 1);
   ...
   RooRealVar WFinalYield("WFinalYield", "WFinalYield", 730.889);
   ...
   RooPlot *FinalResultPlot = MR.frame(Bins(25), Name("FitResults"),
      Title("MR, Simultaneous fit, total model"), Range(400, 1000));
   Dataset.plotOn(FinalResultPlot, MarkerSize(0.9));
