...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult, string TResult)
{
   ...
   RooRealVar ParameterA2("ParameterA2", "s2 = \"a2\" + b2 R^2", TDHFile["CentralValue"]["ParameterA1"].GetDouble());
   RooRealVar ParameterB2("ParameterB2", "s2 = a2 + \"b2\" R^2", TDHFile["CentralValue"]["ParameterB1"].GetDouble());
   ...
   for(int i = 0; i < (int)RCuts.size(); i++)
   {
      ...
      Fraction.push_back(new RooRealVar(Form("Fraction_%d", i), Form("Fraction_%d", i), 0.5, 0.0, 1.0));
   ...
   RooRealVar WFinalYield("WFinalYield", "WFinalYield", 1067);
   RooRealVar TTbarFinalYield("TTbarFinalYield", "TTbarFinalYield", 1083);
