...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult)
{
   ...
   RooRealVar WFinalYield("WFinalYield", "WFinalYield", 701.231);
   RooRealVar TTbarFinalYield("TTbarFinalYield", "TTbarFinalYield", 727.972, 0, 2000);

   RooAddPdf FinalModel("FinalModel", "Final model!!",
      RooArgList(AlmostFinalModel, WFinalModel), RooArgList(TTbarFinalYield, WFinalYield));
   ...
   */
   ...
   double WeightedYields = 600.509;   // taking TTbar.root, cut on R2 > 0.07, MR = 400-3500, then integrate
