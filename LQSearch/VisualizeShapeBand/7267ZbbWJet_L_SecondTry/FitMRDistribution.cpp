...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts)
{
   ...
   */
   ...
   // double WeightedYields = 2008.848;   // Electron*, single loose, R2 = 0.07-0.50, MR=300-3500
   // double WeightedYields = 13708.487;   // Had, exclusive single loose, same R/MR selection
   double WeightedYields = 2102.442;   // Had, double loose, same R/MR selection
