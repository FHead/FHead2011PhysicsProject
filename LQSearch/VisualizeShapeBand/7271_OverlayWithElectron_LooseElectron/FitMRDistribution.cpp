   ...
   string WResult, string TResult, string QCDResult)
{
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 1264.239);
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", 1169.339);
   RooRealVar QCDFinalRawYield("QCDFinalRawYield", "QCD final yield", 748.376);
   ...
   RooPlot *FinalResultPlot = MR.frame(Bins(50), Name("FitResults"),
      Title("MR overlay, total model"), AutoRange(Dataset));
