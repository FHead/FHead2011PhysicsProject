   ...
   string WResult, string TResult, string QCDResult)
{
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 53.59);
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", 56.15);
   RooRealVar QCDFinalRawYield("QCDFinalRawYield", "QCD final yield", 52.01);
   ...
   ModelLegend.AddEntry(&HDummy, "Data (863/pb)", "pl");
