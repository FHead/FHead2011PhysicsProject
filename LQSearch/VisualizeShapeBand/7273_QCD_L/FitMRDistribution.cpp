...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult, string TResult)
{
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 989.201);
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", 875.066);
   RooRealVar QCDFinalRawYield("QCDFinalRawYield", "QCD final yield", 7699.283);
