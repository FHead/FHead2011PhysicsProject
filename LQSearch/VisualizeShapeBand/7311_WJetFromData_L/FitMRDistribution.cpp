...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string TResult)
{
   ...
   RooRealVar TFinalRawYield("TFinalRawYield", "TFinalYield", 888.255);
   RooRealVar WJetFinalRawYield("WJetFinalRawYield", "WJetFinalYield", 1080.396);
   ...
   */
   ...
   double WJetRestrictedYield = 12345;
