...
int main()
{
   ...
   for(int i = 1; i <= 1000; i++)
   {
      ...
      double WSignal = WToyS->sumEntries("MR > 400 && R * R > 0.25 && R * R < 0.50");
      double TSignal = TToyS->sumEntries("MR > 400 && R * R > 0.25 && R * R < 0.50");
      double QSignal = QToyS->sumEntries("MR > 400 && R * R > 0.25 && R * R < 0.50");
      ...
      if(WSignal > 0 && TSignal > 0 && QSignal > 0 && TSignal < 190)
