   ...
   string WResult, string TResult, string QCDResult)
{
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 78.500 + 41.991);
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", ....);
   RooRealVar QCDFinalRawYield("QCDFinalRawYield", "QCD final yield", 171.761);
