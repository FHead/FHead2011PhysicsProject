...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string TResult)
{
   ...
   RooRealVar ParameterA1("ParameterA1", "s1 = \"a1\" + b1 R^2", 0.005, 0, 0.1);
   RooRealVar ParameterB1("ParameterB1", "s1 = a1 + \"b1\" R^2", 0.016, 0, 1);
   RooRealVar ParameterA2("ParameterA2", "s2 = \"a2\" + b2 R^2", 0.002, 0, 0.1);
   RooRealVar ParameterB2("ParameterB2", "s2 = a2 + \"b2\" R^2", 0.012, 0, 1);
   ...
   RooRealVar TFinalRawYield("TFinalRawYield", "TFinalYield", 467.361);
   RooRealVar WJetFinalRawYield("WJetFinalRawYield", "WJetFinalYield", 209.457);
   ...
   */
   ...
   double WJetRestrictedYield = 104.532 + 59.722;
