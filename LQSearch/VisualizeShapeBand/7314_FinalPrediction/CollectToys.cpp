...
int main()
{
   ...
   for(int i = 1; i <= 1000; i++)
   {
      ...
      double WSignal = WToyS->sumEntries("MR > 400 && R * R >= 0.40 && R * R < 0.50");
      double TSignal = TToyS->sumEntries("MR > 400 && R * R >= 0.40 && R * R < 0.50");
      double QSignal = QToyS->sumEntries("MR > 400 && R * R >= 0.40 && R * R < 0.50");
