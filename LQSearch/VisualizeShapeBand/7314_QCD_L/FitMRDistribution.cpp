...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult, string TResult)
{
   ...
   RooPlot *FinalResultPlot = MR.frame(Bins(40), Name("FitResults"),
      Title("  "), AutoRange(Dataset));
   Dataset.plotOn(FinalResultPlot, MarkerSize(0.9));
   ...
   RooPlot *FinalResultPlot2 = MR.frame(Bins(40), Name("FitResults2"), Title("  "),
      AutoRange(Dataset));
