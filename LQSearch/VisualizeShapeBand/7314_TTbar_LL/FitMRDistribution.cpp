...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult)
{
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 209.457);
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", 467.361);
   ...
   double TTbarRestrictedYield = 176.557;   // MR > 400, R2 = 0.2-0.5, HadLL
   // double TTbarRestrictedYield = 151.149;   // MR > 400, R2 = 0.2-0.5, ElectronLL
