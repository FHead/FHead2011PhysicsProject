   ...
   string WResult, string TResult, string QCDResult)
{
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 468.095);
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", 335.012);
   RooRealVar QCDFinalRawYield("QCDFinalRawYield", "QCD final yield", 24.326);
