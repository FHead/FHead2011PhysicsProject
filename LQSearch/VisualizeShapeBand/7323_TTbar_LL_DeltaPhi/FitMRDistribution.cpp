...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult)
{
   ...
   for(int i = 0; i < (int)RCuts.size(); i++)
   {
      ...
      if(i == 0)
         FractionIncrement.push_back(new RooRealVar("FractionIncrement_0", "FractionIncrement_0", 0.5, 0.0, 1.0));
      else
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 208.188);
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", 464.767);
