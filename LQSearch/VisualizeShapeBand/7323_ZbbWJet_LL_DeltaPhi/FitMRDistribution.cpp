...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts)
{
   ...
   FinalResultPlot->SetMinimum(0.9);
   PsFile.AddPlot(FinalResultPlot, "", true);
   ...
   FinalResultPlot2->SetMinimum(0.9);
   ...
   // double WJetRestrictedYield = 83.236;   // Electron + LL, full, R2 > 0.2, MR > 400
   // double WJetRestrictedYield = 70.723;   // Electron + LL, full, R2 > 0.2, MR > 400, New
   // double WJetRestrictedYield = 111.339 + 59.722;   // Had + LL, full, R2 > 0.2, MR > 400
   // double WJetRestrictedYield = 114.284 + 29.992;   // Had + LL, full, R2 > 0.2, MR > 400 - electron ID fixed

   double WJetRestrictedYield = 133.176;   // Muon + LL
