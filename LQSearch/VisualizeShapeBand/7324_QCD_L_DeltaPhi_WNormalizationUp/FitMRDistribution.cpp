...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult, string TResult)
{
   ...
   RooRealVar ParameterA1("ParameterA1", "s1 = \"a1\" + b1 R^2", 0.014, 0, 0.1);
   RooRealVar ParameterB1("ParameterB1", "s1 = a1 + \"b1\" R^2", 0.008, 0, 1);
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", (1290.539 + 80.758) * (1 + 0.11543396));
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", 980.708);
   RooRealVar QCDFinalRawYield("QCDFinalRawYield", "QCD final yield", 7760.394);
   ...
   RooFormulaVar QCDFinalYield("QCDFinalYield", "QCDFinalYield", "@0*@1", RooArgList(QCDFinalRawYield, TotalScalingFactor));
   ...
   // double QCDRestrictedYield = 244.278;   // HadLL, R2 0.2, MR 400
   double QCDRestrictedYield = 807.978;   // Had, L, R2 0.2, MR 400
