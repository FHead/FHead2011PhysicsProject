   ...
   string WResult, string TResult, string QCDResult)
{
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 65.873 + 57.414);
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", 107.238);
   RooRealVar QCDFinalRawYield("QCDFinalRawYield", "QCD final yield", 76.536);
   ...
   FinalModel.plotOn(FinalResultPlot, LineColor(kBlue), Normalization(274.45 / 295));
   FinalModel.plotOn(FinalResultPlot, LineColor(kGreen), Components("AlmostFinalModel"), Normalization(274.45 / 295));
   FinalModel.plotOn(FinalResultPlot, LineColor(kRed), Components("WFinalModel"), Normalization(274.45 / 295));
   FinalModel.plotOn(FinalResultPlot, LineColor(kYellow), Components("TFinalModel"), Normalization(274.45 / 295));
