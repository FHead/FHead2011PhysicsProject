...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult, string TResult)
{
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 1177.328 + 48.370);
   ...
   RooRealVar TotalScalingFactor("ScalingFactor", "ScalingFactor", 1, 0, 20);
   RooRealVar QCDScalingFactor("QCDScalingFactor", "QCDScalingFactor", 1.6, 0, 20);
