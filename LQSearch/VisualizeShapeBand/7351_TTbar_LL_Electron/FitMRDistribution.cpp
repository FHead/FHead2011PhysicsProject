...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult)
{
   ...
   for(int i = 0; i < (int)RCuts.size(); i++)
   {
      ...
      if(i == 0)
         FractionIncrement.push_back(new RooRealVar("FractionIncrement_0", "FractionIncrement_0", 0.4, 0.0, 1.0));
      else
         FractionIncrement.push_back(new RooRealVar(Form("FractionIncrement_%d", i), Form("FractionIncrement_%d", i),
            0.99, 0.0, 1.0));
      if(i == 0)
         Fraction.push_back(new RooFormulaVar("Fraction_0", "Fraction_0", "@0", RooArgList(*FractionIncrement[0])));
      else
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 95.911);
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", 211.651);
   ...
   // double TTbarRestrictedYield = 166.827;   // MR > 400, R2 > 0.2, ElectronLL
   // double TTbarRestrictedYield = 185.115;   // MR > 400, R2 > 0.2, HadLL
   // double TTbarRestrictedYield = 134.581;   // MR > 400, R2 > 0.2, ElectronLL (New)

   // double TTbarRestrictedYield = 180.242;   // MR > 400, R2 > 0.2, Had LL
   // double TTbarRestrictedYield = 134.581;   // MR > 400, R2 > 0.2, Electron LL
   double TTbarRestrictedYield = 251.035;   // MR > 400, R2 > 0.2, Muon LL
