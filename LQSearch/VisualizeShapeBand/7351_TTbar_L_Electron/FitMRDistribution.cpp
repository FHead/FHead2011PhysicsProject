...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult)
{
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 543.446);
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", 422.893);
   ...
   double TTbarRestrictedYield = 533.978;   // MR > 400, R2 > 0.2, Muon L
