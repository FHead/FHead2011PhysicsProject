   ...
   string WResult, string TResult, string QCDResult)
{
   ...
   RooRealVar WFinalRawYield("WFinalRawYield", "WFinalYield", 1.91484675146639347e+02);
   RooRealVar TTbarFinalRawYield("TTbarFinalRawYield", "TTbarFinalYield", 4.15362234028056264e+02);
   RooRealVar QCDFinalRawYield("QCDFinalRawYield", "QCD final yield", 0);
