   ...
   string WResult, string TResult, string QCDResult)
{
   ...
   Legend1.AddEntry(&Dummy6, "LQ (250 GeV)", "l");
   ...
   Legend1.AddEntry(&Dummy4, "W/Z + jets", "l");
   ...
   TFile F2("LQ250.root");
   TH1D *HSignalOnly = (TH1D *)F2.Get("HMRNew_RNew05_2");
   ...
   RViewLegend.AddEntry(&HModelR2View, "Prediction", "l");
   RViewLegend.AddEntry(&HLQR2View, "Prediction + signal (M_{LQ} = 250 GeV)", "l");
