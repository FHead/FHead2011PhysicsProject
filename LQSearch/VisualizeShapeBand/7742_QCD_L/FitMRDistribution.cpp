...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult, string TResult)
{
   ...
   RooRealVar ParameterB1("ParameterB1", "s1 = a1 + \"b1\" R^2", 0.004, 0, 1);
   ...
   RooRealVar QCDScalingFactor("QCDScalingFactor", "QCDScalingFactor", 1.11286);
   ...
   // double QCDRestrictedYield = 2088.571;   // Had L, R2 0.2, MR 400
