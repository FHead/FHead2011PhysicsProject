...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts, string WResult)
{
   ...
   RooRealVar ParameterA1Val("ParameterA1Val", "Parameter A1 value", 0.137 * 0.063);
   RooRealVar ParameterA1Error("ParameterA1Error", "Parameter A1 error", sqrt(0.137 * 0.013 * 0.137 * 0.013 + 0.063 * 0.035 * 0.063 * 0.035));
   RooRealVar ParameterB1Val("ParameterB1Val", "Parameter B1 value", 0.063);
   RooRealVar ParameterB1Error("ParameterB1Error", "Parameter B1 error", 0.013);
   RooRealVar ParameterA2Val("ParameterA2Val", "Parameter A2 value", 0.310 * 0.017);
   RooRealVar ParameterA2Error("ParameterA2Error", "Parameter A2 error", sqrt(0.310 * 0.008 * 0.310 * 0.008 + 0.017 * 0.180 * 0.017 * 0.180));
   RooRealVar ParameterB2Val("ParameterB2Val", "Parameter B2 value", 0.017);
   RooRealVar ParameterB2Error("ParameterB2Error", "Parameter B2 error", 0.008);
   RooGaussian ParameterA1Penalty("ParameterA1Penalty", "Penalty for A1", ParameterA1, ParameterA1Val, ParameterA1Error);
   RooGaussian ParameterA2Penalty("ParameterA2Penalty", "Penalty for A2", ParameterA2, ParameterA2Val, ParameterA2Error);
   RooGaussian ParameterB1Penalty("ParameterB1Penalty", "Penalty for B1", ParameterB1, ParameterB1Val, ParameterB1Error);
   RooGaussian ParameterB2Penalty("ParameterB2Penalty", "Penalty for B2", ParameterB2, ParameterB2Val, ParameterB2Error);
