...
SingleFitResult FitWithRCut(PsFileHelper &PsFile, string FileName, double RCut)
{
   ...
   RooPlot *FinalResultPlot = MR.frame(Bins(25), Name("FitResults"), Title("MR"), Range(400, 2200));
...
RooFitResult *FitWithRCut(PsFileHelper &PsFile, string FileName, vector<double> RCuts)
{
   ...
   RooPlot *FinalResultPlot = MR.frame(Bins(25), Name("FitResults"), Title("MR, Simultaneous fit, total model"),
      Range(400, 2200));
   Dataset.plotOn(FinalResultPlot, MarkerSize(0.9));
   ...
   RooPlot *FinalResultPlot2 = MR.frame(Bins(25), Name("FitResults2"), Title("MR, Simultaneous fit"), Range(400, 2200));
   ...
   double WJetRestrictedYield = 1818.072 + 842.937;   // Had, L, R2 > 0.20, MR > 400
