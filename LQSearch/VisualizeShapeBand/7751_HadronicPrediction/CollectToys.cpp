...
int main()
{
   ...
   TH1D HWSideBand("HWSideBand", "W prediction in side band", 20000, 0, 20000);
   TH1D HTSideBand("HTSideBand", "Top prediction in side band", 20000, 0, 20000);
   TH1D HQSideBand("HQSideBand", "QCD prediction in side band", 20000, 0, 20000);
   TH1D HAllSideBand("HAllSideBand", "Total prediction in side band", 20000, 0, 20000);

   TH1D HWSignal("HWSignal", "W prediction in signal region", 20000, 0, 20000);
   TH1D HTSignal("HTSignal", "Top prediction in signal region", 20000, 0, 20000);
   TH1D HQSignal("HQSignal", "QCD prediction in signal region", 20000, 0, 20000);
   TH1D HAllSignal("HAllSignal", "Total prediction in signal region", 20000, 0, 20000);
   ...
   for(int i = 1; i <= 200; i++)
   {
      ...
      double QPrediction = QToySB->sumEntries("MRL > 400 && MRL < 600 && RL * RL > 0.20 && RL * RL < 0.25") * 2088.571 / 85.73737;
