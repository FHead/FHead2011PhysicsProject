...
int main()
{
   ...
   for(int i = 1; i <= 200; i++)
   {
      ...
      double WSignal = WToyS->sumEntries("MR > 400 && R * R >= 0.42");
      double TSignal = TToyS->sumEntries("MRL > 400 && RL * RL >= 0.42");
      double QSignal = QToyS->sumEntries("MRL > 400 && RL * RL >= 0.42");
      ...
      if(QPrediction > 10 && QPrediction < 500 && QSignal > 1)
      {
