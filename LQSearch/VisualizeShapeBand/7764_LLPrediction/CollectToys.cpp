...
int main()
{
   ...
   TH1D HWSideBand("HWSideBand", "W prediction in side band", 5000, 0, 5000);
   TH1D HTSideBand("HTSideBand", "Top prediction in side band", 5000, 0, 5000);
   TH1D HQSideBand("HQSideBand", "QCD prediction in side band", 5000, 0, 5000);
