...
void ReadSample(string Tag, double CrossSection)
{
   ...
   TH1D HR2New_R2New025("HR2New_R2New025", "R^{2} (new), R^{2} > 0.25;R^{2} (new)", 40, 0.0, 1.2);
   TH1D HR2New_R2New025_MRNew300("HR2New_R2New025_MRNew300",
      "R^{2} (new), MR (new) > 300, R^{2} (new) > 0.25;R^{2} (new)", 40, 0.0, 1.2);
   TH1D HR2New_R2New025_MRNew400("HR2New_R2New025_MRNew400",
      "R^{2} (new), MR (new) > 400, R^{2} (new) > 0.25;R^{2} (new)", 40, 0.0, 1.2);
   TH1D HR2New_R2New025_MRNew500("HR2New_R2New025_MRNew500",
      "R^{2} (new), MR (new) > 500, R^{2} (new) > 0.25;R^{2} (new)", 40, 0.0, 1.2);
   TH1D HR2New_R2New025_MRNew600("HR2New_R2New025_MRNew600",
      "R^{2} (new), MR (new) > 600, R^{2} (new) > 0.25;R^{2} (new)", 40, 0.0, 1.2);
   TH1D HR2New_R2New025_MRNew700("HR2New_R2New025_MRNew700",
      "R^{2} (new), MR (new) > 700, R^{2} (new) > 0.25;R^{2} (new)", 40, 0.0, 1.2);
   ...
   HR2New_R2New025.Sumw2();
   HR2New_R2New025_MRNew300.Sumw2();
   HR2New_R2New025_MRNew400.Sumw2();
   HR2New_R2New025_MRNew500.Sumw2();
   HR2New_R2New025_MRNew600.Sumw2();
   HR2New_R2New025_MRNew700.Sumw2();
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      if(R2New > 0.25 && MRNew > 0)
      {
         HR2New_R2New025.Fill(R2New, WPU);
         if(MRNew > 300)   HR2New_R2New025_MRNew300.Fill(R2New, WPU);
         if(MRNew > 400)   HR2New_R2New025_MRNew400.Fill(R2New, WPU);
         if(MRNew > 500)   HR2New_R2New025_MRNew500.Fill(R2New, WPU);
         if(MRNew > 600)   HR2New_R2New025_MRNew600.Fill(R2New, WPU);
         if(MRNew > 700)   HR2New_R2New025_MRNew700.Fill(R2New, WPU);
      }
   }
   ...
   PsFile.AddPlot(HR2New_R2New025, "", true);
   PsFile.AddPlot(HR2New_R2New025_MRNew300, "", true);
   PsFile.AddPlot(HR2New_R2New025_MRNew400, "", true);
   PsFile.AddPlot(HR2New_R2New025_MRNew500, "", true);
   PsFile.AddPlot(HR2New_R2New025_MRNew600, "", true);
   PsFile.AddPlot(HR2New_R2New025_MRNew700, "", true);
   ...
   HR2New_R2New025.Write();
   HR2New_R2New025_MRNew300.Write();
   HR2New_R2New025_MRNew400.Write();
   HR2New_R2New025_MRNew500.Write();
   HR2New_R2New025_MRNew600.Write();
   HR2New_R2New025_MRNew700.Write();
