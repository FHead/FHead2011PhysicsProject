...
int main(int argc, char *argv[])
{
   ...
   TH1D HMRNew("HMRNew", "MR (new) after single-lepton-neutrino treatment;MR (new)", 100, 0, 1500);
   TH1D HMRNew_R2New005("HMRNew_R2New005",
      "MR (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.05;MR (new)", 100, 0, 1500);
   TH1D HMRNew_R2New010("HMRNew_R2New010",
      "MR (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.10;MR (new)", 100, 0, 1500);
   TH1D HMRNew_R2New015("HMRNew_R2New015",
      "MR (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.15;MR (new)", 100, 0, 1500);
   TH1D HMRNew_R2New020("HMRNew_R2New020",
      "MR (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.20;MR (new)", 100, 0, 1500);
   TH1D HMRNew_R2New025("HMRNew_R2New025",
      "MR (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.25;MR (new)", 100, 0, 1500);
   
   TH1D HR2New("HR2New", "R^{2} (new) after single-lepton-neutrino treatment;R^{2} (new)", 100, 0, 1.2);
   TH1D HR2New_MRNew300("HR2New_MRNew300",
      "R^{2} (new) after single-lepton-neutrino treatment, MR (new) > 300;R^{2} (new)", 100, 0, 1.2);
   TH1D HR2New_MRNew400("HR2New_MRNew400",
      "R^{2} (new) after single-lepton-neutrino treatment, MR (new) > 400;R^{2} (new)", 100, 0, 1.2);
   TH1D HR2New_MRNew500("HR2New_MRNew500",
      "R^{2} (new) after single-lepton-neutrino treatment, MR (new) > 500;R^{2} (new)", 100, 0, 1.2);
   TH1D HR2New_MRNew600("HR2New_MRNew600",
      "R^{2} (new) after single-lepton-neutrino treatment, MR (new) > 600;R^{2} (new)", 100, 0, 1.2);
   TH1D HR2New_MRNew700("HR2New_MRNew700",
      "R^{2} (new) after single-lepton-neutrino treatment, MR (new) > 700;R^{2} (new)", 100, 0, 1.2);

   TH1D HMRNew_MRNew300("HMRNew_MRNew300",
      "MR (new) after single-lepton-neutrino treatment, MR(new) > 300;MR (new)", 100, 0, 1500);
   TH1D HMRNew_MRNew300_R2New005("HMRNew_MRNew300_R2New005",
      "MR (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.05, MR (new) > 300;MR (new)", 100, 0, 1500);
   TH1D HMRNew_MRNew300_R2New010("HMRNew_MRNew300_R2New010",
      "MR (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.10, MR (new) > 300;MR (new)", 100, 0, 1500);
   TH1D HMRNew_MRNew300_R2New015("HMRNew_MRNew300_R2New015",
      "MR (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.15, MR (new) > 300;MR (new)", 100, 0, 1500);
   TH1D HMRNew_MRNew300_R2New020("HMRNew_MRNew300_R2New020",
      "MR (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.20, MR (new) > 300;MR (new)", 100, 0, 1500);
   TH1D HMRNew_MRNew300_R2New025("HMRNew_MRNew300_R2New025",
      "MR (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.25, MR (new) > 300;MR (new)", 100, 0, 1500);
   
   TH1D HR2New_R2New015("HR2New_R2New015",
      "R^{2} (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.15;R^{2} (new)", 100, 0, 1.2);
   TH1D HR2New_MRNew300_R2New015("HR2New_MRNew300_R2New015",
      "R^{2} (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.15, MR (new) > 300;R^{2} (new)", 100, 0, 1.2);
   TH1D HR2New_MRNew400_R2New015("HR2New_MRNew400_R2New015",
      "R^{2} (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.15, MR (new) > 400;R^{2} (new)", 100, 0, 1.2);
   TH1D HR2New_MRNew500_R2New015("HR2New_MRNew500_R2New015",
      "R^{2} (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.15, MR (new) > 500;R^{2} (new)", 100, 0, 1.2);
   TH1D HR2New_MRNew600_R2New015("HR2New_MRNew600_R2New015",
      "R^{2} (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.15, MR (new) > 600;R^{2} (new)", 100, 0, 1.2);
   TH1D HR2New_MRNew700_R2New015("HR2New_MRNew700_R2New015",
      "R^{2} (new) after single-lepton-neutrino treatment, R^{2} (new) > 0.15, MR (new) > 700;R^{2} (new)", 100, 0, 1.2);
   ...
   for(int iEntry = 0; iEntry < EntryCount; iEntry++)
   {
      ...
      // Get indices of taus from Z
      vector<int> TauIndices;
      if(VBIndex != -1)
      {
         for(int i = 0; i < MCTree[VBIndex].Daughters.size(); i++)
         {
            int DaughterIndex = MCTree[VBIndex].Daughters[i];
            if(MCTree[DaughterIndex].PDGID == 15 || MCTree[DaughterIndex].PDGID == -15)
               TauIndices.push_back(DaughterIndex);
         }
      }
      HMCTauCount.Fill(TauIndices.size());

      // for each tau, look at a few things
      for(int i = 0; i < (int)TauIndices.size(); i++)
      {
         FourVector TauP(MCTree[TauIndices[i]].P);

         // Trace tau and find children
         vector<int> FinalTauChildren;
         deque<int> ToBeProcessed;
         ToBeProcessed.push_back(TauIndices[i]);
         while(ToBeProcessed.size() > 0)
         {
            int Current = ToBeProcessed[0];
            ToBeProcessed.pop_front();

            if(MCTree[Current].StatusCode == 1)
               FinalTauChildren.push_back(Current);

            // Does this work???  g++ didn't complain though...  In anycase, we'll see
            ToBeProcessed.insert(ToBeProcessed.end(), MCTree[Current].Daughters.begin(),
               MCTree[Current].Daughters.end());
         }
         sort(FinalTauChildren.begin(), FinalTauChildren.end());
         vector<int>::iterator iter = unique(FinalTauChildren.begin(), FinalTauChildren.end());
         FinalTauChildren.erase(iter, FinalTauChildren.end());
         HMCTauChildrenCount.Fill(FinalTauChildren.size());

         // Look at spread of these final children
         for(int j = 0; j < (int)FinalTauChildren.size(); j++)
         {
            FourVector ParticleP(MCTree[FinalTauChildren[j]].P);
            HMCTauChildrenSpread.Fill(GetDR(TauP, ParticleP));
         }

         if(fabs(TauP.GetEta()) < 3 && TauP.GetPT() > 20)
         {
            // closest jet to tau itself
            ...
            for(int j = 0; j < M.nAK5Jet; j++)
            {
               ...
               {
                  ClosestJetIndex = j;
                  BestDistance = GetDR(JetP, TauP);
                  BestJetP = JetP;
               }
               else
               {
                  double CurrentDistance = GetDR(JetP, TauP);
            ...
            HMCTauClosestJetDR.Fill(BestDistance);
            HMCTauClosestJetPTRatio.Fill(BestJetP.GetPT() / TauP.GetPT());
            HMCTauClosestJetDRVsPTRatio.Fill(BestDistance, BestJetP.GetPT() / TauP.GetPT());
         }
      }
      ...
      bool HasTau = false;
      for(int j = 0; j < (int)VBChildren.size(); j++)
         if(MCTree[VBChildren[j]].PDGID == 15 || MCTree[VBChildren[j]].PDGID == -15)
            HasTau = true;
      if(HasTau == true)   // exclude taus for simplicity
         continue;

      bool HasElectron = false;
      for(int j = 0; j < (int)VBChildren.size(); j++)
         if(MCTree[VBChildren[j]].PDGID == 11 || MCTree[VBChildren[j]].PDGID == -11)
            HasElectron = true;
      if(HasElectron == true)   // exclude also electrons for simplicity
         continue;
      ...
      for(int j = 0; j < M.nAK5Jet; j++)
      {
         ...
         if(JetP.GetPT() < 40)
            continue;
         /*
         for(int k = 0; k < (int)VBChildren.size(); k++)   // exclude possible lepton-jets
         {
            if(MCTree[VBChildren[k]].PDGID == 11 || MCTree[VBChildren[k]].PDGID == 15 ||
               MCTree[VBChildren[k]].PDGID == -11 || MCTree[VBChildren[k]].PDGID == -15)
            {
               if(GetDR(JetP, FourVector(MCTree[VBChildren[k]].P)) < 0.5)
                  continue;
            }
         }
         */
      ...
      for(int i = 0; i < (int)VBChildren.size(); i++)
      {
         ...
         if(LeptonP.GetEta() < 2.4 && LeptonP.GetEta() > -2.4)
            PFMET = PFMET + LeptonP;   // add leptons back
      }
   ...
   {
      PsFileHelper PsFile("ZbbEmulateZnunuShape.ps");
      PsFile.AddTextPage("Using Zbb MC to emulate Znunu shape!");
