...
int main()
{
   ...
   TFile FInclusive("ZinvisibleJets_7TeV-madgraph_All.root");
   ...
   TH1D HSummaryHistogram("HSummaryHistogram",
      "Summary of effective cross section from Zbb to Znunu in signal selection;;Effective cross section (nb)",
...
RatioResult Compare1DHistogram(PsFileHelper &PsFile, TFile &FZbb, TFile &FInclusive, string HistogramName)
{
   ...
   legend.SetTextFont(42);
   legend.AddEntry(HInclusive, "Inclusive sample (Z to nunu) scaled to 1/fb", "l");
