...
void NTPTreeMessenger::InitializeWeight(string RootFile)
{
...
double NTPTreeMessenger::GetCurrentWeight()
{
   return GetWeight(nPU[0]);
}

double NTPTreeMessenger::GetWeight(int NPU)
{
