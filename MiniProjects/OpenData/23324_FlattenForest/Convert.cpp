...
int main(int argc, char *argv[])
{
   ...
   int NPixel, NPixelTrack, NFullTrack, NFullTrackPTCut, NFullTrackEtaCut, NFullTrackEtaPTCut;
   float HFPlus, HFMinus, HFPlusEta4, HFMinusEta4;
   int HFHitPlus, HFHitMinus;
   float ZDCPlus, ZDCMinus, EEPlus, EEMinus, EB, ET;
   AnalyzerTree->SetBranchAddress("NPixel", &NPixel);
   AnalyzerTree->SetBranchAddress("NPixelTrack", &NPixelTrack);
   AnalyzerTree->SetBranchAddress("NFullTrack", &NFullTrack);
   AnalyzerTree->SetBranchAddress("NFullTrackPTCut", &NFullTrackPTCut);
   AnalyzerTree->SetBranchAddress("NFullTrackEtaCut", &NFullTrackEtaCut);
   AnalyzerTree->SetBranchAddress("NFullTrackEtaPTCut", &NFullTrackEtaPTCut);
   AnalyzerTree->SetBranchAddress("HFPlus", &HFPlus);
   AnalyzerTree->SetBranchAddress("HFMinus", &HFMinus);
   AnalyzerTree->SetBranchAddress("HFPlusEta4", &HFPlusEta4);
   AnalyzerTree->SetBranchAddress("HFMinusEta4", &HFMinusEta4);
   AnalyzerTree->SetBranchAddress("HFHitPlus", &HFHitPlus);
   AnalyzerTree->SetBranchAddress("HFHitMinus", &HFHitMinus);
   AnalyzerTree->SetBranchAddress("ZDCPlus", &ZDCPlus);
   AnalyzerTree->SetBranchAddress("ZDCMinus", &ZDCMinus);
   AnalyzerTree->SetBranchAddress("EEPlus", &EEPlus);
   AnalyzerTree->SetBranchAddress("EEMinus", &EEMinus);
   AnalyzerTree->SetBranchAddress("EB", &EB);
   AnalyzerTree->SetBranchAddress("ET", &ET);
   ...
   int EntryCount = AnalyzerTree->GetEntries() * Fraction;
   ProgressBar Bar(cout, EntryCount);

   for(int iE = 0; iE < EntryCount; iE++)
   {
      if(EntryCount < 1000 || (iE % 300) == 0)
      {
         Bar.Update(iE);
         Bar.Print();
      }
      ...
      out << "Centrality " << HFPlus << " " << HFMinus << " " << HFPlusEta4 << " " << HFMinusEta4
         << " " << ZDCPlus << " " << ZDCMinus << " " << EEPlus << " " << EEMinus << " " << EB << " " << ET
         << " " << NPixel << " " << NPixelTrack
         << " " << NFullTrack << " " << NFullTrackPTCut << " " << NFullTrackEtaCut << " " << NFullTrackEtaPTCut
         << endl;
