...
int main(int argc, char *argv[])
{
   ...
   for(int i = 0; i < EntryCount; i++)
   {
      ...
      if(BestCSVV1Index >= 0 && MTrigger.CheckTrigger("HLT_PAAK4CaloJet60_Eta2p1_v1") == 1)
      {
      ...
      if(BestCSVV2Index >= 0 && MTrigger.CheckTrigger("HLT_PAAK4CaloJet60_Eta2p1_v1") == 1)
      {
      ...
      if(BestPFCSVIndex >= 0 && MTrigger.CheckTrigger("HLT_PAAK4PFJet60_Eta2p1_v1") == 1)
      {
