...
int main()
{
   ...
   ExportCurve(File, "HCaloJetBestCSV_All40", "HCaloJetBestCSV_Passed40", "Plots/CaloJetCSV40", true);
   ExportCurve(File, "HCaloJetBestCSV_All60", "HCaloJetBestCSV_Passed60", "Plots/CaloJetCSV60", true);
   ExportCurve(File, "HCaloJetBestCSV_All80", "HCaloJetBestCSV_Passed80", "Plots/CaloJetCSV80", true);

   ExportCurve(File, "HPFJetBestCSV_All40", "HPFJetBestCSV_Passed40", "Plots/PFJetCSV40", true);
   ...
   ExportCurve(File, "HCaloJetBestPT_All", "HCaloJetBestPT_Passed40", "Plots/CaloJetPT40", false);
   ...
   ExportCurve(File, "HPFJetBestPT_All", "HPFJetBestPT_Passed40", "Plots/PFJetPT40", false);
