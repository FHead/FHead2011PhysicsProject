...
int main(int argc, char *argv[])
{
   ...
   string CaloJetForwardBestPTPassed[3] = {"HForwardPass40CaloJets", "HForwardPass60CaloJets", "HForwardPass80CaloJets"};
   string CaloJetForwardBestPTAll[3] = {"HForwardCaloJets", "HForwardCaloJets", "HForwardCaloJets"};
   string PFJetBestPTPassed[3] = {"HPass40PFJets", "HPass60PFJets", "HPass80PFJets"};
   string PFJetBestPTPassedCalo[3] = {"HPassCalo40PFJets", "HPassCalo60PFJets", "HPassCalo80PFJets"};
   ...
   //    "Plots/PFJetPT-" + Tag + "-");
   // ExportCurve(File, vector<string>(CaloJetForwardBestPTAll, CaloJetForwardBestPTAll + 3),
   //    vector<string>(CaloJetForwardBestPTPassed, CaloJetForwardBestPTPassed + 3),
   //    vector<string>(CaloJetNames, CaloJetNames + 3),
   //    "Plots/ForwardCaloJetPT-" + Tag + "-");
