...
# with command line options: hlt -s RAW2DIGI,RECO,HLT:HighPTV14Legacy,EI,DQM -n 10 --filein root://xrootd.cmsaf.mit.edu//store/user/gsfs/Pythia8_Dijet80_pp_CUETP8M1_5020GeV/RAW_20171002/171002_194411/0000/step2_pp_DIGI_L1_DIGI2RAW_HLT_2.root --eventcontent DQM --datatier DQMIO --conditions 92X_upgrade2017_realistic_v11 --mc --process reHLT --hltProcess reHLT --era=Run2_2017
...
process.load('HLTrigger.Configuration.HLT_HighPTV14Legacy_cff')
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('hlt_RAW2DIGI_RECO_HLT_EI_DQM.root'),
