...
# with command line options: step01 -s HLT:HighPTV14,RAW2DIGI,L1Reco,RECO,EI,DQM --conditions 92X_upgrade2017_realistic_v11 --era Run2_2017 --mc --eventcontent DQM --datatier DQMIO --geometry DB:Extended --hltProcess reHLT --filein root://xrootd.cmsaf.mit.edu//store/user/gsfs/Pythia8_Dijet80_pp_CUETP8M1_5020GeV/RAW_20171002/171002_194411/0000/step2_pp_DIGI_L1_DIGI2RAW_HLT_2.root --processName=reHLT -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step01 nevts:100'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('step01_HLT_RAW2DIGI_L1Reco_RECO_EI_DQM.root'),
...
process.schedule.extend([process.raw2digi_step,process.L1Reco_step,process.reconstruction_step,process.eventinterpretaion_step,process.dqmoffline_step,process.dqmofflineOnPAT_step,process.DQMoutput_step])
