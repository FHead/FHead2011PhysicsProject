...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('step01_RAW2DIGI_RECO_HLT_DQM.root'),
...
process.schedule.extend([process.dqmoffline_step,process.dqmofflineOnPAT_step,process.DQMoutput_step])
