...
# with command line options: step2 -s HARVESTING:dqmHarvesting --harvesting AtRunEnd --conditions 92X_upgrade2017_realistic_v11 --era Run2_2017 --geometry DB:Extended --mc --scenario pp --filein file:step01_RAW2DIGI_RECO_HLT_EI_DQM.root --filetype DQM -n -1
...
process.source = cms.Source("DQMRootSource",
    fileNames = cms.untracked.vstring('file:step01_RAW2DIGI_RECO_HLT_EI_DQM.root')
)
