...
# with command line options: hlt -s RAW2DIGI,L1Reco,RECO -n 100 --filein file:/tmp/chenyi/Zee.root --conditions 92X_upgrade2017_realistic_v11 --mc --process reHLT --hltProcess reHLT --era=Run2_2017
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/tmp/chenyi/Zee.root'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('hlt_RAW2DIGI_L1Reco_RECO.root'),
