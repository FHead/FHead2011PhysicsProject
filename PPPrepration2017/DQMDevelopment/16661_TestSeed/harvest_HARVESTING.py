...
# with command line options: harvest -s HARVESTING:dqmHarvesting --era Run2_2017 --conditions 92X_upgrade2017_realistic_v11 --filein file:hlt_RAW2DIGI_L1Reco_RECO_HLT_EI_DQM.root --mc --fileout file:DQM_hlt.root --filetype DQM
...
process.source = cms.Source("DQMRootSource",
    fileNames = cms.untracked.vstring('file:hlt_RAW2DIGI_L1Reco_RECO_HLT_EI_DQM.root')
)
