# hltGetConfiguration /users/chenyi/PP2017/HIHighPTPP2017/V10 --globaltag 92X_upgrade2017_realistic_v11 --input root://xrootd.cmsaf.mit.edu//store/user/gsfs/Pythia8_MinBias_pp_CUETP8M1_5020GeV/RAW_20171002/171003_010838/0000/step2_pp_DIGI_L1_DIGI2RAW_HLT___JOB__.root --mc --process MYHLT --full --offline --l1-emulator FullMC --l1Xml L1Menu_Collisions2017_dev_r9_HIppRefMOD_Mod2.xml --unprescale --max-events -1

# /users/chenyi/PP2017/HIHighPTPP2017/V10 (CMSSW_9_2_10)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/chenyi/PP2017/HIHighPTPP2017/V10')
)
...
process.hltPreAK4CaloJet50FWD = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1sSingleJet4 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet4" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet4Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet8 = cms.EDFilter( "HLTL1TSeed",
...
process.hltPreL1SingleJet8Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet12 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet12" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet12Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleJet16Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet20 = cms.EDFilter( "HLTL1TSeed",
...
process.hltPreL1SingleJet20Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleJet24Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet28 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet28" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet28Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleJet32Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleJet35Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet40 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet40" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet40Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleJet44Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet48 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet48" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet48Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet52 = cms.EDFilter( "HLTL1TSeed",
...
process.hltPreL1SingleJet52Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet56 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet56" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet56Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleJet60Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleJet90Eta5p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet16ForEta1p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet16ForEta1p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet16ForEta1p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet24ForEta1p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet24ForEta1p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet24ForEta1p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet32ForEta1p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet32ForEta1p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet32ForEta1p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet40ForEta1p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet40ForEta1p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet40ForEta1p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet48ForEta1p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet48ForEta1p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet48ForEta1p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet56ForEta1p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet56ForEta1p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet56ForEta1p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet16ForEta2p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet16ForEta2p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet16ForEta2p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet24ForEta2p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet24ForEta2p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet24ForEta2p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet32ForEta2p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet32ForEta2p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet32ForEta2p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet40ForEta2p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet40ForEta2p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet40ForEta2p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet48ForEta2p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet48ForEta2p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet48ForEta2p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet56ForEta2p9 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet56ForEta2p9" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet60FWD = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleJet20FWD = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleJet35FWD = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet40FWD = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet40_FWD" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet40FWD = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleJet50FWD = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJet50_FWD" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleJet50FWD = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1sDijet4MidEta2p1 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet4MidEta2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet4MidEta2p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet8MidEta2p1 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet8MidEta2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet8MidEta2p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet8And4MidEta2p1 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet8And4MidEta2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet8And4MidEta2p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet12MidEta2p1 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet12MidEta2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet12MidEta2p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet12And4MidEta2p1 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet12And4MidEta2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet12And4MidEta2p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet12And8MidEta2p1 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet12And8MidEta2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet12And8MidEta2p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet16MidEta2p1 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet16MidEta2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet16MidEta2p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet16And8MidEta2p1 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet16And8MidEta2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet16And8MidEta2p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet20MidEta2p1 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet20MidEta2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet20MidEta2p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet20And8MidEta2p1 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet20And8MidEta2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet20And8MidEta2p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet20And12MidEta2p1 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet20And12MidEta2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet20And12MidEta2p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet4MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet4MidEta2p1DPhiPiOver2" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet4MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet8MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet8MidEta2p1DPhiPiOver2" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet8MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet8And4MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet8And4MidEta2p1DPhiPiOver2" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet8And4MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet12MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet12MidEta2p1DPhiPiOver2" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet12MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet12And4MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet12And4MidEta2p1DPhiPiOver2" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet12And4MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet12And8MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet12And8MidEta2p1DPhiPiOver2" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet12And8MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet16MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet16MidEta2p1DPhiPiOver2" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet16MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet16And8MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet16And8MidEta2p1DPhiPiOver2" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet16And8MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet20MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet4MidEta2p1DPhiPiOver2" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
...
process.hltPreL1Dijet20MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet20And8MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet20And8MidEta2p1DPhiPiOver2" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet20And8MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDijet20And12MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Dijet20And12MidEta2p1DPhiPiOver2" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1Dijet20And12MidEta2p1DPhiPiOver2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleEG5Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreL1SingleEG10Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleEG15Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleEG18Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleEG21Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreL1SingleEG24Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleEG26Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleEG28 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG28" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleEG28Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleEG30Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleEG32 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG32" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleEG32Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleEG34Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleEG36 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG36" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleEG36Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleEG38 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG38" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleEG38Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleEG40 = cms.EDFilter( "HLTL1TSeed",
...
process.hltPreL1SingleEG40Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleEG42 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG42" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleEG42Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleEG45 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG45" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleEG45Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sSingleEG50 = cms.EDFilter( "HLTL1TSeed",
...
process.hltPreL1SingleEG50Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sDoubleEG15And10 = cms.EDFilter( "HLTL1TSeed",
...
process.hltPreL1DoubleEG15And10Eta3p1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.HLT_AK4PFJet50_v15 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4PFJet50 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet30 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets30 + process.hltSingleAK4PFJet50 + process.HLTEndSequence )
...
process.HLT_AK4CaloJet50_v9 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4CaloJet50 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet50 + process.HLTEndSequence )
...
process.HLT_AK4CaloJet50FWD_v8 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4CaloJet50FWD + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet50FWD + process.HLTEndSequence )
...
process.HLT_L1SingleJet4_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet4 + process.hltPreL1SingleJet4Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet8_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet8 + process.hltPreL1SingleJet8Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet12_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet12 + process.hltPreL1SingleJet12Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet16_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet16 + process.hltPreL1SingleJet16Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet20_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet20 + process.hltPreL1SingleJet20Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet24_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet24 + process.hltPreL1SingleJet24Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet28_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet28 + process.hltPreL1SingleJet28Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet32_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet32 + process.hltPreL1SingleJet32Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet35_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet35 + process.hltPreL1SingleJet35Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet40_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet40 + process.hltPreL1SingleJet40Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet44_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet44 + process.hltPreL1SingleJet44Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet48_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet48 + process.hltPreL1SingleJet48Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet52_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet52 + process.hltPreL1SingleJet52Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet56_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet56 + process.hltPreL1SingleJet56Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet60_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet60 + process.hltPreL1SingleJet60Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet90_Eta5p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet90 + process.hltPreL1SingleJet90Eta5p1 + process.HLTEndSequence )
process.HLT_L1SingleJet16_ForEta1p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet16ForEta1p9 + process.hltPreL1SingleJet16ForEta1p9 + process.HLTEndSequence )
process.HLT_L1SingleJet24_ForEta1p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet24ForEta1p9 + process.hltPreL1SingleJet24ForEta1p9 + process.HLTEndSequence )
process.HLT_L1SingleJet32_ForEta1p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet32ForEta1p9 + process.hltPreL1SingleJet32ForEta1p9 + process.HLTEndSequence )
process.HLT_L1SingleJet40_ForEta1p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet40ForEta1p9 + process.hltPreL1SingleJet40ForEta1p9 + process.HLTEndSequence )
process.HLT_L1SingleJet48_ForEta1p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet48ForEta1p9 + process.hltPreL1SingleJet48ForEta1p9 + process.HLTEndSequence )
process.HLT_L1SingleJet56_ForEta1p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet56ForEta1p9 + process.hltPreL1SingleJet56ForEta1p9 + process.HLTEndSequence )
process.HLT_L1SingleJet16_ForEta2p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet16ForEta2p9 + process.hltPreL1SingleJet16ForEta2p9 + process.HLTEndSequence )
process.HLT_L1SingleJet24_ForEta2p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet24ForEta2p9 + process.hltPreL1SingleJet24ForEta2p9 + process.HLTEndSequence )
process.HLT_L1SingleJet32_ForEta2p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet32ForEta2p9 + process.hltPreL1SingleJet32ForEta2p9 + process.HLTEndSequence )
process.HLT_L1SingleJet40_ForEta2p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet40ForEta2p9 + process.hltPreL1SingleJet40ForEta2p9 + process.HLTEndSequence )
process.HLT_L1SingleJet48_ForEta2p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet48ForEta2p9 + process.hltPreL1SingleJet48ForEta2p9 + process.HLTEndSequence )
process.HLT_L1SingleJet56_ForEta2p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet56ForEta2p9 + process.hltPreL1SingleJet60FWD + process.HLTEndSequence )
process.HLT_L1SingleJet20FWD = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet20FWD + process.hltPreL1SingleJet20FWD + process.HLTEndSequence )
process.HLT_L1SingleJet35FWD = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet35FWD + process.hltPreL1SingleJet35FWD + process.HLTEndSequence )
process.HLT_L1SingleJet40FWD = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet40FWD + process.hltPreL1SingleJet40FWD + process.HLTEndSequence )
process.HLT_L1SingleJet50FWD = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet50FWD + process.hltPreL1SingleJet50FWD + process.HLTEndSequence )
process.HLT_L1SingleJet60FWD = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet60FWD + process.hltPreL1SingleJet60FWD + process.HLTEndSequence )
process.HLT_L1Dijet4_MidEta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet4MidEta2p1 + process.hltPreL1Dijet4MidEta2p1 + process.HLTEndSequence )
process.HLT_L1Dijet8_MidEta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet8MidEta2p1 + process.hltPreL1Dijet8MidEta2p1 + process.HLTEndSequence )
process.HLT_L1Dijet8And4_MidEta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet8And4MidEta2p1 + process.hltPreL1Dijet8And4MidEta2p1 + process.HLTEndSequence )
process.HLT_L1Dijet12_MidEta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet12MidEta2p1 + process.hltPreL1Dijet12MidEta2p1 + process.HLTEndSequence )
process.HLT_L1Dijet12And4_MidEta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet12And4MidEta2p1 + process.hltPreL1Dijet12And4MidEta2p1 + process.HLTEndSequence )
process.HLT_L1Dijet12And8_MidEta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet12And8MidEta2p1 + process.hltPreL1Dijet12And8MidEta2p1 + process.HLTEndSequence )
process.HLT_L1Dijet16_MidEta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet16MidEta2p1 + process.hltPreL1Dijet16MidEta2p1 + process.HLTEndSequence )
process.HLT_L1Dijet16And8_MidEta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet16And8MidEta2p1 + process.hltPreL1Dijet16And8MidEta2p1 + process.HLTEndSequence )
process.HLT_L1Dijet20_MidEta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet20MidEta2p1 + process.hltPreL1Dijet20MidEta2p1 + process.HLTEndSequence )
process.HLT_L1Dijet20And8_MidEta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet20And8MidEta2p1 + process.hltPreL1Dijet20And8MidEta2p1 + process.HLTEndSequence )
process.HLT_L1Dijet20And12_MidEta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet20And12MidEta2p1 + process.hltPreL1Dijet20And12MidEta2p1 + process.HLTEndSequence )
process.HLT_L1Dijet4_MidEta2p1_DPhiPiOver2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet4MidEta2p1DPhiPiOver2 + process.hltPreL1Dijet4MidEta2p1DPhiPiOver2 + process.HLTEndSequence )
process.HLT_L1Dijet8_MidEta2p1_DPhiPiOver2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet8MidEta2p1DPhiPiOver2 + process.hltPreL1Dijet8MidEta2p1DPhiPiOver2 + process.HLTEndSequence )
process.HLT_L1Dijet8And4_MidEta2p1_DPhiPiOver2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet8And4MidEta2p1DPhiPiOver2 + process.hltPreL1Dijet8And4MidEta2p1DPhiPiOver2 + process.HLTEndSequence )
process.HLT_L1Dijet12_MidEta2p1_DPhiPiOver2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet12MidEta2p1DPhiPiOver2 + process.hltPreL1Dijet12MidEta2p1DPhiPiOver2 + process.HLTEndSequence )
process.HLT_L1Dijet12And4_MidEta2p1_DPhiPiOver2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet12And4MidEta2p1DPhiPiOver2 + process.hltPreL1Dijet12And4MidEta2p1DPhiPiOver2 + process.HLTEndSequence )
process.HLT_L1Dijet12And8_MidEta2p1_DPhiPiOver2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet12And8MidEta2p1DPhiPiOver2 + process.hltPreL1Dijet12And8MidEta2p1DPhiPiOver2 + process.HLTEndSequence )
process.HLT_L1Dijet16_MidEta2p1_DPhiPiOver2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet16MidEta2p1DPhiPiOver2 + process.hltPreL1Dijet16MidEta2p1DPhiPiOver2 + process.HLTEndSequence )
process.HLT_L1Dijet16And8_MidEta2p1_DPhiPiOver2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet16And8MidEta2p1DPhiPiOver2 + process.hltPreL1Dijet16And8MidEta2p1DPhiPiOver2 + process.HLTEndSequence )
process.HLT_L1Dijet20_MidEta2p1_DPhiPiOver2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet20MidEta2p1DPhiPiOver2 + process.hltPreL1Dijet20MidEta2p1DPhiPiOver2 + process.HLTEndSequence )
process.HLT_L1Dijet20And8_MidEta2p1_DPhiPiOver2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet20And8MidEta2p1DPhiPiOver2 + process.hltPreL1Dijet20And8MidEta2p1DPhiPiOver2 + process.HLTEndSequence )
process.HLT_L1Dijet20And12_MidEta2p1_DPhiPiOver2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDijet20And12MidEta2p1DPhiPiOver2 + process.hltPreL1Dijet20And12MidEta2p1DPhiPiOver2 + process.HLTEndSequence )
process.HLT_L1SingleEG5_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG5 + process.hltPreL1SingleEG5Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG10_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG10 + process.hltPreL1SingleEG10Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG15_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG15 + process.hltPreL1SingleEG15Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG18_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG18 + process.hltPreL1SingleEG18Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG21_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG21 + process.hltPreL1SingleEG21Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG24_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG24 + process.hltPreL1SingleEG24Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG26_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG26 + process.hltPreL1SingleEG26Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG28_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG28 + process.hltPreL1SingleEG28Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG30_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG30 + process.hltPreL1SingleEG30Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG32_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG32 + process.hltPreL1SingleEG32Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG34_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG34 + process.hltPreL1SingleEG34Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG36_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG36 + process.hltPreL1SingleEG36Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG38_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG38 + process.hltPreL1SingleEG38Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG40_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG40 + process.hltPreL1SingleEG40Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG42_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG42 + process.hltPreL1SingleEG42Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG45_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG45 + process.hltPreL1SingleEG45Eta3p1 + process.HLTEndSequence )
process.HLT_L1SingleEG50_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG50 + process.hltPreL1SingleEG50Eta3p1 + process.HLTEndSequence )
process.HLT_L1DoubleEG15And10_Eta3p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleEG15And10 + process.hltPreL1DoubleEG15And10Eta3p1 + process.HLTEndSequence )


process.HLTSchedule = cms.Schedule( *(process.HLT_AK4PFJet30_v15, process.HLT_AK4PFJet40_v15, process.HLT_AK4PFJet50_v15, process.HLT_AK4PFJet60_v15, process.HLT_AK4PFJet80_v15, process.HLT_AK4PFJet100_v15, process.HLT_AK4PFJet120_v14, process.HLT_AK4PFJet30FWD_v14, process.HLT_AK4PFJet50FWD_v14, process.HLT_AK4PFJet60FWD_v14, process.HLT_AK4PFJet70FWD_v14, process.HLT_AK4PFJet80FWD_v14, process.HLT_AK4CaloJet30_v10, process.HLT_AK4CaloJet40_v9, process.HLT_AK4CaloJet50_v9, process.HLT_AK4CaloJet60_v9, process.HLT_AK4CaloJet80_v9, process.HLT_AK4CaloJet100_v9, process.HLT_AK4CaloJet120_v8, process.HLT_AK4CaloJet50FWD_v8, process.HLT_AK4CaloJet60FWD_v8, process.HLT_AK4CaloJet70FWD_v8, process.HLT_AK4CaloJet80FWD_v8, process.HLT_HISinglePhoton10_Eta3p1ForPPRef_v8, process.HLT_HISinglePhoton20_Eta3p1ForPPRef_v8, process.HLT_HISinglePhoton30_Eta3p1ForPPRef_v8, process.HLT_HISinglePhoton40_Eta3p1ForPPRef_v8, process.HLT_HISinglePhoton50_Eta3p1ForPPRef_v8, process.HLT_HISinglePhoton60_Eta3p1ForPPRef_v8, process.HLT_Photon20_HoverELoose_v9, process.HLT_Photon30_HoverELoose_v9, process.HLT_Photon40_HoverELoose_v9, process.HLT_Photon50_HoverELoose_v9, process.HLT_Photon60_HoverELoose_v9, process.HLT_L1SingleJet4_Eta5p1_v1, process.HLT_L1SingleJet8_Eta5p1_v1, process.HLT_L1SingleJet12_Eta5p1_v1, process.HLT_L1SingleJet16_Eta5p1_v1, process.HLT_L1SingleJet20_Eta5p1_v1, process.HLT_L1SingleJet24_Eta5p1_v1, process.HLT_L1SingleJet28_Eta5p1_v1, process.HLT_L1SingleJet32_Eta5p1_v1, process.HLT_L1SingleJet35_Eta5p1_v1, process.HLT_L1SingleJet40_Eta5p1_v1, process.HLT_L1SingleJet44_Eta5p1_v1, process.HLT_L1SingleJet48_Eta5p1_v1, process.HLT_L1SingleJet52_Eta5p1_v1, process.HLT_L1SingleJet56_Eta5p1_v1, process.HLT_L1SingleJet60_Eta5p1_v1, process.HLT_L1SingleJet90_Eta5p1_v1, process.HLT_L1SingleJet16_ForEta1p9_v1, process.HLT_L1SingleJet24_ForEta1p9_v1, process.HLT_L1SingleJet32_ForEta1p9_v1, process.HLT_L1SingleJet40_ForEta1p9_v1, process.HLT_L1SingleJet48_ForEta1p9_v1, process.HLT_L1SingleJet56_ForEta1p9_v1, process.HLT_L1SingleJet16_ForEta2p9_v1, process.HLT_L1SingleJet24_ForEta2p9_v1, process.HLT_L1SingleJet32_ForEta2p9_v1, process.HLT_L1SingleJet40_ForEta2p9_v1, process.HLT_L1SingleJet48_ForEta2p9_v1, process.HLT_L1SingleJet56_ForEta2p9_v1, process.HLT_L1SingleJet20FWD, process.HLT_L1SingleJet35FWD, process.HLT_L1SingleJet40FWD, process.HLT_L1SingleJet50FWD, process.HLT_L1SingleJet60FWD, process.HLT_L1Dijet4_MidEta2p1_v1, process.HLT_L1Dijet8_MidEta2p1_v1, process.HLT_L1Dijet8And4_MidEta2p1_v1, process.HLT_L1Dijet12_MidEta2p1_v1, process.HLT_L1Dijet12And4_MidEta2p1_v1, process.HLT_L1Dijet12And8_MidEta2p1_v1, process.HLT_L1Dijet16_MidEta2p1_v1, process.HLT_L1Dijet16And8_MidEta2p1_v1, process.HLT_L1Dijet20_MidEta2p1_v1, process.HLT_L1Dijet20And8_MidEta2p1_v1, process.HLT_L1Dijet20And12_MidEta2p1_v1, process.HLT_L1Dijet4_MidEta2p1_DPhiPiOver2_v1, process.HLT_L1Dijet8_MidEta2p1_DPhiPiOver2_v1, process.HLT_L1Dijet8And4_MidEta2p1_DPhiPiOver2_v1, process.HLT_L1Dijet12_MidEta2p1_DPhiPiOver2_v1, process.HLT_L1Dijet12And4_MidEta2p1_DPhiPiOver2_v1, process.HLT_L1Dijet12And8_MidEta2p1_DPhiPiOver2_v1, process.HLT_L1Dijet16_MidEta2p1_DPhiPiOver2_v1, process.HLT_L1Dijet16And8_MidEta2p1_DPhiPiOver2_v1, process.HLT_L1Dijet20_MidEta2p1_DPhiPiOver2_v1, process.HLT_L1Dijet20And8_MidEta2p1_DPhiPiOver2_v1, process.HLT_L1Dijet20And12_MidEta2p1_DPhiPiOver2_v1, process.HLT_L1SingleEG5_Eta3p1_v1, process.HLT_L1SingleEG10_Eta3p1_v1, process.HLT_L1SingleEG15_Eta3p1_v1, process.HLT_L1SingleEG18_Eta3p1_v1, process.HLT_L1SingleEG21_Eta3p1_v1, process.HLT_L1SingleEG24_Eta3p1_v1, process.HLT_L1SingleEG26_Eta3p1_v1, process.HLT_L1SingleEG28_Eta3p1_v1, process.HLT_L1SingleEG30_Eta3p1_v1, process.HLT_L1SingleEG32_Eta3p1_v1, process.HLT_L1SingleEG34_Eta3p1_v1, process.HLT_L1SingleEG36_Eta3p1_v1, process.HLT_L1SingleEG38_Eta3p1_v1, process.HLT_L1SingleEG40_Eta3p1_v1, process.HLT_L1SingleEG42_Eta3p1_v1, process.HLT_L1SingleEG45_Eta3p1_v1, process.HLT_L1SingleEG50_Eta3p1_v1, process.HLT_L1DoubleEG15And10_Eta3p1_v1 ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'root://xrootd.cmsaf.mit.edu//store/user/gsfs/Pythia8_MinBias_pp_CUETP8M1_5020GeV/RAW_20171002/171003_010838/0000/step2_pp_DIGI_L1_DIGI2RAW_HLT___JOB__.root',
    ),
...
process = L1XML(process,"L1Menu_Collisions2017_dev_r9_HIppRefMOD_Mod2.xml")
...
_customInfo['inputFile' ]=  ['root://xrootd.cmsaf.mit.edu//store/user/gsfs/Pythia8_MinBias_pp_CUETP8M1_5020GeV/RAW_20171002/171003_010838/0000/step2_pp_DIGI_L1_DIGI2RAW_HLT___JOB__.root']
