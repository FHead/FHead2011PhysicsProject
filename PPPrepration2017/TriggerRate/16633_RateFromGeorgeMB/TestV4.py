# hltGetConfiguration /users/chenyi/PP2017/HIHighPTPP2017/V4 --globaltag 92X_upgrade2017_TSG_For90XSamples_V2 --input file:///eos/cms/store/cmst3/user/chenyi/PPTrigger2017/Test-GEN-SIM-RAW/QCD_50_80.root --mc --process MYHLT --full --offline --l1-emulator FullMC --l1Xml L1Menu_Collisions2017_dev_r9_HIppRefMOD.xml --unprescale --max-events 500

# /users/chenyi/PP2017/HIHighPTPP2017/V4 (CMSSW_9_2_10)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/chenyi/PP2017/HIHighPTPP2017/V4')
)
...
process.hltPreL1SingleJet56ForEta2p9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.HLT_L1SingleJet56_ForEta2p9_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet56ForEta2p9 + process.hltPreL1SingleJet56ForEta2p9 + process.HLTEndSequence )
...
#    process.source.fileNames.extend(["root://xrootd.cmsaf.mit.edu//store/user/gsfs/Pythia8_Dijet80_pp_CUETP8M1_5020GeV/RAW_20171002/171002_194411/0000/step2_pp_DIGI_L1_DIGI2RAW_HLT_%d.root" % (i)])
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = '92X_upgrade2017_TSG_For90XSamples_V2')
...
# _customInfo['inputFile' ]=  ['root://xrootd.cmsaf.mit.edu//store/user/gsfs/Pythia8_Dijet80_pp_CUETP8M1_5020GeV/RAW_20171002/171002_194411/0000/step2_pp_DIGI_L1_DIGI2RAW_HLT_1.root']
_customInfo['inputFile' ]=  process.source.fileNames
