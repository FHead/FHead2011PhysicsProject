{
   ...
   // double mean[] = {6.85273, 6.64127, 6.56715, 6.00821, 5.93441, 6.37178, 6.35796};   <= all in
   // double mean[] = {6.88639, 6.7606, 6.54533, 5.79978, 5.49556, 6.29898, 6.27827};   <= ABC cut
   double mean[] = {6.81625, 6.69292, 6.48053, 5.73813, 5.43523, 6.23434, 6.21581};
   // double mean[] = {6.64276, 6.53041, 6.33956, 5.66645, 5.36331, 6.12615, 6.10894}; // updated MIP
