...
process.fillfraction = cms.EDAnalyzer("FillLayerRangeEnergyFractionAnalyzer",
    ...
    output = cms.untracked.string("EnergyFraction_ABC_MinEnergy_LowFraction_108532.root"),
)
...
process.averagecharge = cms.EDAnalyzer("FillAverageChargeLayerAnalyzer",
    output = cms.untracked.string("TotalEnergy_ABC_MinEnergy_LowFraction_108532.root"),
...
process.eventdisplay = cms.EDAnalyzer("FillEventDisplayAnalyzer",
    output = cms.untracked.string("LowFractionEvents.root")
)
