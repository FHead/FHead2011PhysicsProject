...
process.fillfraction = cms.EDAnalyzer("FillLayerRangeEnergyFractionAnalyzer",
    ...
    output = cms.untracked.string("EnergyFraction_ABC_MinEnergy_LowFraction_ZeroVeto_108532.root"),
)

process.cutfraction = cms.EDFilter("LayerRangeEnergyFractionFilter",
    minLayer = cms.untracked.int32(9),
    maxLayer = cms.untracked.int32(15),
    minimum = cms.untracked.double(0.03)
)

process.averagecharge = cms.EDAnalyzer("FillAverageChargeLayerAnalyzer",
    output = cms.untracked.string("TotalEnergy_ABC_MinEnergy_LowFraction_ZeroVeto_108532.root"),
...
process.zerolayercut = cms.EDFilter("LayerZeroVetoFilter")

process.eventdisplay = cms.EDAnalyzer("FillEventDisplayAnalyzer",
    output = cms.untracked.string("LowFractionEvents_ZeroVeto.root")
)
