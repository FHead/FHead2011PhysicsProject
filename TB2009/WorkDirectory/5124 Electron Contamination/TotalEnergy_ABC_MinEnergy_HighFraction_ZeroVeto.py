...
process.fillfraction = cms.EDAnalyzer("FillLayerRangeEnergyFractionAnalyzer",
    output = cms.untracked.string("EnergyFraction_ABC_MinEnergy_HighFraction_ZeroVeto_108532.root"),
    minLayer = cms.untracked.int32(9),
    maxLayer = cms.untracked.int32(15)
)

process.fractioncut = cms.EDFilter("LayerRangeEnergyFractionFilter",
    minLayer = cms.untracked.int32(9),
    maxLayer = cms.untracked.int32(15),
...
process.averagecharge = cms.EDAnalyzer("FillAverageChargeLayerAnalyzer",
    output = cms.untracked.string("TotalEnergy_ABC_MinEnergy_HighFraction_ZeroVeto_108532.root"),
...
process.cutzeromax = cms.EDFilter("LayerZeroVetoFilter")
