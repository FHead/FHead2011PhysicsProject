...
process.es_ascii = cms.ESSource("HcalTextCalibrations",
    input = cms.VPSet(
        ...
        cms.PSet(
            ...
            file = cms.FileInPath('pedestals_TB2009_2.txt')
        ),
        cms.PSet(
...
process.output = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('file:/tmp/chenyi/output.root')
)

process.energydistribution = cms.EDAnalyzer("FillRHEnergyDistributionAnalyzer",
    normalModule = cms.untracked.string('hbhereco'),
    output = cms.untracked.string("file:NREnergyDistribution_106425.root")
)
...
process.pickevents = cms.EDFilter("EveryNthEventFilter",
   N = cms.untracked.int32(4),
   offset = cms.untracked.int32(2),
)
