...
process.fillfraction = cms.EDAnalyzer("FillLayerRangeEnergyFractionAnalyzer",
    ...
    output = cms.untracked.string("MuonFraction_ScaledMIP_Contamination.root"),
)
...
process.averagecharge = cms.EDAnalyzer("FillAverageChargeLayerAnalyzer",
    output = cms.untracked.string("TotalEnergy_ScaledMIP_Muon_Contamination_108303.root"),
...
process.eventdisplay = cms.EDAnalyzer("FillEventDisplayAnalyzer",
    output = cms.untracked.string("MuonEvents_ScaledMIP_Contamination_108303.root")
)
