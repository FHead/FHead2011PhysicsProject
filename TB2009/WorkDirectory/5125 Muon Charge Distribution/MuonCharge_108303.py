...
process.vlsbinfo = cms.EDProducer("VLSBInformationProducer",
    ...
    mip = cms.untracked.string("GeV?Calibration_preampoff.txt"),
    ...
    # pedestalMean = cms.untracked.string('PedestalMean_108303.txt')
)
...
process.fillfraction = cms.EDAnalyzer("FillLayerRangeEnergyFractionAnalyzer",
    ...
    output = cms.untracked.string("MuonFraction_108303.root"),
)
...
process.averagecharge = cms.EDAnalyzer("FillAverageChargeLayerAnalyzer",
    output = cms.untracked.string("TotalEnergy_Muon_108303.root"),
...
process.eventdisplay = cms.EDAnalyzer("FillEventDisplayAnalyzer",
    output = cms.untracked.string("MuonEvents_108303.root")
)
