...
process.vlsbinfo = cms.EDProducer("VLSBInformationProducer",
    ...
    pedestalFile = cms.untracked.string("PedestalMean_108532.txt")
)
...
process.percentage = cms.EDAnalyzer("FillCentralTowerEnergyPercentage",
   output = cms.untracked.string("CentralTowerEnergyPercentage_108532_ABC_MinEnergy.root")
)
...
process.fillfraction = cms.EDAnalyzer("FillLayerRangeEnergyFractionAnalyzer",
    output = cms.untracked.string("EnergyFraction_ABC_MinEnergy_108532.root"),
    minLayer = cms.untracked.int32(9),
    maxLayer = cms.untracked.int32(15)
)
