...
process.alignmuon = cms.EDAnalyzer("AlignPulseAnalyzer",
   rejectionSample = cms.untracked.int32(3),
   rejectionHeight = cms.untracked.double(0.1),
   output = cms.untracked.string("AlignPionTime.root")
)

process.p = cms.Path(process.tbunpack*process.ABCcut*process.vlsbinfo*process.alignmuon)
