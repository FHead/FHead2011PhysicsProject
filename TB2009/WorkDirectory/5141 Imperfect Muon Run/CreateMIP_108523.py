...
process.source = cms.Source("HcalTBSource",
    fileNames = cms.untracked.vstring("file:/tmp/chenyi/HTB_108523.root"),
...
process.percentage = cms.EDAnalyzer("FillCentralTowerEnergyPercentage",
   output = cms.untracked.string("Percentage_108523.root")
)

process.percentagecut = cms.EDFilter("CentralTowerEnergyPercentageFilter",
    cut = cms.untracked.double(0.5),
    includeMotherBoard0 = cms.untracked.bool(False),
    includeMotherBoard1 = cms.untracked.bool(False),
    includeMotherBoard3 = cms.untracked.bool(True),
)
