...
process.es_ascii = cms.ESSource("HcalTextCalibrations",
    input = cms.VPSet(
        ...
        cms.PSet(
            ...
            file = cms.FileInPath('gains_TB2009_Landau_LMIP.txt')
        )
    )
)
...
process.vlsbinfo = cms.EDProducer("VLSBInformationProducer",
    ...
    mip = cms.untracked.string("PercentageCorrectedMIP.txt"),
    ...
    pedestalFile = cms.untracked.string("PedestalMean_108540.txt"),
...
process.vlsbreco = cms.EDProducer("HcalTBVLSBReconstructor",
    minSample = cms.untracked.uint32(0),
    maxSample = cms.untracked.uint32(31),
    mipFileName = cms.untracked.string("PercentageCorrectedMIP.txt"),
    pedestalMeanFileName = cms.untracked.string("PedestalMean_108540.txt"),
