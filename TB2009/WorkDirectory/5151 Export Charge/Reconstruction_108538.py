...
process.mincut = cms.EDFilter("RHTotalEnergyCut",
    # minimum = cms.untracked.double(12.42),   # 2 sigma
    # minimum = cms.untracked.double(17.42),   # 1 sigma
    minimum = cms.untracked.double(14.92),   # 1.5 sigma
    vlsbModule = cms.untracked.string("vlsbreco"),
    normalModule = cms.untracked.string("hbhereco")
)

process.maxcut = cms.EDFilter("RHTotalEnergyCut",
    # minimum = cms.untracked.double(32.42),   # 2 sigma
    # minimum = cms.untracked.double(27.42),   # 1 sigma
    minimum = cms.untracked.double(29.92),   # 1.5 sigma
    vlsbModule = cms.untracked.string("vlsbreco"),
    normalModule = cms.untracked.string("hbhereco")
)
