...
process.es_ascii = cms.ESSource("HcalTextCalibrations",
    input = cms.VPSet(
        ...
        cms.PSet(
            ...
            file = cms.FileInPath('pedestals_TB2009_106425.txt')
        ),
        cms.PSet(
...
process.vlsbinfo = cms.EDProducer("VLSBInformationProducer",
    ...
    pedestalMean = cms.untracked.string("PedestalMean_106425.txt"),
...
process.vlsbreco = cms.EDProducer("HcalTBVLSBReconstructor",
    ...
    pedestalMeanFileName = cms.untracked.string("PedestalMean_106425.txt"),
...
process.energydistribution = cms.EDAnalyzer("FillRHEnergyDistributionAnalyzer",
    ...
    normalModule = cms.untracked.string("hbhereco"),
    output = cms.untracked.string("EnergyDistribution_ABC_106425.root")
)
