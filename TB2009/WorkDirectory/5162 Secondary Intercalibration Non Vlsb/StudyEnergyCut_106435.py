...
process.source = cms.Source("HcalTBSource",
    fileNames = cms.untracked.vstring('file:/tmp/chenyi/HTB_106435.root'),
...
process.es_ascii = cms.ESSource("HcalTextCalibrations",
    input = cms.VPSet(
        ...
        cms.PSet(
            ...
            file = cms.FileInPath('pedestals_TB2009_106435.txt')
        ),
        cms.PSet(
...
process.vlsbinfo = cms.EDProducer("VLSBInformationProducer",
    ...
    pedestalMean = cms.untracked.string("PedestalMean_106435.txt"),
...
process.vlsbreco = cms.EDProducer("HcalTBVLSBReconstructor",
    ...
    pedestalMeanFileName = cms.untracked.string("PedestalMean_106435.txt"),
...
process.energydistribution = cms.EDAnalyzer("FillRHEnergyDistributionAnalyzer",
    ...
    normalModule = cms.untracked.string("hbhereco"),
    output = cms.untracked.string("EnergyDistribution_ABC_106435.root")
)
