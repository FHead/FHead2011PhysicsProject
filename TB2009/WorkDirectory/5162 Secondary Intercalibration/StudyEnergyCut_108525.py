...
process.es_ascii = cms.ESSource("HcalTextCalibrations",
    input = cms.VPSet(
        ...
        cms.PSet(
            ...
            file = cms.FileInPath('pedestals_TB2009_108525.txt')
        ),
        cms.PSet(
...
process.vlsbreco = cms.EDProducer("HcalTBVLSBReconstructor",
    ...
    pedestalMeanFileName = cms.untracked.string("PedestalMean_108525.txt"),
...
process.energydistribution = cms.EDAnalyzer("FillRHEnergyDistributionAnalyzer",
    ...
    output = cms.untracked.string("EnergyDistribution_ABC_108525.root")
)
