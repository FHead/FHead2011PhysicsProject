...
process.vlsbreco = cms.EDProducer("HcalTBVLSBReconstructor",
    ...
    pedestalMeanFileName = cms.untracked.string("PedestalMean_108528.txt"),
...
process.energydistribution = cms.EDAnalyzer("FillRHEnergyDistributionAnalyzer",
    ...
    # normalModule = cms.untracked.string("hbhereco"),
    output = cms.untracked.string("EnergyDistribution_ABC_108528.root")
)

process.energy = cms.EDAnalyzer("FillAverageChargeLayerAnalyzer",
    output = cms.untracked.string("Energy_108528.root")
)
