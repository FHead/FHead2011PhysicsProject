...
process.source = cms.Source("HcalTBSource",
    fileNames = cms.untracked.vstring("file:/home/yichen/TB2009/HTB_108523.root"),
...
process.vlsbinfo = cms.EDProducer("VLSBInformationProducer",
    ...
    pedestalFile = cms.untracked.string("PedestalMean_108523.txt"),
...
process.percentage = cms.EDAnalyzer("FillCentralTowerEnergyPercentage",
   output = cms.untracked.string("CentralTowerEnergyPercentage_108523.root")
)
