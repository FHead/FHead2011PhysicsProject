...
process.es_ascii = cms.ESSource("HcalTextCalibrations",
    input = cms.VPSet(
        ...
        cms.PSet(
            ...
            file = cms.FileInPath('pedestals_TB2009_Profile_template.py.txt')
        ),
        cms.PSet(
...
process.source = cms.Source("HcalTBSource",
    fileNames = cms.untracked.vstring("file:/tmp/chenyi/HTB_Profile_template.py.root"),
...
process.averagecharge = cms.EDAnalyzer("FillAverageChargeLayerAnalyzer",
    output = cms.untracked.string("TotalEnergy_Profile_template.py.root"),
...
process.averagecharge_interpolated = cms.EDAnalyzer("FillAverageChargeLayerAnalyzer",
    output = cms.untracked.string("TotalEnergy_Interpolated_Profile_template.py.root"),
    textOutput = cms.untracked.bool(True),
...
process.filladc = cms.EDAnalyzer("FillAdcDistributionAnalyzer",
    ...
    output = cms.untracked.string("AdcDistribution_Profile_template.py.root")
)
...
process.energydistribution = cms.EDAnalyzer("FillCRHEnergyDistributionAnalyzer",
    ...
    output = cms.untracked.string("EnergyDistribution_ABC_Profile_template.py.root")
)

process.vlsbreco = cms.EDProducer("HcalTBVLSBReconstructor",
    minSample = cms.untracked.uint32(0),
    maxSample = cms.untracked.uint32(31),
    mipFileName = cms.untracked.string("MIP_EarlyRejection.txt"),
...
process.merge = cms.EDProducer("CombineCollectionProducer",
    ...
    interCalibration = cms.untracked.string("InterCalibration_EarlyRejection.txt")
)
