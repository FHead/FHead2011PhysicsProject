...
process.simHcalDigis.digiLabel = cms.InputTag("hcalDigis")
process.simHcalDigis.HBlevel = cms.int32(0)
...
process.averagecharge = cms.EDAnalyzer("FillAverageChargeLayerAnalyzer",
    output = cms.untracked.string("TotalEnergy___RUNNUM__.root"),
...
process.averagecharge_interpolated = cms.EDAnalyzer("FillAverageChargeLayerAnalyzer",
    output = cms.untracked.string("TotalEnergy_Interpolated___RUNNUM__.root"),
    textOutput = cms.untracked.bool(True),
...
process.filladc = cms.EDAnalyzer("FillAdcDistributionAnalyzer",
    ...
    output = cms.untracked.string("AdcDistribution___RUNNUM__.root")
)
...
process.vlsbreco = cms.EDProducer("HcalTBVLSBReconstructor",
    ...
    zeroSuppressionLevel = cms.untracked.double(200)
)
