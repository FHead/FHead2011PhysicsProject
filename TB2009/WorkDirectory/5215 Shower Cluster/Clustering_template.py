...
process.source = cms.Source("HcalTBSource",
    fileNames = cms.untracked.vstring("file:/tmp/chenyi/HTB___RUNNUMBER__.root"),
...
process.fillcluster = cms.EDAnalyzer("FillShowerClusterDistributions",
    ...
    output = cms.untracked.string('ClusterInfo___RUNNUMBER__.root')
)

process.averagecharge = cms.EDAnalyzer("FillAverageChargeLayerAnalyzer",
    output = cms.untracked.string("TotalEnergy_ABC_MinEnergy___RUNNUMBER__.root"),
