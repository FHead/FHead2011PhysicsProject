...
process.maxlayer = cms.EDAnalyzer("FillMaxLayerDistributionAnalyzer",
    output = cms.untracked.string("MaxLayer_108540.root")
)

process.ABChitfilter = cms.EDFilter("SingleTowerParticleFilter")
...
process.p = cms.Path(process.tbunpack*process.vlsbinfo*process.ABChitfilter*process.timecut*process.hitcut*process.maxlayer)
