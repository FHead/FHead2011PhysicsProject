...
void CollectResult(string FileName, double AlphaCentralValue, int RunStart = 0, int RunEnd = 137);

void CollectResult(string FileName, double AlphaCentralValue, int RunStart, int RunEnd)
{
