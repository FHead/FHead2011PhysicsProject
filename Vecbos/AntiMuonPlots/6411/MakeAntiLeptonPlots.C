...
void MakeAntiLeptonPlots(double Isolation = 0.3, string DataFile = "Samples/DataAll.root", string MCFile = "Samples/QDCppMuMuXAll.root")
{
   ...
   DataAntiHistogram1.Sumw2();
   MCAntiHistogram1.Sumw2();
   MCHistogram1.Sumw2();
   DataAntiHistogram2.Sumw2();
   MCAntiHistogram2.Sumw2();
   MCHistogram2.Sumw2();

   TChain DataChain("OutTreeNoIsolation", "OutTreeNoIsolation");
   ...
   TChain MCChain("OutTreeNoIsolation", "OutTreeNoIsolation");
   ...
   canvas.SaveAs("SingleLegAntiMuon.eps");
   ...
   canvas.SaveAs("DoubleLegAntiMuon.eps");
