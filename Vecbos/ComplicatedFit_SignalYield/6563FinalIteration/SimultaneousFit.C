   ...
   string DataHelperFile, bool Weighted, string SmearingMatrixFile)
{
   ...
   RooRealVar Alpha("Alpha", "Alpha parameter in signal yield", 4.6, 1, 10);
   RooRealVar Beta("Beta", "Beta parameter in signal yield", 0.30, -3, 3);
