   ...
   string DataHelperFile, bool Weighted, string SmearingMatrixFile)
{
   ...
   double AlphaL1 = (AlphaLValue * SmearingMatrix[1][1] + ZeroJetBinAlphaLValue * SmearingMatrix[1][0] * 5)
      / (SmearingMatrix[1][0] * 5 + SmearingMatrix[1][1]);
   double AlphaL0 = (-AlphaLValue * SmearingMatrix[0][1] + ZeroJetBinAlphaLValue * SmearingMatrix[0][0] * 5)
      / (-SmearingMatrix[0][1] + SmearingMatrix[0][0] * 5);
   ...
   RooRealVar AlphaL("AlphaL", "AlphaL", AlphaL1);
   ...
   RooRealVar ZeroJetBinAlphaL("ZeroJetBinAlphaL", "ZeroJetBinAlphaL", AlphaL0);
   ...
   RooRealVar ZeroJetBinSignalYield("ZeroJetBinSignalYield", "Zero-jet bin signal yield",
      DataSetTotalEntry * 0.8, 1, 10000000);   // this is exclusive
   RooRealVar SignalInclusiveYield("SignalInclusiveYield", "Signal yield for >= 1 jet",
      DataSetTotalEntry * 0.2, 1, 10000000);
   ...
   RooRealVar Alpha("Alpha", "Alpha parameter in signal yield", 4.4, 1, 10);
   RooRealVar Beta("Beta", "Beta parameter in signal yield", 0.60, -3, 3);
   ...
   // BackgroundJetYields[0]->setConstant();
