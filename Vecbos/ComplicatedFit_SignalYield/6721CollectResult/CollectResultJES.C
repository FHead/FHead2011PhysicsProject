...
void CollectResultJES();
void CollectResultJES(string Threshold);
...
void CollectResultJES(string Threshold)
{
   ...
   TFile F1(("NoJEC_Unfold_Weighted/UnfoldedResultW_pf_" + Threshold + ".root").c_str());
   TFile F2(("JECMinus_Unfold_Weighted/UnfoldedResultW_pf_" + Threshold + ".root").c_str());
   TFile F3(("JECPlus_Unfold_Weighted/UnfoldedResultW_pf_" + Threshold + ".root").c_str());
