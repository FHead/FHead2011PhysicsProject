...
void SimultaneousFit(string RootFile, int LastJetBin, string JetFlavor)
{
   // Dependent variables
   ...
   RooRealVar AlphaL("AlphaL", "AlphaL", 0.553, 50.01, 1000000);
   ...
   Notice.push_back("- I forgot to set sigmas the same....");
