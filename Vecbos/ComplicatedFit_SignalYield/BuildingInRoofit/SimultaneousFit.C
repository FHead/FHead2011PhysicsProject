...
void SimultaneousFit(string RootFile = "Samples/ZJetsAll.root", string BackgroundRootFile = "Samples/TTbarAll.root");
...
void SimultaneousFit(string RootFile, string BackgroundRootFile)
{
