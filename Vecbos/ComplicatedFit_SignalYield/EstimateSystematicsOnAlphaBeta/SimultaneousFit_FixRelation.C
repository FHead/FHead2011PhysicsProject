...
void SimultaneousFit_FixRelation(string RootFile, int LastJetBin, string JetFlavor, double AlphaLValue)
{
   ...
   RooRealVar PeakPosition("PeakPosition", "Z peak position", 90.82, 80, 100, "GeV/c^2");
   RooRealVar AlphaR("AlphaR", "AlphaR", 0.423, 0.01, 1000000);
   RooRealVar AlphaL("AlphaL", "AlphaL", AlphaLValue);
   RooRealVar Sigma("Sigma", "Sigma", 2.02, 0.01, 1000000);
   ...
   PsFileHelper PsFile("ResultPlots_FixRelation_" + JetFlavor + ".ps");
