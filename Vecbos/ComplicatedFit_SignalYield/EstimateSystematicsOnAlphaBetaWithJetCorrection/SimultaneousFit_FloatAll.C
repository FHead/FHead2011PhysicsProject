...
void SimultaneousFit_FloatAll(string RootFile = "Samples/DataAll.root", int LastJetBin = 4,
   string JetFlavor = "PF", double AlphaLValue = 0.485, string JetAppendix = "");
   ...
   string JetAppendix)
{
   ...
   RooRealVar Alpha("Alpha", "Alpha parameter in signal yield", 0.2843, 0.0001, 0.5);
   ...
   vector<RooRealVar *> SignalJetYields;
   ...
   PsFileHelper PsFile("ResultPlots_FloatAll_" + JetFlavor + "_" + JetAppendix + ".ps");
