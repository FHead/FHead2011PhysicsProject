...
do
   root -l -b -q "FitZPeak.C+(\"Samples/DataAllExceptLast.root\", \"DataFitNormalIsolation\", \"$i\", 0.3)"
   root -l -b -q "FitZPeak.C+(\"Samples/DataAllExceptLast.root\", \"DataFitTightIsolation\", \"$i\", 0.05)"
