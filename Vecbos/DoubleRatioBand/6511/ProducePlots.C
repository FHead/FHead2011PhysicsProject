...
void ProducePlots()
{
   TFile FWUnconstrained("combined-sim-excl-excl-weighted4.root");
   TFile FZUnconstrained("ZUnconstrained30.root");
   TFile FWConstrained("ZConstrained30.root");   // TODO TODO
   TFile FZConstrained("ZConstrained30.root");
   ...
   RooFitResult *WConstrained = (RooFitResult *)FWConstrained.Get("ConstrainedResult");
