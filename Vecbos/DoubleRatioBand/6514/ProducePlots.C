...
void ProducePlots()
{
   TFile FWUnconstrained("combined-sim-exclfit01234-weighted11.root");
   TFile FZUnconstrained("ZWeightedUnconstrained.root");
   TFile FWConstrained("combined-sim-constr-constr-weighted-final11.root");
   TFile FZConstrained("ZWeightedConstrained.root");
   ...
   RooFitResult *ZUnconstrained, RooFitResult *ZConstrained)
{
   ...
   WInclusiveYields.SetLineWidth(2);
   WInclusiveYields.SetMarkerStyle(20);
   ...
   WInclusiveRatio.SetLineWidth(2);
   WInclusiveRatio.SetMarkerStyle(20);
   ...
   ZInclusiveYields.SetLineWidth(2);
   ZInclusiveYields.SetMarkerStyle(20);
   ...
   ZInclusiveRatio.SetLineWidth(2);
   ZInclusiveRatio.SetMarkerStyle(20);
   ...
   WZInclusiveRatio.SetLineWidth(2);
   WZInclusiveRatio.SetMarkerStyle(20);
   ...
   WZInclusiveDoubleRatio.SetMarkerStyle(20);
   ...
   ConstrainedRatioBandGraph.SetLineWidth(2);
   ConstrainedRatioBandGraph.SetMarkerStyle(11);
   ConstrainedRatioBandGraph.SetTitle("Double Ratio Summary Plot (W/Z)");
   ConstrainedRatioBandGraph.Draw("al3");
   // ConstrainedRatioBandGraph.SetLineColor(8);
   // ConstrainedRatioBandGraph.Draw("p");
   ConstrainedRatioBandGraph.GetXaxis()->SetTitle("Jet count (N)");
   ConstrainedRatioBandGraph.GetYaxis()->SetTitle("Double ratio (#frac{(W+N Jet)/(W+(N+1) Jet)}{(Z+N Jet)/(Z+(N+1) Jet)})");
   ConstrainedRatioBandGraph.GetHistogram()->SetMaximum(3);
   WZInclusiveDoubleRatio.SetMarkerStyle(20);
