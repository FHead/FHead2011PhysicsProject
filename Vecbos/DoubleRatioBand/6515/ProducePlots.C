...
void ProducePlots()
{
   TFile FWUnconstrained("ZExclusiveUnweighted.root");
   TFile FZUnconstrained("ZExclusiveUnweighted.root");
   TFile FWConstrained("combined-sim-constr-constr-unfold-final10.root");
   TFile FZConstrained("ZUnweighted.root");

   RooFitResult *WUnconstrained = (RooFitResult *)FWUnconstrained.Get("UnconstrainedFitResult");   // TODO
   ...
   RooFitResult *ZUnconstrained, RooFitResult *ZConstrained)
{
   ...
   Texts.push_back("   (x) W inclusive yields: from unconstrained fit");
   Texts.push_back("   (x) W inclusive ratio: from unconstrained fit, divide yields directly");
   ...
   Texts.push_back("   (x) W/Z inclusive ratio: from unconstrained fit, assuming W/Z independent");
   Texts.push_back("   Polynomial ratio band: from constrained fit, dividing polynomials");
   Texts.push_back("   (x) Double-ratio from inclusive yields: divide unconstrained ratio");
   Texts.push_back("   (x) Last: overlay of band and points (previous two pages)");
