...
void ProducePlots()
{
   TFile FWUnconstrained("combined-sim-excl-excl-data-w30mt-5.root");
   TFile FZUnconstrained("ZWeighted.root");
   TFile FWConstrained("combined-sim-constr-constrained-data-w30mt-10.root");
