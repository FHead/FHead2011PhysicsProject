...
void ProduceRawPlots();
void ProduceRawPlots(RooFitResult *WUnconstrained, RooFitResult *WConstrained,
   RooFitResult *ZUnconstrained, RooFitResult *ZConstrained);

void ProduceRawPlots()
{
   TFile FWUnconstrained("combined-sim-excl-excl-raw-7000.root");
   TFile FZUnconstrained("Unconstrained/NoJEC_NoUnfold_Unweighted/ResultFileU_pf_30.root");
   TFile FWConstrained("combined-sim-constr-constrained-raw-7001.root");
   TFile FZConstrained("Constrained/NoJEC_NoUnfold_Unweighted/UnfoldedResultU_pf_30.root");
   ...
   ProduceRawPlots(WUnconstrained, WConstrained, ZUnconstrained, ZConstrained);
   ...
   RooFitResult *ZUnconstrained, RooFitResult *ZConstrained)
{
   ...
   // Output file!
   PsFileHelper PsFile("RAWDoubleRatioPlots.ps");
   ...
   ConstrainedRatioBandGraphCanvas.SaveAs("RAWRatioBand.C");
   ConstrainedRatioBandGraphCanvas.SaveAs("RAWRatioBand.png");
   ConstrainedRatioBandGraphCanvas.SaveAs("RAWRatioBand.eps");
   ...
   WZInclusiveDoubleRatioCanvas.SaveAs("RAWDoubleRatioPlot.C");
   WZInclusiveDoubleRatioCanvas.SaveAs("RAwDoubleRatioPlot.png");
   WZInclusiveDoubleRatioCanvas.SaveAs("RAWDoubleRatioPlot.eps");
   ...
   canvas.SaveAs("RAWDoubleRatioSummaryPlot.C");
   canvas.SaveAs("RAwDoubleRatioSummaryPlot.png");
   canvas.SaveAs("RAWDoubleRatioSummaryPlot.eps");
