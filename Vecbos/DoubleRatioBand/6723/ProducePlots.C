...
void ProducePlots()
{
   ...
   TFile FZUnconstrained("UnconstrainedNoUnfold/NoJEC_NoUnfold_Weighted/ResultFileW_pf_30.root");
   TFile FWConstrained("summary_BG/central.root");
   ...
   RooFitResult *WConstrained = (RooFitResult *)FWConstrained.Get("fitres");
