...
void MakeCombinedPlots(PsFileHelper &PsFile, TH1D *ZJets, TH1D *WJets, TH1D *TTbar, TH1D *QCD, bool SingleLeg, int JetMultiplicity, string JetFlavor)
{
   ...
   if(SingleLeg == true)
   {
      ...
      Canvas.SaveAs(Form("Plots/SingleLeg_NoQCD_%d%sJet.eps", JetMultiplicity, JetFlavor.c_str()));
   }
   else
   {
      Canvas.SaveAs(Form("Plots/DoubleLeg_NoQCD_%d%sJet.png", JetMultiplicity, JetFlavor.c_str()));
      Canvas.SaveAs(Form("Plots/DoubleLeg_NoQCD_%d%sJet.eps", JetMultiplicity, JetFlavor.c_str()));
   }
   ...
   if(SingleLeg == true)
   {
      ...
      Canvas.SaveAs(Form("Plots/SingleLeg_WithQCD_%d%sJet.eps", JetMultiplicity, JetFlavor.c_str()));
   }
   else
   {
      Canvas.SaveAs(Form("Plots/DoubleLeg_WithQCD_%d%sJet.png", JetMultiplicity, JetFlavor.c_str()));
      Canvas.SaveAs(Form("Plots/DoubleLeg_WithQCD_%d%sJet.eps", JetMultiplicity, JetFlavor.c_str()));
   }
   ...
   if(SingleLeg == true)
   {
      ...
      Canvas.SaveAs(Form("Plots/SingleLeg_BackgroundToSignalRatio_%d%sJet.eps", JetMultiplicity, JetFlavor.c_str()));
   }
   else
   {
      Canvas.SaveAs(Form("Plots/DoubleLeg_BackgroundToSignalRatio_%d%sJet.png", JetMultiplicity, JetFlavor.c_str()));
      Canvas.SaveAs(Form("Plots/DoubleLeg_BackgroundToSignalRatio_%d%sJet.eps", JetMultiplicity, JetFlavor.c_str()));
   }
