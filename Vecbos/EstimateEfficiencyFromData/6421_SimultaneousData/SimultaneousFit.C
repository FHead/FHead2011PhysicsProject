...
void SimultaneousFit()
{
   SimultaneousFit_FloatAll("Samples/DataAll.root", 4, "Calo", 0.522, "EfficiencyTreeOriginal");
   SimultaneousFit_FloatAll("Samples/DataAll.root", 4, "Calo", 0.522, "EfficiencyTreeIso");
   SimultaneousFit_FloatAll("Samples/DataAll.root", 4, "Calo", 0.522, "EfficiencyTreeHit");
   SimultaneousFit_FloatAll("Samples/DataAll.root", 4, "Calo", 0.522, "EfficiencyTreeChi2");
}
