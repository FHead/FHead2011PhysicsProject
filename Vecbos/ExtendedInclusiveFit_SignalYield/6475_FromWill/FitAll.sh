...
root -l -b -q "SimultaneousFit_FloatAll.C+(\"Samples/data_w15.root\", 5, \"pf\", 15, $DHFile, true)"

DHFile="\"Samples/data_w15_unweighted.dh\""
root -l -b -q "SimultaneousFit_FloatAll.C+(\"Samples/data_w15.root\", 5, \"pf\", 15, $DHFile, false)"
