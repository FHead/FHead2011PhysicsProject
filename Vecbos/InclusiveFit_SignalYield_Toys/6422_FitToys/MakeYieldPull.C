...
void MakeYieldPull(string RootFile = "CaloFitResult_00001_00300.root")
{
   ...
   double SignalYield[] = {3117, 688.975, 139.492, 36.0101, 5.80152};
   ...
   for(int i = 0; i < EntryCount; i++)
   {
      ...
      Pull1.Fill((InclusiveSignal[0] - SignalYield[0]) / InclusiveSignalError[0]);
