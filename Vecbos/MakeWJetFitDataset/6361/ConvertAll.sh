...
root -l -b -q "ConvertToDataset.C+(\"QCDAll.root\", \"QCDAll.Dataset.root\", 85254400)"
root -l -b -q "ConvertToDataset.C+(\"SingleTopSAll.root\", \"SingleTopSAll.Dataset.root\", 4.5 * 0.32442)"
root -l -b -q "ConvertToDataset.C+(\"SingleTopTAll.root\", \"SingleTopTAll.Dataset.root\", 63 * 0.32442)"
