...
void PlotJetEnergyCorrectionPlots(TFile &F, PsFileHelper &PsFile, string HistogramName);
...
void MakeVecbosPlots(string RootFile, string OutputBase)
{
   ...
   HZMass->Draw();
   Canvas.SetLogy();
   Canvas.SaveAs("HZMass.png");
   Canvas.SaveAs("HZMass.eps");
   Canvas.SaveAs("HZMass.C");
   ...
   PlotJetEnergyCorrectionPlots(F, PsFile, "HCaloJetCorrectionCountVsType");
   // PlotJetEnergyCorrectionPlots(F, PsFileEnergyScale, "HCaloJetCorrectionCountVsType");
   ...
   SaveToFile(F, "HPFJetClosestToFirstLegDEtaDPhi", "colz", false, true);
   SaveToFile(F, "HPFJetClosestToSecondLegDEtaDPhi", "colz", false, true);

   SaveToFile(F, "HPFJetClosestToFirstLegPTPT", "colz", false, true);
   SaveToFile(F, "HPFJetClosestToSecondLegPTPT", "colz", false, true);
   
   SaveToFile(F, "HPFJetClosestToFirstLegPTOverMuonPT", "", true);
   SaveToFile(F, "HPFJetClosestToSecondLegPTOverMuonPT", "", true);

   PsFile.AddHistogramFromFile(F, "HPFJetCorrectionCountVsType", "text0 colz", false);

   PlotJetEnergyCorrectionPlots(F, PsFile, "HPFJetCorrectionCountVsType");
   // PlotJetEnergyCorrectionPlots(F, PsFileEnergyScale, "HPFJetCorrectionCountVsType");
...
void PlotJetEnergyCorrectionPlots(TFile &F, PsFileHelper &PsFile, string HistogramName)
{
   ...
   Canvas.SaveAs(Form("%s_JES.png", HistogramName.c_str()));
...
void SaveToFile(TFile &F, string HistogramName, string Option, bool LogY, bool LogZ)
{
   ...
   canvas.SaveAs((HistogramName + ".eps").c_str());
   canvas.SaveAs((HistogramName + ".png").c_str());
   canvas.SaveAs((HistogramName + ".C").c_str());

   gROOT->ProcessLine((".! epstopdf " + HistogramName + ".eps").c_str());
}
