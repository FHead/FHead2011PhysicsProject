...
\begin{figure}
   \centering
   \includegraphics[width=110mm]{SummaryPlotAlphaL}
...
% The fit is taking forever.....I'll make the fit with smaller statistics if it hasn't finished by tonight.
% \begin{table}[htdp]
...
\begin{figure}[hbtp]
   \begin{center} 
  \includegraphics[width=110mm]{FinalPlot_FloatAll_Calo_30}
...
\begin{figure}[hbtp]
   \begin{center}
   \includegraphics[width=110mm]{FinalPlot_FloatAll_UncorrectedCalo_20}
...
\begin{figure}[hbtp]
   \begin{center}
   \includegraphics[width=110mm]{FinalPlot_FloatAll_PF_20}
...
\begin{figure}[hbtp]
   \begin{center}
   \includegraphics[width=110mm]{FinalPlot_FloatAll_Track_20}
...
\begin{figure}[hbtp]
   \begin{center} 
  \includegraphics[width=110mm]{FitPlot_Calo_30}
...
\begin{figure}[hbtp]
   \begin{center} 
  \includegraphics[width=110mm]{FitPlot_UncorrectedCalo_20}
...
\begin{figure}[hbtp]
   \begin{center}
  \includegraphics[width=110mm]{FitPlot_PF_20}
...
\begin{figure}[hbtp]
   \begin{center} 
  \includegraphics[width=110mm]{FitPlot_Track_20}
...
\begin{figure}[hbtp]
\begin{center}
\includegraphics[width=150mm]{SummaryWithRatio_CaloJet_JES}
...
\begin{figure}[hbtp]
\begin{center}
\includegraphics[width=150mm]{SummaryWithRatio_PFJet_JES}
...
\begin{figure}[hbtp]
\begin{center}
\includegraphics[width=150mm]{AlphaBetaPull}
