...
int main()
{
   ...
   // pythia.readString("24:oneChannel = 1 1 0 -11 12");   // force W to decay to e nu
   // pythia.readString("23:oneChannel = 1 1 0 11 -11");   // force Z to decay to e e
